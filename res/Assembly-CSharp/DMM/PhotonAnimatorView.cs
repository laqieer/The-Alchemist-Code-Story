...
public class PhotonAnimatorView : MonoBehaviour, IPunObservable
{
  ...
  public PhotonAnimatorView.SynchronizeType GetLayerSynchronizeType(int layerIndex)
  {
    ...
    return index == -1 ? PhotonAnimatorView.SynchronizeType.Disabled : this.m_SynchronizeLayers[index].SynchronizeType;
  }
  ...
  public PhotonAnimatorView.SynchronizeType GetParameterSynchronizeType(string name)
  {
    ...
    return index == -1 ? PhotonAnimatorView.SynchronizeType.Disabled : this.m_SynchronizeParameters[index].SynchronizeType;
  }

  public void SetLayerSynchronized(
    int layerIndex,
    PhotonAnimatorView.SynchronizeType synchronizeType)
  {
  ...
  public void SetParameterSynchronized(
    string name,
    PhotonAnimatorView.ParameterType type,
    PhotonAnimatorView.SynchronizeType synchronizeType)
  {
    if (Application.isPlaying)
      this.m_WasSynchronizeTypeChanged = true;
