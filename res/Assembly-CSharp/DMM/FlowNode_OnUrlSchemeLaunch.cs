...
public class FlowNode_OnUrlSchemeLaunch : FlowNodePersistent
{
  ...
  {
    return string.IsNullOrEmpty(s0) ? string.IsNullOrEmpty(s1) : !string.IsNullOrEmpty(s1) && s0.Equals(s1);
  }

  public static FlowNode_OnUrlSchemeLaunch Instance => FlowNode_OnUrlSchemeLaunch.mInstance;
  ...
  public static bool IsExecuting
  {
    get
    {
      ...
      FlowNode_OnUrlSchemeLaunch component = gameObject.GetComponent<FlowNode_OnUrlSchemeLaunch>();
  ...
  {
    base.Awake();
    FlowNode_OnUrlSchemeLaunch.mInstance = this;
  }
  ...
  private void Update()
  {
    ...
    {
      if (!this.StartCheck || !FlowNode_GetCurrentScene.IsAfterLogin() || UnityEngine.Object.op_Equality((UnityEngine.Object) MonoSingleton<GameManager>.GetInstanceDirect(), (UnityEngine.Object) null) || string.IsNullOrEmpty(MonoSingleton<GameManager>.GetInstanceDirect().Player.Name) || UnityEngine.Object.op_Equality((UnityEngine.Object) EventSystem.current, (UnityEngine.Object) null) || UnityEngine.Object.op_Equality((UnityEngine.Object) EventSystem.current.currentInputModule, (UnityEngine.Object) null) || !((Behaviour) EventSystem.current.currentInputModule).enabled || Network.IsConnecting || UnityEngine.Object.op_Inequality((UnityEngine.Object) HomeWindow.Current, (UnityEngine.Object) null) && HomeWindow.Current.IsSceneChanging || BlockInterrupt.IsBlocked(BlockInterrupt.EType.URL_SCHEME_LAUNCH) || CriticalSection.IsActive || !GlobalVars.IsTutorialEnd)
        return;
      ...
      if (!this.UpdatePendingParam())
        return;
      if (!FlowNode_OnUrlSchemeLaunch.IsQRAccess && UnityEngine.Object.op_Inequality((UnityEngine.Object) MonoSingleton<GameManager>.GetInstanceDirect(), (UnityEngine.Object) null))
      {
  ...
  public bool UpdatePendingParam()
  {
  ...
  private string[] ParseSchemeParams(string str, int encode_key = -1)
  {
    ...
    if (strArray2 == null || strArray2.Length <= 1 || strArray2[1] == null)
      return (string[]) null;
    string s = UnityWebRequest.UnEscapeURL(strArray2[1]);
    byte[] data;
    try
    {
    ...
    return MyEncrypt.Decrypt(encode_key, data).Split('&');
  }
  ...
  private void CreateQRCode()
  {
    ...
    Debug.Log((object) ("URLScheme=>" + (str + UnityWebRequest.EscapeURL(Convert.ToBase64String(inArray)))));
  }
  ...
  private FlowNode_OnUrlSchemeLaunch.LINEParam Analyze(string str)
  {
    ...
    if (strArray1.Length <= 1 || strArray1[1] == null)
      return (FlowNode_OnUrlSchemeLaunch.LINEParam) null;
    string s = UnityWebRequest.UnEscapeURL(strArray1[1].Split('=')[1]);
    byte[] data;
    try
    {
      data = Convert.FromBase64String(s);
    ...
    string[] strArray2 = MyEncrypt.Decrypt(JSON_MyPhotonRoomParam.LINE_PARAM_ENCODE_KEY, data).Split('&');
  ...
  public class LINEParam
  {
    ...
    {
      return tgt != null && tgt is FlowNode_OnUrlSchemeLaunch.LINEParam lineParam && this.type == lineParam.type && FlowNode_OnUrlSchemeLaunch.IsEqual(this.iname, lineParam.iname) && FlowNode_OnUrlSchemeLaunch.IsEqual(this.creatorFUID, lineParam.creatorFUID) && this.roomid == lineParam.roomid;
    }
  }
}
