...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<Json_PlayerDataAll>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      Json_PlayerDataAll jsonPlayerDataAll = (Json_PlayerDataAll) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              jsonPlayerDataAll = formatterResolver.GetFormatterWithVerify<Json_PlayerDataAll>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqUpdateBingo.MP_UpdateBingoResponse updateBingoResponse = new FlowNode_ReqUpdateBingo.MP_UpdateBingoResponse();
      updateBingoResponse.body = jsonPlayerDataAll;
      updateBingoResponse.stat = num3;
      updateBingoResponse.stat_msg = str1;
      updateBingoResponse.stat_code = str2;
      updateBingoResponse.time = num4;
      updateBingoResponse.ticket = num5;
      return updateBingoResponse;
    }
  }
}
