...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<Json_QuestList>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              jsonQuestList = formatterResolver.GetFormatterWithVerify<Json_QuestList>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqQuestParam.MP_QuestParam mpQuestParam = new FlowNode_ReqQuestParam.MP_QuestParam();
      mpQuestParam.body = jsonQuestList;
      mpQuestParam.stat = num3;
      mpQuestParam.stat_msg = str1;
      mpQuestParam.stat_code = str2;
      mpQuestParam.time = num4;
      mpQuestParam.ticket = num5;
      return mpQuestParam;
    }
  }
}
