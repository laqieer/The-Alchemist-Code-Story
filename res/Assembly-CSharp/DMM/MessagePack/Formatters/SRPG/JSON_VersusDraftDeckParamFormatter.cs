    ...
    IMessagePackFormatter
  {
    ...
    public JSON_VersusDraftDeckParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[3][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("secret_max")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.secret_max);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_VersusDraftDeckParam()
      {
        id = num3,
        name = str,
        secret_max = num4
