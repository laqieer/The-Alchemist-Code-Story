...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_MasterParam>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              jsonMasterParam = formatterResolver.GetFormatterWithVerify<JSON_MasterParam>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqMasterParam.MP_MasterParam mpMasterParam = new FlowNode_ReqMasterParam.MP_MasterParam();
      mpMasterParam.body = jsonMasterParam;
      mpMasterParam.stat = num3;
      mpMasterParam.stat_msg = str1;
      mpMasterParam.stat_code = str2;
      mpMasterParam.time = num4;
      mpMasterParam.ticket = num5;
      return mpMasterParam;
    }
  }
}
