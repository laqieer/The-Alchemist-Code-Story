...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public MultiPlayResumeMhmDmgFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("typ"),
        MessagePackBinary.GetEncodedStringBytes("dmg")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.typ);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[1]);
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.dmg);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new MultiPlayResumeMhmDmg()
      {
        typ = num3,
        dmg = num4
      };
