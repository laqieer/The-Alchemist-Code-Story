...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_FilterConceptCardConditionParam[]>().Serialize(ref bytes, offset, value.cnds, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      int num3 = 0;
      JSON_FilterConceptCardConditionParam[] cardConditionParamArray = (JSON_FilterConceptCardConditionParam[]) null;
        ...
        else
        {
          switch (num4)
          {
            ...
            case 3:
              ...
              break;
            case 4:
              cardConditionParamArray = formatterResolver.GetFormatterWithVerify<JSON_FilterConceptCardConditionParam[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_FilterConceptCardParam()
      {
        iname = str1,
        tab_name = str2,
        name = str3,
        filter_type = num3,
        cnds = cardConditionParamArray
      };
    }
  }
}
