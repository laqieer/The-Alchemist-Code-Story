    ...
    IMessagePackFormatter
  {
    ...
    public JSON_TrophyStarMissionParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[5][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("stars")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_TrophyStarMissionParam.StarSetParam[]>().Serialize(ref bytes, offset, value.stars, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_TrophyStarMissionParam.StarSetParam[] starSetParamArray = (JSON_TrophyStarMissionParam.StarSetParam[]) null;
        ...
        else
        {
          switch (num4)
          {
            ...
            case 3:
              ...
              break;
            case 4:
              starSetParamArray = formatterResolver.GetFormatterWithVerify<JSON_TrophyStarMissionParam.StarSetParam[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_TrophyStarMissionParam()
      {
        iname = str1,
        type = num3,
        begin_at = str2,
        end_at = str3,
        stars = starSetParamArray
      };
    }
  }
}
