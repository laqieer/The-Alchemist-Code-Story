...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqSetConceptCardList.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqSetConceptCardList.Response response = (ReqSetConceptCardList.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqSetConceptCardList.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      PartyWindow2.MP_Response_SetConceptCardList setConceptCardList = new PartyWindow2.MP_Response_SetConceptCardList();
      setConceptCardList.body = response;
      setConceptCardList.stat = num3;
      setConceptCardList.stat_msg = str1;
      setConceptCardList.stat_code = str2;
      setConceptCardList.time = num4;
      setConceptCardList.ticket = num5;
      return setConceptCardList;
    }
  }
}
