...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_UnitRentalNotificationDataParamFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("pers"),
        MessagePackBinary.GetEncodedStringBytes("sys_id")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<int[]>().Serialize(ref bytes, offset, value.pers, formatterResolver);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[1]);
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.sys_id, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_UnitRentalNotificationDataParam()
      {
        pers = numArray,
        sys_id = str
      };
