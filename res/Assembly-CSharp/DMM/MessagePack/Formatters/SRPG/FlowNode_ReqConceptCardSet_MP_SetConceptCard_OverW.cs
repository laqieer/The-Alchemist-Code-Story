...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqSetConceptCard_OverWrite.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqSetConceptCard_OverWrite.Response response = (ReqSetConceptCard_OverWrite.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqSetConceptCard_OverWrite.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqConceptCardSet.MP_SetConceptCard_OverWriteResponse overWriteResponse = new FlowNode_ReqConceptCardSet.MP_SetConceptCard_OverWriteResponse();
