    ...
    IMessagePackFormatter
  {
    ...
    public JSON_GrowParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[2][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("curve")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GrowCurve[]>().Serialize(ref bytes, offset, value.curve, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GrowCurve[] jsonGrowCurveArray = (JSON_GrowCurve[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              jsonGrowCurveArray = formatterResolver.GetFormatterWithVerify<JSON_GrowCurve[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GrowParam()
      {
        type = str,
        curve = jsonGrowCurveArray
      };
    }
  }
}
