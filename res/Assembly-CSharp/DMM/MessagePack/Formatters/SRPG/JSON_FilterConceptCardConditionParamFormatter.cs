    ...
    IMessagePackFormatter
  {
    ...
    public JSON_FilterConceptCardConditionParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[5][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("card_group")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.card_group, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_FilterConceptCardConditionParam()
      {
        cnds_iname = str1,
        name = str2,
        rarity = num3,
