    ...
    IMessagePackFormatter
  {
    ...
    public MultiPlayGimmickEventParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[2][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("completed")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.completed);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new MultiPlayGimmickEventParam()
      {
        count = num3,
        completed = num4
      };
