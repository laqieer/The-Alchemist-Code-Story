...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestEnd.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqAutoRepeatQuestEnd.Response response = (ReqAutoRepeatQuestEnd.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestEnd.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqAutoRepeatQuestResult.MP_AutoRepeatQuestEndResponse questEndResponse = new FlowNode_ReqAutoRepeatQuestResult.MP_AutoRepeatQuestEndResponse();
      questEndResponse.body = response;
      questEndResponse.stat = num3;
      questEndResponse.stat_msg = str1;
      questEndResponse.stat_code = str2;
      questEndResponse.time = num4;
      questEndResponse.ticket = num5;
      return questEndResponse;
    }
  }
}
