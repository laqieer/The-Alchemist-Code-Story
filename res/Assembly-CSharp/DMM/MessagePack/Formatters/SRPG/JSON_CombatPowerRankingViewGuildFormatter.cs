...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      out int readSize)
    {
      ...
      JSON_CombatPowerRankingViewGuild rankingViewGuild = new JSON_CombatPowerRankingViewGuild();
      rankingViewGuild.rank = num3;
      rankingViewGuild.combat_power = num4;
      rankingViewGuild.id = num5;
      rankingViewGuild.name = str1;
      rankingViewGuild.award_id = str2;
      rankingViewGuild.level = num6;
      rankingViewGuild.count = num7;
      rankingViewGuild.max_count = num8;
      rankingViewGuild.guild_master = str3;
      rankingViewGuild.created_at = num9;
      return rankingViewGuild;
    }
  }
}
