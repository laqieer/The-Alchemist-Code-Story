...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_GuildRaidRewardDmgRankingRankParamFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("rank_start"),
        MessagePackBinary.GetEncodedStringBytes("rank_end"),
        MessagePackBinary.GetEncodedStringBytes("reward_round_id")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.rank_start);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[1]);
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.rank_end);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[2]);
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.reward_round_id, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_GuildRaidRewardDmgRankingRankParam()
      {
        rank_start = num3,
        rank_end = num4,
        reward_round_id = str
