...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqJukeBoxPlaylistDel.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqJukeBoxPlaylistDel.Response response = (ReqJukeBoxPlaylistDel.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqJukeBoxPlaylistDel.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqJukeBoxMylistDel.MP_Del_Response mpDelResponse = new FlowNode_ReqJukeBoxMylistDel.MP_Del_Response();
      mpDelResponse.body = response;
      mpDelResponse.stat = num3;
      mpDelResponse.stat_msg = str1;
      mpDelResponse.stat_code = str2;
      mpDelResponse.time = num4;
      mpDelResponse.ticket = num5;
      return mpDelResponse;
    }
  }
}
