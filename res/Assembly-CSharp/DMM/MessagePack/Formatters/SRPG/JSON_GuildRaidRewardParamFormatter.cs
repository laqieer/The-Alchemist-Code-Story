...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GuildRaidReward[]>().Serialize(ref bytes, offset, value.rewards, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GuildRaidReward[] jsonGuildRaidRewardArray = (JSON_GuildRaidReward[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              jsonGuildRaidRewardArray = formatterResolver.GetFormatterWithVerify<JSON_GuildRaidReward[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GuildRaidRewardParam()
      {
        id = str,
        rewards = jsonGuildRaidRewardArray
      };
    }
  }
}
