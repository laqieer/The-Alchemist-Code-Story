    ...
    IMessagePackFormatter
  {
    ...
    public JSON_ConceptCardTrustRewardItemParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[3][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("reward_num")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.reward_num);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_ConceptCardTrustRewardItemParam()
      {
        reward_type = num3,
        reward_iname = str,
        reward_num = num4
