...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_GuildRaidRewardDmgRatioFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("damage_ratio"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.damage_ratio);
      ...
      out int readSize)
    {
      ...
      return new JSON_GuildRaidRewardDmgRatio()
      {
        damage_ratio = num3,
        reward_round_id = str
      };
