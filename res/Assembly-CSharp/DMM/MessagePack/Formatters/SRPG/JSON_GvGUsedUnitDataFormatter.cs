    ...
    IMessagePackFormatter
  {
    ...
    public JSON_GvGUsedUnitDataFormatter()
    {
      ...
      this.____stringByteKeys = new byte[3][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("used")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.limit, formatterResolver);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[2]);
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.used, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_GvGUsedUnitData()
      {
        uiid = num3,
        limit = str1,
        used = str2
