...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GvGRewardDetailParam[]>().Serialize(ref bytes, offset, value.rewards, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GvGRewardDetailParam[] grewardDetailParamArray = (JSON_GvGRewardDetailParam[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              grewardDetailParamArray = formatterResolver.GetFormatterWithVerify<JSON_GvGRewardDetailParam[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GvGRewardParam()
      {
        id = str,
        rewards = grewardDetailParamArray
      };
    }
  }
}
