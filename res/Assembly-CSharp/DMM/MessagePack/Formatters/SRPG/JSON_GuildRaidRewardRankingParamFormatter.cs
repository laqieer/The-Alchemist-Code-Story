...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GuildRaidRewardRankingDataParam[]>().Serialize(ref bytes, offset, value.ranking, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GuildRaidRewardRankingDataParam[] rankingDataParamArray = (JSON_GuildRaidRewardRankingDataParam[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              rankingDataParamArray = formatterResolver.GetFormatterWithVerify<JSON_GuildRaidRewardRankingDataParam[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GuildRaidRewardRankingParam()
      {
        id = str,
        ranking = rankingDataParamArray
      };
    }
  }
}
