...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_ReplacePeriodFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("sprite_name"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.sprite_name, formatterResolver);
