    ...
    IMessagePackFormatter
  {
    ...
    public JSON_WorldRaidBossParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[7][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("detail_url"),
        MessagePackBinary.GetEncodedStringBytes("detail_title")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt64(ref bytes, offset, value.hp);
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.detail_url, formatterResolver);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[6]);
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.detail_title, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_WorldRaidBossParam()
      {
        iname = str1,
        name = str2,
        hp = num3,
