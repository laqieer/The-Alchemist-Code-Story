    ...
    IMessagePackFormatter
  {
    ...
    public JSON_TobiraCondsUnitParam_JobCondFormatter()
    {
      ...
      this.____stringByteKeys = new byte[2][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("job_lv")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.job_lv);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_TobiraCondsUnitParam.JobCond()
      {
        job_iname = str,
        job_lv = num3
      };
