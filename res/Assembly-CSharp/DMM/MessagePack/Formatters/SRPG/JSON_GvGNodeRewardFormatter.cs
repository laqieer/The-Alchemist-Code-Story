...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_GvGNodeRewardFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("league_id"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.league_id, formatterResolver);
