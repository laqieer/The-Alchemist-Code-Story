...
namespace MessagePack.Internal
{
  ...
  {
    public static readonly IFormatterResolver Instance = (IFormatterResolver) new StandardResolverAllowPrivateCore();
    ...
    {
      return StandardResolverAllowPrivateCore.FormatterCache<T>.formatter;
    }
    ...
    private static class FormatterCache<T>
    {
      ...
      {
        foreach (IFormatterResolver resolver in StandardResolverAllowPrivateCore.resolvers)
        {
          IMessagePackFormatter<T> formatter = resolver.GetFormatter<T>();
          if (formatter != null)
          {
            StandardResolverAllowPrivateCore.FormatterCache<T>.formatter = formatter;
            break;
          }
        }
      }
