...
namespace SRPG
{
  ...
  public class FlowCommonWindow : FlowNodePersistent
  {
    ...
    public FlowCommonWindow.RootWindow rootWindow => this.m_RootWindow;
    ...
    private IEnumerator Start()
    {
      ...
      return (IEnumerator) new FlowCommonWindow.\u003CStart\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    private void LateUpdate() => this.m_WindowController.LateUpdate();
    ...
    public class RootWindow : FlowWindowBase
    {
      ...
      public override string name => "FlowCommonWindow.RootWindow";
      ...
      {
        public override System.Type type => typeof (FlowCommonWindow.RootWindow);
      }
    }
  }
}
