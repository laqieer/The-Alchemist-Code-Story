...
namespace SRPG
{
  ...
  public class FlowNode_TowerStartQuest : FlowNode_StartQuest
  {
    ...
    public override void OnActivate(int pinID)
    {
      ...
      PlayerPartyTypes playerPartyTypes = PlayerPartyTypes.Tower;
      GlobalVars.SelectedPartyIndex.Set((int) playerPartyTypes);
      MonoSingleton<GameManager>.Instance.Player.SetPartyCurrentIndex((int) playerPartyTypes);
      ...
      else
      {
        ...
        if (this.PlayOffline || Network.Mode != Network.EConnectMode.Online)
          return;
        PartyData partyOfType = instance1.Player.FindPartyOfType(playerPartyTypes);
    ...
    public override void OnSuccess(WWWResult www)
    {
      ...
      if (this.mResume)
      {
        ...
        if (jsonBodyResponse.body.btlinfo != null)
          MonoSingleton<GameManager>.Instance.TowerResuponse.TowerID = jsonBodyResponse.body.btlinfo.tower_iname;
      }
      ...
      else
      {
        ...
        if (jsonObject.body.guild_trophies != null)
          MonoSingleton<GameManager>.Instance.Player.GuildTrophyData.OverwriteGuildTrophyProgress(jsonObject.body.guild_trophies);
    ...
    private class Json_TowerBtlInfo : BattleCore.Json_BtlInfo
    {
      ...
      public override RandDeckResult[] GetDeck() => this.lot_enemies;
