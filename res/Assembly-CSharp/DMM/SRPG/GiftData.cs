...
namespace SRPG
{
  public class GiftData
  {
    ...
    {
      get => this.conceptCard == null ? string.Empty : this.conceptCard.iname;
    }

    public int ConceptCardNum => this.conceptCard == null ? 0 : this.conceptCard.num;

    public bool IsGetConceptCardUnit
    {
      get => this.conceptCard != null && !string.IsNullOrEmpty(this.conceptCard.get_unit);
    }

    public string ConceptCardGetUnitIname
    {
      get => this.conceptCard == null ? string.Empty : this.conceptCard.get_unit;
    }

    public int LimitBreakCount => this.conceptCard == null ? 0 : this.conceptCard.plus;

    public bool IsValidRarity => this.rarity != -1;

    public bool NotSet => this.giftTypes == 0L;
    ...
    public void SetGiftTypeIncluded(GiftTypes flag) => this.giftTypes |= (long) flag;
