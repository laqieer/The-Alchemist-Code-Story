...
namespace SRPG
{
  ...
  public class FlowNode_ReqRaidInfo : FlowNode_ReqRaidBase
  {
    ...
    public override bool Success(WWWResult www)
    {
      ...
      {
        Network.ResetError();
        UIUtility.SystemMessage(LocalizedText.Get("sys.RAID_BATTLE_ERR_BEAT_RESCUE_TITLE"), LocalizedText.Get("sys.RAID_BATTLE_ERR_BEAT_RESCUE_MSG"), (UIUtility.DialogResultEvent) (gameObject => this.ActivateOutputLinks(202)));
        return false;
      }
      ...
      try
      {
        ...
        if (jsonObject.body.raidboss.boss_info.is_timeover != 0)
        {
          ...
          if (raidBoss != null)
            str = raidBoss.Name;
          UIUtility.SystemMessage(LocalizedText.Get("sys.RAID_BATTLE_TIME_OVER_TITLE"), string.Format(LocalizedText.Get("sys.RAID_BATTLE_TIME_OVER_MSG"), (object) num, (object) str), (UIUtility.DialogResultEvent) (go => this.ActivateOutputLinks(201)));
          return false;
        }
        if (jsonObject.body.raidboss.boss_info.is_rescue_damage_zero != 0)
        {
          UIUtility.SystemMessage(LocalizedText.Get("sys.RAID_BATTLE_RESCUE_DAMAGE_ZERO_TITLE"), LocalizedText.Get("sys.RAID_BATTLE_RESCUE_DAMAGE_ZERO_MSG"), (UIUtility.DialogResultEvent) (go => this.ActivateOutputLinks(203)));
          return false;
        }
        if (jsonObject.body.raidboss.boss_info.is_beat_resucue != 0)
        {
          ...
          if (raidBoss != null)
            str = raidBoss.Name;
          UIUtility.SystemMessage(string.Format(LocalizedText.Get("sys.RAID_BATTLE_BEAT_RESCUE_TITLE"), (object) str), string.Format(LocalizedText.Get("sys.RAID_BATTLE_BEAT_RESCUE_MSG"), (object) str), (UIUtility.DialogResultEvent) null);
        }
    ...
    private IEnumerator DownloadUnitImage()
    {
      ...
      return (IEnumerator) new FlowNode_ReqRaidInfo.\u003CDownloadUnitImage\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
