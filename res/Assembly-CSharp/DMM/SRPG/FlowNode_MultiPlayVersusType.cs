...
namespace SRPG
{
  [FlowNode.NodeType("Multi/Versus/Type", 32741)]
  ...
  [FlowNode.Pin(115, "CheckDraftFriendOnly", FlowNode.PinTypes.Input, 115)]
  ...
  public class FlowNode_MultiPlayVersusType : FlowNode
  {
    ...
    private const int CHECK_DRAFT_FRIEND_ONLY = 115;
    ...
    public override void OnActivate(int pinID)
    {
      ...
      switch (pinID)
      {
        ...
        case 113:
          ...
          return;
        case 114:
          if (instance.VSDraftType == VersusDraftType.Draft || instance.VSDraftType == VersusDraftType.DraftFriend || instance.VSDraftType == VersusDraftType.DraftFriendOnly)
          {
            this.ActivateOutputLinks(201);
            return;
          }
          ...
          return;
        case 115:
          if (instance.VSDraftType == VersusDraftType.DraftFriendOnly)
          {
            this.ActivateOutputLinks(201);
            return;
          }
