  ...
  public class ItemListWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private void Start()
    {
      ...
      for (int index = 0; index < items.Count; ++index)
      {
        ...
        if (!itemData.Param.IsExpire && itemData.Num != 0 && itemData.Param.CheckCanShowInList())
    ...
    public class ItemSource : ContentSource
    {
      ...
      public override ContentNode Instantiate(ContentNode res)
      {
        ...
        return UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject, (UnityEngine.Object) null) ? (ContentNode) gameObject.AddComponent<ItemListWindow.ItemNode>() : (ContentNode) null;
      }
      ...
      public class ItemParam : ContentSource.Param
      {
        ...
        public ItemParam(ItemData item) => this.m_Item = item;

        public override bool IsValid() => this.m_Item != null;

        public ItemData data => this.m_Item;

        public EItemType itemType => this.m_Item.ItemType;
