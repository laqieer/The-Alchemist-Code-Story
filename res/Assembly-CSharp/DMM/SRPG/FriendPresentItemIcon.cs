...
namespace SRPG
{
  public class FriendPresentItemIcon : MonoBehaviour
  {
    ...
    public void SetRestTime(GameObject gobj, long endTime)
    {
      ...
      string str;
      if (num >= 86400L)
        str = LocalizedText.Get("sys.QUEST_TIMELIMIT_D", (object) (int) (num / 86400L));
      else if (num >= 3600L)
        str = LocalizedText.Get("sys.QUEST_TIMELIMIT_H", (object) (int) (num / 3600L));
      else
        str = LocalizedText.Get("sys.QUEST_TIMELIMIT_M", (object) (int) (num / 60L));
      component.text = str;
    }
