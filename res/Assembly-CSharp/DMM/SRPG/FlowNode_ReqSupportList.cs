...
namespace SRPG
{
  ...
  public class FlowNode_ReqSupportList : FlowNode_Network
  {
    ...
    public class Api_SupportList : FlowNode_ReqSupportList.ApiBase
    {
      ...
      {
        get => this.m_Element == EElement.None ? "btl/com/supportlist" : "btl/com/support_elem";
      }
      ...
      public override string req
      {
        get
        {
          ...
          stringBuilder.Append("\"elem\":" + (object) (int) this.m_Element);
          ...
          if (this.m_Select != null && this.m_Select.Count > 0)
          {
            ...
            for (int index = 0; index < this.m_Select.Count; ++index)
            {
              ...
              stringBuilder.Append(",\"elem\":" + (object) (int) this.m_Select[index].Unit.SupportElement);
    ...
    public class SupportList
    {
      ...
      public SupportList(EElement element) => this.m_Element = element;
