...
namespace SRPG
{
  ...
  public class FlowNode_ReqMultiInvitation : FlowNode_Network
  {
    ...
    public class ApiBase
    {
      ...
      public ApiBase(FlowNode_ReqMultiInvitation node) => this.m_Node = node;
    ...
    public class Api_NotifyInvitation : FlowNode_ReqMultiInvitation.ApiBase
    {
      ...
      public override string url => "btl/multi/invitation";
    ...
    public class Api_RoomInvitation : FlowNode_ReqMultiInvitation.ApiBase
    {
      ...
      public override string url => "btl/room/invitation";
      ...
      public override void Complete(WWWResult www)
      {
        ...
        else
        {
          ...
          DebugUtility.Assert(jsonObject != null, "res == null");
          if (jsonObject.body != null)
            MultiInvitationReceiveWindow.instance?.DeserializeActiveList(jsonObject.body);
          Network.RemoveAPI();
          this.Success();
        }
      }
    ...
    public class Api_RoomInvitationSend : FlowNode_ReqMultiInvitation.ApiBase
    {
      ...
      public override string url => "btl/room/invitation/send";
      ...
      public override void Complete(WWWResult www)
      {
        ...
        {
          DebugMenu.Log("API", this.url + ":" + www.text);
          DebugUtility.Assert(JsonUtility.FromJson<WebAPI.JSON_BodyResponse<FlowNode_ReqMultiInvitation.Api_RoomInvitationSend.Json>>(www.text) != null, "res == null");
          if (this.m_Sends != null)
          {
            for (int index = 0; index < this.m_Sends.Length; ++index)
