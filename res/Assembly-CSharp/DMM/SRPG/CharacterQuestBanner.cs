  ...
  public class CharacterQuestBanner : MonoBehaviour, IGameParameter
  {
    ...
    private void Start()
    {
      if (Object.op_Inequality((Object) this.UnitIcon1, (Object) null))
      {
        ...
        if (Object.op_Inequality((Object) componentInChildren, (Object) null))
        {
          ...
          ((UnityEvent) componentInChildren.onClick).AddListener(new UnityAction((object) this, __methodptr(OnUnitIcon1_Click)));
        }
      }
      ...
      if (!Object.op_Inequality((Object) componentInChildren1, (Object) null))
        return;
      // ISSUE: method pointer
      ((UnityEvent) componentInChildren1.onClick).AddListener(new UnityAction((object) this, __methodptr(OnUnitIcon2_Click)));
    }
    ...
    public void UpdateValue()
    {
      if (!((Component) this).gameObject.activeInHierarchy)
        return;
      CharacterQuestData dataOfClass = DataSource.FindDataOfClass<CharacterQuestData>(((Component) this).gameObject, (CharacterQuestData) null);
      if (dataOfClass == null)
        return;
    ...
    private void OnUnitIcon1_Click() => this.OnUnitIconClickInternal(this.UnitIcon1);

    private void OnUnitIcon2_Click() => this.OnUnitIconClickInternal(this.UnitIcon2);

    private void OnUnitIconClickInternal(GameObject go)
    {
      FlowNode_OnUnitIconClick componentInParent = ((Component) this).GetComponentInParent<FlowNode_OnUnitIconClick>();
