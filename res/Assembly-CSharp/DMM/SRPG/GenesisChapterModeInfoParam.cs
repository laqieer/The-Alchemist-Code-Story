...
namespace SRPG
{
  public class GenesisChapterModeInfoParam
  {
    ...
    public GenesisStarParam StarParam => this.mStarParam;
    ...
    public GenesisRewardParam BossRewardParam => this.mBossRewardParam;
    ...
    public GenesisLapBossParam LapBossParam
    {
      get
      {
        ...
        if (this.mLapBossParam == null)
        {
          GameManager instance = MonoSingleton<GameManager>.Instance;
          if (Object.op_Implicit((Object) instance))
            this.mLapBossParam = instance.GetGenesisLapBossParam(this.mLapBossId);
        }
