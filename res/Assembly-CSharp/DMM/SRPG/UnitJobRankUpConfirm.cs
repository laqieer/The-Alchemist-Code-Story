...
namespace SRPG
{
  public class UnitJobRankUpConfirm : MonoBehaviour
  {
    ...
    public IEnumerator ScrollInit()
    {
      ...
      return (IEnumerator) new UnitJobRankUpConfirm.\u003CScrollInit\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    public void OnNeedEquip()
    {
      if (this.NeedEquipList.IsEnoughCommon())
      {
        ...
        UIUtility.ConfirmBox(LocalizedText.Get(!this.IsSoul ? "sys.COMMON_EQUIP_CHECK" : "sys.COMMON_EQUIP_CHECK_SOUL", (object) commonItemListString), (UIUtility.DialogResultEvent) (go => this.OnAllEquipAccept(this.target_rank, this.can_jobmaster, this.can_jobmax)), (UIUtility.DialogResultEvent) null);
      }
      else
