...
namespace SRPG
{
  ...
  public class ConceptCardDetailAbility : ConceptCardDetailBase, IFlowInterface
  {
    ...
    [SerializeField]
    private UnityEngine.UI.Text mDecreaseEffectText;
    ...
    public void OnClickDetail() => this.mClickDetail(this.mShowData);
      ...
      int decreaseEffectRate)
    {
      ...
      {
        DataSource.Bind<AbilityData>(((Component) this).gameObject, data.effect == null || data.effect.Ability == null ? (AbilityData) null : data.effect.Ability);
        DataSource.Bind<SkillData>(((Component) this).gameObject, data.skill_data);
        ...
        if (Object.op_Inequality((Object) this.mCardSkillStatusList, (Object) null))
          ((Component) this.mCardSkillStatusList).gameObject.SetActive(false);
        ...
        {
          ((Component) this.mCardSkillStatusList).gameObject.SetActive(true);
        ...
        bool active = decreaseEffectRate > 0 && data.effect != null && data.effect.IsDecreaseEffectOnSub && isSubSlot;
        GameUtility.SetGameObjectActive(this.mDecreaseEffectObject, active);
        if (active)
          ConceptCardUtility.SetDecreaseEffectRateText(this.mDecreaseEffectText, decreaseEffectRate);
    ...
    public void SetUnitIcon(Image_Transparent image, UnitParam unit_param)
    {
      ...
      image.sprite = spriteSheet.GetSprite(itemParam.icon);
    }
