...
namespace SRPG
{
  public class MultiInvitationSendWindow : FlowWindowBase
  {
    ...
    public override string name => "FriendInvicationSendWindow";

    public static MultiInvitationSendWindow instance => MultiInvitationSendWindow.m_Instance;

    public static void ClearInvited() => MultiInvitationSendWindow.m_Invited.Clear();

    public static void AddInvited(string uid) => MultiInvitationSendWindow.m_Invited.Add(uid);
    ...
    private void RefreshUI()
    {
      ...
      else
      {
        for (int index = 0; index < count; ++index)
        {
          if (this.m_ContentSource.GetParam(index) is MultiInvitationSendWindow.Content.ItemSource.ItemParam itemParam && itemParam.IsValid())
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) instance, (UnityEngine.Object) null))
      {
        ...
        for (int index1 = 0; index1 < roomPlayerList.Count; ++index1)
        {
          if (roomPlayerList[index1] != null && !string.IsNullOrEmpty(roomPlayerList[index1].json))
          {
            ...
            if (param != null && param.isSupportAI == 0)
            {
    ...
    public static class Content
    {
      ...
      public class ItemAccessor
      {
        ...
        public Toggle tgl => this.m_Toggle;
        ...
        public bool isOn
        {
          ...
          get => UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Toggle, (UnityEngine.Object) null) && this.m_Toggle.isOn;
        }

        public bool isValid => this.m_Friend != null;
      ...
      public class ItemSource : ContentSource
      {
        ...
        public class ItemParam : ContentSource.Param
        {
          ...
          public MultiInvitationSendWindow.Content.ItemAccessor accessor => this.m_Accessor;
    ...
    public class SerializeParam : FlowWindowBase.SerializeParamBase
    {
      ...
      public override System.Type type => typeof (MultiInvitationSendWindow);
    }
  }
}
