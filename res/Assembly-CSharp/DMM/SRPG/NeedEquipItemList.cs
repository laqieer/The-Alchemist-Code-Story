...
namespace SRPG
{
  public class NeedEquipItemList
  {
    ...
    public NeedEquipItemList() => this.SetRecipeTree(new RecipeTree((ItemParam) null), false);
    ...
    public List<RecipeTree> GetCurrentRecipeTreeChildren()
    {
      ...
      return this.RecipeTree != null ? this.RecipeTree.Children : (List<RecipeTree>) null;
    }
