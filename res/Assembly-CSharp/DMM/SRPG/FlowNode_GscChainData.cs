    ...
    private void AddUserResponse(AddDeviceWithEmailAddressAndPasswordResult res)
    {
      switch (res.ResultCode)
      {
        ...
        case AddDeviceWithEmailAddressAndPasswordResultCode.Locked:
          ...
          string msg = LocalizedText.Get("sys.CHAINDATA_LOCKED", (object) string.Format("{0}/{1:D2}/{2:D2} {3:D2}:{4:D2}", (object) dateTime.Year, (object) dateTime.Month, (object) dateTime.Day, (object) dateTime.Hour, (object) dateTime.Minute));
          UIUtility.NegativeSystemMessage(string.Empty, msg, (UIUtility.DialogResultEvent) (obj => this.ActivateOutputLinks(22)), systemModal: true);
          break;
        default:
          this.ActivateOutputLinks(11);
          break;
