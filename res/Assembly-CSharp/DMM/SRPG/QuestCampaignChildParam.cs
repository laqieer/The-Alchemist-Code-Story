...
namespace SRPG
{
  public class QuestCampaignChildParam
  {
    ...
    public bool Deserialize(JSON_QuestCampaignChildParam json)
    {
      ...
      this.rentalFavRate = json.rental_fav_rate;
      this.parents = new QuestCampaignParentParam[0];
      this.campaignTrust = (QuestCampaignTrust) null;
      this.campaignInspSkill = (QuestCampaignInspSkill) null;
      return true;
    }
    ...
    public QuestCampaignData[] MakeData()
    {
      ...
      if (this.campaignInspSkill != null && !string.IsNullOrEmpty(this.campaignInspSkill.InspirationSkillIname) && this.campaignInspSkill.Rate > 0)
        ++length;
      ...
      if (this.campaignInspSkill != null && !string.IsNullOrEmpty(this.campaignInspSkill.InspirationSkillIname) && this.campaignInspSkill.Rate > 0)
      {
        questCampaignDataArray[index] = new QuestCampaignData()
        {
          type = QuestCampaignValueTypes.InspirationSkill,
          value = this.campaignInspSkill.Rate
        };
        int num = index - 1;
      }
