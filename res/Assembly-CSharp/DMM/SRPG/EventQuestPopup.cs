      ...
      switch (pinID)
      {
        case 1:
          if (this.Chapter != null && this.Chapter.keys.Count > 0)
          {
            ...
            {
              UIUtility.SystemMessage(LocalizedText.Get("sys.KEYQUEST_UNLOCK"), LocalizedText.Get("sys.KEYQUEST_OUTOFKEY"), (UIUtility.DialogResultEvent) (go => FlowNode_GameObject.ActivateOutputLinks((Component) this, 101)));
              break;
            }
            if (!this.Chapter.IsDateUnlock(Network.GetServerTime()))
            {
              UIUtility.SystemMessage(LocalizedText.Get("sys.KEYQUEST_UNLOCK"), LocalizedText.Get("sys.QUEST_OUT_OF_DATE"), (UIUtility.DialogResultEvent) (go => FlowNode_GameObject.ActivateOutputLinks((Component) this, 101)));
              break;
            }
          }
    ...
    private void Refresh()
    {
      ...
      for (int index = 0; index < this.Chapter.keys.Count; ++index)
      {
        ...
        if (key != null && !string.IsNullOrEmpty(key.iname) && key.num != 0)
        {
          ...
          KeyQuestBanner component = gameObject.GetComponent<KeyQuestBanner>();
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
            component.UpdateValue();
          gameObject.transform.SetParent(this.ItemLayout.transform, false);
