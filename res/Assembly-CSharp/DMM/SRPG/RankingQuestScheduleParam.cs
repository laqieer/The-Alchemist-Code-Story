...
namespace SRPG
{
  public class RankingQuestScheduleParam
  {
    ...
    {
      List<RankingQuestScheduleParam> questScheduleParam = new List<RankingQuestScheduleParam>();
      GameManager instanceDirect = MonoSingleton<GameManager>.GetInstanceDirect();
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) instanceDirect, (UnityEngine.Object) null))
        return questScheduleParam;
      ...
      {
        questScheduleParam.AddRange((IEnumerable<RankingQuestScheduleParam>) instanceDirect.RankingQuestScheduleParams);
      }
      else
      {
        bool period = false;
        questScheduleParam = instanceDirect.RankingQuestScheduleParams.Where<RankingQuestScheduleParam>((Func<RankingQuestScheduleParam, bool>) (param =>
        {
          period = false;
    ...
    public static List<RankingQuestParam> FindRankingQuestParamBySchedule(
      RankingQuestScheduleParam.RakingQuestScheduleGetFlags flag)
    {
      List<RankingQuestParam> questParamBySchedule = new List<RankingQuestParam>();
      GameManager instanceDirect = MonoSingleton<GameManager>.GetInstanceDirect();
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) instanceDirect, (UnityEngine.Object) null))
        return questParamBySchedule;
      if (instanceDirect.RankingQuestParams == null)
      {
        DebugUtility.LogError("GameManager.Instance.RankingQuestParamsがnullです");
        return questParamBySchedule;
      ...
      for (int index1 = 0; index1 < rankingQuestParams.Count; ++index1)
      {
        for (int index2 = 0; index2 < questScheduleParam.Count; ++index2)
        {
          ...
          {
            questParamBySchedule.Add(rankingQuestParams[index1]);
            break;
          }
        }
      }
    ...
    public static RankingQuestScheduleParam FindByID(int id)
    {
      ...
      return instanceDirect.RankingQuestScheduleParams == null ? (RankingQuestScheduleParam) null : instanceDirect.RankingQuestScheduleParams.Find((Predicate<RankingQuestScheduleParam>) (param => param.id == id));
    }
