...
namespace SRPG
{
  ...
  public class UnitSkinSelectWindow : SRPG_ListBase, IFlowInterface
  {
    ...
    protected override void Start()
    {
      ...
      ArtifactParam[] allSkins = this.mCurrentUnit.GetAllSkins();
      ArtifactParam[] selectableSkins = this.mCurrentUnit.GetSelectableSkins();
      ArtifactParam selectedSkinData = this.mCurrentUnit.GetSelectedSkinData();
      ArtifactParam[] conceptCardSkins = this.mCurrentUnit.GetEnableConceptCardSkins();
      ...
      this.RemoveName.text = LocalizedText.Get("sys.UNITLIST_SKIN_DEFAULT_NAME", (object) this.mCurrentUnit.UnitParam.name);
    ...
    private void SetActiveListItem(GameObject listItem, bool active)
    {
      ...
      ((Selectable) component.Button).interactable = active;
    ...
    {
      SRPG_Button component = ((Component) this.DecideButton).gameObject.GetComponent<SRPG_Button>();
    ...
    private void OnRemoveSelect(GameObject go) => this.Activated(3);
    ...
    public void Activated(int pinID)
    {
      switch (pinID)
      {
        case 1:
          ...
          {
            this.mCurrentUnit.SetJobSkin(this.mConfirmSkin.iname);
            this.Refresh();
        ...
        case 3:
          ...
          {
            this.mCurrentUnit.ResetJobSkin();
            this.Refresh();
