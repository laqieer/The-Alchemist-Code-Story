...
namespace SRPG
{
  ...
  public class FlowNode_ReqSupport : FlowNode_Network
  {
    ...
    public class ApiBase
    {
      ...
      public ApiBase(FlowNode_ReqSupport node) => this.m_Node = node;
    ...
    public class Api_Support : FlowNode_ReqSupport.ApiBase
    {
      ...
      public override string url => "support";

      public override string req => (string) null;
      ...
      public override void Complete(WWWResult www)
      {
        ...
        else
        {
          ...
          WebAPI.JSON_BodyResponse<FlowNode_ReqSupport.Api_Support.Json> jsonBodyResponse = JsonUtility.FromJson<WebAPI.JSON_BodyResponse<FlowNode_ReqSupport.Api_Support.Json>>(www.text);
