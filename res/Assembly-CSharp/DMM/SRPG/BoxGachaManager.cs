...
namespace SRPG
{
  ...
  public class BoxGachaManager : FlowNodePersistent
  {
    ...
    {
      get => BoxGachaManager.m_CurrentBoxGachaStatus;
      set => BoxGachaManager.m_CurrentBoxGachaStatus = value;
    }
    ...
    public override void OnActivate(int pinID)
    {
      switch (pinID)
      {
        ...
        case 10:
          ...
          if (BoxGachaManager.m_CurrentBoxGachaStatus.IsCostShort())
            pinID1 = 16;
    ...
    private void OnDisable() => Input.multiTouchEnabled = this.m_LastMultiToucheEnabled;

    private void Refresh()
    {
      if (BoxGachaManager.m_CurrentBoxGachaStatus == null)
        return;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Cost, (UnityEngine.Object) null))
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostItemObj, (UnityEngine.Object) null) || UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostCoinObj, (UnityEngine.Object) null) || UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostGoldObj, (UnityEngine.Object) null))
        {
          ...
          if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostItemObj, (UnityEngine.Object) null))
            DebugUtility.LogError("'cost_item_obj'が登録されていません.");
          this.m_CostCoinObj = component.list.GetGameObject("cost_coin_obj");
          if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostCoinObj, (UnityEngine.Object) null))
            DebugUtility.LogError("'cost_coin_obj'が登録されていません.");
          this.m_CostGoldObj = component.list.GetGameObject("cost_gold_obj");
          if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostGoldObj, (UnityEngine.Object) null))
        ...
        if (BoxGachaManager.m_CurrentBoxGachaStatus.CostType == BoxGachaManager.BoxGachaCostType.Item)
        {
          ...
          if (data != null)
          {
            DataSource.Bind<ItemData>(this.m_Cost, data);
          }
          else
          {
            ...
            DataSource.Bind<ItemParam>(this.m_Cost, itemParam);
          }
        }
        else
          DataSource.Bind<ItemData>(this.m_Cost, (ItemData) null);
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_CostResult, (UnityEngine.Object) null))
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostResultItemObj, (UnityEngine.Object) null) || UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostResultCoinObj, (UnityEngine.Object) null) || UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostResultGoldObj, (UnityEngine.Object) null))
        {
          ...
          if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostResultItemObj, (UnityEngine.Object) null))
            DebugUtility.LogError("'cost_item_obj'が登録されていません.");
          this.m_CostResultCoinObj = component.list.GetGameObject("cost_coin_obj");
          if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostResultCoinObj, (UnityEngine.Object) null))
            DebugUtility.LogError("'cost_coin_obj'が登録されていません.");
          this.m_CostResultGoldObj = component.list.GetGameObject("cost_gold_obj");
          if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_CostResultGoldObj, (UnityEngine.Object) null))
            DebugUtility.LogError("'cost_gold_obj'が登録されていません.");
        }
        if (BoxGachaManager.m_CurrentBoxGachaStatus.CostType == BoxGachaManager.BoxGachaCostType.Item)
        {
          ...
          if (data != null)
          {
            DataSource.Bind<ItemData>(this.m_CostResult, data);
          }
          else
          {
            ItemParam itemParam = MonoSingleton<GameManager>.Instance.MasterParam.GetItemParam(BoxGachaManager.m_CurrentBoxGachaStatus.CostIname);
            ...
            DataSource.Bind<ItemParam>(this.m_CostResult, itemParam);
          }
        }
        else
          DataSource.Bind<ItemData>(this.m_CostResult, (ItemData) null);
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_SingleButton, (UnityEngine.Object) null))
      {
        SerializeValueBehaviour component = ((Component) this.m_SingleButton).GetComponent<SerializeValueBehaviour>();
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
        {
          Text uiLabel1 = component.list.GetUILabel("count");
          Text uiLabel2 = component.list.GetUILabel("cost");
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) uiLabel1, (UnityEngine.Object) null))
            uiLabel1.text = BoxGachaManager.SELECT_SINGLE.ToString();
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) uiLabel2, (UnityEngine.Object) null))
            uiLabel2.text = BoxGachaManager.m_CurrentBoxGachaStatus.CostValue.ToString();
        }
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_MultiButton, (UnityEngine.Object) null))
      {
        SerializeValueBehaviour component = ((Component) this.m_MultiButton).GetComponent<SerializeValueBehaviour>();
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
        {
          Text uiLabel3 = component.list.GetUILabel("count");
          Text uiLabel4 = component.list.GetUILabel("cost");
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) uiLabel3, (UnityEngine.Object) null))
            uiLabel3.text = BoxGachaManager.m_CurrentBoxGachaStatus.MultiCount.ToString();
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) uiLabel4, (UnityEngine.Object) null))
            uiLabel4.text = BoxGachaManager.m_CurrentBoxGachaStatus.MultiCost.ToString();
        }
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ResultButton, (UnityEngine.Object) null))
      {
        SerializeValueBehaviour component = ((Component) this.m_ResultButton).GetComponent<SerializeValueBehaviour>();
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
        {
          Text uiLabel5 = component.list.GetUILabel("count");
          Text uiLabel6 = component.list.GetUILabel("cost");
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) uiLabel5, (UnityEngine.Object) null))
            uiLabel5.text = !this.m_LastSelectExecSingle ? BoxGachaManager.m_CurrentBoxGachaStatus.MultiCount.ToString() : BoxGachaManager.SELECT_SINGLE.ToString();
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) uiLabel6, (UnityEngine.Object) null))
            uiLabel6.text = !this.m_LastSelectExecSingle ? BoxGachaManager.m_CurrentBoxGachaStatus.MultiCost.ToString() : BoxGachaManager.m_CurrentBoxGachaStatus.CostValue.ToString();
        }
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ResetButton, (UnityEngine.Object) null))
        ((Selectable) this.m_ResetButton).interactable = BoxGachaManager.m_CurrentBoxGachaStatus.IsReset;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_TopImage, (UnityEngine.Object) null))
      {
        if (this.IsAdvanceEvent)
        {
          ...
          if (advanceEventParam != null && instance.AdvanceAssets.GachaTopImage.Length > advanceEventParam.EventUiIndex)
            instance.LoadAssets<GameObject>(instance.AdvanceAssets.GachaTopImage[advanceEventParam.EventUiIndex], new AdvanceEventManager.LoadAssetCallback<GameObject>(this.DownLoadedPreview));
        }
        else
        {
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) img_prefab, (UnityEngine.Object) null))
    ...
    public class BoxGachaStatus
    {
      ...
      public int Remain => this.remain;

      public bool IsReset => this.reset;

      public BoxGachaManager.BoxGachaCostType CostType => this.cost_type;

      public string CostIname => this.cost_iname;

      public int CostValue => this.cost_value;

      public bool IsBoxEmpty => this.remain <= 0;

      public int MultiCount => this.multi_count;

      public int MultiCost => this.multi_cost;

      public bool IsSelectMulti => this.multi_count > 1;

      public List<GachaDropData> Drops => this.drops;
