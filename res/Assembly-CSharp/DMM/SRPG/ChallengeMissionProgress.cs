...
namespace SRPG
{
  ...
  public class ChallengeMissionProgress : MonoBehaviour, IFlowInterface
  {
    ...
    private void OnEnable() => GlobalEvent.Invoke(this.EVENT_CHALLENGE_ICON_HIDE, (object) this);

    private void OnDisable() => GlobalEvent.Invoke(this.EVENT_CHALLENGE_ICON_SHOW, (object) this);
    ...
    private void Awake()
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ButtonTry, (UnityEngine.Object) null))
      {
        ...
        ((UnityEvent) this.ButtonTry.onClick).AddListener(new UnityAction((object) this, __methodptr(OnClickTry)));
      }
    ...
    private void OnDestroy()
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ButtonTry, (UnityEngine.Object) null))
        return;
      // ISSUE: method pointer
      ((UnityEvent) this.ButtonTry.onClick).RemoveListener(new UnityAction((object) this, __methodptr(OnClickTry)));
    }

    private void Update()
    {
      if (!this.IsBGTouchHide || this.mShowingOverlay || !Input.GetMouseButtonDown(0))
        return;
      ...
      if (raycastResultList.Count != 0)
      {
        ...
        if (this.IsIncludeObject(((RaycastResult) ref raycastResult).gameObject))
          flag = false;
      }
      if (flag)
        return;
      ...
      if (this.IsIncludeObject(((RaycastResult) ref raycastResult1).gameObject))
        return;
      ((Component) this).gameObject.SetActive(false);
    }
    ...
    {
      for (Transform transform = value.transform; UnityEngine.Object.op_Inequality((UnityEngine.Object) transform, (UnityEngine.Object) null); transform = transform.parent)
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) ((Component) this).gameObject, (UnityEngine.Object) ((Component) transform).gameObject))
          return true;
      }
      return false;
    }
    ...
    private void Refresh(bool fromRefresh)
    {
      ...
      {
        DataSource.Bind<TrophyParam>(((Component) this).gameObject, mostPriorityTrophy);
        DataSource.Bind<TrophyState>(((Component) this).gameObject, trophyCounter);
      ...
      if (challengeCategories != null && challengeCategories.Length > 0)
        DataSource.Bind<ChallengeCategoryParam>(((Component) this.HelpIcon).gameObject, ((IEnumerable<ChallengeCategoryParam>) challengeCategories).FirstOrDefault<ChallengeCategoryParam>());
      bool flag1 = mostPriorityTrophy.IsChallengeMissionRoot || trophyCounter.IsCompleted;
      bool flag2 = ChallengeMissionDetail.IsChallengeable(mostPriorityTrophy);
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ButtonTry, (UnityEngine.Object) null) || !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ButtonDetail, (UnityEngine.Object) null) || !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ButtonReward, (UnityEngine.Object) null) || !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ButtonHelp, (UnityEngine.Object) null))
        return;
      ((Component) this.ButtonTry).gameObject.SetActive(flag2 && !flag1);
      ((Component) this.ButtonDetail).gameObject.SetActive(!flag1);
      ((Component) this.ButtonReward).gameObject.SetActive(flag1);
      ((Component) this.ButtonHelp).gameObject.SetActive(!flag1);
    }
    ...
    private void RefreshRewardIcon(TrophyParam trophy)
    {
      ...
      if (trophy.RewardPriority == TrophyRewardPriority.None)
      {
        if (trophy.Gold != 0)
        ...
        trophyRewardPriority = trophy.RewardPriority;
      bool flag7 = false;
      switch (trophyRewardPriority)
      {
        ...
        case TrophyRewardPriority.Gold:
          if (trophy.Gold != 0)
          {
            ...
            str = string.Format(format, (object) formatedText);
            flag7 = true;
            break;
          }
          break;
      ...
      if (!flag7)
        DebugUtility.LogError("チャレンジミッション [" + trophy.iname + "] の表示優先報酬として [" + (object) trophy.RewardPriority + "] が指定されていますが、報酬データが空です。");
      ...
      else if (flag2)
      {
        ...
        DataSource.Bind<ItemParam>(((Component) this).gameObject, data);
      }
      else
      {
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ItemIcon, (UnityEngine.Object) null))
