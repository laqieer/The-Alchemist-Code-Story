...
namespace SRPG
{
  ...
  public class FlowNode_ReqQuestRankingParty : FlowNode_Network
  {
    ...
    {
      ReqQuestRankingPartyData dataOfClass = DataSource.FindDataOfClass<ReqQuestRankingPartyData>(((Component) this).gameObject, (ReqQuestRankingPartyData) null);
    ...
    private void Success() => this.ActivateOutputLinks(101);
