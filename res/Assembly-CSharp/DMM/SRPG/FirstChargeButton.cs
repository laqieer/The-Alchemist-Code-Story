...
namespace SRPG
{
  ...
  public class FirstChargeButton : AppealItemBase, IFlowInterface
  {
    ...
    private void OnEnable() => this.InitMaster();
    ...
    private IEnumerator CreateInfoView()
    {
      ...
      return (IEnumerator) new FirstChargeButton.\u003CCreateInfoView\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FirstChargeButton.\u003CLoadAppealSprite\u003Ec__Iterator1()
      {
        _path = _path,
        \u0024this = this
      };
    ...
    private IEnumerator CreateResultWindow()
    {
      ...
      FirstChargeButton.\u003CCreateResultWindow\u003Ec__Iterator2 resultWindow = new FirstChargeButton.\u003CCreateResultWindow\u003Ec__Iterator2();
      return (IEnumerator) resultWindow;
    }
  }
}
