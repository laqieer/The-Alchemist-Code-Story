...
namespace SRPG
{
  ...
  public class ArtifactWindow : MonoBehaviour, IFlowInterface
  {
    ...
    public void Activated(int pinID)
    {
      switch (pinID)
      {
        ...
        default:
          ...
          {
            case 0:
              this.SetArtifactType(ArtifactTypes.None);
              return;
            case 1:
              this.SetArtifactType(ArtifactTypes.Arms);
              return;
            case 2:
              this.SetArtifactType(ArtifactTypes.Armor);
              return;
            case 3:
              this.SetArtifactType(ArtifactTypes.Accessory);
              return;
            case 4:
              this.RefreshSortFilter();
              return;
            default:
              switch (pinID - 5)
              {
                            ...
                            if (pinID != 400)
                            {
                              if (pinID != 600)
                              {
                                if (pinID != 700)
                                {
                                  ...
                                  FlowNode_GameObject.ActivateOutputLinks((Component) this, 911);
                                  return;
                                }
    ...
    public static ArtifactWindow Instance => ArtifactWindow.mInstance;

    public List<ItemData> TmpItems => this.mTmpItems;

    public UnitData OwnerUnitData => this.mOwnerUnitData;

    public int OwnerUnitJobIndex => this.mOwnerUnitJobIndex;

    public ArtifactTypes SelectArtifactSlot
    {
      get => this.mSelectArtifactSlot;
      set => this.mSelectArtifactSlot = value;
    }

    private void Awake()
    {
      ArtifactWindow.mInstance = this;
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mButtonAutoEquip, (UnityEngine.Object) null))
        return;
      ((Selectable) this.mButtonAutoEquip).interactable = false;
    }

    private void Start()
    {
      this.SelectSlotArtifactType = ArtifactTypes.None;
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ExpPanelAdd, (UnityEngine.Object) null))
      {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        this.ArtifactScrollList.OnSelectionChange += new ArtifactScrollList.SelectionChangeEvent(this.OnArtifactSelect);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.KyokaListItem, (UnityEngine.Object) null) && this.KyokaListItem.activeInHierarchy)
        this.KyokaListItem.SetActive(false);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.SelectionListItem, (UnityEngine.Object) null) && ((Component) this.SelectionListItem).gameObject.activeSelf)
        ((Component) this.SelectionListItem).gameObject.SetActive(false);
      ...
      this.ReflectEnbBtnArtiStrengthen();
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.artiProssessButton, (UnityEngine.Object) null))
        ((Selectable) this.artiProssessButton).interactable = false;
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillListItem, (UnityEngine.Object) null))
        this.m_InspSkillListItem.SetActive(false);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceListItem, (UnityEngine.Object) null))
        this.m_InspSkillEnhanceListItem.SetActive(false);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceConfirmListItem, (UnityEngine.Object) null))
        this.m_InspSkillEnhanceConfirmListItem.SetActive(false);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mArtiDropDown, (UnityEngine.Object) null))
        this.mArtiDropDown.Refresh();
      this.mCurrentArtifact = DataSource.FindDataOfClass<ArtifactData>(((Component) this).gameObject, (ArtifactData) null);
      if (this.mCurrentArtifact != null)
      {
        this.mCurrentArtifactParam = this.mCurrentArtifact.ArtifactParam;
        this.SelectSlotArtifactType = this.mCurrentArtifact.ArtifactParam.type;
      }
      this.Rebind();
    ...
    private void OnDestroy()
    {
      ...
      if (this.OnDestroyCallBack != null)
        this.OnDestroyCallBack((ArtifactData) null);
      ArtifactWindow.mInstance = (ArtifactWindow) null;
    }

    private bool IsConnectableNetwork()
    {
      NetworkReachability internetReachability = Application.internetReachability;
      return internetReachability == 2 || internetReachability == 1 || internetReachability != null;
    }
    ...
    private bool IsRequestPending<T>() => this.mRequests.Count > 0 && this.mRequests[0] is T;
    ...
    private void Update()
    {
      if (this.mSendingRequests)
      {
        ...
        if (this.mRequests.Count > 0)
        {
          if (Network.Mode == Network.EConnectMode.Online)
          {
            Network.RequestAPI(this.mRequests[0].Compose());
            this.mRequests.RemoveAt(0);
          }
          this.mSendingRequests = true;
          return;
    ...
    private void OnArtifactBulkLevelUp(Dictionary<string, int> data)
    {
      ...
      if (itemList.Count <= 0)
        return;
      this.RequestUseAddExpItem((IEnumerable<ItemData>) itemList, (GameObject) null);
    }
    ...
    private void RequestUseAddExpItem(IEnumerable<ItemData> itemList, GameObject updataTarget)
    {
      ...
      if ((int) this.mCurrentArtifact.Lv >= this.mCurrentArtifact.GetLevelCap())
      {
        if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ExpPanel, (UnityEngine.Object) null) || this.ExpPanel.IsBusy)
          return;
        UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get((int) this.mCurrentArtifact.Rarity < (int) this.mCurrentArtifact.RarityCap ? "sys.ARTI_EXPFULL1" : "sys.ARTI_EXPFULL2"), (UIUtility.DialogResultEvent) null);
      }
      else
      {
        ...
        if (!string.IsNullOrEmpty(this.KyokaSE))
          MonoSingleton<MySound>.Instance.PlaySEOneShot(this.KyokaSE);
        ArtifactWindow.RequestAddExp req = (ArtifactWindow.RequestAddExp) null;
        if (this.mRequests.Count > 0 && this.mRequests[this.mRequests.Count - 1] is ArtifactWindow.RequestAddExp)
          req = this.mRequests[this.mRequests.Count - 1] as ArtifactWindow.RequestAddExp;
        if (req == null)
        {
          req = new ArtifactWindow.RequestAddExp();
          req.UniqueID = (long) this.mCurrentArtifact.UniqueID;
          req.Callback = new Network.ResponseCallback(this.AddExpResult);
          this.AddAsyncRequest((ArtifactWindow.Request) req);
        }
        if (this.mStatusCache == null)
        {
          ...
          this.mCurrentArtifact.GetHomePassiveBuffStatus(ref this.mStatusCache.BaseAdd, ref this.mStatusCache.BaseMul);
          this.mCurrentArtifact.GetHomePassiveBuffStatus(ref this.mStatusCache.UnitAdd, ref this.mStatusCache.UnitMul, unit, job_index);
        }
        foreach (ItemData itemData in itemList)
        {
          req.Items.Add(itemData.Param);
    ...
    public void RefreshArtifactList()
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        return;
      this.ArtifactScrollList.Refresh();
    }
    ...
    private void OnArtifactSelect(ArtifactScrollList list)
    {
      ...
      else
      {
        ...
        if (!(selection[0] is ArtifactData))
        {
          if (selection[0] is ArtifactParam)
          {
            this.mCurrentArtifactParam = selection[0] as ArtifactParam;
            if (this.mCurrentArtifactParam == null)
            {
              Debug.LogWarning((object) "Non ArtifactParam Selected");
              return;
        ...
        if (selection[0] is ArtifactData)
        {
          this.mCurrentArtifact = (selection[0] as ArtifactData).Copy();
          this.mCurrentArtifactParam = this.mCurrentArtifact.ArtifactParam;
          GlobalVars.SelectedArtifactUniqueID.Set((long) this.mCurrentArtifact.UniqueID);
        }
        else
    ...
    public void RefreshAbilities()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.AbilityListItemAdd, (UnityEngine.Object) null))
      {
        DataSource.Bind<AbilityParam>(this.AbilityListItemAdd, (AbilityParam) null);
        DataSource.Bind<AbilityData>(this.AbilityListItemAdd, (AbilityData) null);
        DataSource.Bind<SkillAbilityDeriveData>(this.AbilityListItemAdd, (SkillAbilityDeriveData) null);
      }
            ...
            if (abilityParam != null)
            {
              ...
              if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.AbilityList, (UnityEngine.Object) null))
              {
                if (DataSource.FindDataOfClass<AbilityParam>(this.AbilityListItem, (AbilityParam) null) == null && DataSource.FindDataOfClass<AbilityData>(this.AbilityListItem, (AbilityData) null) == null)
                {
                  ...
                  if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.AbilityListItemAdd, (UnityEngine.Object) null))
                    DataSource.Bind<AbilityParam>(this.AbilityListItemAdd, abilityParam);
                }
              ...
              if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null) && learningAbilities != null && !string.IsNullOrEmpty(this.AbilityListItemState))
              {
                if (learningAbilities != null)
                {
                  for (int index3 = 0; index3 < learningAbilities.Count; ++index3)
                  {
                    ...
                    if (artifactParam.abil_inames[index2] == iname)
                    {
                      ...
                      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.AbilityListItemAdd, (UnityEngine.Object) null))
                      {
                        DataSource.Bind<AbilityData>(this.AbilityListItemAdd, deriveAbility);
                        DataSource.Bind<AbilityParam>(this.AbilityListItemAdd, deriveAbility.Param);
                      }
                      flag2 = this.mOwnerUnitData == null || abilityParam.CheckEnableUseAbility(this.mOwnerUnitData, this.mOwnerUnitJobIndex);
                      break;
                    }
                  }
                }
                ...
                if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.NotWeaponAbility, (UnityEngine.Object) null))
                {
                  this.NotWeaponAbility.SetActive(false);
                  if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.NotWeaponAbilityAdd, (UnityEngine.Object) null))
                    this.NotWeaponAbilityAdd.SetActive(false);
                }
              }
              ++index1;
              flag1 = flag2;
      ...
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.AbilityList, (UnityEngine.Object) null) && index1 == 0)
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component1, (UnityEngine.Object) null) && !string.IsNullOrEmpty(this.AbilityListItemState))
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.AbilityListItemAdd, (UnityEngine.Object) null))
        {
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component2, (UnityEngine.Object) null) && !string.IsNullOrEmpty(this.AbilityListItemState))
            component2.SetInteger(this.AbilityListItemState, this.AbilityListItem_Hidden);
        }
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.NotWeaponAbility, (UnityEngine.Object) null))
        {
          this.NotWeaponAbility.SetActive(true);
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.NotWeaponAbilityAdd, (UnityEngine.Object) null))
            this.NotWeaponAbilityAdd.SetActive(true);
        }
      }
      for (; index1 < this.mAbilityItems.Count; ++index1)
        this.mAbilityItems[index1].SetActive(false);
      if (this.mCurrentArtifact == null || UnityEngine.Object.op_Equality((UnityEngine.Object) this.EquipInspSkillItem, (UnityEngine.Object) null))
        return;
      GameUtility.SetGameObjectActive(this.NotInspSkill, true);
      DataSource.Bind<AbilityParam>(this.EquipInspSkillItem, (AbilityParam) null);
      DataSource.Bind<AbilityData>(this.EquipInspSkillItem, (AbilityData) null);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.EquipInspSkillItemAdd, (UnityEngine.Object) null))
      {
        DataSource.Bind<AbilityParam>(this.EquipInspSkillItemAdd, (AbilityParam) null);
        DataSource.Bind<AbilityData>(this.EquipInspSkillItemAdd, (AbilityData) null);
      }
      ...
      if (this.mCurrentArtifact.IsInspiration())
      {
        ...
        if (artifactData != null)
        {
          ...
          {
            GameUtility.SetGameObjectActive(this.NotInspSkill, false);
            DataSource.Bind<AbilityParam>(this.EquipInspSkillItem, inspirationSkillData.AbilityData.Param);
            DataSource.Bind<AbilityData>(this.EquipInspSkillItem, inspirationSkillData.AbilityData);
            if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.EquipInspSkillItemAdd, (UnityEngine.Object) null))
            {
              DataSource.Bind<AbilityParam>(this.EquipInspSkillItemAdd, inspirationSkillData.AbilityData.Param);
              DataSource.Bind<AbilityData>(this.EquipInspSkillItemAdd, inspirationSkillData.AbilityData);
            }
            flag3 = this.mOwnerUnitData == null || inspirationSkillData.AbilityData.CheckEnableUseAbility(this.mOwnerUnitData, this.mOwnerUnitJobIndex);
          }
        }
      }
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.EquipInspSkillItemAdd, (UnityEngine.Object) null))
      {
        Animator component4 = this.EquipInspSkillItemAdd.GetComponent<Animator>();
        if (flag3)
          component4.SetInteger(this.AbilityListItemState, this.AbilityListItem_Unlocked);
        else
          component4.SetInteger(this.AbilityListItemState, this.AbilityListItem_Hidden);
        GameParameter.UpdateAll(this.EquipInspSkillItemAdd);
      }
      GameParameter.UpdateAll(this.EquipInspSkillItem);
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.EquipInspSkillTab, (UnityEngine.Object) null))
        return;
      if (this.mCurrentArtifact.IsInspiration())
      {
        ((Component) this.EquipInspSkillTab).gameObject.SetActive(true);
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.EquipInspSkillTabAdd, (UnityEngine.Object) null))
          ((Component) this.EquipInspSkillTabAdd).gameObject.SetActive(true);
        flag1 = true;
      }
      else
      {
        ((Component) this.EquipInspSkillTab).gameObject.SetActive(false);
        this.EquipInspSkillTab.isOn = false;
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.EquipInspSkillTabAdd, (UnityEngine.Object) null))
        {
          ((Component) this.EquipInspSkillTabAdd).gameObject.SetActive(false);
          this.EquipInspSkillTabAdd.isOn = false;
        }
        this.WeaponAbilityTab.isOn = true;
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.WeaponAbilityTabAdd, (UnityEngine.Object) null))
          this.WeaponAbilityTabAdd.isOn = true;
      }
      ((Selectable) this.WeaponAbilityTab).interactable = flag1;
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.WeaponAbilityTabAdd, (UnityEngine.Object) null))
        return;
      ((Selectable) this.WeaponAbilityTabAdd).interactable = flag1;
    }
    ...
    public void ShowSelection()
    {
      ...
      for (int index = 0; index < this.mSelectionItems.Count; ++index)
        UnityEngine.Object.Destroy((UnityEngine.Object) ((Component) this.mSelectionItems[index]).gameObject);
      ...
      Transform transform = !UnityEngine.Object.op_Equality((UnityEngine.Object) this.SelectionList, (UnityEngine.Object) null) ? this.SelectionList.transform : ((Component) this.SelectionListItem).transform.parent;
      for (int index = 0; index < this.mSelectedArtifacts.Length; ++index)
      {
        ...
        DataSource.Bind(((Component) artifactIcon).gameObject, this.mSelectedArtifacts[index].GetType(), this.mSelectedArtifacts[index]);
        ((Component) artifactIcon).transform.SetParent(transform, false);
        ((Component) artifactIcon).gameObject.SetActive(true);
      }
    }
    ...
    public void RefreshWindow()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Status, (UnityEngine.Object) null))
      {
        if (this.mCurrentArtifact != null)
        {
          ...
          this.mCurrentArtifact.GetHomePassiveBuffStatus(ref fixed_status1, ref scale_status1);
          BaseStatus fixed_status2 = new BaseStatus();
          BaseStatus scale_status2 = new BaseStatus();
          this.mCurrentArtifact.GetHomePassiveBuffStatus(ref fixed_status2, ref scale_status2, unit, job_index);
          this.Status.SetValues(fixed_status1, scale_status1, fixed_status2, scale_status2);
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.StatusAdd, (UnityEngine.Object) null))
            this.StatusAdd.SetValues(fixed_status1, scale_status1, fixed_status2, scale_status2);
        }
        else
        {
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.StatusAdd, (UnityEngine.Object) null))
            this.StatusAdd.SetValues(baseStatus, baseStatus);
        }
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.OwnerSlot, (UnityEngine.Object) null))
      {
        ...
        if (unit != null && job_index != -1)
          DataSource.Bind<JobData>(((Component) this.OwnerSlot).gameObject, unit.Jobs[job_index]);
        else
          DataSource.Bind<JobData>(((Component) this.OwnerSlot).gameObject, (JobData) null);
      }
      this.RefreshKyokaList();
      ...
      {
        Animator component = ((Component) this.RarityUpCost).GetComponent<Animator>();
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ExpPanelAdd, (UnityEngine.Object) null) && this.mCurrentArtifact != null)
      {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.WindowBodyAdd, (UnityEngine.Object) null))
        return;
    ...
    public void AddRarity()
    {
      ...
      {
        UIUtility.ConfirmBox(LocalizedText.Get("sys.ARTI_RARITYUP_CONFIRM", (object) this.mCurrentArtifactParam.name), new UIUtility.DialogResultEvent(this.OnAddRarityAccept), new UIUtility.DialogResultEvent(this.OnAddRarityCancel));
      }
      else
      {
        ...
        if (key == null)
          return;
        UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get(key), (UIUtility.DialogResultEvent) null);
      }
    }
    ...
    private void OnAddRarityAccept(GameObject go)
    {
      ...
      for (int index3 = 0; index3 < abilityDataList2.Count; ++index3)
      {
        if (abilityDataList1[index3].Rank != intList[index3])
        {
          this.mChangeSet.Add(new ChangeListData());
          this.mChangeSet[index1].ItemID = this.NewAbilityID;
          this.mChangeSet[index1].MetaDataType = typeof (AbilityData);
          this.mChangeSet[index1].MetaData = (object) abilityDataList2[index3];
          this.mChangeSet[index1].ValOld = abilityDataList1[index3].Rank.ToString();
          this.mChangeSet[index1].ValNew = intList[index3].ToString();
          ++index1;
        }
      }
      ...
      ArtifactWindow.RequestAddRare req = new ArtifactWindow.RequestAddRare();
      req.UniqueID = (long) this.mCurrentArtifact.UniqueID;
      req.trophyprog = trophy_progs;
      req.bingoprog = bingo_progs;
      req.Callback = new Network.ResponseCallback(this.AddRarityResult);
      this.AddAsyncRequest((ArtifactWindow.Request) req);
      this.mBusy = true;
      this.FlushRequests(false);
    }
    ...
    private IEnumerator AddRareAsync()
    {
      ...
      return (IEnumerator) new ArtifactWindow.\u003CAddRareAsync\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    public void RefreshDecomposeInfo()
    {
      ...
      if (this.mCurrentArtifact.Kakera != null)
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.DecomposeCost, (UnityEngine.Object) null))
        {
          ...
          {
            Animator component = ((Component) this.DecomposeCost).GetComponent<Animator>();
            if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
            {
    ...
    public void RefreshRarityUpInfo()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.RarityUpButton, (UnityEngine.Object) null))
        ((Selectable) this.RarityUpButton).interactable = flag;
    ...
    public void TransmuteArtifact()
    {
      ...
      {
        UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_TRANSMUTE_MAXNUM", (object) this.mCurrentArtifactParam.name, (object) this.mCurrentArtifactParam.maxnum), (UIUtility.DialogResultEvent) null);
      }
      else
      {
        ...
        if (num2 < (int) rarityParam.ArtifactCreatePieceNum)
          UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_TRANSMUTE_NOKAKERA", (object) this.mCurrentArtifactParam.name, (object) rarityParam.ArtifactCreatePieceNum, (object) ((int) rarityParam.ArtifactCreatePieceNum - num2), (object) num2), (UIUtility.DialogResultEvent) null);
        else if (player.Gold < (int) rarityParam.ArtifactCreateCost)
          UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_TRANSMUTE_NOGOLD", (object) this.mCurrentArtifactParam.name, (object) rarityParam.ArtifactCreateCost, (object) ((int) rarityParam.ArtifactCreateCost - player.Gold), (object) player.Gold), (UIUtility.DialogResultEvent) null);
        else
          UIUtility.ConfirmBox(LocalizedText.Get("sys.ARTI_TRANSMUTE_CONFIRM", (object) this.mCurrentArtifactParam.name), new UIUtility.DialogResultEvent(this.OnTransmuteAccept), new UIUtility.DialogResultEvent(this.OnTransmuteCancel));
      }
    }
    ...
    private void OnTransmuteAccept(GameObject go)
    {
      ...
      if (Network.Mode == Network.EConnectMode.Online)
      {
        ...
        string bingo_progs;
        MonoSingleton<GameManager>.Instance.ServerSyncTrophyExecStart(out trophy_progs, out bingo_progs);
        Network.RequestAPI((WebAPI) new ReqArtifactAdd(this.mCurrentArtifactParam.iname, new Network.ResponseCallback(this.OnTransmuteResult), trophy_progs, bingo_progs));
      }
      else
      {
      ...
      if (Network.IsError)
      {
        switch (Network.ErrCode)
        {
          case Network.EErrCode.ArtifactBoxLimit:
            FlowNode_Network.Back();
            UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_FULL"), (UIUtility.DialogResultEvent) null);
            break;
          case Network.EErrCode.ArtifactPieceShort:
            UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_NOKAKERA_ERR"), (UIUtility.DialogResultEvent) null);
            FlowNode_Network.Back();
            break;
          default:
            FlowNode_Network.Retry();
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003CShowTransmuteResultAsync\u003Ec__Iterator1()
      {
        changeset = changeset,
        \u0024this = this
      };
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.ArtifactList, (UnityEngine.Object) null) && UnityEngine.Object.op_Equality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        return new ArtifactData[0];
      object[] objArray = !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null) ? this.ArtifactList.Selection : this.ArtifactScrollList.Selection;
      List<ArtifactData> artifactDataList = new List<ArtifactData>(objArray.Length);
      for (int index = 0; index < objArray.Length; ++index)
      {
        if (objArray[index] is ArtifactData && !artifactDataList.Contains(objArray[index] as ArtifactData))
          artifactDataList.Add(objArray[index] as ArtifactData);
      }
    ...
    public void DecomposeArtifact()
    {
      ...
      for (int index = 0; index < this.mSelectedArtifacts.Length; ++index)
      {
        ...
        {
          UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_DECOMPOSE_NODEC"), (UIUtility.DialogResultEvent) null);
          return;
        }
      ...
      {
        UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_DECOMPOSE_NOGOLD"), (UIUtility.DialogResultEvent) null);
      }
      else
      {
        this.mConfirmDialogGo = UIUtility.ConfirmBox(LocalizedText.Get("sys.ARTI_DECOMPOSE_CONFIRM"), new UIUtility.DialogResultEvent(this.OnDecomposeRarityCheck), new UIUtility.DialogResultEvent(this.OnDecomposeCancel));
    ...
    private void OnDecomposeRarityCheck(GameObject go)
    {
      ...
      if (flag)
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject1, (UnityEngine.Object) null))
        {
          ...
          {
            ArtifactRarityCheck componentInChildren = gameObject2.GetComponentInChildren<ArtifactRarityCheck>();
    ...
    private void OnDecomposeAccept(GameObject go)
    {
      ...
      {
        ArtifactData selectedArtifact = (ArtifactData) this.mSelectedArtifacts[index];
        if (instance.Player.FindOwner(selectedArtifact, out UnitData _, out JobData _))
        {
          flag = true;
          break;
        }
      ...
      if (flag)
        UIUtility.ConfirmBox(LocalizedText.Get("sys.ARTI_DECOMPOSE_CONFIRM2"), new UIUtility.DialogResultEvent(this.OnDecomposeAccept2), new UIUtility.DialogResultEvent(this.OnDecomposeCancel));
      else
    ...
    private void OnDecomposeAccept2(GameObject go)
    {
      ...
      if (!string.IsNullOrEmpty(this.DecomposeSE))
        MonoSingleton<MySound>.Instance.PlaySEOneShot(this.DecomposeSE);
      ...
      if (Network.Mode == Network.EConnectMode.Online)
      {
        ...
        Network.RequestAPI((WebAPI) new ReqArtifactConvert(artifact_iids, new Network.ResponseCallback(this.OnDecomposeResult)));
      }
      else
      {
        ...
        else
        {
          ...
          try
          {
            ...
            if (jsonObject.body.iids != null)
            {
              ...
              instance.Deserialize(jsonObject.body.artifacts);
    ...
    private void ShowDecomposeResult() => this.StartCoroutine(this.ShowDecomposeResultAsync());

    [DebuggerHidden]
    private IEnumerator ShowDecomposeResultAsync()
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003CShowDecomposeResultAsync\u003Ec__Iterator2()
      {
        \u0024this = this
      };
    }
    ...
    public void SellArtifacts()
    {
      ...
      {
        UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_NOTHING2SELL"), (UIUtility.DialogResultEvent) null);
      }
      else
      {
        this.mConfirmDialogGo = UIUtility.ConfirmBox(LocalizedText.Get("sys.ARTI_SELL_CONFIRM"), new UIUtility.DialogResultEvent(this.OnSellRarityCheck), new UIUtility.DialogResultEvent(this.OnSellCancel));
        if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mConfirmDialogGo, (UnityEngine.Object) null))
          return;
        Win_Btn_DecideCancel_FL_C component = this.mConfirmDialogGo.GetComponent<Win_Btn_DecideCancel_FL_C>();
        if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
    ...
    private void OnSellAccept(GameObject go)
    {
      ...
      if (flag)
        UIUtility.ConfirmBox(LocalizedText.Get("sys.ARTI_SELL_CONFIRM2"), new UIUtility.DialogResultEvent(this.OnSellAccept2), new UIUtility.DialogResultEvent(this.OnSellCancel));
      else
    ...
    private void OnSellAccept2(GameObject go)
    {
      ...
      if (!string.IsNullOrEmpty(this.SellSE))
        MonoSingleton<MySound>.Instance.PlaySEOneShot(this.SellSE);
      ...
      if (Network.Mode == Network.EConnectMode.Online)
      {
        Network.RequestAPI((WebAPI) new ReqArtifactSell(artifact_iids, new Network.ResponseCallback(this.OnSellResult)));
      }
      else
      {
    ...
    private void ShowSellResult()
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        return;
      this.ArtifactScrollList.ClearSelection();
      this.ArtifactScrollList.Refresh();
    }
    ...
    public void SetOwnerUnit(UnitData unit, int jobIndex)
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mButtonAutoEquip, (UnityEngine.Object) null))
        return;
      List<ArtifactData> autoEquipArtifacts = AutoEquipArtifacts.CreateAutoEquipArtifacts(unit, jobIndex);
      if (unit != null && unit.JobCount > jobIndex && autoEquipArtifacts.Count > 0 && autoEquipArtifacts[0] != null)
      {
        SerializeValueBehaviour component = ((Component) this).GetComponent<SerializeValueBehaviour>();
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
        {
          component.list.SetObject(ArtifactSVB_Key.UNIT, (object) unit);
          component.list.SetObject(ArtifactSVB_Key.JOB_INDEX, (object) jobIndex);
        }
        ((Selectable) this.mButtonAutoEquip).interactable = true;
      }
      else
        ((Selectable) this.mButtonAutoEquip).interactable = false;
    }
    ...
    {
      if (this.IsBusy || UnityEngine.Object.op_Equality((UnityEngine.Object) this.ArtifactList, (UnityEngine.Object) null) && UnityEngine.Object.op_Equality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        return;
      ArtifactData[] selectedArtifacts = this.GetSelectedArtifacts();
      ...
      else
      {
        ...
        if (owner && unit.UniqueID == this.mOwnerUnitData.UniqueID && this.mOwnerUnitData.Jobs[this.mOwnerUnitJobIndex].UniqueID == job.UniqueID)
          ...
          UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ARTI_CANT_EQUIP"), (UIUtility.DialogResultEvent) null);
          ...
          UIUtility.ConfirmBox(LocalizedText.Get("sys.ARTI_EQUIP_CONFIRM", (object) unit.UnitParam.name, (object) job.Name), new UIUtility.DialogResultEvent(this.OnEquipArtifactAccept), new UIUtility.DialogResultEvent(this.OnEquipArtifactCancel));
        else
    ...
    private void EndEquip() => FlowNode_GameObject.ActivateOutputLinks((Component) this, 500);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003CShowDetailAsync\u003Ec__Iterator3()
      {
        \u0024this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003COnSceneChangeAsync\u003Ec__Iterator4()
      {
        \u0024this = this
      };
    }
    ...
    private void Rebind()
    {
      ...
      {
        if (this.mCurrentArtifact != null)
          ((Selectable) this.artiProssessButton).interactable = true;
        else
          ((Selectable) this.artiProssessButton).interactable = false;
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.WindowBody, (UnityEngine.Object) null))
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.WindowBodyAdd, (UnityEngine.Object) null))
      {
        DataSource.Bind<ArtifactData>(this.WindowBodyAdd, this.mCurrentArtifact);
        DataSource.Bind<UnitData>(this.WindowBodyAdd, this.mCurrentArtifactOwner);
        DataSource.Bind<JobData>(this.WindowBodyAdd, this.mCurrentArtifactOwnerJob);
      }
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_SetEffectsButton, (UnityEngine.Object) null) || this.mCurrentArtifact == null)
        return;
      ((Selectable) this.m_SetEffectsButton).interactable = MonoSingleton<GameManager>.Instance.MasterParam.ExistSkillAbilityDeriveDataWithArtifact(this.mCurrentArtifact.ArtifactParam.iname);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_SetEffectsButtonAdd, (UnityEngine.Object) null))
        ((Selectable) this.m_SetEffectsButtonAdd).interactable = MonoSingleton<GameManager>.Instance.MasterParam.ExistSkillAbilityDeriveDataWithArtifact(this.mCurrentArtifact.ArtifactParam.iname);
      ArtifactSetList.SetSelectedArtifactParam(this.mCurrentArtifact.ArtifactParam);
    }

    private bool IsBusy => this.mSceneChanging || this.mBusy;
    ...
    public void OnKakeraCreateOnlyValueChanged(bool isOn)
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactList, (UnityEngine.Object) null))
      {
        this.ArtifactList.KakeraCreateOnly = !this.ArtifactList.KakeraCreateOnly;
        this.ArtifactList.Refresh();
      }
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        return;
      this.ArtifactScrollList.KakeraCreateOnly = !this.ArtifactScrollList.KakeraCreateOnly;
      this.ArtifactScrollList.Refresh();
    }
    ...
    public void OnExcludeEquipedValueChanged(bool isOn)
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        return;
      this.WriteExcludeEquipedSettingValue(isOn);
      this.ArtifactScrollList.ExcludeEquiped = isOn;
      this.ArtifactScrollList.Refresh();
    }

    public void OnEquipedSortValueChanged(bool isOn) => this.RefreshSortFilter();
    ...
    private void RefreshSortFilter()
    {
      if (this.mOwnerUnitData != null)
      {
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactScrollList, (UnityEngine.Object) null))
        {
          this.ArtifactScrollList.FiltersPriority = this.SetEquipArtifactFiltersOnly(this.mOwnerUnitData.CurrentJob, this.mCurrentArtifact, this.SelectSlotArtifactType, true);
        }
        else
        {
          if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ArtifactList, (UnityEngine.Object) null))
            return;
          this.ArtifactList.FiltersPriority = this.SetEquipArtifactFiltersOnly(this.mOwnerUnitData.CurrentJob, this.mCurrentArtifact, this.SelectSlotArtifactType, true);
        }
      }
      this.RefreshWindow();
      this.RefreshArtifactList();
    ...
    {
      return PlayerPrefsUtility.GetInt(PlayerPrefsUtility.ARTIFACT_EXCLUDE_EQUIPED) != 0;
    }

    private void WriteExcludeEquipedSettingValue(bool isOn)
    {
      int num = isOn ? 1 : 0;
      PlayerPrefsUtility.SetInt(PlayerPrefsUtility.ARTIFACT_EXCLUDE_EQUIPED, num);
    }
    ...
    public void RefreshInspSkillEnhance()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceConfirmButton, (UnityEngine.Object) null))
        ((Selectable) this.m_InspSkillEnhanceConfirmButton).interactable = false;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceStatus, (UnityEngine.Object) null))
      {
        ...
        DataSource.Bind<ArtifactData>(this.m_InspSkillEnhanceStatus, data);
        DataSource.Bind<ArtifactParam>(this.m_InspSkillEnhanceStatus, data.ArtifactParam);
        GameParameter.UpdateAll(this.m_InspSkillEnhanceStatus);
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceCost, (UnityEngine.Object) null))
        this.m_InspSkillEnhanceCost.text = "0";
      this.RefreshInspSkillEnhanceList();
      DataSource.Bind<AbilityData>(this.m_InspSkillEnhanceBeforePanel, (AbilityData) null);
      GameParameter.UpdateAll(this.m_InspSkillEnhanceBeforePanel);
      DataSource.Bind<AbilityData>(this.m_InspSkillEnhanceBeforePanel, MonoSingleton<GameManager>.Instance.Player.Artifacts.Find((Predicate<ArtifactData>) (select => (long) select.UniqueID == (long) this.mCurrentArtifact.UniqueID)).InspirationSkillList.Find((Predicate<InspirationSkillData>) (select => (long) select.UniqueID == (long) this.m_CurrentInspSkill.UniqueID)).AbilityData);
      ...
      DataSource.Bind<AbilityData>(this.m_InspSkillEnhanceAfterPanel, (AbilityData) null);
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_InspSkillList, (UnityEngine.Object) null) | UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_InspSkillListItem, (UnityEngine.Object) null))
        return;
      ArtifactData artifactData = MonoSingleton<GameManager>.Instance.Player.Artifacts.Find((Predicate<ArtifactData>) (select => (long) select.UniqueID == (long) this.mCurrentArtifact.UniqueID));
      ...
      for (int index2 = 0; index2 < inspirationSkillSlotMax; ++index2)
      {
        ...
        DataSource.Bind<InspirationSkillData>(root, (InspirationSkillData) null);
        DataSource.Bind<AbilityData>(root, (AbilityData) null);
        GameParameter.UpdateAll(root);
        root.SetActive(false);
        ...
        if (inspSkillState == ArtifactWindow.InspSkillState.LEANED)
        {
          ...
          DataSource.Bind<InspirationSkillData>(root, inspirationSkillList[index2]);
          gameObject6.SetActive((bool) inspirationSkillList[index2].IsSet);
          ((Selectable) button).interactable = (int) inspirationSkillList[index2].Lv < inspirationSkillList[index2].InspSkillParam.LvCap;
          ...
          if (inspSkillParam != null)
          {
            ...
            string str = resetCost.Type != InspSkillCostType.GOLD ? resetCost.Num.ToString() : CurrencyBitmapText.CreateFormatedText(resetCost.Num.ToString());
            text2.text = str;
          ...
          DataSource.Bind<AbilityData>(root, abilityData);
          root.SetActive(true);
          GameParameter.UpdateAll(root);
          ++index1;
        }
        else
        {
          ...
          if (!flag)
          {
            ...
            string str = inspSkillOpenCost.Type != InspSkillCostType.GOLD ? inspSkillOpenCost.Num.ToString() : CurrencyBitmapText.CreateFormatedText(inspSkillOpenCost.Num.ToString());
            text1.text = str;
            ImageArray component3 = gameObject7.GetComponent<ImageArray>();
            if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component3, (UnityEngine.Object) null))
            {
              int type = (int) inspSkillOpenCost.Type;
              component3.ImageIndex = type > component3.Images.Length ? 0 : type;
            }
          }
          root.SetActive(true);
          ++index1;
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_InspSkillEnhanceList, (UnityEngine.Object) null) || UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_InspSkillEnhanceListItem, (UnityEngine.Object) null))
        return;
      this.m_SelectedArtifactList.Clear();
      List<ArtifactData> skillLvUpArtifacts = MonoSingleton<GameManager>.Instance.Player.GetInspirationSkillLvUpArtifacts(this.mCurrentArtifact, this.m_CurrentInspSkill);
      int index1 = 0;
      ...
      for (int index2 = 0; index2 < skillLvUpArtifacts.Count; ++index2)
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component1, (UnityEngine.Object) null))
        {
          ...
          gameObject1.SetActive(false);
          gameObject2.SetActive(skillLvUpArtifacts[index2].IsEquipped(true) || skillLvUpArtifacts[index2].IsFavorite || flag);
        }
        DataSource.Bind<ArtifactData>(root, skillLvUpArtifacts[index2]);
        root.SetActive(false);
        root.SetActive(true);
        GameParameter.UpdateAll(root);
        ++index1;
    ...
    private void RefreshInspSkillEnhanceListNotSelect(bool active = true)
    {
      ...
      for (int index = 0; index < this.m_InspSkillEnhanceItems.Count; ++index)
      {
        ...
        if (skillEnhanceItem.activeInHierarchy)
        {
          ...
          if (item_artifact != null && !item_artifact.IsEquipped(true) && !item_artifact.IsFavorite && this.m_SelectedArtifactList.FindIndex((Predicate<ArtifactData>) (select => (long) select.UniqueID == (long) item_artifact.UniqueID)) < 0)
          {
    ...
    private void OnSelectEquipInspSkill(GameObject go)
    {
      ...
      if (dataOfClass != null)
        this.m_CurrentInspSkill = dataOfClass;
      DataSource.Bind<InspirationSkillData>(this.m_InspSkillEquipConfirm, dataOfClass);
      DataSource.Bind<AbilityData>(this.m_InspSkillEquipConfirm, dataOfClass.AbilityData);
    ...
    private void OnSelectResetInspSkill(GameObject go)
    {
      ...
      else
      {
        ...
        DataSource.Bind<AbilityData>(this.m_InspSkillResetBefore, dataOfClass.AbilityData);
        DataSource.Bind<AbilityData>(this.m_InspSkillResetAfter, inspirationSkillData.AbilityData);
        GameParameter.UpdateAll(this.m_InspSkillResetBefore);
        GameParameter.UpdateAll(this.m_InspSkillResetAfter);
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillResetText, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillResetTitle, (UnityEngine.Object) null))
        {
    ...
    private void OnSelectEnhanceListItem(GameObject go)
    {
      ...
      if (data == null || data.IsFavorite || data.IsEquipped(true))
        return;
      InspirationSkillData inspirationSkillData = MonoSingleton<GameManager>.Instance.Player.Artifacts.Find((Predicate<ArtifactData>) (select => (long) select.UniqueID == (long) this.mCurrentArtifact.UniqueID)).InspirationSkillList.Find((Predicate<InspirationSkillData>) (select => (long) select.UniqueID == (long) this.m_CurrentInspSkill.UniqueID));
      ...
      DataSource.Bind<InspirationSkillData>(this.m_InspSkillEnhanceAfterPanel, data1);
      DataSource.Bind<AbilityData>(this.m_InspSkillEnhanceAfterPanel, data1.AbilityData);
      GameParameter.UpdateAll(this.m_InspSkillEnhanceAfterPanel);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceCost, (UnityEngine.Object) null))
      {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceConfirmButton, (UnityEngine.Object) null))
        ((Selectable) this.m_InspSkillEnhanceConfirmButton).interactable = this.m_SelectedArtifactList.Count > 0;
      bool active = false;
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_InspSkillSlotUnlockConfirmText, (UnityEngine.Object) null))
      {
      ...
      else
      {
        ...
        {
          this.m_InspSkillSlotUnlockConfirmText.text = LocalizedText.Get("sys.ARTIFACT_INSPIRATIONSKILL_OPEN_TEXT", (object) LocalizedText.Get("sys.ARTIFACT_INSPIRATIONSKILL_COST_PREFIX_" + inspSkillOpenCost.Type.ToString(), (object) inspSkillOpenCost.Num));
    ...
    private void OnConfirmInspSkillEnhance()
    {
      ...
      {
        DataSource.Bind<ArtifactData>(this.m_InspSkillEnhanceConfirmItems[index], (ArtifactData) null);
      ...
      for (int index = 0; index < this.m_SelectedArtifactList.Count; ++index)
      {
        ...
        DataSource.Bind<ArtifactData>(root, this.m_SelectedArtifactList[index]);
        GameParameter.UpdateAll(root);
        root.SetActive(true);
      }
    ...
    {
      this.m_SelectedArtifactList.Clear();
      DataSource.Bind<InspirationSkillData>(this.m_InspSkillEnhanceAfterPanel, (InspirationSkillData) null);
      DataSource.Bind<AbilityData>(this.m_InspSkillEnhanceAfterPanel, (AbilityData) null);
      GameParameter.UpdateAll(this.m_InspSkillEnhanceAfterPanel);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_InspSkillEnhanceCost, (UnityEngine.Object) null))
        this.m_InspSkillEnhanceCost.text = "0";
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.m_InspSkillEnhanceSuccessEffect, (UnityEngine.Object) null))
        return;
      DataSource.Bind<AbilityData>(this.m_InspSkillEnhanceSuccessEffect, (AbilityData) null);
      long artifact_iid = (long) this.mCurrentArtifact.UniqueID;
      long insp_iid = (long) this.m_CurrentInspSkill.UniqueID;
      DataSource.Bind<AbilityData>(this.m_InspSkillEnhanceSuccessEffect, MonoSingleton<GameManager>.Instance.Player.Artifacts.Find((Predicate<ArtifactData>) (select => (long) select.UniqueID == artifact_iid)).InspirationSkillList.Find((Predicate<InspirationSkillData>) (select => (long) select.UniqueID == insp_iid)).AbilityData);
    ...
    public bool IsEnbBtnArtiStrengthen
    {
      set
      {
        this.mIsEnbBtnArtiStrengthen = value;
        this.ReflectEnbBtnArtiStrengthen();
      }
    }
    ...
    {
      if (!UnityEngine.Object.op_Implicit((UnityEngine.Object) this.artiProssessButton))
        return;
      ((Component) this.artiProssessButton).gameObject.SetActive(this.mIsEnbBtnArtiStrengthen);
    }

    public void SetArtifactType(ArtifactTypes type)
    {
      this.SelectSlotArtifactType = type;
      this.RefreshSortFilter();
    }
    ...
    {
      switch (select_slot_artifact_type)
      {
        case ArtifactTypes.None:
          FlowNode_GameObject.ActivateOutputLinks((Component) this, 810);
          break;
        case ArtifactTypes.Arms:
          FlowNode_GameObject.ActivateOutputLinks((Component) this, 811);
          break;
        case ArtifactTypes.Armor:
          FlowNode_GameObject.ActivateOutputLinks((Component) this, 812);
          break;
        case ArtifactTypes.Accessory:
          FlowNode_GameObject.ActivateOutputLinks((Component) this, 813);
          break;
      }
      return this.SetEquipArtifactFiltersOnly(job, data, select_slot_artifact_type);
    }
      ...
      bool only = false)
    {
      ...
      if (select_slot_artifact_type != ArtifactTypes.None)
      {
        stringList.Add("TYPE:" + (object) select_slot_artifact_type);
      }
      else
      {
    ...
    {
      ArtifactData dataOfClass = DataSource.FindDataOfClass<ArtifactData>(icon.gameObject, (ArtifactData) null);
      if (dataOfClass == null || !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mProcessWindow, (UnityEngine.Object) null))
        return;
      DataSource.Bind<ArtifactData>(this.mProcessWindow, dataOfClass);
      this.mProcessWindow.SetActive(true);
    }
