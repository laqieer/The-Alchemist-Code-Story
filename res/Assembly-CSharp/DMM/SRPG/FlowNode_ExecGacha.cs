...
namespace SRPG
{
  ...
  public class FlowNode_ExecGacha : FlowNode_Network
  {
    ...
    private void OnClickYes(GameObject dialog) => this.Success();

    private void ShowResultDialog(string result)
    {
      UIUtility.SystemMessage("獲得", result, new UIUtility.DialogResultEvent(this.OnClickYes));
    }
    ...
    private IEnumerator StartGachaSceneAsync(FlowNode_ExecGacha.GachaModes mode)
    {
      ...
      return (IEnumerator) new FlowNode_ExecGacha.\u003CStartGachaSceneAsync\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
