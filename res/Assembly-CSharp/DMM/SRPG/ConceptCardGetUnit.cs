...
namespace SRPG
{
  ...
  public class ConceptCardGetUnit : MonoBehaviour, IFlowInterface
  {
    ...
    {
      get => this.m_ConceptCardAnimator.GetCurrentAnimatorStateInfo(0);
    }
    ...
    public void Setup(ConceptCardData conceptCardData)
    {
      try
      {
        ...
        if (unitParam != null)
          FlowNode_ExtraUnitOpenPopup.ReserveOpenExtraQuestPopup(unitParam.iname);
    ...
    private IEnumerator WaitConceptCardEffectEnd()
    {
      ...
      return (IEnumerator) new ConceptCardGetUnit.\u003CWaitConceptCardEffectEnd\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
