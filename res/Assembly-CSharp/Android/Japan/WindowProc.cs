...
public class WindowProc : MonoSingleton<WindowProc>
{
  ...
  private IntPtr wndProc(IntPtr hWnd, uint msg, IntPtr wParam, IntPtr lParam)
  {
    ...
    switch (msg)
    {
      ...
      case 532:
        ...
        obj3.rect = new Rect();
        obj3.rect.xMin = (float) structure.left;
        obj3.rect.yMin = (float) structure.top;
        obj3.rect.xMax = (float) structure.right;
        obj3.rect.yMax = (float) structure.bottom;
        this.onWM_Sizing.Invoke(obj3);
        structure.left = (int) obj3.rect.xMin;
        structure.top = (int) obj3.rect.yMin;
        structure.right = (int) obj3.rect.xMax;
        structure.bottom = (int) obj3.rect.yMax;
    ...
    if (windowEventParamBase != null && windowEventParamBase.skipProc)
      return IntPtr.Zero;
    return WindowsAPI.CallWindowProc(this.oldWndProcPtr, hWnd, msg, wParam, lParam);
  }

  protected short LoWord(long input)
  {
    return (short) ((int) input & (int) ushort.MaxValue);
  }
  ...
  public void AddWM_CloseListener(UnityAction<WindowProc.WM_CloseEvent.Param> callback)
  {
    this.onWM_Close.AddListener(callback);
  }

  public void RemoveWM_CloseListener(UnityAction<WindowProc.WM_CloseEvent.Param> callback)
  {
    this.onWM_Close.RemoveListener(callback);
  }

  public void AddWM_MoveListener(UnityAction<WindowProc.WM_MoveEvent.Param> callback)
  {
    this.onWM_Move.AddListener(callback);
  }

  public void RemoveWM_MoveListener(UnityAction<WindowProc.WM_MoveEvent.Param> callback)
  {
    this.onWM_Move.RemoveListener(callback);
  }

  public void AddWM_SizeListener(UnityAction<WindowProc.WM_SizeEvent.Param> callback)
  {
    this.onWM_Size.AddListener(callback);
  }

  public void RemoveWM_SizeListener(UnityAction<WindowProc.WM_SizeEvent.Param> callback)
  {
    this.onWM_Size.RemoveListener(callback);
  }

  public void AddWM_SizingListener(UnityAction<WindowProc.WM_SizingEvent.Param> callback)
  {
    this.onWM_Sizing.AddListener(callback);
  }

  public void RemoveWM_SizingListener(UnityAction<WindowProc.WM_SizingEvent.Param> callback)
  {
    this.onWM_Sizing.RemoveListener(callback);
  }

  public void AddWM_EnterSizeMoveListener(UnityAction<WindowProc.WM_EnterSizeMoveEvent.Param> callback)
  {
    this.onWM_EnterSizeMove.AddListener(callback);
  }

  public void RemoveWM_EnterSizeMoveListener(UnityAction<WindowProc.WM_EnterSizeMoveEvent.Param> callback)
  {
    this.onWM_EnterSizeMove.RemoveListener(callback);
  }

  public void AddWM_ExitSizeMoveListener(UnityAction<WindowProc.WM_ExitSizeMoveEvent.Param> callback)
  {
    this.onWM_ExitSizeMove.AddListener(callback);
  }

  public void RemoveWM_ExitSizeMoveListener(UnityAction<WindowProc.WM_ExitSizeMoveEvent.Param> callback)
  {
