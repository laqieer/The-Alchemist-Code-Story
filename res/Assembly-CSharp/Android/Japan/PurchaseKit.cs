...
public static class PurchaseKit
{
  ...
  public static void Init(IPurchaseListener listener, GameObject serviceNode = null, PurchaseKit.Logger logger = null, IntPtr nativeLogger = default (IntPtr))
  {
    PurchaseKit.Init((string[]) null, listener, serviceNode, logger, nativeLogger);
  }

  public static void Init(string[] productIds, IPurchaseListener listener, GameObject serviceNode = null, PurchaseKit.Logger logger = null, IntPtr nativeLogger = default (IntPtr))
  {
    ...
    if ((Object) purchaseService == (Object) null)
  ...
  public abstract class AbstractResponse<TMeta, TValue> where TMeta : PurchaseKit.IContent, new() where TValue : PurchaseKit.IContent, new()
  {
    ...
    public AbstractResponse(IntPtr intptr)
    {
      ...
      {
        this.Meta = Activator.CreateInstance<TMeta>();
      ...
      for (int index = 0; (long) index < (long) structure.value_count; ++index)
      {
        ...
        instance.Parse((IntPtr) ((long) structure.values + (long) ((int) structure.value_size * index)));
        this.Values[index] = instance;
      }
    }
  }
