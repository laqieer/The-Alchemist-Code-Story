...
public class PhotonView : Photon.MonoBehaviour
{
  ...
  {
    return string.Format("View ({3}){0} on {1} {2}", (object) this.viewID, !((Object) this.gameObject != (Object) null) ? (object) "GO==null" : (object) this.gameObject.name, !this.isSceneView ? (object) string.Empty : (object) "(scene)", (object) this.prefix);
  }
}
