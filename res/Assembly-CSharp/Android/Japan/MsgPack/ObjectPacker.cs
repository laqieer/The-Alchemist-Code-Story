...
namespace MsgPack
{
  public class ObjectPacker
  {
    ...
    static ObjectPacker()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      ObjectPacker.PackDelegate fMgCache0 = ObjectPacker.\u003C\u003Ef__mg\u0024cache0;
      packerMapping.Add(key1, fMgCache0);
      ...
      // ISSUE: reference to a compiler-generated field
      ObjectPacker.UnpackDelegate fMgCache1 = ObjectPacker.\u003C\u003Ef__mg\u0024cache1;
      unpackerMapping.Add(key2, fMgCache1);
    }
    ...
    private object Unpack(MsgPackReader reader, Type t)
    {
      ...
      (uninitializedObject as IDeserializationCallback)?.OnDeserialization((object) this);
