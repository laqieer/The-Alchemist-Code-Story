...
{
  public abstract class Request<TRequest, TResponse> : ApiObject, IRequest<TRequest, TResponse>, IRequest where TRequest : IRequest<TRequest, TResponse> where TResponse : IResponse<TResponse>
  {
    ...
    public virtual byte[] GetPayload()
    {
      ...
      return Encoding.UTF8.GetBytes(MiniJSON.Json.Serialize(Gsc.DOM.FastJSON.Json.Deserialize((IValue) (Value) ((Object) this))));
    }
