...
{
  public class WebTask<TRequest, TResponse> : IWebTask<TRequest, TResponse>, IWebTask<TResponse>, IWebTask, IWebTaskBase, ITask, IEnumerator where TRequest : IRequest<TRequest, TResponse> where TResponse : IResponse<TResponse>
  {
