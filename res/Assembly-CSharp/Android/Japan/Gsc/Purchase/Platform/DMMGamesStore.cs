  ...
  public class DMMGamesStore : IPurchaseFlowImpl
  {
    ...
    private class InnerFlow
    {
      ...
      private IEnumerator _Purchase(string productId)
      {
        ...
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_Purchase\u003Ec__Iterator0() { productId = productId, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_GetPaymentId\u003Ec__Iterator1() { productId = productId, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_WaitPurchase\u003Ec__Iterator2() { \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_Resume\u003Ec__Iterator3() { handler = handler };
      }
