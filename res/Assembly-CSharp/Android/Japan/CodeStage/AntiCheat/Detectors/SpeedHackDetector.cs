...
namespace CodeStage.AntiCheat.Detectors
{
  ...
  public class SpeedHackDetector : ActDetectorBase
  {
    ...
    {
      if ((Object) SpeedHackDetector.Instance != (Object) null)
    ...
    private void LoadedLevel(Scene scenename, LoadSceneMode SceneMode)
    {
      ...
      {
        if (this.keepAlive || !((Object) SpeedHackDetector.Instance != (Object) this))
          return;
        this.DisposeInternal();
      }
    }
    ...
    protected override void DisposeInternal()
    {
      ...
      if (!((Object) SpeedHackDetector.Instance == (Object) this))
        return;
