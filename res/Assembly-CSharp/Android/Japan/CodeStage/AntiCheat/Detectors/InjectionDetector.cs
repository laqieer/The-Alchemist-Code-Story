...
namespace CodeStage.AntiCheat.Detectors
{
  ...
  public class InjectionDetector : ActDetectorBase
  {
    ...
    {
      if ((Object) InjectionDetector.Instance != (Object) null)
    ...
    private void LoadedLevel(Scene scenename, LoadSceneMode SceneMode)
    {
      ...
      {
        if (this.keepAlive || !((Object) InjectionDetector.Instance != (Object) this))
          return;
        this.DisposeInternal();
      }
    }
    ...
    protected override void DisposeInternal()
    {
      ...
      if (!((Object) InjectionDetector.Instance == (Object) this))
        return;
