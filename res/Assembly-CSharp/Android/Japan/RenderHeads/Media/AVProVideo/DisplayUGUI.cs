...
namespace RenderHeads.Media.AVProVideo
{
  ...
  public class DisplayUGUI : MaskableGraphic
  {
    ...
    protected override void Awake()
    {
      ...
      if ((Object) DisplayUGUI._shaderAlphaPacking == (Object) null)
      {
      ...
      if ((Object) DisplayUGUI._shaderStereoPacking == (Object) null)
      {
    ...
    {
      this._userMaterial = (Object) this.m_Material != (Object) null;
      base.Start();
    }
    ...
    private Shader GetRequiredShader()
    {
      ...
      if ((Object) shader == (Object) null && this._mediaPlayer.Info != null && (QualitySettings.activeColorSpace == ColorSpace.Linear && !this._mediaPlayer.Info.PlayerSupportsLinearColorSpace()))
        shader = DisplayUGUI._shaderAlphaPacking;
    ...
    public override Texture mainTexture
    {
      get
      {
        ...
        else if ((Object) this._defaultTexture != (Object) null)
    ...
    {
      if ((Object) this._mediaPlayer != (Object) null && this._mediaPlayer.TextureProducer != null)
        return (Object) this._mediaPlayer.TextureProducer.GetTexture(0) != (Object) null;
      return false;
    }
    ...
    private void LateUpdate()
    {
      if (this._setNativeSize)
        this.SetNativeSize();
      if ((Object) this._lastTexture != (Object) this.mainTexture)
      {
        this._lastTexture = this.mainTexture;
        this.SetVerticesDirty();
      }
      if (this.HasValidTexture() && (Object) this.mainTexture != (Object) null && (this.mainTexture.width != this._lastWidth || this.mainTexture.height != this._lastHeight))
      {
      ...
      if ((Object) this.material != (Object) null && (Object) this._mediaPlayer != (Object) null)
      {
    ...
    public MediaPlayer CurrentMediaPlayer
    {
      ...
      set
      {
        if (!((Object) this._mediaPlayer != (Object) value))
          return;
    ...
    private Vector4 GetDrawingDimensions(UnityEngine.ScaleMode scaleMode, ref Rect uvRect)
    {
      ...
      if ((Object) this.mainTexture != (Object) null)
      {
