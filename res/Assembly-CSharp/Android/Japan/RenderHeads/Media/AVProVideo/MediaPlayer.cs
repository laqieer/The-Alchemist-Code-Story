...
namespace RenderHeads.Media.AVProVideo
{
  ...
  public class MediaPlayer : MonoBehaviour
  {
    ...
    private IEnumerator LoadSubtitlesCoroutine(string url, MediaPlayer.FileLocation fileLocation, string filePath)
    {
      ...
      return (IEnumerator) new MediaPlayer.\u003CLoadSubtitlesCoroutine\u003Ec__Iterator0() { url = url, fileLocation = fileLocation, filePath = filePath, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new MediaPlayer.\u003CFinalRenderCapture\u003Ec__Iterator1() { \u0024this = this };
    }
    ...
    private void UpdateEvents()
    {
      ...
      {
        bool flag = false;
        if ((double) this.m_Info.GetDurationMs() - (double) this.m_Control.GetCurrentTimeMs() > (double) (1000f / this.m_Info.GetVideoFrameRate()))
          flag = true;
        if (flag)
      ...
      bool flag1 = this.m_Info.IsPlaybackStalled();
      if (flag1 == this.m_isPlaybackStalled)
        return;
      this.m_isPlaybackStalled = flag1;
    ...
    {
      Texture2D frame = this.ExtractFrame((Texture2D) null, -1f, true, 1000);
    ...
    private Texture ExtractFrame(float timeSeconds = -1f, bool accurateSeek = true, int timeoutMs = 1000)
    {
      ...
      if (this.m_Control != null)
      {
        if ((double) timeSeconds >= 0.0)
        {
          ...
          if ((Object) this.TextureProducer.GetTexture(0) != (Object) null && (double) this.m_Control.GetCurrentTimeMs() == (double) timeMs)
          {
