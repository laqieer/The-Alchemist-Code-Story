...
internal class NetworkingPeer : LoadBalancingPeer, IPhotonPeerListener
{
  ...
  protected internal void SetupProtocol(ServerConnection serverType)
  {
    ...
    System.Type type = System.Type.GetType("ExitGames.Client.Photon.SocketWebTcp, Assembly-CSharp", false) ?? System.Type.GetType("ExitGames.Client.Photon.SocketWebTcp, Assembly-CSharp-firstpass", false);
    if (type != null)
    {
  ...
  {
    if (actorProperties.ContainsKey((object) actorNr))
    ...
    if (destroyInstantiatedGameObjects)
    {
      ...
      foreach (PhotonView photonView in this.photonViewList.Values)
      {
        if (photonView.isRuntimeInstantiated)
          gameObjectSet.Add(photonView.gameObject);
      }
  ...
  protected internal bool SetMasterClient(int playerId, bool sync)
  {
    ...
    if (sync)
    {
      ...
      hashtable1.Add((object) (byte) 1, (object) playerId);
  ...
  {
    Hashtable hashtable1 = new Hashtable();
    hashtable1.Add((object) (byte) 248, (object) nextMasterId);
    Hashtable gameProperties = hashtable1;
    Hashtable hashtable2 = new Hashtable();
    hashtable2.Add((object) (byte) 248, (object) this.mMasterClientId);
  ...
  private Hashtable GetLocalActorProperties()
  {
    ...
    return new Hashtable() { [(object) byte.MaxValue] = (object) this.PlayerName };
  }
      ...
      switch (operationCode)
      {
        case 217:
          ...
          foreach (object key in hashtable.Keys)
          {
            ...
            this.mGameList[roomName] = new RoomInfo(roomName, (Hashtable) hashtable[key]);
          }
  ...
  public void OnEvent(EventData photonEvent)
  {
    ...
    switch (code)
    {
      ...
      case 206:
        ...
        byte num1 = 10;
        int num2 = 1;
        if (hashtable1.ContainsKey((object) (byte) 1))
        {
          correctPrefix = (short) hashtable1[(object) (byte) 1];
          num2 = 2;
        }
        for (byte index2 = num1; (int) index2 - (int) num1 < hashtable1.Count - num2; ++index2)
      ...
      case 204:
        ...
        if (this.DebugOut < DebugLevel.ERROR)
          break;
        Debug.LogError((object) ("Ev Destroy Failed. Could not find PhotonView with instantiationId " + (object) key1 + ". Sent by actorNr: " + (object) index1));
        break;
      case 207:
      ...
      case 209:
        ...
        if ((Object) photonView2 == (Object) null)
        {
      ...
      case 210:
        ...
        if (!((Object) photonView3 != (Object) null))
          break;
      ...
      default:
        switch (code)
        {
          ...
          case 229:
            ...
            {
              string index2 = (string) key2;
              RoomInfo roomInfo = new RoomInfo(index2, (Hashtable) hashtable2[key2]);
          ...
          case 230:
            ...
            {
              string roomName = (string) key2;
              this.mGameList[roomName] = new RoomInfo(roomName, (Hashtable) hashtable3[key2]);
            }
            this.mGameListCopy = new RoomInfo[this.mGameList.Count];
            this.mGameList.Values.CopyTo(this.mGameListCopy, 0);
            NetworkingPeer.SendMonoMessage(PhotonNetworkingMessage.OnReceivedRoomListUpdate);
  ...
  public static void SendMonoMessage(PhotonNetworkingMessage methodString, params object[] parameters)
  {
    ...
    foreach (GameObject gameObject in gameObjectSet)
    {
      if ((Object) gameObject != (Object) null)
        gameObject.SendMessage(methodName, obj, SendMessageOptions.DontRequireReceiver);
    }
  }

  protected internal void ExecuteRpc(Hashtable rpcData, PhotonPlayer sender)
  {
    if (rpcData == null || !rpcData.ContainsKey((object) (byte) 0))
    {
    ...
    else
    {
      ...
      int num1 = 0;
      if (rpcData.ContainsKey((object) (byte) 1))
        num1 = (int) (short) rpcData[(object) (byte) 1];
      string rpc;
      if (rpcData.ContainsKey((object) (byte) 5))
      {
      ...
      if (rpcData.ContainsKey((object) (byte) 4))
      ...
      else
      {
        ...
        for (int index1 = 0; index1 < photonView.RpcMonoBehaviours.Length; ++index1)
        {
          ...
          if ((Object) rpcMonoBehaviour == (Object) null)
          {
                ...
                if (mo.Name.Equals(rpc))
                {
                  ...
                  if (cachedParemeters.Length == callParameterTypes.Length)
                  {
                    if (this.CheckTypeMatch(cachedParemeters, callParameterTypes))
                    {
                      ...
                      if (PhotonNetwork.StartRpcsAsCoroutine && mo.ReturnType == typeof (IEnumerator))
                        rpcMonoBehaviour.StartCoroutine((IEnumerator) obj);
                    }
                  }
                  else if (cachedParemeters.Length - 1 == callParameterTypes.Length)
                  {
                    if (this.CheckTypeMatch(cachedParemeters, callParameterTypes) && cachedParemeters[cachedParemeters.Length - 1].ParameterType == typeof (PhotonMessageInfo))
                    {
                      ++num2;
  ...
  private bool CheckTypeMatch(ParameterInfo[] methodParameters, System.Type[] callParameterTypes)
  {
    ...
    for (int index = 0; index < callParameterTypes.Length; ++index)
    {
      ...
      if (callParameterTypes[index] != null && !parameterType.IsAssignableFrom(callParameterTypes[index]) && (!parameterType.IsEnum || !Enum.GetUnderlyingType(parameterType).IsAssignableFrom(callParameterTypes[index])))
        return false;
    }
    return true;
  }
  ...
  internal GameObject DoInstantiate(Hashtable evData, PhotonPlayer photonPlayer, GameObject resourceGameObject)
  {
    ...
    Vector3 position = !evData.ContainsKey((object) (byte) 1) ? Vector3.zero : (Vector3) evData[(object) (byte) 1];
    Quaternion identity = Quaternion.identity;
    if (evData.ContainsKey((object) (byte) 2))
      identity = (Quaternion) evData[(object) (byte) 2];
    int num1 = 0;
    if (evData.ContainsKey((object) (byte) 3))
      num1 = (int) evData[(object) (byte) 3];
    short num2 = 0;
    if (evData.ContainsKey((object) (byte) 8))
      num2 = (short) evData[(object) (byte) 8];
    int[] numArray;
    if (evData.ContainsKey((object) (byte) 4))
      numArray = (int[]) evData[(object) (byte) 4];
    else
      numArray = new int[1]{ instantiationId };
    object[] instantiationData = !evData.ContainsKey((object) (byte) 5) ? (object[]) null : (object[]) evData[(object) (byte) 5];
    ...
    if ((Object) resourceGameObject == (Object) null)
    {
  ...
  public void DestroyPlayerObjects(int playerId, bool localOnly)
  {
    ...
    else
    {
      ...
      foreach (PhotonView photonView in this.photonViewList.Values)
      {
        if ((Object) photonView != (Object) null && photonView.CreatorActorNr == playerId)
          gameObjectSet.Add(photonView.gameObject);
      }
      foreach (GameObject go in gameObjectSet)
        this.RemoveInstantiatedGO(go, true);
  ...
  public PhotonView GetPhotonView(int viewID)
  {
    ...
    if ((Object) photonView1 == (Object) null)
    {
  ...
  public void RegisterPhotonView(PhotonView netView)
  {
    ...
    else
    {
      ...
      {
        if (!((Object) netView != (Object) photonView))
          return;
  ...
  public void NewSceneLoaded()
  {
    ...
    {
      if ((Object) photonView.Value == (Object) null)
  ...
  public void RunViewUpdate()
  {
    ...
    foreach (PhotonView view in this.photonViewList.Values)
    {
      if (view.synchronization != ViewSynchronization.Off && view.isMine && (view.gameObject.activeInHierarchy && !this.blockSendingGroups.Contains(view.group)))
      {
        ...
        if (objArray != null)
        {
          if (view.synchronization == ViewSynchronization.ReliableDeltaCompressed || view.mixedModeIsReliable)
          {
            ...
            if (!this.dataPerGroupReliable.TryGetValue(view.group, out hashtable))
            {
              hashtable = new Hashtable(NetworkingPeer.ObjectsInOneUpdate);
              this.dataPerGroupReliable[view.group] = hashtable;
            }
            hashtable.Add((object) (byte) (hashtable.Count + 10), (object) objArray);
            ++num;
          ...
          {
            Hashtable hashtable = (Hashtable) null;
            if (!this.dataPerGroupUnreliable.TryGetValue(view.group, out hashtable))
            {
              hashtable = new Hashtable(NetworkingPeer.ObjectsInOneUpdate);
              this.dataPerGroupUnreliable[view.group] = hashtable;
            }
            hashtable.Add((object) (byte) (hashtable.Count + 10), (object) objArray);
            ++num;
            if (hashtable.Count >= NetworkingPeer.ObjectsInOneUpdate)
    ...
    foreach (int key in this.dataPerGroupReliable.Keys)
    {
      ...
      Hashtable hashtable = this.dataPerGroupReliable[key];
    ...
    {
      raiseEventOptions.InterestGroup = (byte) key;
      Hashtable hashtable = this.dataPerGroupUnreliable[key];
      if (hashtable.Count != 0)
      {
        hashtable[(object) (byte) 0] = (object) PhotonNetwork.ServerTimestamp;
        if (this.currentLevelPrefix >= (short) 0)
  ...
  {
    mi = (MethodInfo) null;
    if ((Object) monob == (Object) null || string.IsNullOrEmpty(methodType))
      return false;
  ...
  {
    if (!PhotonNetwork.automaticallySyncScene || PhotonNetwork.isMasterClient || (PhotonNetwork.room == null || !PhotonNetwork.room.CustomProperties.ContainsKey((object) "curScn")))
      return;
  ...
  protected internal void SetLevelInPropsIfSynced(object levelId)
  {
    ...
    {
      if (PhotonNetwork.room.CustomProperties.ContainsKey((object) "curScn"))
      {
        object customProperty = PhotonNetwork.room.CustomProperties[(object) "curScn"];
