...
public class MediaPlayerWrapper : MonoBehaviour
{
  ...
  private void Start()
  {
    this.m_MediaPlayer.Events.RemoveListener(new UnityAction<MediaPlayer, MediaPlayerEvent.EventType, RenderHeads.Media.AVProVideo.ErrorCode>(this.OnMediaPlayerEvent));
    this.m_MediaPlayer.Events.AddListener(new UnityAction<MediaPlayer, MediaPlayerEvent.EventType, RenderHeads.Media.AVProVideo.ErrorCode>(this.OnMediaPlayerEvent));
  ...
  private IEnumerator LoadInternal(string url, bool autoPlay)
  {
    ...
    return (IEnumerator) new MediaPlayerWrapper.\u003CLoadInternal\u003Ec__Iterator0() { url = url, autoPlay = autoPlay, \u0024this = this };
  }
