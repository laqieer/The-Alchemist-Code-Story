...
public class InRoomChat : Photon.MonoBehaviour
{
  ...
  public void OnGUI()
  {
    if (!this.IsVisible || !PhotonNetwork.inRoom)
      return;
    if (UnityEngine.Event.current.type == UnityEngine.EventType.KeyDown && (UnityEngine.Event.current.keyCode == KeyCode.KeypadEnter || UnityEngine.Event.current.keyCode == KeyCode.Return))
    {
