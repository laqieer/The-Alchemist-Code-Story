...
public abstract class FlowNode : MonoBehaviour
{
  ...
  public FlowNode.Pin[] Pins
  {
    get
    {
      FlowNode.Pin[] customAttributes = (FlowNode.Pin[]) this.GetType().GetCustomAttributes(typeof (FlowNode.Pin), true);
  ...
  public virtual string[] GetInfoLines()
  {
    ...
    for (int index = 0; index < fields.Length; ++index)
    {
      ...
      if (customAttributes.Length > 0)
      {
        ...
        if (obj != null)
        {
          string str = !obj.GetType().IsSubclassOf(typeof (Object)) || !((Object) obj != (Object) null) ? obj.ToString() : ((Object) obj).name;
  ...
  public int ActivateOutputLinks(int pinID)
  {
    ...
    {
      if (this.OutputLinks[index].SrcPinID == pinID && !((Object) this.OutputLinks[index].Dest == (Object) null))
      {
  ...
  public void LinkPin(FlowNode.Pin srcPin, FlowNode dest, FlowNode.Pin destPin)
  {
    ...
    for (int index = 0; index < this.OutputLinks.Length; ++index)
    {
      if (flowNode1.OutputLinks[index].SrcPinID == srcPin.PinID && (Object) flowNode1.OutputLinks[index].Dest == (Object) flowNode2 && flowNode1.OutputLinks[index].DestPinID == destPin.PinID)
        return;
    }
  ...
  {
    FlowNode.NodeType[] customAttributes = (FlowNode.NodeType[]) this.GetType().GetCustomAttributes(typeof (FlowNode.NodeType), true);
    if (customAttributes.Length > 0)
