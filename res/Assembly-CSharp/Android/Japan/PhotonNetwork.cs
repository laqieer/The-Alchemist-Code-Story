...
public static class PhotonNetwork
{
  ...
  {
    if ((Object) PhotonNetwork.PhotonServerSettings != (Object) null)
...
label_7:
  ...
  public static int sendRate
  {
    ...
    set
    {
      ...
      if ((Object) PhotonNetwork.photonMono != (Object) null)
  ...
  public static void RemovePlayerCustomProperties(string[] customPropertiesToDelete)
  {
    ...
    else
    {
      for (int index = 0; index < customPropertiesToDelete.Length; ++index)
      {
        ...
        if (PhotonNetwork.player.CustomProperties.ContainsKey((object) str))
          PhotonNetwork.player.CustomProperties.Remove((object) str);
      }
    }
  }
  ...
  public static GameObject Instantiate(string prefabName, Vector3 position, Quaternion rotation, int group, object[] data)
  {
    ...
    if ((Object) gameObject.GetComponent<PhotonView>() == (Object) null)
    {
  ...
  public static bool SetMasterClient(PhotonPlayer masterClientPlayer)
  {
    ...
    if (PhotonNetwork.room.serverSideMasterClient)
    {
      ...
      hashtable1.Add((object) (byte) 248, (object) masterClientPlayer.ID);
      Hashtable gameProperties = hashtable1;
      Hashtable hashtable2 = new Hashtable();
      hashtable2.Add((object) (byte) 248, (object) PhotonNetwork.networkingPeer.mMasterClientId);
