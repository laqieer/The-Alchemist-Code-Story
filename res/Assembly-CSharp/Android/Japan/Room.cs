...
public class Room : RoomInfo
{
  ...
  public new bool IsOpen
  {
    ...
    set
    {
      ...
      if (value != this.openField && !PhotonNetwork.offlineMode)
      {
        ...
        hashtable.Add((object) (byte) 253, (object) value);
  ...
  public new bool IsVisible
  {
    ...
    set
    {
      ...
      if (value != this.visibleField && !PhotonNetwork.offlineMode)
      {
        NetworkingPeer networkingPeer = PhotonNetwork.networkingPeer;
        Hashtable hashtable = new Hashtable();
        hashtable.Add((object) (byte) 254, (object) value);
        Hashtable gameProperties = hashtable;
        __Null local = null;
        int num = 0;
        networkingPeer.OpSetPropertiesOfRoom(gameProperties, (Hashtable) local, num != 0);
  ...
  public int MaxPlayers
  {
    ...
    set
    {
      ...
      if (value != (int) this.maxPlayersField && !PhotonNetwork.offlineMode)
      {
        NetworkingPeer networkingPeer = PhotonNetwork.networkingPeer;
        Hashtable hashtable = new Hashtable();
        hashtable.Add((object) byte.MaxValue, (object) (byte) value);
        Hashtable gameProperties = hashtable;
        __Null local = null;
        int num = 0;
        networkingPeer.OpSetPropertiesOfRoom(gameProperties, (Hashtable) local, num != 0);
  ...
  public void SetCustomProperties(Hashtable propertiesToSet, Hashtable expectedValues = null, bool webForward = false)
  {
    ...
    bool flag = stringKeys2 == null || stringKeys2.Count == 0;
    if (flag)
    {
  ...
  {
    return string.Format("Room: '{0}' {1},{2} {4}/{3} players.\ncustomProps: {5}", (object) this.nameField, !this.visibleField ? (object) "hidden" : (object) "visible", !this.openField ? (object) "closed" : (object) "open", (object) this.maxPlayersField, (object) this.PlayerCount, (object) this.CustomProperties.ToStringFull());
  }
