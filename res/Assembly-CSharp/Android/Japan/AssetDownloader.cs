...
public class AssetDownloader : MonoBehaviour
{
  ...
  public static bool IsEnableShowSizeBeforeDownloading
  {
    get
    {
      return false;
  ...
  public static void Reset()
  {
    ...
    if (!((UnityEngine.Object) AssetDownloader.mInstance != (UnityEngine.Object) null))
      return;
    UnityEngine.Object.Destroy((UnityEngine.Object) AssetDownloader.mInstance.gameObject);
  ...
  private void SetError(SRPG.Network.EErrCode code, string textID)
  {
    SRPG.Network.ErrCode = code;
    SRPG.Network.ErrMsg = LocalizedText.Get(textID);
...
label_17:
  ...
  private bool Internal_isDone
  {
    get
    {
      if (AssetDownloader.mCoroutine == null && AssetDownloader.mRequestIDs.Count == 0)
        return AssetDownloader.mRequestUnmanagedAssets.Count == 0;
      return false;
    }
  }

  public static AssetDownloader.DownloadState StartDownload(bool checkUpdates, bool canRetry = true, ThreadPriority threadPriority = ThreadPriority.Normal, bool dispProgressBar = false, bool autoUpdateProgressText = true)
  {
  ...
  private IEnumerator ConfirmRetryUnmanaged()
  {
    ...
    return (IEnumerator) new AssetDownloader.\u003CConfirmRetryUnmanaged\u003Ec__Iterator0() { \u0024this = this };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CDonwoloadUnmanagedAsset\u003Ec__Iterator1() { RequestAssets = RequestAssets, cacheDir = cacheDir, \u0024this = this };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CParallelDonwloading\u003Ec__Iterator2() { prefix = prefix, requestID = requestID, itemCompressedSize = itemCompressedSize, cacheDir = cacheDir, assetList = assetList, \u0024this = this };
  }
  ...
  [DebuggerHidden]
  private IEnumerator DownloadWWW(string prefix, string name, string writename, bool isError, Action<WWW> onDownloadUpdate = null)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CDownloadWWW\u003Ec__Iterator3() { prefix = prefix, name = name, onDownloadUpdate = onDownloadUpdate, isError = isError, writename = writename, \u0024this = this };
  }

  [DebuggerHidden]
  private IEnumerator InternalDownloadAssets(AssetDownloader.DownloadState state, bool checkUpdates, bool isRetry, ThreadPriority threadPriority, bool dispProgressBar, bool autoUpdateProgressText)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CInternalDownloadAssets\u003Ec__Iterator4() { dispProgressBar = dispProgressBar, checkUpdates = checkUpdates, isRetry = isRetry, threadPriority = threadPriority, autoUpdateProgressText = autoUpdateProgressText, state = state, \u0024this = this };
  }
  ...
  {
    return _size >= 1024UL ? (_size >= 1048576UL ? ((long) (_size / 1024UL / 1024UL)).ToString() + "MB" : ((long) (_size / 1024UL)).ToString() + "KB") : ((long) _size).ToString() + "B";
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CConfirmRetry\u003Ec__Iterator5() { param = param };
  }
  ...
  public static float UnManagedProgress
  {
    get
    {
      return AssetDownloader.mUnManagedDownloadProgress;
    }
  }
  ...
  public static long UnManagedTotalDownloadSize
  {
    get
    {
      if (AssetDownloader.mUnManagedTotalDownloadSize <= 0L)
        return 0;
      return (AssetDownloader.mUnManagedTotalDownloadSize - 1L) / 1048576L + 1L;
    }
  }
  ...
  public static long UnManagedCurrentDownloadSize
  {
    get
    {
      if (AssetDownloader.mUnManagedCurrentDownloadSize <= 0L)
        return 0;
      return (AssetDownloader.mUnManagedCurrentDownloadSize - 1L) / 1048576L + 1L;
    }
  }
  ...
  public static string OldDownloadPath
  {
    get
    {
      return AppPath.assetCachePath + "/" + AssetManager.Format.ToPath() + "cache/";
    }
  }
  ...
  public static string AssetListHashPath
  {
    get
    {
      return AssetDownloader.CachePath + "AssetListHash";
    }
  }
  ...
  public static string UnmanagedListHashPath
  {
    get
    {
      return AssetDownloader.CachePath + "UnmanagedAssetListHash";
    }
  }
    ...
    fixed (byte* numPtr1 = &^(a == null || a.Length == 0 ? (byte&) IntPtr.Zero : ref (*&a[0])))
    {
      ...
      fixed (byte* numPtr2 = &^(b == null || b.Length == 0 ? (byte&) IntPtr.Zero : ref (*&b[0])))
      {
        for (int index = 0; index < length; ++index)
        {
          ...
          // ISSUE: cast to a reference type
          // ISSUE: explicit reference operation
          if ((int) ^(byte&) ((IntPtr) numPtr1 + (IntPtr) index) != (int) ^(byte&) ((IntPtr) numPtr2 + (IntPtr) index))
            return false;
        }
      }
    }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CDestroyAsset\u003Ec__Iterator6() { flags = flags, \u0024this = this };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CStartFileSizeRequest\u003Ec__Iterator7() { completeAllReqeust = completeAllReqeust };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CStartConfirmWindowYesNo\u003Ec__Iterator8() { msg = msg };
  }

  [DebuggerHidden]
  public static IEnumerator StartConfirmDownloadContentYesNo(UIUtility.DialogResultEvent okEventListener = null, UIUtility.DialogResultEvent cancelEventListener = null)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CStartConfirmDownloadContentYesNo\u003Ec__Iterator9() { okEventListener = okEventListener, cancelEventListener = cancelEventListener };
  }

  public static void StartConfirmDownloadQuestContentYesNo(List<UnitData> entryUnits, List<ItemData> itemData, QuestParam questParam, UIUtility.DialogResultEvent okEventListener, UIUtility.DialogResultEvent cancelEventListener)
  {
  ...
  [DebuggerHidden]
  private IEnumerator InternalStartConfirmDownloadQuestContentYesNo(List<UnitData> entryUnits, List<ItemData> itemData, QuestParam questParam, UIUtility.DialogResultEvent okEventListener, UIUtility.DialogResultEvent cancelEventListener)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CInternalStartConfirmDownloadQuestContentYesNo\u003Ec__IteratorA() { entryUnits = entryUnits, itemData = itemData, questParam = questParam, okEventListener = okEventListener, cancelEventListener = cancelEventListener, \u0024this = this };
  }

  [DebuggerHidden]
  public static IEnumerator StartConfirmDownloadContent(UIUtility.DialogResultEvent okEventListener = null, AssetDownloader.OnDownloadPopupTimeout timeoutEventListener = null, float timeoutSec = 0.0f)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CStartConfirmDownloadContent\u003Ec__IteratorB() { okEventListener = okEventListener, timeoutEventListener = timeoutEventListener, timeoutSec = timeoutSec };
  }

  public static void StartConfirmDownloadQuestContent(List<UnitData> entryUnits, List<ItemData> itemData, QuestParam questParam, UIUtility.DialogResultEvent okEventListener, AssetDownloader.OnDownloadPopupTimeout timeoutEventListener = null, float timeoutSec = 0.0f)
  {
  ...
  [DebuggerHidden]
  private IEnumerator InternalStartConfirmDownloadQuestContent(List<UnitData> entryUnits, List<ItemData> itemData, QuestParam questParam, UIUtility.DialogResultEvent okEventListener, AssetDownloader.OnDownloadPopupTimeout timeoutEventListener = null, float timeoutSec = 0.0f)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CInternalStartConfirmDownloadQuestContent\u003Ec__IteratorC() { entryUnits = entryUnits, itemData = itemData, questParam = questParam, timeoutEventListener = timeoutEventListener, timeoutSec = timeoutSec, okEventListener = okEventListener, \u0024this = this };
  }

  [DebuggerHidden]
  public static IEnumerator PrepareQuest(List<UnitData> entryUnits, List<ItemData> itemData, QuestParam questParam)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CPrepareQuest\u003Ec__IteratorD() { itemData = itemData, entryUnits = entryUnits, questParam = questParam };
  }
  ...
  {
    if (AssetDownloader.mRequestIDs.Count <= 0)
      return AssetDownloader.mRequestUnmanagedAssets.Count > 0;
    return true;
  }
  ...
  {
    AssetDownloader.ApproveAssetDownload = true;
  }

  public static void End_ApproveAssetDownload()
  {
    AssetDownloader.ApproveAssetDownload = false;
  }
  ...
  private void OnDownloadUpdate(WWW www)
  {
    AssetDownloader.currentDownloadSize = (long) ((double) AssetDownloader.TotalDownloadSize * (double) www.progress) * 1048576L;
    AssetDownloader.mDownloadProgress = (float) ((double) AssetDownloader.TotalDownloadSize * (double) www.progress % 1.0);
  }
  ...
  private abstract class AssetListHashVersionBase
  {
    ...
    public virtual string Serialize()
    {
      ...
      stringBuilder.AppendLine(SRPG.Network.AssetVersion);
      return stringBuilder.ToString();
    }
  ...
  private abstract class UnManagedAssetListHashVersionBase
  {
    ...
    public virtual string Serialize()
    {
      ...
      stringBuilder.AppendLine(SRPG.Network.AssetVersionEx);
      return stringBuilder.ToString();
    }
  ...
  private class WWWException : Exception
  {
    ...
    {
      this.mStatusCode = int.Parse(www.responseHeaders["STATUS"]);
  ...
  private class FileSizeRequest : IDisposable
  {
    ...
    public FileSizeRequest(string url)
    {
      ...
      this.m_DownloadHandler = AssetDownloader.FileSizeRequest.DownloadHandler.Create(0);
      this.m_Request.downloadHandler = (UnityEngine.Networking.DownloadHandler) this.m_DownloadHandler;
    }
    ...
    public bool HasError
    {
      get
      {
        if (string.IsNullOrEmpty(this.m_Request.error))
          return this.m_Request.responseCode != 200L;
        return true;
      }
    }
    ...
    public string ErrorMessage
    {
      get
      {
        ...
        if (this.m_Request.responseCode != 200L)
          return "Response code : " + (object) this.m_Request.responseCode;
        return string.Empty;
      }
    }
    ...
    public int ContentLength
    {
      get
      {
        return this.m_DownloadHandler.ContentLength;
      }
    }
    ...
    public bool IsSending
    {
      get
      {
        return this.m_State == AssetDownloader.FileSizeRequest.eState.Sending;
      }
    }
  ...
  public class ApproveAssetDownloadScope : IDisposable
  {
    ...
    {
      AssetDownloader.Begin_ApproveAssetDownload();
    }

    public void Dispose()
    {
      AssetDownloader.End_ApproveAssetDownload();
    }
  }
}
