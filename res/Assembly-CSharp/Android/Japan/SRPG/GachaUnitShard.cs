  ...
  public class GachaUnitShard : MonoBehaviour
  {
    ...
    public void Refresh(UnitParam param, string shard_name = "", int awake_lv = 0, int get_shard = 0, int current_index = 0)
    {
      ...
      if (unitDataByUnitId != null)
      {
        ...
        for (int index2 = 0; index2 < index1 && this.mRebirthStars.Count >= index2; ++index2)
        {
          ...
          transform.Find("Rebirthstar_01").gameObject.SetActive(true);
          transform.Find("Rebirthstar_02").gameObject.SetActive(true);
          transform.Find("Rebirthstar_03").gameObject.SetActive(true);
          transform.Find("Rebirthstar_04").gameObject.SetActive(true);
          transform.Find("Rebirthstar_05").gameObject.SetActive(true);
        }
      ...
      {
        int num1 = this.mnext_shard - this.mstart_gauge;
        this.muse_shard = num1 >= this.muse_shard ? this.muse_shard : num1;
      }
      this.mremain_shard -= this.muse_shard;
    ...
    private class State_AddingGaugeSkip : State<GachaUnitShard>
    {
      ...
      private IEnumerator WaitGaugeObject()
      {
        ...
        return (IEnumerator) new GachaUnitShard.State_AddingGaugeSkip.\u003CWaitGaugeObject\u003Ec__Iterator0() { \u0024this = this };
      }
    }
    ...
    private class State_ShowRebirthText : State<GachaUnitShard>
    {
      ...
      public override void Begin(GachaUnitShard self)
      {
        ...
        else
        {
          ...
          this.anim = self.Rebirthtext_root.transform.Find("Rebirth_txtanim").gameObject;
        }
      }
