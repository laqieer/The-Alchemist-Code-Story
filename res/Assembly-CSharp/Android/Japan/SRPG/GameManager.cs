...
namespace SRPG
{
  ...
  public class GameManager : MonoSingleton<GameManager>
  {
    ...
    public List<GenesisChapterParam> GenesisChapterParamList
    {
      get
      {
        return this.mGenesisChapterParam;
      }
    }
    ...
    public List<VersusDraftDeckParam> GetVersusDraftDecks()
    {
      return this.mVersusDraftDecks;
    }
    ...
    public List<VersusDraftDeckParam> GetVersusDraftDecksNow(long schedule_id)
    {
      ...
      if (this.mVersusDraftDecks == null || this.mVersusDraftDecks.Count == 0)
        return (List<VersusDraftDeckParam>) null;
      return this.mVersusDraftDecks.FindAll((Predicate<VersusDraftDeckParam>) (deck => deck.Id == vet.DraftId || vet.FriendDraftIdList != null && vet.FriendDraftIdList.Count != 0 && vet.FriendDraftIdList.Contains(deck.Id)));
    }
    ...
    public ReqRaidBtlEnd.Response RaidBtlEndParam
    {
      set
      {
        this.mRaidBtlEndParam = value;
      }
      get
      {
        return this.mRaidBtlEndParam;
      }
    }
    ...
    protected override void Release()
    {
      ...
      if ((UnityEngine.Object) MonoSingleton<MySound>.GetInstanceDirect() != (UnityEngine.Object) null)
        MonoSingleton<MySound>.Instance.StopBGM();
      if ((UnityEngine.Object) this.mNotifyList != (UnityEngine.Object) null)
      {
    ...
    {
      if ((UnityEngine.Object) notifyListTemplate == (UnityEngine.Object) null || !((UnityEngine.Object) this.mNotifyList == (UnityEngine.Object) null))
        return;
...
label_12:
    ...
    public bool ReloadMasterData(string masterParam = null, string questParam = null)
    {
      ...
      try
      {
        ...
        JSON_MasterParam json1 = JsonUtility.FromJson<JSON_MasterParam>(masterParam);
        if (json1 == null)
          throw new InvalidJSONException();
        this.Deserialize2(json1);
        if (questParam == null)
          questParam = AssetManager.LoadTextData("Data/QuestParam");
        Json_QuestList json2 = JsonUtility.FromJson<Json_QuestList>(questParam);
        if (json2 == null)
          throw new InvalidJSONException();
    ...
    public void ResetJigenQuests(bool is_genesis = false)
    {
      for (int index = 0; index < this.mQuests.Count; ++index)
      {
        if (!is_genesis || this.mQuests[index].IsGenesis)
        {
    ...
    public bool Deserialize(JSON_OpenedQuestArchivesListResponse listResponse)
    {
      if (listResponse == null)
        return false;
      this.Player.IsTodaysNextArchiveOpenFree = listResponse.isFree == 1;
    ...
    public bool Deserialize(JSON_QuestArchiveOpenResponse response)
    {
      ...
      if (this.Player.IsTodaysNextArchiveOpenFree)
        this.Player.IsTodaysNextArchiveOpenFree = false;
      return true;
    }
    ...
    public void Deserialize(Json_GachaResult json)
    {
      ...
      this.mPlayer.OverwiteTrophyProgress(json.trophyprogs);
      this.mPlayer.OverwiteTrophyProgress(json.bingoprogs);
    }
    ...
    private IEnumerator UpdateUnitsBadges()
    {
      ...
      return (IEnumerator) new GameManager.\u003CUpdateUnitsBadges\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CUpdateUnitUnlockBadges\u003Ec__Iterator1() { \u0024this = this };
    }
    ...
    private void UpdateResolution()
    {
      ...
      int num1 = ScreenUtility.DefaultScreenHeight;
      if (flag)
      {
        float num2 = (float) defaultScreenWidth / (float) num1;
        int num3 = Mathf.Min(num1, 750);
        defaultScreenWidth = Mathf.FloorToInt(num2 * (float) num3);
        num1 = num3;
      }
      ScreenUtility.SetResolution(defaultScreenWidth, num1);
      DebugUtility.Log(string.Format("Changing Resolution to [{0} x {1}]", (object) defaultScreenWidth, (object) num1));
    }
    ...
    private void Update()
    {
      ...
      AnimationPlayer.MaxUpdateTime = !this.EnableAnimationFrameSkipping ? long.MaxValue : (long) ((double) Mathf.Lerp(1f / 1000f, 3f / 500f, 1f - Mathf.Clamp01((float) (((double) Time.unscaledDeltaTime - 0.0260000005364418) / 0.00399999879300594))) * 10000000.0);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CStartBuyStaminaSequence2\u003Ec__Iterator2() { _pwindow = _pwindow };
    }
    ...
    public void StartBuyCoinSequence()
    {
      ...
      if (!((UnityEngine.Object) dialogBuyCoin != (UnityEngine.Object) null))
        return;
    ...
    public bool IsBuyCoinWindowOpen
    {
      get
      {
        if ((UnityEngine.Object) this.mBuyCoinWindow != (UnityEngine.Object) null)
          return true;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CAsyncWaitForImportantJobs\u003Ec__Iterator3() { \u0024this = this };
    }
    ...
    {
      foreach (Delegate invocation in this.OnSceneChange.GetInvocationList())
      {
    ...
    public void ApplyTextureAsync(RawImage target, string path)
    {
      ...
      {
        if ((UnityEngine.Object) this.mTextureRequests[index].Target == (UnityEngine.Object) target)
        {
    ...
    private void UpdateTextureLoadRequests()
    {
      for (int index = 0; index < this.mTextureRequests.Count; ++index)
      {
        if ((UnityEngine.Object) this.mTextureRequests[index].Target == (UnityEngine.Object) null)
          this.mTextureRequests.RemoveAt(index--);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CDownloadAndTransitSceneAsync\u003Ec__Iterator4() { sceneName = sceneName };
    }
    ...
    {
      this.AgreedVer = Application.version;
    }
    ...
    public bool HasTutorialDLAssets
    {
      get
      {
        if (!this.mScannedTutorialAssets)
          this.RefreshTutorialDLAssets(false);
    ...
    public bool PartialDownloadTutorialAssets()
    {
      ...
      if (num <= 0)
        return false;
      AssetDownloader.DownloadState state = AssetDownloader.StartDownload(false, false, ThreadPriority.Lowest, false, true);
      if (state == null)
        return false;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CWaitDownloadAsync\u003Ec__Iterator5() { state = state, queue = queue, \u0024this = this };
    }
    ...
    {
      if (Network.Mode != Network.EConnectMode.Online || !this.update_trophy_interval.PlayCheckUpdate() || (this.update_trophy_lock.IsLock || !this.IsExternalPermit()) || (CriticalSection.IsActive || !NotifyList.hasInstance))
        return;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CShowCharacterQuestPopupAsync\u003Ec__Iterator6() { template = template, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CSkinUnlockPopup\u003Ec__Iterator7() { unlockSkin = unlockSkin };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CSkinUnlockPopup\u003Ec__Iterator8() { rewardItems = rewardItems };
    }
    ...
    public List<int> GetMTSkipFloorList()
    {
      ...
      for (int index = 0; index < mtAllFloorParam.Count; ++index)
      {
        ...
        if (multiTowerFloorParam.is_skip && (int) multiTowerFloorParam.floor > mtClearedMaxFloor && (int) multiTowerFloorParam.floor <= this.MaxClearFloor)
          intList.Add((int) multiTowerFloorParam.floor);
      }
      return intList;
    }

    public bool IsMTCanSkip()
    {
      return this.GetMTSkipFloorList().Count != 0;
    }
    ...
    public GenesisChapterParam GetGenesisChapterParamFromAreaId(string area_id)
    {
      ...
      GenesisChapterParam genesisChapterParam = this.mGenesisChapterParam.Find((Predicate<GenesisChapterParam>) (d => d.AreaId == area_id));
      if (genesisChapterParam == null)
    ...
    public int GetStoryPartNum()
    {
      ...
      {
        if (num < mWorld.storyPart)
          num = mWorld.storyPart;
      }
      return num;
    }
    ...
    public string GetReleaseStoryPartMessageSysID(int story_part)
    {
      return this.mWorlds.Find((Predicate<SectionParam>) (p => p.storyPart == story_part))?.message_sys_id;
    }

    public List<SectionParam> GetAllStorySelctionParams(bool isAvailableOnly = false)
    {
      List<QuestParam> questParamList = !isAvailableOnly ? this.mQuests.Where<QuestParam>((Func<QuestParam, bool>) (quest =>
      {
        if (!quest.hidden && quest.IsStory)
          return !string.IsNullOrEmpty(quest.world);
        return false;
      })).ToList<QuestParam>() : ((IEnumerable<QuestParam>) this.mPlayer.AvailableQuests).Where<QuestParam>((Func<QuestParam, bool>) (quest =>
      {
        if (!quest.hidden && quest.IsStory)
          return !string.IsNullOrEmpty(quest.world);
        return false;
    ...
    public List<QuestParam> GetAllQuestParamsInChallengeableStorySelctions()
    {
      ...
      {
        if (quest.type == QuestTypes.Story && quest.type == QuestTypes.Free && dictionary.ContainsKey(quest.world))
    ...
    public List<UnitData> GetBattleEntryUnits(QuestParam questParam)
    {
      ...
      if (PunMonoSingleton<MyPhoton>.Instance.IsMultiPlay)
        unitDataList = this.GetMultiPlayUnits(questParam);
      else if (MonoSingleton<GameManager>.Instance.AudienceMode)
        unitDataList = this.GetAudienceModeUnits(questParam);
      else if (MonoSingleton<GameManager>.Instance.IsVSCpuBattle)
        unitDataList = this.GetCPUBattleUnits(questParam);
      return unitDataList;
    }
    ...
    private List<UnitData> GetCPUBattleUnits(QuestParam questParam)
    {
      ...
      if (PunMonoSingleton<MyPhoton>.Instance.IsMultiPlay || this.AudienceMode || !this.IsVSCpuBattle)
        return unitDataList;
      PartyData partyOfType = this.Player.FindPartyOfType(FlowNode_StartQuest.QuestToPartyIndex(questParam.type));
