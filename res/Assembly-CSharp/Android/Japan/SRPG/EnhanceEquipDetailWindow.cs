  ...
  public class EnhanceEquipDetailWindow : SRPG_FixedList, IFlowInterface
  {
    ...
    protected override void Start()
    {
      ...
      if ((UnityEngine.Object) this.BtnAdd != (UnityEngine.Object) null)
      {
        ...
        this.mTouchControllerAdd = this.BtnAdd.gameObject.AddComponent<EnhanceEquipDetailWindow.EnhanceEquipTouchController>();
        this.mTouchControllerAdd.OnPointerDownFunc = new EnhanceEquipDetailWindow.EnhanceEquipTouchController.DelegateOnPointerDown(this.OnLevelAddDown);
        this.mTouchControllerAdd.OnPointerUpFunc = new EnhanceEquipDetailWindow.EnhanceEquipTouchController.DelegateOnPointerUp(this.OnLevelAddUp);
      ...
      if ((UnityEngine.Object) this.BtnSub != (UnityEngine.Object) null)
      {
        ...
        this.mTouchControllerSub = this.BtnSub.gameObject.AddComponent<EnhanceEquipDetailWindow.EnhanceEquipTouchController>();
        this.mTouchControllerSub.OnPointerDownFunc = new EnhanceEquipDetailWindow.EnhanceEquipTouchController.DelegateOnPointerDown(this.OnLevelSubDown);
        this.mTouchControllerSub.OnPointerUpFunc = new EnhanceEquipDetailWindow.EnhanceEquipTouchController.DelegateOnPointerUp(this.OnLevelSubUp);
    ...
    {
      base.Update();
      if ((UnityEngine.Object) this.mTouchControllerAdd != (UnityEngine.Object) null)
        this.mTouchControllerAdd.UpdateTimer(Time.unscaledDeltaTime);
      if (!((UnityEngine.Object) this.mTouchControllerSub != (UnityEngine.Object) null))
        return;
    ...
    private void RefreshData()
    {
      ...
      DataSource.Bind<UnitData>(this.Unit, this.mUnit, false);
      for (int index = 0; index < this.Equipments.Count; ++index)
      {
        EquipData equip = jobData.Equips[index];
        DataSource.Bind<EquipData>(this.Equipments[index].gameObject, equip, false);
      ...
      {
        DataSource.Bind<EnhanceEquipData>(this.EquipSelectParent, (EnhanceEquipData) null, false);
      ...
      if ((UnityEngine.Object) this.mSelectedEquipItem != (UnityEngine.Object) null)
      {
        ...
        if (equipData != null)
        {
          ...
          if (buffEffect != null && buffEffect.targets != null)
          {
            for (int index = 0; index < buffEffect.targets.Count; ++index)
            {
              ...
              DataSource.Bind<EquipItemParameter>(enhanceParameter, data, false);
        ...
        if ((UnityEngine.Object) this.EquipSelectParent != (UnityEngine.Object) null)
        {
          DataSource.Bind<EnhanceEquipData>(this.EquipSelectParent, this.mEnhanceEquipData, false);
      ...
      {
        DataSource.Bind<EnhanceEquipData>(this.SelectedParent, this.mEnhanceEquipData, false);
    ...
    private void OnLevelAddDown(EnhanceEquipDetailWindow.EnhanceEquipTouchController controller)
    {
    }

    private void OnLevelAddUp(EnhanceEquipDetailWindow.EnhanceEquipTouchController controller)
    {
    }
      ...
      if (dataOfClass != null)
      {
        if (!this.CheckEquipItemEnhance())
        {
          if (this.endAddDialog)
            return;
          UIUtility.NegativeSystemMessage(LocalizedText.Get("sys.FAILED_ENHANCE"), LocalizedText.Get("sys.DIABLE_ENHANCE_RANKCAP_MESSAGE"), (UIUtility.DialogResultEvent) (go => this.endAddDialog = false), (GameObject) null, false, -1);
          this.endAddDialog = true;
          return;
        }
        dataOfClass.num = Math.Min(++dataOfClass.num, dataOfClass.item.Num);
        DataSource.Bind<EnhanceMaterial>(this.mSelectedMaterialItem, dataOfClass, false);
      }
      MonoSingleton<MySound>.Instance.PlaySEOneShot(SoundSettings.Current.Tap, 0.0f);
      this.RefreshData();
    }

    private void OnLevelSubDown(EnhanceEquipDetailWindow.EnhanceEquipTouchController controller)
    {
    }

    private void OnLevelSubUp(EnhanceEquipDetailWindow.EnhanceEquipTouchController controller)
    {
    }
    ...
    public class EnhanceEquipTouchController : MonoBehaviour, IPointerDownHandler, IEventSystemHandler
    {
      ...
      public void UpdateTimer(float deltaTime)
      {
        ...
        else
        {
          ...
          if ((double) this.HoldDuration < (double) this.UseLevelSpan && this.UseNum < 1 && (double) (this.mDragStartPos - (Vector2) Input.mousePosition).sqrMagnitude > (double) (instance.HoldMargin * instance.HoldMargin))
          {
            this.StatusReset();
          }
          else
      ...
      public delegate void DelegateOnPointerDown(EnhanceEquipDetailWindow.EnhanceEquipTouchController controller);

      public delegate void DelegateOnPointerUp(EnhanceEquipDetailWindow.EnhanceEquipTouchController controller);
