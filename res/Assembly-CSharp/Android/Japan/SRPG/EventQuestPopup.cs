...
namespace SRPG
{
  ...
  public class EventQuestPopup : MonoBehaviour, IFlowInterface
  {
    ...
    {
      if ((UnityEngine.Object) this.ItemTemplate == (UnityEngine.Object) null || (UnityEngine.Object) this.ItemLayout == (UnityEngine.Object) null)
        return;
      for (int index = 0; index < this.Chapter.keys.Count; ++index)
      {
        ...
        if (key != null && !string.IsNullOrEmpty(key.iname) && key.num != 0)
        {
          ...
          DataSource.Bind<ChapterParam>(gameObject, this.Chapter, false);
          DataSource.Bind<ItemParam>(gameObject, itemParam, false);
          DataSource.Bind<ItemData>(gameObject, itemDataByItemParam, false);
          DataSource.Bind<KeyItem>(gameObject, key, false);
