...
namespace SRPG
{
  public class Unit : BaseObject
  {
    ...
    public static EUnitDirection[] LeftDirection = new EUnitDirection[5]{ EUnitDirection.PositiveY, EUnitDirection.NegativeX, EUnitDirection.NegativeY, EUnitDirection.PositiveX, EUnitDirection.PositiveY };
    public static EUnitDirection[] RightDirection = new EUnitDirection[5]{ EUnitDirection.NegativeY, EUnitDirection.PositiveX, EUnitDirection.PositiveY, EUnitDirection.NegativeX, EUnitDirection.NegativeY };
    public static EUnitDirection[] ForwardDirection = new EUnitDirection[5]{ EUnitDirection.PositiveX, EUnitDirection.PositiveY, EUnitDirection.NegativeX, EUnitDirection.NegativeY, EUnitDirection.PositiveX };
    ...
    private OInt mOverKillDamage = (OInt) 0;
    ...
    public int SizeX
    {
      get
      {
        if (this.UnitData != null)
          return (int) this.UnitData.UnitParam.sw;
        return 1;
      }
    }
    ...
    public int SizeY
    {
      ...
      {
        if (this.UnitData != null)
          return (int) this.UnitData.UnitParam.sh;
        return 1;
      }
    }
    ...
    public int SizeZ
    {
      ...
      {
        if (this.UnitData != null)
          return (int) this.UnitData.UnitParam.sd;
        return 1;
      }
    }
    ...
    public int MaxColX
    {
      get
      {
        return this.SizeX + this.MinColX;
      }
    }
    ...
    public int MaxColY
    {
      get
      {
        return this.SizeY + this.MinColY;
      }
    }
    ...
    public int InfinitySpawnTag
    {
      get
      {
        return this.mInfinitySpawnTag;
      }
      set
      {
        this.mInfinitySpawnTag = value;
      }
    }
    ...
    public int InfinitySpawnDeck
    {
      get
      {
        return this.mInfinitySpawnDeck;
      }
      set
      {
        this.mInfinitySpawnDeck = value;
      }
    }
    ...
    public DynamicTransformUnitParam DtuParam
    {
      get
      {
        return this.mDtuParam;
      }
      set
      {
        this.mDtuParam = value;
      }
    }
    ...
    public Unit DtuFromUnit
    {
      get
      {
        return this.mDtuFromUnit;
      }
      set
      {
        this.mDtuFromUnit = value;
      }
    }
    ...
    public int DtuRemainTurn
    {
      get
      {
        return this.mDtuRemainTurn;
      }
      set
      {
        this.mDtuRemainTurn = value;
      }
    }

    public OInt OverKillDamage
    {
      get
      {
        return this.mOverKillDamage;
      }
    }
    ...
    private void SetupRaidBuffStatus(NPCSetting npc)
    {
      ...
      if ((int) GlobalVars.CurrentRaidRound > 1)
      {
        ...
        {
          BuffEffect buffEffect = BuffEffect.CreateBuffEffect(buffEffectParam, (int) GlobalVars.CurrentRaidRound, raidPeriod.RoundBuffMax);
          buffEffect.CalcBuffStatus(ref status1, this.Element, BuffTypes.Buff, false, false, SkillParamCalcTypes.Add, 0);
          buffEffect.CalcBuffStatus(ref status2, this.Element, BuffTypes.Buff, false, false, SkillParamCalcTypes.Scale, 0);
          buffEffect.CalcBuffStatus(ref status3, this.Element, BuffTypes.Debuff, false, false, SkillParamCalcTypes.Add, 0);
          buffEffect.CalcBuffStatus(ref status4, this.Element, BuffTypes.Debuff, false, false, SkillParamCalcTypes.Scale, 0);
    ...
    public bool Setup(UnitData unitdata = null, UnitSetting setting = null, Unit.DropItem dropitem = null, Unit.DropItem stealitem = null)
    {
      ...
      if (setting is NPCSetting)
      {
        ...
        if (npc.abilities != null)
        {
          ...
          if ((UnityEngine.Object) SceneBattle.Instance != (UnityEngine.Object) null && SceneBattle.Instance.CurrentQuest != null)
          {
            QuestParam currentQuest = SceneBattle.Instance.CurrentQuest;
            if (currentQuest.IsRaid)
              this.SetupRaidBuffStatus(npc);
            else if (currentQuest.IsGenesisBoss && (bool) npc.is_raid_boss)
              this.mIsRaidBoss = true;
          }
    ...
    public bool SetupDynamicTransform(Unit org_unit, DynamicTransformUnitParam dtu_param, bool is_no_art_cc = false)
    {
      ...
      if (!unitData.Setup(trUnitId, exp, rarity, awakeLv, job_iname, rank, element, 0))
        return false;
      ...
      if (!is_no_art_cc)
      {
        ...
        this.mUnitData.ConceptCard = org_unit.UnitData.ConceptCard;
      }
      ...
      {
        int ab_rank = 1;
        AbilityData abilityData = org_unit.BattleAbilitys.Find((Predicate<AbilityData>) (ba =>
        {
          if (ba.SlotType == EAbilitySlot.Action)
            return ba.Param.is_fixed;
          return false;
        }));
        if (abilityData != null)
    ...
    private void SetupDynamicTransformEntryAbilityAndSkill(string ab_id, int ab_rank)
    {
      ...
      abilityData.UpdateLearningsSkill(true, (List<SkillData>) null);
    ...
    public bool SetupResume(MultiPlayResumeUnitData data, Unit target, Unit rage, Unit casttarget, List<MultiPlayResumeSkillData> buffskill, List<MultiPlayResumeSkillData> condskill)
    {
      ...
      this.mDtuFromUnit = BattleSuspend.GetUnitFromAllUnits(bc, data.dfu);
      this.mDtuRemainTurn = data.drt;
      this.mOverKillDamage = (OInt) data.okd;
          ...
          if (buffskill[index1].skill != null)
          {
            ...
            if (buffEffect != null)
            {
              ...
              if (data.buff[index1].type == 0)
              {
                switch ((SkillParamCalcTypes) data.buff[index1].calc)
                {
                  case SkillParamCalcTypes.Add:
                    buffAttachment1 = data.buff[index1].vtp != 0 ? bc.CreateBuffAttachment(buffskill[index1].user, this, skill, skilltarget, buffEffect.param, BuffTypes.Buff, true, SkillParamCalcTypes.Add, baseStatus3, cond, turn, chkTarget, chkTiming, data.buff[index1].passive, duplicateCount) : bc.CreateBuffAttachment(buffskill[index1].user, this, skill, skilltarget, buffEffect.param, BuffTypes.Buff, false, SkillParamCalcTypes.Add, baseStatus1, cond, turn, chkTarget, chkTiming, data.buff[index1].passive, duplicateCount);
                    break;
                  case SkillParamCalcTypes.Scale:
                    buffAttachment1 = bc.CreateBuffAttachment(buffskill[index1].user, this, skill, skilltarget, buffEffect.param, BuffTypes.Buff, data.buff[index1].vtp != 0, SkillParamCalcTypes.Scale, baseStatus5, cond, turn, chkTarget, chkTiming, data.buff[index1].passive, duplicateCount);
                    break;
                }
              }
              else
              {
                ...
                {
                  case SkillParamCalcTypes.Add:
                    buffAttachment1 = data.buff[index1].vtp != 0 ? bc.CreateBuffAttachment(buffskill[index1].user, this, skill, skilltarget, buffEffect.param, BuffTypes.Debuff, true, SkillParamCalcTypes.Add, baseStatus4, cond, turn, chkTarget, chkTiming, data.buff[index1].passive, duplicateCount) : bc.CreateBuffAttachment(buffskill[index1].user, this, skill, skilltarget, buffEffect.param, BuffTypes.Debuff, false, SkillParamCalcTypes.Add, baseStatus2, cond, turn, chkTarget, chkTiming, data.buff[index1].passive, duplicateCount);
                    break;
                  case SkillParamCalcTypes.Scale:
                    buffAttachment1 = bc.CreateBuffAttachment(buffskill[index1].user, this, skill, skilltarget, buffEffect.param, BuffTypes.Debuff, data.buff[index1].vtp != 0, SkillParamCalcTypes.Scale, baseStatus6, cond, turn, chkTarget, chkTiming, data.buff[index1].passive, duplicateCount);
                    break;
                }
              }
      ...
      if (data.cond != null && bc != null)
      {
        for (int index1 = 0; index1 < data.cond.Length; ++index1)
        {
          ...
          CondAttachment condAttachment1 = bc.CreateCondAttachment(condskill[index1].user, this, condskill[index1].skill, skilltarget, condEffectParam, (ConditionEffectTypes) data.cond[index1].type, (ESkillCondition) data.cond[index1].condition, (EUnitCondition) data.cond[index1].calc, EffectCheckTargets.Target, (EffectCheckTimings) data.cond[index1].timing, data.cond[index1].turn, data.cond[index1].passive, data.cond[index1].curse != 0);
    ...
    public bool SetupSuspend(BattleCore bc, BattleSuspend.Data.UnitInfo unit_info)
    {
      ...
      this.mOverKillDamage = (OInt) unit_info.okd;
      ...
      foreach (BattleSuspend.Data.UnitInfo.Buff buff1 in unit_info.bfl)
      {
        ...
        if (unitFromAllUnits2 != null)
        {
          ...
          else
          {
            ...
            {
              if (buff1.ipa && skill != null && (skill.IsSubActuate() || this.ContainsSkillAttachment(skill)))
              {
                if ((bool) buffEffect.param.mIsUpBuff)
                {
                  foreach (BuffAttachment buffAttachment in this.BuffAttachments)
                  {
                    if (buffAttachment.skill != null && buffAttachment.skill.SkillID == skill.SkillID && (buffAttachment.Param != null && buffAttachment.Param.iname == buffEffect.param.iname) && buffAttachment.skilltarget == (SkillEffectTargets) buff1.stg)
                    {
                      ...
                      this.UpdateUpBuffEffect(buffAttachment, EffectCheckTimings.ActionStart, false);
                    }
                  }
                }
              }
              else
              {
                ...
                if (buff1.btp == 0)
                {
                  ...
                  {
                    case SkillParamCalcTypes.Add:
                      buff2 = bc.CreateBuffAttachment(unitFromAllUnits1, this, skill, stg, buffEffect.param, BuffTypes.Buff, buff1.vtp != 0, SkillParamCalcTypes.Add, baseStatus1, cond, tur, chkTarget, chkTiming, buff1.ipa, duplicateCount);
                      break;
                    case SkillParamCalcTypes.Scale:
                      buff2 = bc.CreateBuffAttachment(unitFromAllUnits1, this, skill, stg, buffEffect.param, BuffTypes.Buff, buff1.vtp != 0, SkillParamCalcTypes.Scale, baseStatus3, cond, tur, chkTarget, chkTiming, buff1.ipa, duplicateCount);
                      break;
                  }
                }
                else
                {
                  ...
                  {
                    case SkillParamCalcTypes.Add:
                      buff2 = bc.CreateBuffAttachment(unitFromAllUnits1, this, skill, stg, buffEffect.param, BuffTypes.Debuff, buff1.vtp != 0, SkillParamCalcTypes.Add, baseStatus2, cond, tur, chkTarget, chkTiming, buff1.ipa, duplicateCount);
                      break;
                    case SkillParamCalcTypes.Scale:
                      buff2 = bc.CreateBuffAttachment(unitFromAllUnits1, this, skill, stg, buffEffect.param, BuffTypes.Debuff, buff1.vtp != 0, SkillParamCalcTypes.Scale, baseStatus4, cond, tur, chkTarget, chkTiming, buff1.ipa, duplicateCount);
                      break;
                  }
                }
                if (buff2 != null)
                {
                  ...
                  if (buff2.Param != null && (bool) buff2.Param.mIsUpBuff)
                    this.UpdateUpBuffEffect(buff2, EffectCheckTimings.ActionStart, false);
      ...
      {
        Unit unitFromAllUnits1 = BattleSuspend.GetUnitFromAllUnits(bc, cond.uni);
        Unit unitFromAllUnits2 = BattleSuspend.GetUnitFromAllUnits(bc, cond.cui);
        SkillData skill = unitFromAllUnits1 == null ? (SkillData) null : unitFromAllUnits1.GetSkillData(cond.sid);
        if (skill == null && unitFromAllUnits1 != null && unitFromAllUnits1.IsUnitFlag(EUnitFlag.IsDynamicTransform))
        {
          Unit unit = unitFromAllUnits1;
          while (unit.IsUnitFlag(EUnitFlag.IsDynamicTransform))
        ...
        if (skill == null)
          skill = unitFromAllUnits1 == null ? (SkillData) null : unitFromAllUnits1.SearchArtifactSkill(cond.sid);
        if (skill == null)
        ...
        if (unitFromAllUnits2 != null)
        {
          ...
          else if (cond.ipa && (skill.IsSubActuate() || this.ContainsSkillAttachment(skill)))
            continue;
          ...
          CondAttachment condAttachment = bc.CreateCondAttachment(unitFromAllUnits1, this, skill, stg, condEffectParam, (ConditionEffectTypes) cond.cdt, (ESkillCondition) cond.ucd, (EUnitCondition) cond.cnd, EffectCheckTargets.Target, (EffectCheckTimings) cond.tim, cond.tur, cond.ipa, cond.icu);
    ...
    public bool CheckEnableUseSkill(SkillData skill, bool bCheckCondOnly = false)
    {
      ...
      if (this.IsUnitFlag(EUnitFlag.IsDynamicTransform) && this.mDtuParam != null)
      {
        ...
        if (this.mDtuParam.IsNoVisionAbility && this.UnitData.ConceptCard != null)
        {
          List<ConceptCardEquipEffect> enableEquipEffects = this.UnitData.ConceptCard.GetEnableEquipEffects(this.UnitData, this.UnitData.CurrentJob, true);
          for (int index = 0; index < enableEquipEffects.Count; ++index)
          {
            AbilityData ability = enableEquipEffects[index].Ability;
    ...
    private void ReflectMhmDamage()
    {
      foreach (Unit.UnitMhmDamage mMhmDamageList in this.mMhmDamageLists)
        this.ReflectMhmDamage(mMhmDamageList.mType, (int) mMhmDamageList.mDamage, false);
    }
      ...
      switch (type)
      {
        case Unit.eTypeMhmDamage.HP:
          if (is_allow_to_dead && damage > (int) this.MaximumStatus.param.hp)
            this.mOverKillDamage = (OInt) (damage - (int) this.MaximumStatus.param.hp);
    ...
    public bool UpdateBuffEffects()
    {
      ...
      for (int index = 0; index < this.BuffAttachments.Count; ++index)
      {
        ...
        if ((bool) buffAttachment.IsPassive)
        {
          ...
          this.BuffAttachments.RemoveAt(index--);
        else if (buffAttachment.CheckTarget != null && buffAttachment.CheckTarget.IsDeadCondition() && buffAttachment.CheckTiming != EffectCheckTimings.PrevApply)
          this.BuffAttachments.RemoveAt(index--);
    ...
    public void RefleshMomentBuff(List<Unit> others, bool is_direct = false, int grid_x = -1, int grid_y = -1)
    {
      ...
      foreach (Unit other in others)
      {
        ...
        other.UpdateBuffEffectTurnCount(EffectCheckTimings.Moment, this);
        if (false | other.UpdateBuffEffects() | other.setRelatedBuff(grid_x1, grid_y1, is_direct) | TrickData.MomentBuff(other, grid_x1, grid_y1, EffectCheckTimings.Moment))
          other.CalcCurrentStatus(false, false);
      }
    }
    ...
    public void RefleshMomentBuff(bool is_direct = false, int grid_x = -1, int grid_y = -1)
    {
      ...
      if (!(false | this.UpdateBuffEffects() | this.setRelatedBuff(grid_x1, grid_y1, is_direct) | TrickData.MomentBuff(this, grid_x1, grid_y1, EffectCheckTimings.Moment)))
        return;
      this.CalcCurrentStatus(false, false);
    }
    ...
    public void Damage(int value, bool is_check_dying = false)
    {
      ...
      if (value > (int) this.CurrentStatus.param.hp)
        this.mOverKillDamage = (OInt) (value - (int) this.CurrentStatus.param.hp);
    ...
    public int GetSkillUsedCost(SkillData skill)
    {
      ...
      if (skill.EffectType != SkillEffectTypes.GemsGift && !skill.IsNormalAttack() && !skill.IsItem())
      {
        ...
        num1 = Math.Max(num2 + num2 * (int) this.CurrentStatus[BattleBonus.UsedJewelRate] / 100, 0);
      }
      return num1;
    }
    ...
    private bool setRelatedBuff(int grid_x, int grid_y, bool is_direct = false)
    {
      ...
      for (int index = 0; index < 4; ++index)
      {
        ...
        if (grid != null)
        {
          ...
          if (unit != null && unit != this)
          {
            ...
            {
              if (buffAttachment.CheckTiming != EffectCheckTimings.Moment && buffAttachment.Param != null && (buffAttachment.Param.mEffRange == EEffRange.SelfNearAlly && unit.mSide == this.mSide))
              {
                unitList.Add(unit);
                break;
              }
      ...
      foreach (Unit unit in unitList)
      {
        ...
        {
          if (buffAttachment1.CheckTiming != EffectCheckTimings.Moment && buffAttachment1.Param != null && (buffAttachment1.Param.mEffRange == EEffRange.SelfNearAlly && unit.mSide == this.mSide))
          {
            ...
            if (!flag2)
            {
              this.SetBuffAttachment(buffAttachment2, false);
              flag1 = true;
            }
          }
        }
    ...
    public bool IsChanging
    {
      get
      {
        return this.mUnitData.IsChanging;
      }
    }
    ...
    public void DtuCopyTo(Unit from_unit)
    {
      if (from_unit == null)
        return;
    ...
    public Unit.UnitInsp CreateInsp(long aiid, int slot_no = 0, bool valid = false, int check_ctr = 1)
    {
      ...
      if (artifactByUniqueId == null)
        return (Unit.UnitInsp) null;
      return new Unit.UnitInsp(artifactByUniqueId, slot_no, valid, check_ctr);
    }
    ...
    public bool EntryInspUse(long aiid)
    {
      if (!this.IsPartyMember || this.IsUnitFlag(EUnitFlag.IsHelp) || this.mInspUseList.Find((Predicate<Unit.UnitInsp>) (d => (long) d.mArtifact.UniqueID == aiid)) != null)
        return false;
      Unit.UnitInsp insp = this.CreateInsp(aiid, 0, false, 1);
      if (insp == null)
        return false;
    ...
    public void CalcCurrentStatus(bool is_initialized = false, bool is_predict = false)
    {
      ...
      if (this.IsUnitCondition(EUnitCondition.Berserk))
      {
        ...
        (passiveWorkScaleStatus1 = Unit.PassiveWorkScaleStatus)[StatusTypes.Atk] = (OInt) ((int) passiveWorkScaleStatus1[StatusTypes.Atk] + num1);
        BaseStatus passiveWorkScaleStatus2;
        (passiveWorkScaleStatus2 = Unit.PassiveWorkScaleStatus)[StatusTypes.Mag] = (OInt) ((int) passiveWorkScaleStatus2[StatusTypes.Mag] + num1);
        BaseStatus passiveWorkScaleStatus3;
        (passiveWorkScaleStatus3 = Unit.PassiveWorkScaleStatus)[StatusTypes.Def] = (OInt) ((int) passiveWorkScaleStatus3[StatusTypes.Def] + num2);
        BaseStatus passiveWorkScaleStatus4;
        (passiveWorkScaleStatus4 = Unit.PassiveWorkScaleStatus)[StatusTypes.Mnd] = (OInt) ((int) passiveWorkScaleStatus4[StatusTypes.Mnd] + num2);
      }
