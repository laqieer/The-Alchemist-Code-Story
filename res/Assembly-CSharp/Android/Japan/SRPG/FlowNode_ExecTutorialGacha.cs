...
namespace SRPG
{
  ...
  public class FlowNode_ExecTutorialGacha : FlowNode_Network
  {
    ...
    public override void OnActivate(int pinID)
    {
      switch (pinID)
      {
        case 0:
          ...
          break;
        case 1:
          if (this.enabled || string.IsNullOrEmpty(this.TutorialGachaID))
            break;
    ...
    private IEnumerator AsyncDownload(UnitParam _uparam)
    {
      ...
      return (IEnumerator) new FlowNode_ExecTutorialGacha.\u003CAsyncDownload\u003Ec__Iterator0() { _uparam = _uparam, \u0024this = this };
    }
