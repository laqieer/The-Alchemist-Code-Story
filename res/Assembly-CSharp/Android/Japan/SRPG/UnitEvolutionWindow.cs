...
namespace SRPG
{
  ...
  public class UnitEvolutionWindow : MonoBehaviour, IFlowInterface
  {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              DataSource.Bind<ItemParam>(this.SubPanel, itemParam, false);
    ...
    private IEnumerator RefreshScrollRect()
    {
      ...
      return (IEnumerator) new UnitEvolutionWindow.\u003CRefreshScrollRect\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    public void Refresh2()
    {
      ...
      else
      {
        ...
        else
        {
          ...
          DataSource.Bind<RecipeParam>(this.gameObject, currentRecipe, false);
            ...
            else
            {
              ...
              for (int index1 = 0; index1 < length; ++index1)
              {
                ...
                if (recipeItem != null && !string.IsNullOrEmpty(recipeItem.iname))
                {
                  ...
                  DataSource.Bind<ItemParam>(listItemEvents.gameObject, itemParam, false);
                  ...
                  DataSource.Bind<JobEvolutionRecipe>(listItemEvents.gameObject, data, false);
                }
              }
