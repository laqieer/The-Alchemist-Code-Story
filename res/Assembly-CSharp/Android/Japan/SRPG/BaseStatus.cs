      ...
      get
      {
        switch (type)
        {
          ...
          case ParamTypes.Assist_SideAttack:
            return this[EnchantCategory.Assist, EnchantTypes.SideAttack];
          case ParamTypes.Assist_BackAttack:
            return this[EnchantCategory.Assist, EnchantTypes.BackAttack];
          case ParamTypes.Resist_SideAttack:
            return this[EnchantCategory.Resist, EnchantTypes.SideAttack];
          case ParamTypes.Resist_BackAttack:
            return this[EnchantCategory.Resist, EnchantTypes.BackAttack];
          case ParamTypes.Assist_ObstReaction:
            return this[EnchantCategory.Assist, EnchantTypes.ObstReaction];
          case ParamTypes.Resist_ObstReaction:
            return this[EnchantCategory.Resist, EnchantTypes.ObstReaction];
          default:
            return (OInt) 0;
        }
      }
