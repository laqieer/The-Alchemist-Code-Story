  ...
  public class AbilityDetailWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private void Refresh()
    {
      ...
      else
      {
        ...
        {
          DataSource.Bind<AbilityParam>(this.gameObject, AbilityDetailWindow.BindAbility, false);
          if ((UnityEngine.Object) this.SkillTemplate != (UnityEngine.Object) null)
          {
        ...
        else
        {
          ...
          DataSource.Bind<AbilityData>(this.gameObject, data2, false);
          ...
          DataSource.Bind<AbilityParam>(this.gameObject, data3, false);
          if ((UnityEngine.Object) this.SkillTemplate != (UnityEngine.Object) null)
          {
            List<AbilityDetailWindow.ViewContentParam> viewContentParams = new List<AbilityDetailWindow.ViewContentParam>();
            ...
            for (int index = 0; index < unlockUnitDataParamList.Count; ++index)
            {
              ...
              DataSource.Bind<SkillParam>(gameObject, MonoSingleton<GameManager>.Instance.GetSkillParam(unlockUnitDataParamList[index].new_id), false);
              DataSource.Bind<QuestClearUnlockUnitDataParam>(gameObject, unlockUnitDataParamList[index], false);
              gameObject.transform.SetParent(this.SkillLayoutParent, false);
              gameObject.SetActive(true);
            }
            for (int index = 0; index < viewContentParams.Count; ++index)
    ...
    public void OnOpenSkillUnlockCondWindow(GameObject button)
    {
      ...
      DataSource.Bind<QuestClearUnlockUnitDataParam>(gameObject1, dataOfClass, false);
