...
namespace SRPG
{
  ...
  public class EventShopBuyConfirmWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private void Refresh()
    {
      ...
      if ((UnityEngine.Object) this.HasJem != (UnityEngine.Object) null && (UnityEngine.Object) this.HasCoin != (UnityEngine.Object) null && (UnityEngine.Object) this.HasZenny != (UnityEngine.Object) null)
      {
        switch (this.mShopitem.saleType)
        {
          ...
          default:
            ...
            this.HasZenny.SetActive(false);
            DataSource.Bind<EventCoinData>(this.HasCoin, MonoSingleton<GameManager>.Instance.Player.EventCoinList.Find((Predicate<EventCoinData>) (f => f.iname.Equals(this.mShopitem.cost_iname))), false);
            break;
        }
      }
      ...
      DataSource.Bind<EventShopItem>(this.gameObject, this.mShopitem, false);
