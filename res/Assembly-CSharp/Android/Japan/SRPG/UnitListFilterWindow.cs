  ...
  public class UnitListFilterWindow : FlowWindowBase
  {
    ...
    private void CacheToggleParam(GameObject toggle_parent_obj)
    {
      ...
      for (int index = 0; index < componentsInChildren.Length; ++index)
      {
        try
        {
          UnitListFilterWindow.SelectType key = (UnitListFilterWindow.SelectType) Enum.Parse(typeof (UnitListFilterWindow.SelectType), componentsInChildren[index].name);
          ButtonEvent component = componentsInChildren[index].GetComponent<ButtonEvent>();
          if ((UnityEngine.Object) component != (UnityEngine.Object) null)
            component.GetEvent("UNITFILTER_TGL_CHANGE")?.valueList.SetField("select", (int) key);
    ...
    {
      foreach (KeyValuePair<UnitListFilterWindow.SelectType, Toggle> toggle in this.m_Toggles)
        toggle.Value.isOn = (this.m_SelectType & toggle.Key) != UnitListFilterWindow.SelectType.NONE;
    ...
    public void SaveSelectType()
    {
      ...
      {
        int num2 = 1 << index;
        if ((num2 & 16777183) != 0 && (this.m_SelectType & (UnitListFilterWindow.SelectType) num2) == UnitListFilterWindow.SelectType.NONE)
          num1 |= num2;
      }
    ...
    public override int OnActivate(int pinId)
    {
      switch (pinId)
      {
        ...
        case 650:
          ...
          {
            while (enumerator.MoveNext())
              enumerator.Current.Value.isOn = false;
            break;
          }
      }
      return -1;
    ...
    public static UnitListFilterWindow.SelectType GetFilterMask(UnitListWindow.Data data)
    {
      ...
      switch (unitParam.birthID)
      {
        case 1:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_ENV;
        case 2:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_WRATH;
        case 3:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_SLOTH;
        case 4:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_LUST;
        case 5:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_GLUTTONY;
        case 6:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_GREED;
        case 7:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_SAGA;
        case 8:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_WADATSUMI;
        case 9:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_DESERT;
        case 10:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_NOZ;
        case 11:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_LOSTBLUE;
        default:
          return selectType | UnitListFilterWindow.SelectType.BIRTH_OTHER;
      }
    }
    ...
    public static UnitListFilterWindow.SelectType ConvertFilterString(string text)
    {
      ...
      if (text == "BIRTH:ロストブルー")
        return UnitListFilterWindow.SelectType.BIRTH_LOSTBLUE;
    ...
    public enum SelectType
    {
      ...
      BIRTH_LOSTBLUE = 8388608, // 0x00800000
    }
