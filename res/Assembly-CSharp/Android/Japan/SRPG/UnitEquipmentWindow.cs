  ...
  public class UnitEquipmentWindow : MonoBehaviour, IFlowInterface
  {
      ...
      if (this.mEquipmentData != null && this.mEquipmentData.Skill != null)
      {
        ...
        if (buffEffect != null && buffEffect.targets != null)
        {
          for (int index = 0; index < buffEffect.targets.Count; ++index)
          {
            ...
            DataSource.Bind<EquipItemParameter>(equipmentParameter, data, false);
            equipmentParameter.SetActive(true);
          }
        }
      }
      this.RefreshEquipButton(unit);
      DataSource.Bind<EquipData>(this.gameObject, this.mEquipmentData, false);
    ...
    private void RefreshItemTree(bool created = false)
    {
      ...
      for (int index = 0; index < this.mItemParamTree.Count; ++index)
      {
        ...
        DataSource.Bind<ItemParam>(this.ItemTree[index].gameObject, this.mItemParamTree[index], false);
      }
      for (int index = 0; index < this.ItemTree.Count; ++index)
      {
    ...
    private void RefreshRecipeItems()
    {
      ...
      DataSource.Bind<ItemParam>(this.SelectedItem.gameObject, this.mItemParamTree[index1], false);
      ...
      for (int index2 = 0; index2 < recipeParam.items.Length; ++index2)
      {
        ...
        DataSource.Bind<RecipeItemParameter>(this.RecipeItems[index2].gameObject, data, false);
      }
      int cost = 0;
    ...
    private void RefreshGainedQuests()
    {
      ...
      DataSource.Bind<ItemParam>(this.QuestsParent.gameObject, data, false);
    ...
    private void AddPanel(QuestParam questparam, QuestParam[] availableQuests)
    {
      ...
      if ((UnityEngine.Object) component2 != (UnityEngine.Object) null)
      {
        ...
        if (!component2.interactable && flag2 && (questparam.Chapter != null && MonoSingleton<GameManager>.Instance.Player.IsQuestArchiveOpenByArea(questparam.Chapter.iname)))
