...
namespace SRPG
{
  ...
  public class RaidResultWindow : SRPG_ListBase, IFlowInterface
  {
      ...
      if (this.mRaidResult != null)
      {
        ...
        if ((UnityEngine.Object) this.ResultTemplate != (UnityEngine.Object) null)
        {
          for (int index = 0; index < this.mRaidResult.results.Count; ++index)
          {
            ...
            DataSource.Bind<RaidQuestResult>(gameObject, this.mRaidResult.results[index], false);
        ...
        if ((UnityEngine.Object) this.UnitListItem != (UnityEngine.Object) null)
        {
          ...
          for (int index = 0; index < this.mRaidResult.members.Count; ++index)
          {
            ...
            DataSource.Bind<UnitData>(gameObject, this.mRaidResult.members[index], false);
    ...
    private void CreateDropItemObjects(QuestResult.DropItemData[] items)
    {
      ...
      foreach (QuestResult.DropItemData data in items)
      {
        ...
        if (data.IsConceptCard)
        {
          ...
          DataSource.Bind<QuestResult.DropItemData>(root, data, false);
          root.SetActive(true);
        ...
        else if (data.IsItem)
        {
          ...
          root.transform.SetParent(parent, false);
          DataSource.Bind<ItemData>(root, (ItemData) data, false);
          root.SetActive(true);
          GameParameter.UpdateAll(root);
        }
        else
    ...
    private IEnumerator QuestResultAnimation()
    {
      ...
      return (IEnumerator) new RaidResultWindow.\u003CQuestResultAnimation\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new RaidResultWindow.\u003CGainPlayerExpAnimation\u003Ec__Iterator1() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new RaidResultWindow.\u003CGainUnitExpAnimation\u003Ec__Iterator2() { \u0024this = this };
    }
  }
}
