...
namespace SRPG
{
  public class JSON_MyPhotonRoomParam
  {
    ...
    {
      string str = "{" + "\"creatorName\":\"" + JsonEscape.Escape(this.creatorName) + "\"" + ",\"creatorLV\":" + (object) this.creatorLV + ",\"creatorFUID\":\"" + JsonEscape.Escape(this.creatorFUID) + "\"" + ",\"comment\":\"" + JsonEscape.Escape(this.comment) + "\"" + ",\"passCode\":\"" + JsonEscape.Escape(this.passCode) + "\"" + ",\"btlSpd\":" + (object) this.btlSpd + ",\"iname\":\"" + JsonEscape.Escape(this.iname) + "\"" + ",\"type\":" + (object) this.type + ",\"isLINE\":" + (object) this.isLINE + ",\"started\":" + (object) this.started + ",\"roomid\":" + (object) this.roomid + ",\"audience\":" + (object) this.audience + ",\"audienceNum\":" + (object) this.audienceNum + ",\"unitlv\":" + (object) this.unitlv + ",\"challegedMTFloor\":" + (object) GlobalVars.SelectedMultiTowerFloor + ",\"vsmode\":" + (object) this.vsmode + ",\"draft_type\":" + (object) this.draft_type + ",\"draft_deck_id\":" + (object) this.draft_deck_id + ",\"players\":[";
      if (this.players != null)
      {
