  ...
  public class ArtifactList : UIBehaviour, IFlowInterface, ISortableList
  {
    ...
    public int CellCount
    {
      get
      {
        ...
        float num5;
        float num6;
        if (this.UseGridLayout && (UnityEngine.Object) (component = this.GetComponent<GridLayoutGroup>()) != (UnityEngine.Object) null)
        {
          num1 = component.cellSize.x;
          num2 = component.cellSize.y;
          num3 = component.spacing.x;
          num4 = component.spacing.y;
          num5 = (float) component.padding.horizontal;
          num6 = (float) component.padding.vertical;
        }
        else
        {
          num1 = this.CellWidth;
        ...
        float num7 = rect.width - num5 + num3;
        if (!this.TruncateX)
          num7 += (float) ((double) num1 + (double) num4 - 1.0);
        float num8 = rect.height - num6 + num4;
        if (!this.TruncateY)
    ...
    protected override void Start()
    {
      ...
      if ((UnityEngine.Object) this.EmptyMessage != (UnityEngine.Object) null && !this.mEmptyMessageChanged)
      {
    ...
    private bool IsCreatableArtifact(List<ArtifactData> artifactDataList)
    {
      ...
      if ((UnityEngine.Object) instanceDirect == (UnityEngine.Object) null || instanceDirect.Player == null)
        return false;
    ...
    private List<GenericBadge<ArtifactData>> AddCreatableInfo(List<ArtifactData> artifactDataList)
    {
      ...
      foreach (ArtifactData artifactData in artifactDataList)
      {
        ...
        if (itemData == null)
        {
          genericBadgeList.Add(new GenericBadge<ArtifactData>(artifactData, false));
        }
        else
        {
          RarityParam rarityParam = MonoSingleton<GameManager>.Instance.GetRarityParam(artifactParam.rareini);
    ...
    private void _Refresh()
    {
      ...
      if (this.Source == ArtifactList.ListSource.Normal && this.TestOwner != null)
      {
        List<ArtifactParam> recommendedArtifactParams = instance.MasterParam.GetRecommendedArtifactParams(this.TestOwner, false);
        ...
        for (int index = 0; index < objArray.Length; ++index)
        {
          ...
          {
            if (recommendedArtifactParams.FindIndex((Predicate<ArtifactParam>) (ap => ap.iname == artifact_data.ArtifactParam.iname)) >= 0)
        ...
        if (source.Count > 0)
        {
          ...
          source.AddRange((IEnumerable<ArtifactData>) artifactDataList);
      ...
      for (int index1 = 0; index1 < this.mItems.Count; ++index1)
      {
        ...
        if (0 <= index2 && index2 < this.mData.Length)
        {
          ...
          DataSource.Bind<RecommendedArtifactViewParam>(this.mItems[index1], artifactViewParamArray[index2], false);
    ...
    public void UpdateSelection()
    {
      ...
      List<CheckBadge> results = new List<CheckBadge>();
      for (int index1 = 0; index1 < this.mItems.Count; ++index1)
      {
        int index2 = this.mPage * this.mPageSize + index1 - this.ExtraItems.Length;
        if (0 <= index2 && index2 < this.mData.Length)
        {
          ...
          if ((UnityEngine.Object) component != (UnityEngine.Object) null && !string.IsNullOrEmpty(this.SelectionState))
          {
            if (num >= 0)
          ...
          GameParameter.UpdateAll(this.mItems[index1]);
          this.mItems[index1].GetComponentsInChildren<CheckBadge>(true, results);
          for (int index3 = 0; index3 < results.Count; ++index3)
          {
            if (num >= 0)
              results[index3].gameObject.SetActive(true);
            else
              results[index3].gameObject.SetActive(false);
          }
        }
        else
          this.mItems[index1].SetActive(false);
      ...
      if (this.Source == ArtifactList.ListSource.Normal)
      {
        if ((UnityEngine.Object) this.TotalDecomposeCost != (UnityEngine.Object) null)
        {
          long num = 0;
        ...
        if ((UnityEngine.Object) this.TotalSellCost != (UnityEngine.Object) null)
        {
          long num = 0;
          for (int index = 0; index < this.mSelection.Count; ++index)
          {
      ...
      if (!((UnityEngine.Object) this.ApplyButton != (UnityEngine.Object) null))
        return;
      this.ApplyButton.interactable = this.mSelection.Count > 0;
    }
    ...
    {
      if ((UnityEngine.Object) this.ArtifactDetail == (UnityEngine.Object) null)
      {
        if (!((UnityEngine.Object) this.ArtifactDetailRef != (UnityEngine.Object) null))
          return;
      ...
      else
      {
        ...
        DataSource.Bind(gameObject, this.mDataType, dataOfClass, false);
        UnitData unit;
        JobData job;
        ...
        {
          DataSource.Bind<UnitData>(gameObject, unit, false);
          DataSource.Bind<JobData>(gameObject, job, false);
        }
    ...
    private void TriggerSelectionChange()
    {
      ...
      if ((UnityEngine.Object) this.AbilityScrollBar != (UnityEngine.Object) null)
    ...
    {
      if (artifact == null || this.mDataType != typeof (ArtifactData))
        return -1;
