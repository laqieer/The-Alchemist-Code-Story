...
namespace SRPG
{
  public class TacticsUnitController : UnitController
  {
    ...
    private IEnumerator CacheIconsAsync()
    {
      ...
      return (IEnumerator) new TacticsUnitController.\u003CCacheIconsAsync\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    public void SetHPChangeYosou(int newHP, int hpmax_damage = 0)
    {
      ...
      if (hpmax_damage > 0 && (UnityEngine.Object) this.mHPGauge.MaxGauge != (UnityEngine.Object) null)
      {
      ...
      else if (newHP < this.mCachedHP)
      {
        ...
        else
        {
          ...
          colors[0].a = (byte) ((ulong) newHP * (ulong) byte.MaxValue / (ulong) this.mCachedHP);
      ...
      else if (newHP > this.mCachedHP)
      {
        ...
        colors[0].a = (int) this.Unit.MaximumStatus.param.hp == 0 ? (byte) 0 : (byte) ((ulong) this.mCachedHP * (ulong) byte.MaxValue / (ulong) (int) this.Unit.MaximumStatus.param.hp);
        colors[1].a = (byte) ((uint) byte.MaxValue - (uint) colors[0].a);
    ...
    public bool IsHPGaugeChanging
    {
      get
      {
        if (!((UnityEngine.Object) this.mHPGauge != (UnityEngine.Object) null) || !this.mHPGauge.gameObject.activeInHierarchy || (!((UnityEngine.Object) this.mHPGauge.MainGauge != (UnityEngine.Object) null) || !this.mHPGauge.MainGauge.gameObject.activeInHierarchy))
          return false;
        if ((UnityEngine.Object) this.mHPGauge.MaxGauge != (UnityEngine.Object) null)
    ...
    public void UpdateHPRelative(int delta, float duration = 0.5f, bool is_hpmax_damage = false)
    {
      ...
      this.mCachedHP = Mathf.Clamp(this.mCachedHP, 0, this.mCachedHpMax);
      if ((UnityEngine.Object) this.mHPGauge == (UnityEngine.Object) null || !(bool) ((UnityEngine.Object) this.mHPGauge.MainGauge))
        return;
      if (is_hpmax_damage && (bool) ((UnityEngine.Object) this.mHPGauge.MaxGauge))
      {
    ...
    public bool CreateOwnerIndexUI(Canvas canvas, GameObject templeteUI, JSON_MyPhotonPlayerParam param)
    {
      ...
      if ((UnityEngine.Object) this.mOwnerIndexUI == (UnityEngine.Object) null)
        return false;
      DataSource.Bind<JSON_MyPhotonPlayerParam>(this.mOwnerIndexUI, param, false);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TacticsUnitController.\u003CLoadDefendSkillEffectAsync\u003Ec__Iterator1() { skillEffectName = skillEffectName, \u0024this = this };
    }
    ...
    protected override void PostSetup()
    {
      ...
      if ((UnityEngine.Object) component != (UnityEngine.Object) null)
      {
        ...
        if (this.mUnitObjectLists.Count <= 1 && (UnityEngine.Object) component.ShadowProjector != (UnityEngine.Object) null)
        {
          ...
          this.mShadow = UnityEngine.Object.Instantiate<GameObject>(gameObject, this.transform.position + gameObject.transform.position, gameObject.transform.rotation).GetComponent<Projector>();
    ...
    public void SetDrainEffect(GameObject eff)
    {
      ...
      this.mDrainEffect = UnityEngine.Object.Instantiate<GameObject>(eff, this.transform.position, this.transform.rotation);
    ...
    public bool isIdle
    {
      get
      {
        if (!this.mStateMachine.IsInState<TacticsUnitController.State_Idle>() && !this.mStateMachine.IsInState<TacticsUnitController.State_Down>())
          return this.mStateMachine.IsInState<TacticsUnitController.State_BigUnitBsIdle>();
        return true;
      }
    }
    ...
    public bool IsInitLoading
    {
      ...
      {
        if (!this.IsLoading)
          return this.mStateMachine.IsInState<TacticsUnitController.State_WaitResources>();
        return true;
      }
    }
    ...
    public void UpdateBadStatus()
    {
      ...
      if (this.IsCursed != flag1 && (UnityEngine.Object) BadStatusEffects.CurseEffect != (UnityEngine.Object) null)
      {
        if (flag1)
        {
          ...
          this.attachBadStatusEffect(this.mCurseEffect, attach_target, false);
        }
        else
        {
      ...
      if (this.mBadStatus != null)
      {
        ...
        else if ((UnityEngine.Object) this.mBadStatus.EffectBigUnit != (UnityEngine.Object) null)
        {
          this.mBadStatusEffect = UnityEngine.Object.Instantiate<GameObject>(this.mBadStatus.EffectBigUnit);
          this.attachBadStatusEffect(this.mBadStatusEffect, this.mBadStatus.AttachTargetBigUnit, false);
        }
        ...
        if (this.Unit.IsUnitCondition(EUnitCondition.DeathSentence) && (UnityEngine.Object) this.mDeathSentenceIcon != (UnityEngine.Object) null)
    ...
    public void UpdateShields(bool is_update_turn = true)
    {
      if (this.mUnit == null)
        return;
      foreach (TacticsUnitController.ShieldState shield in this.Shields)
      {
        if ((int) shield.Target.hp != shield.LastHP || (bool) shield.Target.is_efficacy)
          shield.Dirty = true;
      }
    ...
    private void DrainGems(TacticsUnitController goal)
    {
      ...
      {
        Quaternion quaternion = Quaternion.AngleAxis((float) Random.Range(135, 225), axis) * Quaternion.AngleAxis((float) Random.Range(70, 110), Vector3.right);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TacticsUnitController.\u003CShowHitPopup\u003Ec__Iterator2() { guard = guard, target = target, critical = critical, backstab = backstab, weak = weak, resist = resist, absorb = absorb, is_guts = is_guts, hpDamage = hpDamage, hpDamageValue = hpDamageValue, mpDamage = mpDamage, mpDamageValue = mpDamageValue, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TacticsUnitController.\u003CShowHealPopup\u003Ec__Iterator3() { hpHeal = hpHeal, target = target, mpHeal = mpHeal };
    }
    ...
    private void HitTarget(TacticsUnitController target, HitReactionTypes hitReaction = HitReactionTypes.None, bool doReaction = true)
    {
      ...
      if (this.mSkillVars.Skill.effect_type != SkillEffectTypes.Throw && this.mSkillVars.Skill.effect_type != SkillEffectTypes.DynamicTransformUnit && ((UnityEngine.Object) target != (UnityEngine.Object) this && this.mSkillVars.NumHitsLeft == this.mSkillVars.TotalHits - 1))
      {
      ...
      if (this.mSkillVars.Skill.IsDamagedSkill() && !flag4)
      {
        ...
        if (flag2 && hpDamage)
        {
          ...
          target.UpdateHPRelative(-num2, duration, this.mSkillVars.Skill.IsMhmDamage());
    ...
    public void BuffEffectSelf()
    {
      if (this.mSkillVars == null || this.mSkillVars.Skill == null || (!this.mSkillVars.Skill.IsPrevApply() || this.mHitInfoSelf == null) || this.mHitInfoSelf.hits.Count <= 0 && !this.mHitInfoSelf.buff.CheckEffect() && !this.mHitInfoSelf.debuff.CheckEffect() || !this.mHitInfoSelf.IsBuffEffect())
        return;
      SceneBattle.Instance.PopupParamChange(this.UIDispPosition, this.mHitInfoSelf.buff, this.mHitInfoSelf.debuff, 0);
    ...
    private bool ReflectTargetTypeToPos(ref Vector3 pos)
    {
      ...
      if (battleCore == null)
        return false;
      EUnitDirection eunitDirection = instance.UnitDirectionFromPosition(this.transform.position, pos, this.mSkillVars.Skill);
        ...
        else
        {
          ...
          if (this.mSkillVars.mSkillEffect.MapHitEffectType == SkillEffect.MapHitEffectTypes.EachHits)
          {
            if (this.mSkillVars.Skill != null || SkillParam.IsTypeLaser(this.mSkillVars.Skill.select_scope))
            {
              ...
              {
                Vector3 position = this.mSkillVars.Targets[index].transform.position;
          ...
          if ((bool) ((UnityEngine.Object) this.mSkillVars.mTargetController) && this.mSkillVars.mTargetController.Unit != null && !this.mSkillVars.mTargetController.Unit.IsNormalSize)
          {
            if ((bool) ((UnityEngine.Object) this.mSkillVars.mTargetController) && this.mSkillVars.Skill != null && !this.mSkillVars.Skill.IsAreaSkill())
            {
              SceneBattle instance = SceneBattle.Instance;
              if ((bool) ((UnityEngine.Object) instance))
            ...
            Vector3 vector3 = this.mSkillVars.mTargetPosition + Vector3.up * 0.5f;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TacticsUnitController.\u003CAnimateProjectile\u003Ec__Iterator4() { length = length, clip = clip, pd = pd, basePosition = basePosition, baseRotation = baseRotation, callback = callback };
    }
    ...
    public void PlayDodge(bool perfectAvoid, bool is_disp_popup = true)
    {
      ...
      {
        if (perfectAvoid)
          SceneBattle.Instance.PopupPefectAvoid(this.UIDispPosition, 0.0f);
        else
          SceneBattle.Instance.PopupMiss(this.UIDispPosition, 0.0f);
      }
      if (this.mSkillVars != null || !this.Unit.IsEnablePlayAnimCondition() || ((UnityEngine.Object) this.FindAnimation("B_DGE") == (UnityEngine.Object) null || this.mStateMachine.IsInState<TacticsUnitController.State_BigUnitBsIdle>()) || this.mStateMachine.IsInState<TacticsUnitController.State_BigUnitBsDamage>())
        return;
    ...
    public void LoadSkillSequence(SkillParam skillParam, SkillMotion skill_motion, bool loadJobAnimation, bool useBattleScene, bool is_cs = false, bool is_cs_sub = false)
    {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TacticsUnitController.\u003CLoadSkillSequenceAsync\u003Ec__Iterator5() { skillParam = skillParam, loadJobAnimation = loadJobAnimation, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TacticsUnitController.\u003CLoadSkillEffectAsync\u003Ec__Iterator6() { skillEffectName = skillEffectName, \u0024this = this };
    }
    ...
    private void SpawnHitEffect(TacticsUnitController target, bool isLast)
    {
      ...
      if (target.Unit != null && !target.Unit.IsNormalSize)
        position.y += target.Unit.OffsZ;
      this.mSkillVars.mSkillEffect.SpawnExplosionEffect(0, position, Quaternion.identity);
      if (!isLast || !((UnityEngine.Object) this.mLastHitEffect != (UnityEngine.Object) null))
        return;
      GameUtility.SpawnParticle(this.mLastHitEffect, position, Quaternion.identity, (GameObject) null);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TacticsUnitController.\u003CAsyncHitTimer\u003Ec__Iterator7() { \u0024this = this };
    }
    ...
    {
      if (!(bool) ((UnityEngine.Object) target) || target.Unit != null && target.Unit.IsJump)
        return;
      SceneBattle instance = SceneBattle.Instance;
      if (!(bool) ((UnityEngine.Object) instance))
        return;
        ...
        else
        {
          switch (this.mKnockBackMode)
          {
            ...
            case TacticsUnitController.eKnockBackMode.EXEC:
              ...
              if (!(bool) ((UnityEngine.Object) jumpSpotEffect))
                break;
              jumpSpotEffect.transform.position = this.transform.position;
    ...
    public SkillSequence GetSkillSequence()
    {
      ...
      return this.mSkillVars.mSkillSequence;
    }
    ...
    public void LoadTransformAnimation(SkillSequence ss)
    {
      ...
      if (!string.IsNullOrEmpty(ss.SkillAnimation.Name))
      {
        ...
        if ((UnityEngine.Object) this.FindAnimation("B_TRANSFORM") == (UnityEngine.Object) null)
          this.LoadUnitAnimationAsync("B_TRANSFORM", animationName, false, false);
      }
      if (string.IsNullOrEmpty(ss.StartAnimation))
        return;
      string animationName1 = ss.StartAnimation + "_chg";
      if (!((UnityEngine.Object) this.FindAnimation("B_PRE_TRANSFORM") == (UnityEngine.Object) null))
        return;
      this.LoadUnitAnimationAsync("B_PRE_TRANSFORM", animationName1, false, false);
    }
    ...
    {
      if ((UnityEngine.Object) this.FindAnimation("B_BU_BS_IDLE") == (UnityEngine.Object) null)
        this.LoadUnitAnimationAsync("B_BU_BS_IDLE", "idleBattleScene0", true, false);
      if (!((UnityEngine.Object) this.FindAnimation("B_BU_BS_DAMAGE") == (UnityEngine.Object) null))
        return;
      this.LoadUnitAnimationAsync("B_BU_BS_DAMAGE", "damageBattleScene0", true, false);
    }
    ...
    public void DirectionOff_LoadSkill(SkillParam skillParam, SkillMotion skill_motion, bool is_cs = false, bool is_cs_sub = false)
    {
      this.mSkillVars = new TacticsUnitController.SkillVars();
      this.mSkillVars.Skill = skillParam;
      this.mSkillVars.mIsCollaboSkill = is_cs;
    ...
    private class State_Skill : TacticsUnitController.State
    {
      ...
      public override void Begin(TacticsUnitController self)
      {
        if (self.mSkillVars.UseBattleScene)
          this.mStartCameraState.CacheCurrent(self.mSkillVars.mActiveCamera);
        if ((bool) ((UnityEngine.Object) self.FindAnimation("B_SKL")))
    ...
    private class State_RangedSkillEnd : TacticsUnitController.State
    {
      ...
      public override void Update(TacticsUnitController self)
      {
        ...
        if (self.mSkillVars.UseBattleScene)
        {
          ...
          {
            if (!projectileDataList.mProjStartAnimEnded && (UnityEngine.Object) projectileDataList.mProjectile != (UnityEngine.Object) null)
            {
    ...
    private class State_JumpCastComplete : TacticsUnitController.State
    {
      ...
      private void EnterFall()
      {
        ...
        {
          this.mFallEffect = UnityEngine.Object.Instantiate<GameObject>(this.self.mSkillVars.mSkillEffect.AuraEffect, this.self.transform.position, this.self.transform.rotation);
    ...
    private class State_ChangeGrid : TacticsUnitController.State
    {
      ...
      {
        GameObject go = UnityEngine.Object.Instantiate<GameObject>(EffectPrefab, Parent.transform.position, Parent.transform.rotation);
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new TacticsUnitController.State_ChangeGrid.\u003CWait\u003Ec__Iterator0() { self = self, Seconds = Seconds, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new TacticsUnitController.State_ChangeGrid.\u003CEffectEndWait\u003Ec__Iterator1() { Seconds = Seconds, self = self };
      }
      ...
      public override void Update(TacticsUnitController self)
      {
        ...
        else
        {
          if (!((UnityEngine.Object) this.mSelfEffect == (UnityEngine.Object) null) || !((UnityEngine.Object) this.mTargetEffect == (UnityEngine.Object) null))
            ;
          if (!((UnityEngine.Object) this.mSelfParticle != (UnityEngine.Object) null) || ((double) this.mSelfParticle.time / (double) this.mSelfParticle.main.duration < 1.0 || this.mChanged))
            return;
          this.mChanged = true;
          TacticsUnitController target = self.mSkillVars.Targets[0];
          Vector3 position1 = self.transform.position;
          ...
          if (!target.IsVisible())
          {
            ...
            if ((bool) ((UnityEngine.Object) instance))
            {
              ...
              if ((bool) ((UnityEngine.Object) jumpSpotEffect))
              {
                jumpSpotEffect.transform.position = target.transform.position;
    ...
    private class State_Throw : TacticsUnitController.State
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new TacticsUnitController.State_Throw.\u003CexecPerformance\u003Ec__Iterator0() { self = self, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new TacticsUnitController.State_Throw.\u003ClerpTurn\u003Ec__Iterator1() { target = target, target_pos = target_pos };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new TacticsUnitController.State_Throw.\u003ClerpPickUp\u003Ec__Iterator2() { target = target, self = self };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new TacticsUnitController.State_Throw.\u003ClerpThrow\u003Ec__Iterator3() { target = target, target_pos = target_pos };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new TacticsUnitController.State_Throw.\u003ClerpBound\u003Ec__Iterator4() { target = target };
      }
    }
    ...
    private class State_PreAfterTransform : TacticsUnitController.State
    {
      ...
      public override void Update(TacticsUnitController self)
      {
        if ((double) self.GetRemainingTime("B_PRE_TRANSFORM") > 0.100000001490116)
          return;
        self.PlayIdle(0.1f);
      }
    }
    ...
    private class State_BigUnitBsDamage : TacticsUnitController.State
    {
      ...
      public override void Update(TacticsUnitController self)
      {
        if ((double) self.GetRemainingTime("B_BU_BS_DAMAGE") > 0.100000001490116)
          return;
