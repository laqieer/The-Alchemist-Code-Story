...
namespace SRPG
{
  ...
  public class FlowNode_ReadMail2 : FlowNode_Network
  {
    ...
    public override void OnActivate(int pinID)
    {
      ...
      {
        case 0:
          MailWindow.MailReadRequestData dataOfClass = DataSource.FindDataOfClass<MailWindow.MailReadRequestData>(this.gameObject, (MailWindow.MailReadRequestData) null);
