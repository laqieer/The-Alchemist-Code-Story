...
namespace SRPG
{
  ...
  public class ScrollClamped_TownMenu : MonoBehaviour, ScrollListSetUp
  {
    ...
    public void OnSetUpItems()
    {
      ...
      this.mController.OnAfterStartup.AddListener(new UnityAction<bool>(this.OnAfterStartup));
      float num1 = 0.0f;
    ...
    private IEnumerator OrdealReleaseAnimationCoroutine(GameObject obj, UnlockParam lockState)
    {
      ...
      return (IEnumerator) new ScrollClamped_TownMenu.\u003COrdealReleaseAnimationCoroutine\u003Ec__Iterator0() { obj = obj, lockState = lockState, \u0024this = this };
    }
