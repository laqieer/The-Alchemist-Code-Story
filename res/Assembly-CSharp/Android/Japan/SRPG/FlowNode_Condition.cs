    ...
    private bool Test()
    {
      ...
      switch (this.Condition)
      {
        ...
        case FlowNode_Condition.Conditions.SHOW_ARENA_REWARD_RANKING:
          if (GlobalVars.ArenaAward != null && GlobalVars.ArenaAward.reward != null)
            return GlobalVars.ArenaAward.reward.rank != null;
          return false;
        case FlowNode_Condition.Conditions.SHOW_ARENA_REWARD_DEFENSE:
          if (GlobalVars.ArenaAward != null && GlobalVars.ArenaAward.reward != null && GlobalVars.ArenaAward.reward.defense != null)
            return GlobalVars.ArenaAward.defense_count > 0;
          return false;
