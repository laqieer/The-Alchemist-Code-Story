...
namespace SRPG
{
  public class GachaResultUnitDetail : MonoBehaviour
  {
    ...
    private IEnumerator ShowLeaderSkillDetail(string _path)
    {
      ...
      return (IEnumerator) new GachaResultUnitDetail.\u003CShowLeaderSkillDetail\u003Ec__Iterator0() { _path = _path, \u0024this = this };
    }

    private void OpenLeaderSkillDetail()
    {
      if (!((UnityEngine.Object) this.mLeaderSkillDetail == (UnityEngine.Object) null) || !((UnityEngine.Object) this.Prefab_LeaderSkillDetail != (UnityEngine.Object) null))
        return;
    ...
    private void Start()
    {
      if (!((UnityEngine.Object) this.LeaderSkillDetailButton != (UnityEngine.Object) null))
        return;
      this.LeaderSkillDetailButton.onClick.AddListener(new UnityAction(this.OpenLeaderSkillDetail));
    }
    ...
    private void Refresh()
    {
      ...
      if (!string.IsNullOrEmpty(this.PreviewParentID))
      {
        ...
        this.mPreviewParent.transform.position = new Vector3(-0.2f, this.mPreviewParent.transform.position.y, this.mPreviewParent.transform.position.z);
      }
    ...
    {
      if ((UnityEngine.Object) this.JobData01 != (UnityEngine.Object) null)
        this.JobData01.SetActive(false);
      if ((UnityEngine.Object) this.JobData02 != (UnityEngine.Object) null)
        this.JobData02.SetActive(false);
      if ((UnityEngine.Object) this.JobData03 != (UnityEngine.Object) null)
        this.JobData03.SetActive(false);
      if ((UnityEngine.Object) this.LeaderSkillDetailButton != (UnityEngine.Object) null)
        this.LeaderSkillDetailButton.interactable = false;
      this.Refresh();
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GachaResultUnitDetail.\u003CRefreshAsync\u003Ec__Iterator1() { immediate = immediate, \u0024this = this };
    }
    ...
    private void ReloadPreviewModels()
    {
      ...
      this.mCurrentPreview = (UnitPreview) null;
      if ((bool) ((UnityEngine.Object) this.mCurrentPreview))
        return;
    ...
    private void RefreshLeaderSkillInfo()
    {
      ...
      {
        this.LeaderSkillDetailButton.interactable = true;
    ...
    private void RefreshJobInfo()
    {
      ...
      DataSource.Bind<JobParam>(this.JobData01, jobs[0].Param, false);
      this.JobData01.SetActive(true);
      if (jobs.Length >= 2)
      {
        DataSource.Bind<JobParam>(this.JobData02, jobs[1].Param, false);
        this.JobData02.SetActive(true);
      }
      if (jobs.Length >= 3)
      {
        DataSource.Bind<JobParam>(this.JobData03, jobs[2].Param, false);
    ...
    {
      if ((UnityEngine.Object) this.AbilityTemplate == (UnityEngine.Object) null)
        return;
      GameUtility.DestroyGameObjects(this.mAbilits);
      this.mAbilits.Clear();
      ...
      for (int index = 0; index < learnedAbilities.Count; ++index)
      {
        ...
        if (this.mCurrentUnit.MapEffectAbility != data)
        {
          ...
          GameObject gameObject2 = gameObject1.transform.Find("icon").gameObject;
          gameObject1.transform.Find("locked").gameObject.SetActive(false);
          ...
          DataSource.Bind<AbilityData>(gameObject1, data, false);
        ...
        if (learningAbilitys != null && (int) rarityParam.UnitJobLvCap >= lv)
        {
          for (int index = 0; index < learningAbilitys.Length; ++index)
          {
            ...
            if (!string.IsNullOrEmpty(key))
            {
              ...
              gameObject.transform.Find("icon").gameObject.GetComponent<ImageArray>().ImageIndex = (int) abilityParam.slot;
              gameObject.transform.SetParent(this.AbilityTemplate.transform.parent, false);
              DataSource.Bind<AbilityParam>(gameObject, abilityParam, false);
      ...
      GameParameter.UpdateAll(this.AbilityTemplate.transform.parent.gameObject);
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GachaResultUnitDetail.\u003CRefreshUnitImage\u003Ec__Iterator2() { \u0024this = this };
    }
  }
}
