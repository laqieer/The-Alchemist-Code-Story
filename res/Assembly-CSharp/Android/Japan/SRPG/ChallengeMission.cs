  ...
  public class ChallengeMission : MonoBehaviour, IFlowInterface
  {
    ...
    private void Awake()
    {
      ...
      for (int index1 = 0; index1 < this.mCategories.Length; ++index1)
      {
        ...
        DataSource.Bind<ChallengeCategoryParam>(component.gameObject, mCategory, false);
    ...
    {
      DataSource.Bind<TrophyParam>(this.ImageReward.gameObject, trophy, false);
      ...
      else
      {
        ...
        else
        {
          ...
          for (int index = 0; index < this.Items.Count; ++index)
          {
            ...
            DataSource.Bind<TrophyParam>(this.Items[index].gameObject, trophy, false);
            ...
            if (data != null)
              DataSource.Bind<ItemParam>(this.Items[index].gameObject, data, false);
    ...
    private void OpenNonAchievedPage(int newPage)
    {
      ...
      foreach (ChallengeMissionItem challengeMissionItem in this.Items)
      {
        ...
        DataSource component = challengeMissionItem.GetComponent<DataSource>();
    ...
    private IEnumerator CloseMessageWindow()
    {
      ...
      return (IEnumerator) new ChallengeMission.\u003CCloseMessageWindow\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    private void OnSelectItem(TrophyParam selectTrophy)
    {
      ...
      {
        DataSource.Bind<TrophyParam>(this.DetailWindow.gameObject, selectTrophy, false);
