  ...
  public class ConceptCardListSortWindow : MonoBehaviour, IFlowInterface
  {
    ...
    public void Start()
    {
      ...
      for (int index = 0; index < this.SortToggles.Length; ++index)
        this.SortToggles[index].toggle.onValueChanged.AddListener(new UnityAction<bool>(this.OnSelect));
      for (int index = 0; index < this.SortOrderToggles.Length; ++index)
        this.SortOrderToggles[index].toggle.onValueChanged.AddListener(new UnityAction<bool>(this.OnSelectOrder));
    ...
    public void Activated(int pinID)
    {
      switch (pinID)
      {
        case 0:
          ...
          if ((UnityEngine.Object) instance != (UnityEngine.Object) null && instance.IsEnhanceListActive)
    ...
    public void OnSelect(bool is_on)
    {
      ...
      for (int index = 0; index < this.SortToggles.Length; ++index)
      {
        ...
        if ((UnityEngine.Object) toggle == (UnityEngine.Object) sortToggle.toggle)
    ...
    public void OnSelectOrder(bool is_on)
    {
      ...
      for (int index = 0; index < this.SortOrderToggles.Length; ++index)
      {
        ...
        if ((UnityEngine.Object) toggle == (UnityEngine.Object) sortOrderToggle.toggle)
