...
namespace SRPG
{
  public class RaidArea : MonoBehaviour
  {
    ...
    {
      if ((UnityEngine.Object) this.mRaidStagePoint == (UnityEngine.Object) null && areaIndex >= 0)
      {
        ...
        if (raidAreaByOrder != null && this.mRaidAreaList.RaidStagePointList.Count > raidAreaByOrder.BossCount)
        {
          ...
          if ((UnityEngine.Object) raidStagePoint != (UnityEngine.Object) null)
            this.mRaidStagePoint = UnityEngine.Object.Instantiate<RaidStagePoint>(raidStagePoint, this.transform);
        }
      }
      if ((UnityEngine.Object) this.mRaidAreaBG == (UnityEngine.Object) null && areaIndex >= 0 && this.mRaidAreaList.RaidAreaBG.Length > areaIndex)
        this.mResourceRequest = AssetManager.LoadAsync<GameObject>(this.mRaidAreaList.RaidAreaBG[areaIndex]);
      if ((UnityEngine.Object) this.mStageRaidIcon == (UnityEngine.Object) null || this.mRaidStagePoint.StageList == null)
        return;
      if (this.mRaidBossIconList != null)
      {
        for (int index = 0; index < this.mRaidBossIconList.Count; ++index)
          UnityEngine.Object.Destroy((UnityEngine.Object) this.mRaidBossIconList[index].gameObject);
      ...
      if (raidArea != null)
      {
        ...
        if ((UnityEngine.Object) this.mRaidAreaTitleText != (UnityEngine.Object) null)
        {
    ...
    private IEnumerator _StartSelectRaid()
    {
      ...
      return (IEnumerator) new RaidArea.\u003C_StartSelectRaid\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new RaidArea.\u003CDownloadUnitImage\u003Ec__Iterator1() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new RaidArea.\u003CDownloadBGImage\u003Ec__Iterator2() { \u0024this = this };
    }
  }
}
