    ...
    private bool attachBuffPassive(Unit target)
    {
      ...
      foreach (BuffEffect mBuffEffectList in this.mBuffEffectLists)
      {
        if (mBuffEffectList != null && mBuffEffectList.param.chk_timing == EffectCheckTimings.Eternal && mBuffEffectList.CheckEnableBuffTarget(target))
        {
          ...
          mBuffEffectList.CalcBuffStatus(ref status1, target.Element, BuffTypes.Buff, true, false, SkillParamCalcTypes.Add, 0);
          mBuffEffectList.CalcBuffStatus(ref status2, target.Element, BuffTypes.Buff, true, true, SkillParamCalcTypes.Add, 0);
          mBuffEffectList.CalcBuffStatus(ref status3, target.Element, BuffTypes.Buff, false, false, SkillParamCalcTypes.Scale, 0);
          mBuffEffectList.CalcBuffStatus(ref status4, target.Element, BuffTypes.Debuff, true, false, SkillParamCalcTypes.Add, 0);
          mBuffEffectList.CalcBuffStatus(ref status5, target.Element, BuffTypes.Debuff, true, true, SkillParamCalcTypes.Add, 0);
          mBuffEffectList.CalcBuffStatus(ref status6, target.Element, BuffTypes.Debuff, false, false, SkillParamCalcTypes.Scale, 0);
