...
namespace SRPG
{
  public static class GlobalVars
  {
    ...
    public static GlobalVars.GlobalVar<int> CurrentRaidAreaId = new GlobalVars.GlobalVar<int>(-1);
    public static GlobalVars.GlobalVar<int> CurrentRaidRound = new GlobalVars.GlobalVar<int>(-1);
    public static RaidBossInfo CurrentRaidBossInfo = new RaidBossInfo();
    ...
    [GlobalVars.ResetOnLogin]
    public static GlobalVars.GlobalVar<bool> IsBeginnerNotified = new GlobalVars.GlobalVar<bool>(false);
