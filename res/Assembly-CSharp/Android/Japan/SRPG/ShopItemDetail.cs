      ...
      else
      {
        if (dataOfClass.type == EItemType.UnitSelectItem)
        {
          if (dataOfClass.iname.StartsWith("IT_SU_"))
            this.mTicketType = ShopItemDetail.TicketType.Unit;
          else if (dataOfClass.iname.StartsWith("IT_SI_"))
            this.mTicketType = ShopItemDetail.TicketType.Item;
          else if (dataOfClass.iname.StartsWith("IT_SA_"))
            this.mTicketType = ShopItemDetail.TicketType.Artifact;
        }
        else if (dataOfClass.type == EItemType.ConceptCardSelectItem && dataOfClass.iname.StartsWith("IT_STS_"))
          this.mTicketType = ShopItemDetail.TicketType.ConceptCard;
        if (this.mTicketType == ShopItemDetail.TicketType.None)
        {
          FlowNode_GameObject.ActivateOutputLinks((Component) this, 10);
        }
        else
        {
          ...
          {
            case ShopItemDetail.TicketType.Unit:
              ...
              break;
            case ShopItemDetail.TicketType.Item:
              ...
              break;
            case ShopItemDetail.TicketType.Artifact:
              ...
              break;
            case ShopItemDetail.TicketType.ConceptCard:
