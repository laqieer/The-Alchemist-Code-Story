...
namespace SRPG
{
  public class BattleBonusParam
  {
    ...
    public static readonly ParamTypes[] ConvertParamTypes = new ParamTypes[49]{ ParamTypes.EffectRange, ParamTypes.EffectScope, ParamTypes.EffectHeight, ParamTypes.HitRate, ParamTypes.AvoidRate, ParamTypes.CriticalRate, ParamTypes.SlashAttack, ParamTypes.PierceAttack, ParamTypes.BlowAttack, ParamTypes.ShotAttack, ParamTypes.MagicAttack, ParamTypes.ReactionAttack, ParamTypes.JumpAttack, ParamTypes.GainJewel, ParamTypes.UsedJewelRate, ParamTypes.ActionCount, ParamTypes.GutsRate, ParamTypes.AutoJewel, ParamTypes.ChargeTimeRate, ParamTypes.CastTimeRate, ParamTypes.BuffTurn, ParamTypes.DebuffTurn, ParamTypes.CombinationRange, ParamTypes.HpCostRate, ParamTypes.SkillUseCount, ParamTypes.PoisonDamage, ParamTypes.PoisonTurn, ParamTypes.Resist_Slash, ParamTypes.Resist_Pierce, ParamTypes.Resist_Blow, ParamTypes.Resist_Shot, ParamTypes.Resist_Magic, ParamTypes.Resist_Reaction, ParamTypes.Resist_Jump, ParamTypes.Avoid_Slash, ParamTypes.Avoid_Pierce, ParamTypes.Avoid_Blow, ParamTypes.Avoid_Shot, ParamTypes.Avoid_Magic, ParamTypes.Avoid_Reaction, ParamTypes.Avoid_Jump, ParamTypes.GainJewelRate, ParamTypes.UsedJewel, ParamTypes.UnitDefenseFire, ParamTypes.UnitDefenseWater, ParamTypes.UnitDefenseWind, ParamTypes.UnitDefenseThunder, ParamTypes.UnitDefenseShine, ParamTypes.UnitDefenseDark };
