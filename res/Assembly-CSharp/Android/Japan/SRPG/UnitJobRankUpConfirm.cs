  ...
  public class UnitJobRankUpConfirm : MonoBehaviour
  {
    ...
    private void Start()
    {
      ...
      if ((UnityEngine.Object) this.JobInfo != (UnityEngine.Object) null)
      {
        ...
        DataSource.Bind<JobData>(this.JobInfo, this.mCurrentUnit.CurrentJob, false);
      }
      ...
      foreach (string key1 in consumes.Keys)
      {
        string key = key1;
        ItemParam itemParam = items.Find((Predicate<ItemParam>) (eq => eq.iname == key));
        if (itemParam != null)
    ...
    public IEnumerator ScrollInit()
    {
      ...
      return (IEnumerator) new UnitJobRankUpConfirm.\u003CScrollInit\u003Ec__Iterator0() { \u0024this = this };
    }
