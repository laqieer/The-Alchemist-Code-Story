  ...
  public class StatusEffect : MonoBehaviour
  {
    ...
    public void SetStatus(Unit unit)
    {
      ...
      for (int index2 = 0; index2 < values.Length; ++index2)
      {
        if (unit.IsUnitCondition(values[index2]))
        {
          ...
          if (index1 < this.StatusSlot.Length)
          {
            ...
            ImageArray component = this.StatusSlot[index1].GetComponent<ImageArray>();
            if ((UnityEngine.Object) component != (UnityEngine.Object) null && index2 < component.Images.Length)
      ...
      if (index1 >= this.StatusSlot.Length)
        return;
      this.StatusSlot[index1].SetActive(true);
      ImageArray component1 = this.StatusSlot[index1].GetComponent<ImageArray>();
      if ((UnityEngine.Object) component1 != (UnityEngine.Object) null && length < component1.Images.Length)
