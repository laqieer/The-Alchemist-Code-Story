    ...
    public override void OnActivate(int pinID)
    {
      switch (pinID)
      {
        case 0:
          ...
          string s1 = string.Format(format1, (object) WWW.EscapeURL(Convert.ToBase64String(inArray1)));
          DebugUtility.Log("LINE:" + s1);
          Application.OpenURL(LocalizedText.Get("sys.MP_LINE_HTTP") + WWW.EscapeURL(s1, Encoding.UTF8));
        ...
        case 200:
          ...
          string s2 = string.Format(format2, (object) WWW.EscapeURL(Convert.ToBase64String(inArray2)), (object) GlobalVars.SelectedMultiPlayRoomID);
          DebugUtility.Log("LINE:" + s2);
          Application.OpenURL(LocalizedText.Get("sys.MP_LINE_HTTP") + WWW.EscapeURL(s2, Encoding.UTF8));
