...
namespace SRPG
{
  ...
  public class ConceptCardEquipWindow : MonoBehaviour, IFlowInterface
  {
    ...
    public void Init(UnitData unit)
    {
      ...
      if ((UnityEngine.Object) this.mIgnoreEquipedConceptCardToggle != (UnityEngine.Object) null)
        this.mIgnoreEquipedConceptCardToggle.isOn = this.mConceptCardEquipList.IsIgnoreEquipedConceptCard;
      this.mFlownodeReqConceptCardSet = this.GetComponent<FlowNode_ReqConceptCardSet>();
      ...
      string str1 = "-";
      this.mLastPageText.text = str1;
      string str2 = str1;
      mCurrentPageText.text = str2;
    ...
    {
      this.mCurrentPageText.text = (this.mConceptCardEquipList.CurrentPage + 1).ToString();
      this.mLastPageText.text = (this.mConceptCardEquipList.LastPage + 1).ToString();
      if (!((UnityEngine.Object) this.mNextPageButton != (UnityEngine.Object) null) || !((UnityEngine.Object) this.mPrevPageButton != (UnityEngine.Object) null))
        return;
      ...
      this.mNextPageButton.interactable = flag1;
      this.mPrevPageButton.interactable = flag2;
    }
    ...
    private void SelectCardIcon()
    {
      ...
      this.SetActiveParamViewObject((UnityEngine.Object) component == (UnityEngine.Object) null);
      this.mSelectedCardData = !((UnityEngine.Object) component != (UnityEngine.Object) null) ? (ConceptCardData) null : component.ConceptCard;
    ...
    private void SetParam(ConceptCardData card_data, UnitData unit, int job_index)
    {
      ...
      if ((UnityEngine.Object) this.mTrustObject != (UnityEngine.Object) null)
      ...
      if ((UnityEngine.Object) this.mIcon != (UnityEngine.Object) null)
      ...
      List<ConceptCardEquipEffect> enableEquipEffects = card_data.GetEnableEquipEffects(unit, job, false);
    ...
    private void ClickOKButton()
    {
      ...
      else
      {
        ...
        if (owner != null && owner.UniqueID != this.mSelectedUnit.UniqueID)
          ...
          this.AcceptEquipConceptCard(this.gameObject);
      }
    }
    ...
    {
      if (!((UnityEngine.Object) this.SortText != (UnityEngine.Object) null))
        return;
    ...
    {
      this.mSelectedCardData = !((UnityEngine.Object) card_icon != (UnityEngine.Object) null) ? (ConceptCardData) null : card_icon.ConceptCard;
    }
