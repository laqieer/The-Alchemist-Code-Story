...
namespace SRPG
{
  public class UnitListRootWindow : FlowWindowBase
  {
    ...
    private GameObject Param_UnitList
    {
      get
      {
        if ((UnityEngine.Object) this.m_UnitList == (UnityEngine.Object) null)
        {
          if (this.m_Param == null || this.m_Param.unitList == null || (UnityEngine.Object) this.m_Param.listParent == (UnityEngine.Object) null)
          ...
          for (int index = 0; index < componentsInChildren.Length; ++index)
            this.m_ValueList.SetField(componentsInChildren[index].name.IndexOf("tower", StringComparison.OrdinalIgnoreCase) <= 0 ? "node_unit" : "node_tower", componentsInChildren[index].gameObject);
        }
    ...
    private GameObject Param_PieceList
    {
      get
      {
        if ((UnityEngine.Object) this.m_PieceList == (UnityEngine.Object) null)
        {
          if (this.m_Param == null || this.m_Param.pieceList == null || (UnityEngine.Object) this.m_Param.listParent == (UnityEngine.Object) null)
            return (GameObject) null;
          ...
          this.m_ValueList.SetField("node_piece", this.m_PieceList.GetComponentInChildren<ContentNode>(true).gameObject);
        }
    ...
    private GameObject Param_SupportList
    {
      get
      {
        if ((UnityEngine.Object) this.m_SupportList == (UnityEngine.Object) null)
        {
          if (this.m_Param == null || this.m_Param.supportList == null || (UnityEngine.Object) this.m_Param.listParent == (UnityEngine.Object) null)
            return (GameObject) null;
          ...
          this.m_ValueList.SetField("node_support", this.m_SupportList.GetComponentInChildren<ContentNode>(true).gameObject);
        }
    ...
    private void SetupTab(UnitListRootWindow.Tab[] tabs, UnitListRootWindow.Tab start)
    {
      ...
      if (!((UnityEngine.Object) this.m_Tab != (UnityEngine.Object) null))
        return;
      ...
      if (this.m_EditType == UnitListWindow.EditType.SUPPORT)
      {
        ...
        if (data != 0)
        {
          ...
          {
            if ((UnityEngine.Object) infos[index].ev != (UnityEngine.Object) null)
    ...
    private void ShowToolTip(string path, UnitData unit)
    {
      ...
      DataSource.Bind<UnitData>(root, unit, false);
    ...
    {
      if (this.m_ContentType == UnitListRootWindow.ContentType.UNIT || pinId == 100 || (pinId == 101 || pinId == 102) || (pinId == 103 || pinId == 105 || (pinId == 120 || pinId == 104)))
    ...
    private void InitializePieceList()
    {
      ...
      if ((UnityEngine.Object) this.m_PieceController != (UnityEngine.Object) null)
    ...
    private UnitListRootWindow.Content.ItemSource SetupPieceList(UnitListRootWindow.Content.ItemSource source)
    {
      ...
      if (source == null)
      {
        ...
        if ((UnityEngine.Object) this.Param_PieceList != (UnityEngine.Object) null)
        {
          ...
          if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          {
            ...
            this.m_ContentController.gameObject.SetActive(true);
          }
    ...
    private void InitializeSupportList()
    {
      ...
      if ((UnityEngine.Object) this.m_SupportController != (UnityEngine.Object) null)
    ...
    private UnitListRootWindow.Content.ItemSource SetupSupportList(UnitListRootWindow.Content.ItemSource source)
    {
      ...
      if (source == null)
      {
        ...
        if ((UnityEngine.Object) this.Param_SupportList != (UnityEngine.Object) null)
        {
    ...
    private void InitializeUnitList()
    {
      ...
      if ((UnityEngine.Object) this.m_UnitController != (UnityEngine.Object) null)
      {
        Transform transform = this.m_UnitController.transform;
        for (int index = 0; index < transform.childCount; ++index)
          transform.GetChild(index).gameObject.SetActive(false);
        this.m_UnitController.SetWork((object) this);
      }
      this.m_UnitList.SetActive(false);
      RectTransform rectTransform = Array.Find<RectTransform>(this.m_UnitList.GetComponentsInChildren<RectTransform>(), (Predicate<RectTransform>) (mono => mono.name == "accessory"));
      if (!((UnityEngine.Object) rectTransform != (UnityEngine.Object) null))
        return;
      this.m_AccessoryRoot = rectTransform.gameObject;
      ...
      if (units != null)
      {
        ...
        switch (editType)
        {
          ...
          case UnitListWindow.EditType.PARTY_TOWER:
            ...
            if (partyEditData != null && data3 != -1 && data3 < partyEditData.PartyData.MAX_UNIT)
            {
              ...
              for (int slotNo = 0; slotNo < partyEditData.PartyData.MAX_UNIT; ++slotNo)
              {
                ...
                if (unit != null)
                {
                  UnitListWindow.Data data5 = list.data.Find((Predicate<UnitListWindow.Data>) (prop =>
                  {
                    if (prop.unit != null)
              ...
              if (partyEditData.Units[data3] != null && (data3 != 0 || this.GetData<bool>("data_heroOnly", false)))
              {
                ...
                data5.RefreshPartySlotPriority();
                list.data.Insert(0, data5);
              }
              if (data4 != null)
              {
                for (int index1 = 0; index1 < list.data.Count; ++index1)
                {
                  UnitListWindow.Data data5 = list.data[index1];
                  if (data5.unit != null)
                  {
          ...
          case UnitListWindow.EditType.SHOP_EQUIP:
            ...
            {
              UnitListWindow.Data data5 = list.data[index];
              if (data5.unit != null)
    ...
    private UnitListRootWindow.Content.ItemSource SetupUnitList(UnitListRootWindow.Content.ItemSource source)
    {
      ...
      if (source == null)
      {
        ...
        if (data1 != null)
          start = data1.tab;
        if (this.m_EditType == UnitListWindow.EditType.DEFAULT && (UnityEngine.Object) UnitManagementWindow.Instance != (UnityEngine.Object) null && UnitManagementWindow.Instance.GetCurrentTab() != UnitListRootWindow.Tab.NONE)
        ...
        if ((UnityEngine.Object) this.Param_UnitList != (UnityEngine.Object) null)
        {
          ...
          if ((UnityEngine.Object) component1 != (UnityEngine.Object) null)
          {
            SerializeValueBehaviour component2 = component1.GetComponent<SerializeValueBehaviour>();
            if ((UnityEngine.Object) component2 != (UnityEngine.Object) null)
            {
        ...
        if (this.m_EditType == UnitListWindow.EditType.PARTY || this.m_EditType == UnitListWindow.EditType.PARTY_TOWER)
        {
          ...
          if (!((UnityEngine.Object) instance != (UnityEngine.Object) null) || !instance.IsConnectedInRoom() || GlobalVars.SelectedMultiPlayRoomType != JSON_MyPhotonRoomParam.EType.RAID)
      ...
      if (listData != null)
      {
        ...
        if (this.m_EditType == UnitListWindow.EditType.DEFAULT && (UnityEngine.Object) UnitManagementWindow.Instance != (UnityEngine.Object) null)
          UnitManagementWindow.Instance.SetCurrentTab(listData.selectTab);
    ...
    public static class Content
    {
      ...
      public class ItemAccessor
      {
        ...
        public void Bind(ContentNode node)
        {
              ...
              if (this.m_RootWindow != null)
              {
                ...
                switch (editType)
                {
                  ...
                  case UnitListWindow.EditType.PARTY_TOWER:
                    ...
                    if (editType != UnitListWindow.EditType.EQUIP && editType != UnitListWindow.EditType.SHOP_EQUIP)
                    {
                      CanvasGroup component1 = this.m_Node.gameObject.GetComponent<CanvasGroup>();
                      if ((UnityEngine.Object) component1 != (UnityEngine.Object) null)
                      {
                        component1.alpha = !this.m_Param.interactable ? 0.5f : 1f;
                      ...
                      if ((UnityEngine.Object) this.m_SlotLabel != (UnityEngine.Object) null)
                      {
                        Image componentInChildren = this.m_SlotLabel.GetComponentInChildren<Image>();
                        if ((UnityEngine.Object) componentInChildren != (UnityEngine.Object) null)
                        {
                          componentInChildren.color = new Color(1f, 1f, 1f, !this.m_Param.interactable ? 0.5f : 1f);
                          break;
                        }
                        break;
                      }
          ...
          if (!((UnityEngine.Object) this.m_SortBadge != (UnityEngine.Object) null))
            return;
        ...
        public void ForceUpdate()
        {
          if (!((UnityEngine.Object) this.m_Node != (UnityEngine.Object) null))
            return;
          GameParameter.UpdateAll(this.m_Node.gameObject);
        }
        ...
        public void SetSortValue(UnitListSortWindow.SelectType section, int value, string name = "")
        {
          ...
          {
            if ((UnityEngine.Object) this.m_SortBadge.Value != (UnityEngine.Object) null)
            {
            ...
            if ((UnityEngine.Object) this.m_SortBadge.Icon != (UnityEngine.Object) null)
              this.m_SortBadge.Icon.sprite = UnitListSortWindow.GetIcon(section);
            this.m_SortBadge.gameObject.SetActive(true);
            this.m_Value.list.SetActive("lv", false);
          }
          else
          {
            this.m_SortBadge.gameObject.SetActive(false);
