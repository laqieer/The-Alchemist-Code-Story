...
namespace SRPG
{
  ...
  public class UnitGetDetail : MonoBehaviour, IFlowInterface
  {
    ...
    private void Awake()
    {
      if ((UnityEngine.Object) this.mLeaderSkillDetailButton != (UnityEngine.Object) null)
        this.mLeaderSkillDetailButton.onClick.AddListener(new UnityAction(this.OpenLeaderSkillDetail));
    ...
    internal void DummyBind()
    {
      ...
      for (int index = 0; index < this.mJobRoot.Length; ++index)
      {
        ...
        DataSource.Bind<JobParam>(this.mJobRoot[index], data, false);
        this.mJobRoot[index].SetActive(data != null);
      }
      DataSource.Bind<UnitData>(this.gameObject, unitData, false);
    }
    ...
    private void OpenLeaderSkillDetail()
    {
      ...
      DataSource.Bind<UnitData>(this.mLeaderSkillDetail, dataOfClass, false);
    }

    private void RefreshAbilitList()
    {
      if ((UnityEngine.Object) this.mAbilityTemplate == (UnityEngine.Object) null)
        return;
      GameUtility.DestroyGameObjects(this.mAbilits);
      this.mAbilits.Clear();
      UnitData dataOfClass = DataSource.FindDataOfClass<UnitData>(this.gameObject, (UnitData) null);
    ...
    private void RefreshLeaderSkillInfo()
    {
      ...
      {
        this.mLeaderSkillDetailButton.gameObject.SetActive(true);
        this.mLeaderSkillDetailButton.interactable = true;
        this.mLeaderSkillText.text = dataOfClass.LeaderSkill.Name;
      }
      else
      {
        this.mLeaderSkillDetailButton.gameObject.SetActive(false);
    ...
    {
      UnitData dataOfClass = DataSource.FindDataOfClass<UnitData>(this.gameObject, (UnitData) null);
      if (dataOfClass == null || (UnityEngine.Object) this.mPreviewParent == (UnityEngine.Object) null)
        return;
      GameUtility.DestroyGameObjects<UnitPreview>(this.mPreviewControllers);
    ...
    private IEnumerator UpdateFadeUnitImage()
    {
      ...
      return (IEnumerator) new UnitGetDetail.\u003CUpdateFadeUnitImage\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitGetDetail.\u003CRefreshUnitImage\u003Ec__Iterator1() { \u0024this = this };
    }
  }
}
