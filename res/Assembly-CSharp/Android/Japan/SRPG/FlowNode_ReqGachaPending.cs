...
namespace SRPG
{
  ...
  public class FlowNode_ReqGachaPending : FlowNode_Network
  {
    ...
    {
      FlowNode_ExecGacha2 component = this.GetComponent<FlowNode_ExecGacha2>();
    ...
    private IEnumerator AsyncGachaResultData(List<GachaDropData> drops)
    {
      ...
      return (IEnumerator) new FlowNode_ReqGachaPending.\u003CAsyncGachaResultData\u003Ec__Iterator0() { drops = drops, \u0024this = this };
    }
  }
}
