...
namespace SRPG
{
  ...
  public class GachaResultThumbnailWindow : MonoBehaviour, IFlowInterface
  {
    ...
    public void Activated(int pinID)
    {
      ...
      {
        if (!this.m_inialize || !((UnityEngine.Object) this.m_Thumbnail != (UnityEngine.Object) null))
          return;
      ...
      else if (pinID == this.IN_ONEMORE_GACHA)
      {
        this.m_inialize = false;
        this.m_FinishedBonusEffect = false;
        if ((UnityEngine.Object) this.m_Thumbnail != (UnityEngine.Object) null)
    ...
    private void Refresh()
    {
      ...
      if ((UnityEngine.Object) this.CautionText != (UnityEngine.Object) null)
    ...
    private void Initalize()
    {
      ...
      else
      {
        ...
        GachaRequestParam dataOfClass = DataSource.FindDataOfClass<GachaRequestParam>(this.gameObject, (GachaRequestParam) null);
        if (dataOfClass != null)
        ...
        if ((UnityEngine.Object) this.m_OnemoreBtn != (UnityEngine.Object) null)
        {
          this.RefreshGachaCostObject(this.m_OnemoreBtn.gameObject);
          this.m_OnemoreBtn.gameObject.SetActive(GachaResultData.UseOneMore && !GachaResultData.IsRedrawGacha);
        }
        if ((UnityEngine.Object) this.m_BonusBtn != (UnityEngine.Object) null)
          this.m_BonusBtn.gameObject.SetActive(GachaResultData.dropMails != null && GachaResultData.dropMails.Length > 0);
        if ((UnityEngine.Object) this.m_RedrawBtn != (UnityEngine.Object) null)
        {
          SerializeValueBehaviour component = this.m_RedrawBtn.GetComponent<SerializeValueBehaviour>();
          ...
          this.m_RedrawBtn.gameObject.SetActive(GachaResultData.IsRedrawGacha);
          this.m_RedrawBtn.interactable = GachaResultData.IsPending && GachaResultData.RedrawRest > 0;
        }
        if ((UnityEngine.Object) this.m_DefaultBtn != (UnityEngine.Object) null)
        {
          SerializeValueBehaviour component = this.m_DefaultBtn.GetComponent<SerializeValueBehaviour>();
          if ((UnityEngine.Object) component != (UnityEngine.Object) null)
    ...
    {
      SerializeValueBehaviour component = this.gameObject.GetComponent<SerializeValueBehaviour>();
      if (!((UnityEngine.Object) component != (UnityEngine.Object) null))
        return;
      if ((UnityEngine.Object) this.m_Thumbnail == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) this.m_UnitDetail == (UnityEngine.Object) null)
      {
    ...
    {
      if ((UnityEngine.Object) this.BlockTemplate == (UnityEngine.Object) null)
      {
      ...
      else
      {
        ...
        if (!((UnityEngine.Object) this.m_ResultBlock == (UnityEngine.Object) null))
          return;
    ...
    {
      if (_drops == null || _drops.Length < 0 || (UnityEngine.Object) _block == (UnityEngine.Object) null)
        return;
      ...
      if ((UnityEngine.Object) component1 != (UnityEngine.Object) null)
      {
        ...
        for (int index1 = 0; index1 < length; ++index1)
        {
          ...
          if (drop != null)
          {
            ...
            gameObject2.GetComponent<Animator>().enabled = _is_anim;
            SerializeValueBehaviour component2 = gameObject2.GetComponent<SerializeValueBehaviour>();
            if (!((UnityEngine.Object) component2 == (UnityEngine.Object) null))
            {
              ...
              if (drop.type == GachaDropData.Type.Unit)
              {
                ...
                DataSource.Bind<UnitData>(gameObject3, this.CreateUnitData(drop.unit), false);
              ...
              else if (drop.type == GachaDropData.Type.Item)
              {
                ...
                DataSource.Bind<ItemData>(gameObject3, this.CreateItemData(drop.item, drop.num), false);
                ItemIcon component3 = gameObject3.GetComponent<ItemIcon>();
              ...
              else if (drop.type == GachaDropData.Type.Artifact)
              {
                ...
                DataSource.Bind<ArtifactData>(gameObject3, this.CreateArtifactData(drop.artifact, drop.Rare), false);
              ...
              else if (drop.type == GachaDropData.Type.ConceptCard)
              {
                ...
                ConceptCardIcon component3 = gameObject3.GetComponent<ConceptCardIcon>();
                if ((UnityEngine.Object) component3 != (UnityEngine.Object) null)
                {
                  component3.Setup(cardDataForDisplay);
                  SerializeValueBehaviour component4 = gameObject3.GetComponent<SerializeValueBehaviour>();
                  if ((UnityEngine.Object) component4 != (UnityEngine.Object) null)
                  {
                    ...
                    if ((UnityEngine.Object) gameObject4 != (UnityEngine.Object) null)
                    {
                      ...
                      DataSource.Bind<UnitData>(gameObject4, data, false);
              ...
              SerializeValueBehaviour component5 = gameObject3.GetComponent<SerializeValueBehaviour>();
              ...
              ButtonEvent component6 = gameObject3.GetComponent<ButtonEvent>();
      ...
      SerializeValueBehaviour component7 = this.gameObject.GetComponent<SerializeValueBehaviour>();
    ...
    private IEnumerator ShowBonus(bool _is_anim = true)
    {
      ...
      return (IEnumerator) new GachaResultThumbnailWindow.\u003CShowBonus\u003Ec__Iterator0() { _is_anim = _is_anim, \u0024this = this };
    }
    ...
    {
      if (_param == null || !((UnityEngine.Object) this.DetailRoot != (UnityEngine.Object) null))
        return false;
      DataSource.Bind<ItemParam>(this.DetailRoot, (ItemParam) null, false);
      DataSource.Bind<ItemData>(this.DetailRoot, (ItemData) null, false);
      DataSource.Bind<ItemParam>(this.DetailRoot, _param, false);
      DataSource.Bind<ItemData>(this.DetailRoot, MonoSingleton<GameManager>.Instance.Player.FindItemDataByItemID(_param.iname), false);
      return true;
    }

    private bool SelectArtifact(ArtifactData _data)
    {
      if (_data == null || !((UnityEngine.Object) this.DetailRoot != (UnityEngine.Object) null))
        return false;
      DataSource.Bind<ArtifactData>(this.DetailRoot, (ArtifactData) null, false);
      DataSource.Bind<ArtifactData>(this.DetailRoot, _data, false);
      return true;
    }
    ...
    {
      if (!((UnityEngine.Object) this.ButtonList != (UnityEngine.Object) null))
        return;
      if ((UnityEngine.Object) this.m_DefaultBtn == (UnityEngine.Object) null)
      {
    ...
    {
      if ((UnityEngine.Object) this.m_RedrawBtn != (UnityEngine.Object) null)
        this.m_RedrawBtn.interactable = !_active ? _active : GachaResultData.IsPending && GachaResultData.RedrawRest > 0;
      if ((UnityEngine.Object) this.m_OnemoreBtn != (UnityEngine.Object) null)
      {
        bool flag = _active;
        ...
        this.m_OnemoreBtn.interactable = flag;
      }
      if ((UnityEngine.Object) this.m_BonusBtn != (UnityEngine.Object) null)
        this.m_BonusBtn.interactable = _active;
      if (!((UnityEngine.Object) this.m_DefaultBtn != (UnityEngine.Object) null))
        return;
      this.m_DefaultBtn.interactable = _active;
    }
