...
namespace SRPG
{
  public class UnitParam
  {
    ...
    {
      return this.flag.Is(4);
    }

    public bool IsInspiration()
    {
      return this.flag.Is(5);
    }
    ...
    public bool IsNormalSize
    {
      get
      {
        return this.sw == (byte) 1 && this.sh == (byte) 1;
      }
    }
    ...
    public class Status
    {
      ...
      public void SetEnchentParamMax(JSON_UnitParam json)
      {
        ...
        this.enchant_resist.side_attack = (OShort) json.mras;
        this.enchant_resist.back_attack = (OShort) json.mrab;
        this.enchant_resist.obst_reaction = (OShort) json.mror;
      }

      private bool IsExistEnchentParamMax(JSON_UnitParam json)
      {
        return json.mrpo != 0 || json.mrpa != 0 || (json.mrst != 0 || json.mrsl != 0) || (json.mrch != 0 || json.mrsn != 0 || (json.mrbl != 0 || json.mrns != 0)) || (json.mrnm != 0 || json.mrna != 0 || (json.mrzo != 0 || json.mrde != 0) || (json.mrkn != 0 || json.mrdf != 0 || (json.mrbe != 0 || json.mrcs != 0))) || (json.mrcu != 0 || json.mrcd != 0 || (json.mrdo != 0 || json.mrra != 0) || (json.mrsa != 0 || json.mraa != 0 || (json.mrdc != 0 || json.mric != 0)) || (json.mras != 0 || json.mrab != 0 || json.mror != 0));
      }
