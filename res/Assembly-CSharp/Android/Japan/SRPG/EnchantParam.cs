...
namespace SRPG
{
  public class EnchantParam
  {
    ...
    public static readonly ParamTypes[] ConvertAssistParamTypes = new ParamTypes[40]{ ParamTypes.Assist_Poison, ParamTypes.Assist_Paralysed, ParamTypes.Assist_Stun, ParamTypes.Assist_Sleep, ParamTypes.Assist_Charm, ParamTypes.Assist_Stone, ParamTypes.Assist_Blind, ParamTypes.Assist_DisableSkill, ParamTypes.Assist_DisableMove, ParamTypes.Assist_DisableAttack, ParamTypes.Assist_Zombie, ParamTypes.Assist_DeathSentence, ParamTypes.Assist_Berserk, ParamTypes.Assist_Knockback, ParamTypes.Assist_ResistBuff, ParamTypes.Assist_ResistDebuff, ParamTypes.Assist_Stun, ParamTypes.Assist_Fast, ParamTypes.Assist_Slow, ParamTypes.Assist_AutoHeal, ParamTypes.Assist_Donsoku, ParamTypes.Assist_Rage, ParamTypes.Assist_GoodSleep, ParamTypes.Assist_AutoJewel, ParamTypes.Assist_DisableHeal, ParamTypes.Assist_SingleAttack, ParamTypes.Assist_AreaAttack, ParamTypes.Assist_DecCT, ParamTypes.Assist_IncCT, ParamTypes.Assist_ESA_Fire, ParamTypes.Assist_ESA_Water, ParamTypes.Assist_ESA_Wind, ParamTypes.Assist_ESA_Thunder, ParamTypes.Assist_ESA_Shine, ParamTypes.Assist_ESA_Dark, ParamTypes.Assist_MaxDamageHp, ParamTypes.Assist_MaxDamageMp, ParamTypes.Assist_SideAttack, ParamTypes.Assist_BackAttack, ParamTypes.Assist_ObstReaction };
    public static readonly ParamTypes[] ConvertResistParamTypes = new ParamTypes[40]{ ParamTypes.Resist_Poison, ParamTypes.Resist_Paralysed, ParamTypes.Resist_Stun, ParamTypes.Resist_Sleep, ParamTypes.Resist_Charm, ParamTypes.Resist_Stone, ParamTypes.Resist_Blind, ParamTypes.Resist_DisableSkill, ParamTypes.Resist_DisableMove, ParamTypes.Resist_DisableAttack, ParamTypes.Resist_Zombie, ParamTypes.Resist_DeathSentence, ParamTypes.Resist_Berserk, ParamTypes.Resist_Knockback, ParamTypes.Resist_ResistBuff, ParamTypes.Resist_ResistDebuff, ParamTypes.Resist_Stun, ParamTypes.Resist_Fast, ParamTypes.Resist_Slow, ParamTypes.Resist_AutoHeal, ParamTypes.Resist_Donsoku, ParamTypes.Resist_Rage, ParamTypes.Resist_GoodSleep, ParamTypes.Resist_AutoJewel, ParamTypes.Resist_DisableHeal, ParamTypes.Resist_SingleAttack, ParamTypes.Resist_AreaAttack, ParamTypes.Resist_DecCT, ParamTypes.Resist_IncCT, ParamTypes.Resist_ESA_Fire, ParamTypes.Resist_ESA_Water, ParamTypes.Resist_ESA_Wind, ParamTypes.Resist_ESA_Thunder, ParamTypes.Resist_ESA_Shine, ParamTypes.Resist_ESA_Dark, ParamTypes.Resist_MaxDamageHp, ParamTypes.Resist_MaxDamageMp, ParamTypes.Resist_SideAttack, ParamTypes.Resist_BackAttack, ParamTypes.Resist_ObstReaction };
    ...
    public OShort side_attack
    {
      get
      {
        return this.values[37];
      }
      set
      {
        this.values[37] = value;
      }
    }

    public OShort back_attack
    {
      get
      {
        return this.values[38];
      }
      set
      {
        this.values[38] = value;
      }
    }

    public OShort obst_reaction
    {
      get
      {
        return this.values[39];
      }
      set
      {
        this.values[39] = value;
      }
    }
