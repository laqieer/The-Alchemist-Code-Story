  ...
  public class VersusDraftReady : MonoBehaviour, IFlowInterface
  {
    ...
    private class State_UnitPlacing : State<VersusDraftReady>
    {
      ...
      public override void Update(VersusDraftReady self)
      {
        ...
        if ((double) this.mTimer < (double) self.mPlaceSec)
          return;
        this.mEnable = false;
        MultiPlayVersusReady component = self.GetComponent<MultiPlayVersusReady>();
        if ((UnityEngine.Object) component == (UnityEngine.Object) null || (UnityEngine.Object) component.GoButton == (UnityEngine.Object) null || component.GoButton.onClick == null)
          return;
        component.GoButton.onClick.Invoke();
      }
    }
    ...
    private class State_UpdatePlayer : State<VersusDraftReady>
    {
      public override void Begin(VersusDraftReady self)
      {
        ...
        draftMessageData.h = 4;
        draftMessageData.pidx = myPlayerIndex;
        draftMessageData.pid = num1;
        draftMessageData.b = 100 + myPlayerIndex;
        byte[] msg = GameUtility.Object2Binary<VersusDraftList.VersusDraftMessageData>(draftMessageData);
