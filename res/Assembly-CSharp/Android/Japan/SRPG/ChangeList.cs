    ...
    public void SetData(ChangeListData[] src)
    {
      ...
      for (int index1 = 0; index1 < src.Length; ++index1)
      {
        ...
        if (index2 != -1)
        {
          ...
          if (changeListData.MetaData != null && changeListData.MetaDataType != null)
            DataSource.Bind(changeListItem.gameObject, changeListData.MetaDataType, changeListData.MetaData, false);
