...
namespace SRPG
{
  public class EventDialogBubble : MonoBehaviour
  {
    ...
    public static void DiscardAll()
    {
      ...
      for (int index = EventDialogBubble.Instances.Count - 1; index >= 0; --index)
      {
        if (!EventDialogBubble.Instances[index].gameObject.activeInHierarchy)
          UnityEngine.Object.Destroy((UnityEngine.Object) EventDialogBubble.Instances[index].gameObject);
        else
    ...
    private void UpdatePortrait()
    {
      if ((UnityEngine.Object) this.PortraitFront == (UnityEngine.Object) null || (UnityEngine.Object) this.PortraitSet == (UnityEngine.Object) null && (UnityEngine.Object) this.CustomEmotion == (UnityEngine.Object) null)
        return;
      if ((UnityEngine.Object) this.CustomEmotion == (UnityEngine.Object) null)
