  ...
  public class AppealItemQuest : AppealItemBase
  {
    ...
    protected override void Destroy()
    {
      ...
      foreach (string key in this.mCacheAppealSprites.Keys)
        UnityEngine.Resources.UnloadAsset((UnityEngine.Object) this.mCacheAppealSprites[key]);
    ...
    private IEnumerator LoadAppealResources()
    {
      ...
      return (IEnumerator) new AppealItemQuest.\u003CLoadAppealResources\u003Ec__Iterator0() { \u0024this = this };
    }
  }
}
