...
namespace SRPG
{
  ...
  {
    private static string[] mStrAtkDetails = new string[10]{ string.Empty, "quest.BUD_AD_SLASH", "quest.BUD_AD_STAB", "quest.BUD_AD_BLOW", "quest.BUD_AD_SHOT", "quest.BUD_AD_MAGIC", "quest.BUD_AD_JUMP", "quest.BUD_AD_ALL_HIT", "quest.BUD_AD_ALL_AVOID", "quest.BUD_AD_ALL_RECOVER" };
