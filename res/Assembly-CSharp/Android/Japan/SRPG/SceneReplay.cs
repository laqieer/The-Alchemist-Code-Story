...
namespace SRPG
{
  ...
  public class SceneReplay : Scene, IFlowInterface
  {
    ...
    private IEnumerator StartQuestAsync(string questID)
    {
      ...
      return (IEnumerator) new SceneReplay.\u003CStartQuestAsync\u003Ec__Iterator0() { questID = questID, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneReplay.\u003CDownloadQuestAsync\u003Ec__Iterator1() { quest = quest, \u0024this = this };
    }
    ...
    private class State_Replay : State<SceneReplay>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneReplay.State_Replay.\u003CExec\u003Ec__Iterator0() { \u0024this = this };
      }
    }
