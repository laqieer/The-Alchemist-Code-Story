...
namespace SRPG
{
  ...
  public class FlowNode_ReqFriendSupport : FlowNode_Network
  {
    ...
    public override void OnActivate(int pinID)
    {
      ...
      {
        this.m_Api = (FlowNode_ReqFriendSupport.ApiBase) new FlowNode_ReqFriendSupport.Api_FriendSupport(this, !((UnityEngine.Object) this.m_SerializeValue != (UnityEngine.Object) null) ? new SerializeValueList() : this.m_SerializeValue.list);
        if (this.m_Api == null)
          return;
        this.m_Api.Start();
        this.enabled = true;
    ...
    public class Api_FriendSupport : FlowNode_ReqFriendSupport.ApiBase
    {
      ...
      public override void Complete(WWWResult www)
      {
        ...
        else
        {
          ...
          WebAPI.JSON_BodyResponse<FlowNode_ReqFriendSupport.Api_FriendSupport.Json> jsonBodyResponse = JsonUtility.FromJson<WebAPI.JSON_BodyResponse<FlowNode_ReqFriendSupport.Api_FriendSupport.Json>>(www.text);
          ...
          if (jsonBodyResponse.body != null && jsonBodyResponse.body.unit != null)
          {
            ...
            if (jsonBodyResponse.body.guild != null)
            {
              ViewGuildData viewGuildData = new ViewGuildData();
              viewGuildData.Deserialize(jsonBodyResponse.body.guild);
              this.m_ValueList.SetObject(GuildSVB_Key.VIEW_GUILD, (object) viewGuildData);
            }
