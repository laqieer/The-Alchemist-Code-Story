...
namespace SRPG
{
  public class SkillData
  {
    ...
    {
      if (this.SkillParam != null)
        return this.SkillParam.IsDynamicTransformSkill();
      return false;
    }
    ...
    public BuffEffect GetBuffEffect(SkillEffectTargets target = SkillEffectTargets.Target)
    {
      ...
      if (target == SkillEffectTargets.Self)
    ...
    public SkillData CreateDeriveSkill(SkillDeriveParam skillDeriveParam)
    {
      ...
      skillData.Setup(skillDeriveParam.DeriveSkillIname, (int) this.mRank, (int) this.mRankCap, (MasterParam) null);
    ...
    {
      if (this.SkillParam != null && !string.IsNullOrEmpty(this.SkillParam.DependStateSpcEffUId) && this.mDependStateSpcEffParam == null)
        this.mDependStateSpcEffParam = MonoSingleton<GameManager>.Instance.MasterParam.GetDependStateSpcEffParam(this.SkillParam.DependStateSpcEffUId);
