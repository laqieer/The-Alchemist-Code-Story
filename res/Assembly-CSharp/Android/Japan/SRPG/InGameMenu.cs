  ...
  public class InGameMenu : MonoBehaviour, IFlowInterface
  {
    ...
    private void Start()
    {
      ...
      if ((UnityEngine.Object) instance != (UnityEngine.Object) null)
      {
        ...
        if (questParam.type == QuestTypes.Multi && (UnityEngine.Object) this.MultiHiSpeedParent != (UnityEngine.Object) null)
    ...
    {
      SceneBattle instance = SceneBattle.Instance;
      if (!(bool) ((UnityEngine.Object) instance) || instance.CurrentQuest == null || !instance.CurrentQuest.CheckAllowedAutoBattle())
        return;
      if (is_active)
      {
        if ((UnityEngine.Object) this.AutoPlayOn != (UnityEngine.Object) null)
