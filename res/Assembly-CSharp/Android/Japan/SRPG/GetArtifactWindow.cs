  ...
  public class GetArtifactWindow : SRPG_FixedList, IFlowInterface
  {
    ...
    public override void BindData()
    {
      for (int index1 = 0; index1 < this.mItems.Count; ++index1)
      {
        ...
        {
          DataSource.Bind(this.mItems[index1], this.mDataType, this.Data[index2], false);
          DataSource.Bind(this.mItems[index1], typeof (ArtifactSelectListItemData), (object) this.mArtifactListItem[index2], false);
