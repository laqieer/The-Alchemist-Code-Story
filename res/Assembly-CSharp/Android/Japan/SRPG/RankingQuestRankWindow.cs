  ...
  public class RankingQuestRankWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private void SetOwnRankingData(RankingQuestUserData ownData)
    {
      ...
      if (flag)
      {
        ...
        DataSource.Bind<RankingQuestUserData>(this.m_OwnRankBanner, ownData, false);
        DataSource.Bind<UnitData>(this.m_OwnRankBanner, ownData.m_UnitData, false);
    ...
    public void OnItemSelect(GameObject go)
    {
      ...
      DataSource.Bind<RankingQuestUserData>(this.m_RootObject, dataOfClass, false);
      DataSource.Bind<ReqQuestRankingPartyData>(this.m_RootObject, data, false);
