...
namespace SRPG
{
  public class CharacterQuestBanner : MonoBehaviour, IGameParameter
  {
    ...
    private void DataBind(UnitData unitData, UnitParam unitParam, GameObject target)
    {
      if (unitData != null)
      {
        DataSource.Bind<UnitParam>(target, (UnitParam) null, false);
        DataSource.Bind<UnitData>(target, unitData, false);
      }
      else
      {
        if (unitParam == null)
          return;
        DataSource.Bind<UnitData>(target, (UnitData) null, false);
