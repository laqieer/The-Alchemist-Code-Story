...
namespace SRPG
{
  ...
  public class BoxGachaResult : FlowNodePersistent
  {
    ...
    {
      if (!((UnityEngine.Object) this.m_TemplateItem != (UnityEngine.Object) null))
        return;
    ...
    private IEnumerator Initalize()
    {
      ...
      return (IEnumerator) new BoxGachaResult.\u003CInitalize\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BoxGachaResult.\u003CIconAnimation\u003Ec__Iterator1() { \u0024this = this };
    }
    ...
    private void IconAnimSkip()
    {
      ...
      else
      {
        if (this.m_IconList != null)
        {
          ...
          {
            string name = this.m_IconAnimSkipTrigger;
            SerializeValueBehaviour component1 = this.m_IconList[index].GetComponent<SerializeValueBehaviour>();
            if ((UnityEngine.Object) component1 != (UnityEngine.Object) null)
              name = !component1.list.GetBool("is_pickup") ? this.m_IconAnimSkipTrigger : this.m_IconAnimPickupSkipTrigger;
