...
namespace SRPG
{
  ...
  public class MailWindow : MonoBehaviour, IFlowInterface
  {
    ...
    private IEnumerator CoroutineActivateOutputLinks(int pinID)
    {
      ...
      return (IEnumerator) new MailWindow.\u003CCoroutineActivateOutputLinks\u003Ec__Iterator0() { pinID = pinID, \u0024this = this };
    }
    ...
    private void UpdateUI()
    {
      ...
      this.nextPageButton.interactable = this.currentTabData.HasNext();
      this.prevPageButton.interactable = this.currentTabData.HasPrev();
