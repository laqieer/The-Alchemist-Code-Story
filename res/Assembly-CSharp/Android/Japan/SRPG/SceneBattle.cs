...
namespace SRPG
{
  ...
  public class SceneBattle : Scene
  {
    ...
    public GameObject CurrentScene
    {
      get
      {
        if ((bool) ((UnityEngine.Object) this.mTacticsSceneRoot))
          return this.mTacticsSceneRoot.gameObject;
    ...
    private void ToggleBattleScene(bool visible, string sceneName = null)
    {
      if (visible)
      {
        ...
        if (!string.IsNullOrEmpty(sceneName))
        {
          ...
          {
            if (this.mBattleScenes[index].name == sceneName)
            {
        ...
        if ((UnityEngine.Object) battleSceneSettings == (UnityEngine.Object) null)
          battleSceneSettings = this.mDefaultBattleScene;
        this.mBattleSceneRoot = battleSceneSettings;
      }
      if ((UnityEngine.Object) this.mBattleSceneRoot != (UnityEngine.Object) null)
        this.mBattleSceneRoot.gameObject.SetActive(visible);
      if ((UnityEngine.Object) this.mTacticsSceneRoot != (UnityEngine.Object) null)
        this.mTacticsSceneRoot.gameObject.SetActive(!visible);
    ...
    {
      if (!((UnityEngine.Object) SceneBattle.Instance == (UnityEngine.Object) this))
        return;
    ...
    {
      if ((bool) ((UnityEngine.Object) this.GoResultBg))
      ...
      if ((UnityEngine.Object) this.mNavigation != (UnityEngine.Object) null)
      {
    ...
    private void OnLoadTacticsScene(GameObject root)
    {
      ...
      GameUtility.DeactivateActiveChildComponents<UnityEngine.Camera>((Component) component1);
      ...
      for (int index1 = 0; index1 < root.transform.childCount; ++index1)
      {
        ...
        if (child1.name == "light")
        {
          for (int index2 = 0; index2 < child1.childCount; ++index2)
          {
            Transform child2 = child1.GetChild(index2);
            if (child2.name != "Ambient Light")
              UnityEngine.Object.Destroy((UnityEngine.Object) child2.gameObject);
          }
          break;
        }
      }
      RenderPipeline component2 = UnityEngine.Camera.main.GetComponent<RenderPipeline>();
    ...
    private void FocusUnit(Unit unit)
    {
      ...
      ObjectAnimator.Get((Component) UnityEngine.Camera.main).AnimateTo(unitController.transform.position + instance.Quest.UnitCamera.transform.position, instance.Quest.UnitCamera.transform.rotation, 0.3f, ObjectAnimator.CurveType.EaseOut);
    }
    ...
    {
      RaycastHit hitInfo;
      if (Physics.Raycast(start + Vector3.up * 10f, -Vector3.up, out hitInfo))
    ...
    private TacticsUnitController FindClosestUnitController(Vector3 position, float maxDistance)
    {
      ...
      for (int index = 0; index < this.mTacticsUnits.Count; ++index)
      {
        ...
        if (!((UnityEngine.Object) mTacticsUnit == (UnityEngine.Object) null))
        {
          if ((UnityEngine.Object) tacticsUnitController != (UnityEngine.Object) null && this.CalcCoord(tacticsUnitController.CenterPosition) == this.CalcCoord(mTacticsUnit.CenterPosition) && !mTacticsUnit.Unit.IsGimmick)
          {
            tacticsUnitController = mTacticsUnit;
          }
          else
          {
            float num2 = GameUtility.CalcDistance2D(mTacticsUnit.transform.position, position);
    ...
    {
      return new IntVector2(Mathf.FloorToInt(position.x), Mathf.FloorToInt(position.z - this.mTacticsSceneRoot.transform.position.z));
    }
    ...
    private IEnumerator DownloadNextQuestAsync()
    {
      ...
      return (IEnumerator) new SceneBattle.\u003CDownloadNextQuestAsync\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CDownloadQuestAsync\u003Ec__Iterator1() { quest = quest, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CStartQuestAsync\u003Ec__Iterator2() { questID = questID, jsonBtl = jsonBtl, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CLoadMapAsync\u003Ec__Iterator3() { \u0024this = this };
    }
    ...
    private Unit RayPickUnit(Vector2 pos)
    {
      ...
      Vector3 position1 = main.transform.position;
      ...
      for (int index = 0; index < this.mBattle.Units.Count; ++index)
      {
        ...
        if (!((UnityEngine.Object) unitController == (UnityEngine.Object) null))
        {
          Vector3 position2 = GameUtility.DeformPosition(unitController.transform.position, position1.z);
          Vector3 screenPoint = main.WorldToScreenPoint(position2);
          Vector2 vector2 = pos;
          vector2.x -= screenPoint.x;
          vector2.y -= screenPoint.y;
          if ((double) vector2.magnitude <= (double) num1 && (double) screenPoint.z < (double) num2)
          {
            unit1 = unit2;
            num2 = screenPoint.z;
          }
    ...
    public void HideUnitCursor(TacticsUnitController controller)
    {
      if ((UnityEngine.Object) controller != (UnityEngine.Object) null)
        controller.HideCursor(false);
      for (int index = 0; index < this.mBattle.Units.Count; ++index)
      {
        Unit unit = this.mBattle.Units[index];
        if ((!((UnityEngine.Object) controller != (UnityEngine.Object) null) || unit != controller.Unit) && !unit.IsNormalSize)
        {
          TacticsUnitController unitController = this.FindUnitController(unit);
    ...
    {
      if ((UnityEngine.Object) this.mBattleUI != (UnityEngine.Object) null)
      {
        this.mBattleUI.OnInputTimeLimit();
        if ((UnityEngine.Object) this.mBattleUI.TargetMain != (UnityEngine.Object) null)
          this.mBattleUI.TargetMain.ForceClose(true);
        if ((UnityEngine.Object) this.mBattleUI.TargetSub != (UnityEngine.Object) null)
          this.mBattleUI.TargetSub.ForceClose(true);
        if ((UnityEngine.Object) this.mBattleUI.TargetObjectSub != (UnityEngine.Object) null)
          this.mBattleUI.TargetObjectSub.ForceClose(true);
        if ((UnityEngine.Object) this.mBattleUI.TargetTrickSub != (UnityEngine.Object) null)
          this.mBattleUI.TargetTrickSub.ForceClose(true);
        if ((UnityEngine.Object) this.mBattleUI.CommandWindow != (UnityEngine.Object) null)
          this.mBattleUI.CommandWindow.OnCommandSelect = (UnitCommands.CommandEvent) null;
        if ((UnityEngine.Object) this.mBattleUI.ItemWindow != (UnityEngine.Object) null)
          this.mBattleUI.ItemWindow.OnSelectItem = (BattleInventory.SelectEvent) null;
        if ((UnityEngine.Object) this.mBattleUI.SkillWindow != (UnityEngine.Object) null)
          this.mBattleUI.SkillWindow.OnSelectSkill = (UnitAbilitySkillList.SelectSkillEvent) null;
        if ((UnityEngine.Object) this.mSkillTargetWindow != (UnityEngine.Object) null)
          this.mSkillTargetWindow.ForceHide();
        if (this.mTacticsUnits != null)
        {
          for (int index = 0; index < this.mTacticsUnits.Count; ++index)
          {
            if (!((UnityEngine.Object) this.mTacticsUnits[index] == (UnityEngine.Object) null))
    ...
    private void HighlightTargetGrid(Unit current, int range, int difffloor)
    {
      ...
      this.mTacticsSceneRoot.ShowGridLayer(0, grid2, (Color32) GameSettings.Instance.Colors.AttackArea, false);
    }
    ...
    private void InternalShowCastSkill()
    {
      ...
      Color32 chargeAreaGrn = (Color32) GameSettings.Instance.Colors.ChargeAreaGrn;
      Color32 chargeAreaRed = (Color32) GameSettings.Instance.Colors.ChargeAreaRed;
          ...
          if (x < grid1.w)
          {
            for (int y = 0; y < scopeGridMap.h; ++y)
            {
              if (y < grid1.h && scopeGridMap.get(x, y))
              {
                ...
                if (flag)
                  grid1.set(x, y, chargeAreaGrn);
                else
                  grid2.set(x, y, chargeAreaRed);
              }
            }
          }
        }
    ...
    private Unit FindTarget(Unit current, SkillData skill, GridMap<bool> map, EUnitSide targetSide)
    {
      ...
      {
        Unit unit2 = this.mBattle.Units[index];
        if ((!unit2.IsGimmick || unit2.IsBreakObj) && (!unit2.IsDead && unit2.IsEntry) && (!unit2.IsSub && (unit2.Side == targetSide || this.mBattle.IsTargetBreakUnit(current, unit2, skill))) && (map.isValid(unit2.x, unit2.y) && this.mBattle.IsTargetUnitForGridMap(unit2, map)))
        {
          int x = unit2.x;
          int y = unit2.y;
          Vector2 rhs = new Vector2((float) (x - current.x), (float) (y - current.y));
          float magnitude = rhs.magnitude;
          rhs.Normalize();
          float num2 = Vector2.Dot(lhs, rhs) - 1f - magnitude;
    ...
    private void GotoSelectAttackTarget()
    {
      ...
      for (int index = 0; index < attackTargetsAi.Count; ++index)
      {
        if (currentUnit != attackTargetsAi[index])
        {
          ...
          Vector2 rhs = new Vector2((float) (x2 - currentUnit.x), (float) (y2 - currentUnit.y));
          float magnitude = rhs.magnitude;
          rhs.Normalize();
          float num2 = Vector2.Dot(lhs, rhs) - 1f - magnitude;
          if ((double) num1 < (double) num2)
    ...
    private bool ApplyUnitMovement(bool test = false)
    {
      Unit currentUnit = this.mBattle.CurrentUnit;
      TacticsUnitController unitController = this.FindUnitController(currentUnit);
      if ((UnityEngine.Object) unitController != (UnityEngine.Object) null && !currentUnit.IsUnitFlag(EUnitFlag.Moved))
      {
        IntVector2 intVector2 = this.CalcCoord(unitController.CenterPosition);
    ...
    private void ResetUnitPosition()
    {
      ...
      unitController.transform.position = this.CalcGridCenter(unitGridPosition);
    }
    ...
    {
      pos.z += this.mTacticsSceneRoot.transform.position.z;
      return pos;
    }
        ...
        for (int y = 0; y < accessMap.h; ++y)
        {
          if (accessMap.get(x, y) >= 0)
          {
            ...
            if (this.mCurrentUnitStartX == x && this.mCurrentUnitStartY == y)
              grid.set(x, y, (Color32) instance.Colors.StartGrid);
            else
              grid.set(x, y, (Color32) instance.Colors.WalkableArea);
          }
        }
      }
    ...
    private void GotoMapCommand()
    {
      Unit currentUnit = this.mBattle.CurrentUnit;
      TacticsUnitController unitController = this.FindUnitController(currentUnit);
      if ((UnityEngine.Object) unitController != (UnityEngine.Object) null && unitController.IsJumpCant())
      {
    ...
    private void GotoMapEnd()
    {
      ...
      this.mBattleUI.OnMapEnd();
      if ((UnityEngine.Object) this.mBattleUI_MultiPlay != (UnityEngine.Object) null)
    ...
    {
      if ((UnityEngine.Object) this.mEventScript != (UnityEngine.Object) null)
      {
        switch (this.Battle.GetQuestResult())
        {
          case BattleCore.QuestResult.Win:
            this.mEventSequence = this.mEventScript.OnQuestWin();
            if ((UnityEngine.Object) this.mEventSequence != (UnityEngine.Object) null)
            {
      ...
      else
      {
        ...
        else
        {
          ...
          try
          {
            ...
            {
              MonoSingleton<GameManager>.Instance.RaidBtlEndParam = (ReqRaidBtlEnd.Response) jsonBodyResponse.body;
              if (MonoSingleton<GameManager>.Instance.RaidBtlEndParam != null && MonoSingleton<GameManager>.Instance.RaidBtlEndParam.raid_battle_reward != null)
              {
                RaidRewardData raidRewardData = new RaidRewardData();
                raidRewardData.Deserialize(RaidRewardKind.Beat, MonoSingleton<GameManager>.Instance.RaidBtlEndParam.raid_battle_reward);
                for (int index = 0; index < raidRewardData.Rewards.Length; ++index)
                  this.mBattle.SetGiftReward(raidRewardData.Rewards[index]);
              }
            }
            if (this.mCurrentQuest.type == QuestTypes.GenesisBoss)
            ...
            if (this.mCurrentQuest.IsVersus && !string.IsNullOrEmpty(jsonBodyResponse.body.fu_status))
            {
              ...
              if (photonPlayerParam != null)
                MonoSingleton<GameManager>.Instance.Deserialize(new Json_MultiFuids[1]
                {
                  new Json_MultiFuids()
                  {
    ...
    private void SubmitBattleResult(long btlid, QuestParam quest)
    {
      ...
      else
      {
        ...
        else if (this.Battle.IsRankingQuest && questRecord.result == BattleCore.QuestResult.Win)
        {
          ...
          Network.RequestAPI((WebAPI) new ReqBtlComEnd(btlid, time, result, beats, itemSteals, goldSteals, missions, missions_log, fuid, questRecord.used_items, new Network.ResponseCallback(this.SubmitResultCallback), !isMultiPlay ? BtlEndTypes.com : BtlEndTypes.multi, trophy_progs, bingo_progs, supportData == null ? 0 : (int) supportData.UnitElement, rankingQuestEndParam, false, new bool?(), questRecord), false);
        }
        else if (quest.type == QuestTypes.Raid)
          Network.RequestAPI((WebAPI) new ReqRaidBtlEnd(btlid, result, GlobalVars.CurrentRaidBossId.Get(), this.Battle.Enemys, questRecord.used_items, new Network.ResponseCallback(this.SubmitResultCallback)), false);
        else if (quest.type == QuestTypes.GenesisBoss)
        {
          Network.RequestAPI((WebAPI) new ReqGenesisBossBtlEnd(btlid, result, this.Battle.AllUnits, this.Battle.NpcStartIndex, questRecord.used_items, new Network.ResponseCallback(this.SubmitResultCallback)), false);
        }
        else
        {
    ...
    {
      Network.RequestAPI((WebAPI) new ReqBtlComEnd(btlid, 0, BtlResultTypes.Win, (int[]) null, (int[]) null, (int[]) null, (int[]) null, (int[]) null, (string[]) null, (Dictionary<OString, OInt>) null, new Network.ResponseCallback(this.SubmitResultCallback), BtlEndTypes.com, (string) null, (string) null, 0, (string) null, false, new bool?(), (BattleCore.Record) null), false);
      MonoSingleton<GameManager>.Instance.Player.MarkQuestCleared(this.mCurrentQuest.iname);
    }
    ...
    {
      Transform transform = GameSettings.Instance.Quest.UnitCamera.transform;
      return new SceneBattle.PosRot() { Position = transform.localPosition, Rotation = transform.localRotation };
    }
    ...
    private void GotoPrepareSkill()
    {
      ...
      if (peek != null && peek.skill != null && peek.targets != null)
      {
        ...
        if ((bool) ((UnityEngine.Object) unitController1))
        {
          ...
          foreach (LogSkill.Target target in peek.targets)
          {
            ...
            if ((bool) ((UnityEngine.Object) unitController2))
            {
      ...
      if (!string.IsNullOrEmpty(skill.SkillParam.SkillMotionId) && peek.self != null)
      {
        ...
        if (skillMotionParam != null)
        {
          ...
          if (skillMotion != null)
            this.mSkillMotion = skillMotion;
        }
      }
      if (!this.mBattle.IsSkillDirection)
      {
        if (peek != null && (UnityEngine.Object) this.mEventScript != (UnityEngine.Object) null)
        {
          TacticsUnitController unitController1 = this.FindUnitController(peek.self);
          if ((UnityEngine.Object) unitController1 != (UnityEngine.Object) null && peek.targets != null && peek.targets.Count != 0)
          {
            List<TacticsUnitController> TargetLists = new List<TacticsUnitController>();
            foreach (LogSkill.Target target in peek.targets)
            {
              TacticsUnitController unitController2 = this.FindUnitController(target.target);
              if ((UnityEngine.Object) unitController2 != (UnityEngine.Object) null)
    ...
    private Unit mCollaboTargetUnit
    {
      get
      {
        if ((bool) ((UnityEngine.Object) this.mCollaboTargetTuc))
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CSetWeatherEffect\u003Ec__Iterator4() { wd = wd, \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CStopWeatherEffect\u003Ec__Iterator5() { is_immidiate = is_immidiate, \u0024this = this };
    }
    ...
    private bool IsCameraMoving
    {
      get
      {
        return ObjectAnimator.Get((Component) UnityEngine.Camera.main).isMoving || this.mUpdateCameraPosition && (this.m_TargetCameraPositionInterp || this.m_TargetCameraDistanceInterp);
      }
    }
    ...
    private void InitCamera()
    {
      ...
      this.m_TargetCamera = GameUtility.RequireComponent<TargetCamera>(UnityEngine.Camera.main.gameObject);
    ...
    private void UpdateCameraControl(bool immediate = false)
    {
      ...
      {
        UnityEngine.Camera main = UnityEngine.Camera.main;
        Transform transform = !((UnityEngine.Object) main != (UnityEngine.Object) null) ? (Transform) null : main.transform;
        GameSettings instance = GameSettings.Instance;
        if ((UnityEngine.Object) this.mTacticsSceneRoot != (UnityEngine.Object) null && this.mTacticsSceneRoot.gameObject.activeInHierarchy)
          main.fieldOfView = GameSettings.Instance.GameCamera_TacticsSceneFOV;
        else if ((UnityEngine.Object) this.mBattleSceneRoot != (UnityEngine.Object) null && this.mBattleSceneRoot.gameObject.activeInHierarchy)
        ...
        if (!ObjectAnimator.Get((Component) main).isMoving && this.mUpdateCameraPosition)
        {
          ...
          {
            float t = !immediate ? Time.deltaTime * 8f : 1f;
            float targetCameraDistance = this.m_TargetCameraDistance;
            this.m_TargetCamera.CameraDistance = Mathf.Lerp(this.m_TargetCamera.CameraDistance, targetCameraDistance, t);
          ...
          this.m_TargetCamera.SetPositionYaw(this.m_CameraPosition + Vector3.up * instance.GameCamera_UnitHeightOffset, this.m_CameraAngle);
        }
        this.OnCameraForcus();
      }
    }
    ...
    private bool UpdateCameraRotationTouchMove(bool isEnable, bool immediate)
    {
      ...
      if (isEnable && this.m_AllowCameraRotation && this.IsControlBattleUI(SceneBattle.eMaskBattleUI.CAMERA))
      {
        ...
        if (!this.isNewCamera)
        {
          ...
          {
            float num2 = Mathf.Pow(1f - Mathf.Clamp01((float) -((double) this.m_CameraAngle - (double) this.m_CameraYawMin) / cameraYawSoftLimit), p);
            num1 *= num2;
          }
          else if ((double) this.m_CameraAngle > (double) this.m_CameraYawMax && (double) num1 > 0.0)
          {
            float num2 = Mathf.Pow(1f - Mathf.Clamp01((this.m_CameraAngle - this.m_CameraYawMax) / cameraYawSoftLimit), p);
            num1 *= num2;
          }
          this.m_CameraAngle += num1;
          if (!SRPG_TouchInputModule.IsMultiTouching)
          {
            float t = !immediate ? Time.deltaTime * 10f : 1f;
            if ((double) this.m_CameraAngle < (double) this.m_CameraYawMin)
              this.m_CameraAngle = (double) Mathf.Abs(this.m_CameraAngle - this.m_CameraYawMin) >= 0.00999999977648258 ? Mathf.Lerp(this.m_CameraAngle, this.m_CameraYawMin, t) : this.m_CameraYawMin;
            else if ((double) this.m_CameraAngle > (double) this.m_CameraYawMax)
              this.m_CameraAngle = (double) Mathf.Abs(this.m_CameraAngle - this.m_CameraYawMax) >= 0.00999999977648258 ? Mathf.Lerp(this.m_CameraAngle, this.m_CameraYawMax, t) : this.m_CameraYawMax;
          }
        }
        else
        {
    ...
    private bool UpdateCameraPositionTouchMove(Vector3 xAxis, Vector3 yAxis)
    {
      UnityEngine.Camera main = UnityEngine.Camera.main;
      bool flag = false;
      if (this.m_AllowCameraTranslation && (double) this.mTouchController.Velocity.magnitude > 0.0 && this.IsControlBattleUI(SceneBattle.eMaskBattleUI.CAMERA))
      {
        Vector2 vector2_1 = this.mTouchController.Velocity;
        yAxis.y = 0.0f;
        yAxis.Normalize();
        xAxis.y = 0.0f;
        xAxis.Normalize();
        Vector3 screenPoint = main.WorldToScreenPoint(this.m_CameraPosition);
        Vector2 vector2_2 = (Vector2) (main.WorldToScreenPoint(this.m_CameraPosition + xAxis + yAxis) - screenPoint);
        vector2_1.x /= Mathf.Abs(vector2_2.x);
        vector2_1.y /= Mathf.Abs(vector2_2.y);
        vector2_1 = new Vector2((float) ((double) xAxis.x * (double) vector2_1.x + (double) yAxis.x * (double) vector2_1.y), (float) ((double) xAxis.z * (double) vector2_1.x + (double) yAxis.z * (double) vector2_1.y));
        this.m_CameraPosition.x -= vector2_1.x;
        this.m_CameraPosition.z -= vector2_1.y;
    ...
    private bool UpdateCameraPositionInterp(bool immediate)
    {
      ...
      if (!this.m_TargetCameraPositionInterp)
        return false;
      this.m_CameraPosition = Vector3.Lerp(this.m_CameraPosition, this.m_TargetCameraPosition, t);
      if ((double) (this.m_TargetCameraPosition - this.m_CameraPosition).magnitude <= 0.00999999977648258)
      {
    ...
    private void SetCameraTarget(Component component, bool is_cal_height = false)
    {
      ...
      Vector3 position2 = new Vector3(position1.x, !is_cal_height ? position1.y : this.CalcHeight(position1.x, position1.z), position1.z);
    ...
    private void InterpCameraTarget(Component component)
    {
      if ((UnityEngine.Object) component == (UnityEngine.Object) null)
        return;
      Vector3 position1 = component.transform.position;
      Vector3 position2 = new Vector3(position1.x, position1.y, position1.z);
      if (component is TacticsUnitController)
      {
        TacticsUnitController tacticsUnitController = component as TacticsUnitController;
        if (tacticsUnitController.Unit != null && !tacticsUnitController.Unit.IsNormalSize)
    ...
    {
      if (!this.IsControlBattleUI(SceneBattle.eMaskBattleUI.CAMERA) || !this.mUpdateCameraPosition || (this.isBattleCamera || this.isUpView) || ObjectAnimator.Get((Component) UnityEngine.Camera.main).isMoving)
        return;
    ...
    public void GetCameraTargetView(out Vector3 center, out float distance, Vector3[] targets)
    {
      ...
      {
        center = new Vector3(0.0f, float.MaxValue, 0.0f);
        ...
        do
        {
          ...
          for (int index = 0; index < targets.Length; ++index)
          {
            ...
            if ((double) viewportPoint.x < 0.0 || (double) viewportPoint.x > 1.0 || ((double) viewportPoint.y < 0.0 || (double) viewportPoint.y > 0.899999976158142))
            {
              ++distance;
              flag = true;
              break;
        ...
        center -= Vector3.up * GameSettings.Instance.GameCamera_UnitHeightOffset;
    ...
    {
      if (!(cam.tag == "MainCamera") || cam.gameObject.layer != GameUtility.LayerDefault)
        return;
    ...
    private void OnCameraForcus()
    {
      if (this.mOnUnitFocus != null)
      {
        ...
        if (!((UnityEngine.Object) this.mFocusedUnit != (UnityEngine.Object) closestUnitController))
          return;
        DebugUtility.Log("Focus:" + (object) closestUnitController);
        this.mFocusedUnit = closestUnitController;
        this.mOnUnitFocus(this.mFocusedUnit, (Grid) null);
      }
      else
    ...
    private void UpdateCameraControlUpView(bool immediate = false)
    {
      ...
      {
        if ((UnityEngine.Object) this.mTouchController != (UnityEngine.Object) null && !ObjectAnimator.Get((Component) main).isMoving)
          this.UpdateCameraPositionTouchMove(transform.right, transform.up);
        this.UpdateCameraPositionInterp(immediate);
        if (this.m_TargetCameraDistanceInterp)
        {
          float t = !immediate ? Time.deltaTime * 8f : 1f;
          float b = 5f + this.m_TargetCameraDistance;
          this.m_TargetCamera.CameraDistance = Mathf.Lerp(this.m_TargetCamera.CameraDistance, b, t);
          if ((double) Mathf.Abs(b - this.m_TargetCamera.CameraDistance) <= 0.00999999977648258)
          {
            this.m_TargetCamera.CameraDistance = b;
            this.m_TargetCameraDistanceInterp = false;
          }
        }
        this.m_TargetCamera.SetPositionYawPitch(this.m_CameraPosition + Vector3.up * instance.GameCamera_UnitHeightOffset, 90f, 270f);
      }
      this.OnCameraForcus();
    }
    ...
    public void OnCameraModeChange(SceneBattle.CameraMode nextMode)
    {
      ...
      if (nextMode == SceneBattle.CameraMode.DEFAULT)
      {
        ...
        this.m_TargetCamera.SetPositionYawPitch(this.m_CameraPosition + Vector3.up * instance.GameCamera_UnitHeightOffset, this.m_CameraAngle, instance.GameCamera_AngleX);
      }
      else
      {
    ...
    private void BeginMultiPlayer()
    {
      ...
      else
      {
        ...
        if ((UnityEngine.Object) instance1 != (UnityEngine.Object) null && multiPlayer != null && (instance1.IsOldestPlayer() && multiPlayer.Disconnected))
    ...
    private TacticsUnitController ResetMultiPlayerTransform(Unit unit)
    {
      ...
      if ((UnityEngine.Object) tacticsUnitController == (UnityEngine.Object) null)
        return (TacticsUnitController) null;
      tacticsUnitController.transform.position = this.CalcGridCenter(unit.startX, unit.startY);
      tacticsUnitController.CancelAction();
      tacticsUnitController.transform.rotation = unit.startDir.ToRotation();
      return tacticsUnitController;
    }
    ...
    {
      MyPhoton instance = PunMonoSingleton<MyPhoton>.Instance;
      if (this.mExecDisconnected && this.Battle.IsMultiTower || (MonoSingleton<GameManager>.Instance.IsVSCpuBattle || instance.CurrentState == MyPhoton.MyState.ROOM) || !((UnityEngine.Object) this.mBattleUI_MultiPlay != (UnityEngine.Object) null))
        return false;
    ...
    private void OtherPlayerDisconnect()
    {
      ...
      if (roomPlayerList1 != null)
      {
        foreach (SceneBattle.MultiPlayer multiPlayer in this.mMultiPlayer)
        {
          if (roomPlayerList1 != null && instance.FindPlayer(roomPlayerList1, multiPlayer.PlayerID, multiPlayer.PlayerIndex) == null)
          {
      ...
      if ((UnityEngine.Object) this.mBattleUI_MultiPlay != (UnityEngine.Object) null && !this.mIsWaitingForBattleSignal && (!BlockInterrupt.IsBlocked(BlockInterrupt.EType.PHOTON_DISCONNECTED) && this.CurrentNotifyDisconnectedPlayer == null) && !this.mExecDisconnected)
      {
        List<JSON_MyPhotonPlayerParam> myPlayersStarted = instance.GetMyPlayersStarted();
        MyPhoton.MyPlayer myPlayer = instance.GetMyPlayer();
    ...
    private void OtherPlayerResume()
    {
      ...
      if (!((UnityEngine.Object) this.mBattleUI_MultiPlay != (UnityEngine.Object) null) || this.mIsWaitingForBattleSignal || (BlockInterrupt.IsBlocked(BlockInterrupt.EType.PHOTON_DISCONNECTED) || this.CurrentResumePlayer != null))
        return;
    ...
    private void CheckStart()
    {
      ...
      foreach (SceneBattle.MultiPlayer multiPlayer in this.mMultiPlayer)
      {
        if (!multiPlayer.NotifyDisconnected)
      ...
      else
      {
        ...
        else
        {
          if (!this.Battle.CurrentUnit.IsUnitFlag(EUnitFlag.Moved))
          {
            ...
            if ((UnityEngine.Object) tacticsUnitController != (UnityEngine.Object) null)
              this.SetCameraTarget((Component) tacticsUnitController, false);
...
label_20:
    ...
    public void SkipLog()
    {
      ...
      else
      {
            ...
            else
            {
              ...
              if (unitController.Unit.IsDead)
              {
                ...
                if (!unitController.Unit.IsUnitFlag(EUnitFlag.UnitTransformed) && !unitController.Unit.IsUnitFlag(EUnitFlag.IsDynamicTransform))
                {
                  ...
                  UnityEngine.Object.Destroy((UnityEngine.Object) unitController.gameObject);
                }
              }
              else
              {
        ...
        for (int index = this.mTacticsUnits.Count - 1; index >= 0; --index)
        {
          ...
          if ((bool) ((UnityEngine.Object) tuc))
          {
            if (this.Battle.AllUnits.Find((Predicate<Unit>) (unit => unit == tuc.Unit)) == null)
            {
              ...
              UnityEngine.Object.Destroy((UnityEngine.Object) tuc.gameObject);
            }
            else
              continue;
          }
        ...
        if (this.ReqCreateDtuUcLists.Count != 0)
        {
          for (int index = 0; index < this.ReqCreateDtuUcLists.Count; ++index)
          {
            ...
            if ((bool) ((UnityEngine.Object) tuc))
            {
              ...
              this.StartCoroutine(SceneBattle.State_PrepareSkill.loadTransformUnit(this, rcd.mTargetUnit, (TacticsUnitController) null, (Action) (() =>
              {
    ...
    private bool SendCheckMultiPlay()
    {
      if (MonoSingleton<GameManager>.Instance.AudienceMode || !this.Battle.IsMultiPlay)
        return true;
      MyPhoton instance = PunMonoSingleton<MyPhoton>.Instance;
      bool flag = !((UnityEngine.Object) this.mBattleUI_MultiPlay == (UnityEngine.Object) null) && this.mBattleUI_MultiPlay.CheckRandCheat;
    ...
    private SRPG_TouchInputModule GetTouchInputModule()
    {
      ...
      return gameObject.GetComponent<SRPG_TouchInputModule>();
    }
    ...
    public void SetupGoodJob()
    {
      ...
      if ((UnityEngine.Object) touchInputModule == (UnityEngine.Object) null)
        return;
    ...
    private void AddGoodJob(int gx, int gy, int unitID = -1)
    {
      ...
      if (gx < 0 || gx >= this.Battle.CurrentMap.Width || (gy < 0 || gy >= this.Battle.CurrentMap.Height))
        return;
      BattleStamp battleStamp = !((UnityEngine.Object) this.mBattleUI_MultiPlay == (UnityEngine.Object) null) ? this.mBattleUI_MultiPlay.StampWindow : (BattleStamp) null;
      byte[] sendBinary = this.CreateSendBinary(SceneBattle.EMultiPlayRecvDataHeader.GOODJOB, unitID, new List<SceneBattle.MultiPlayInput>() { new SceneBattle.MultiPlayInput() { gx = gx, gy = gy, c = !((UnityEngine.Object) battleStamp == (UnityEngine.Object) null) ? battleStamp.SelectStampID : -1 } });
    ...
    private void UpdateGoodJob()
    {
      ...
      if ((UnityEngine.Object) this.mBattleUI_MultiPlay != (UnityEngine.Object) null && this.mBattleUI_MultiPlay.StampWindowIsOpened)
      {
      ...
      {
        int index1 = multiPlayRecvData.c == null || multiPlayRecvData.c.Length <= 0 ? multiPlayInput.c : multiPlayRecvData.c[0];
        int index2 = multiPlayRecvData.gx == null || multiPlayRecvData.gx.Length <= 0 ? multiPlayInput.gx : multiPlayRecvData.gx[0];
        int index3 = multiPlayRecvData.gy == null || multiPlayRecvData.gy.Length <= 0 ? multiPlayInput.gy : multiPlayRecvData.gy[0];
        ...
        if (this.Battle.CurrentMap != null && this.mHeightMap != null && (0 <= index2 && index2 < this.Battle.CurrentMap.Width) && (0 <= index3 && index3 < this.Battle.CurrentMap.Height))
        {
          ...
          BattleStamp battleStamp = !((UnityEngine.Object) this.mBattleUI_MultiPlay == (UnityEngine.Object) null) ? this.mBattleUI_MultiPlay.StampWindow : (BattleStamp) null;
          Sprite sprite = (UnityEngine.Object) battleStamp == (UnityEngine.Object) null || battleStamp.Sprites == null || (index1 < 0 || index1 >= battleStamp.Sprites.Length) ? (Sprite) null : battleStamp.Sprites[index1];
          GameObject prefab = (UnityEngine.Object) battleStamp == (UnityEngine.Object) null || battleStamp.Prefabs == null || (index1 < 0 || index1 >= battleStamp.Prefabs.Length) ? (GameObject) null : battleStamp.Prefabs[index1];
    ...
    private byte[] CreateSendResumeInfo()
    {
      ...
      for (int index1 = 0; index1 < this.Battle.AllUnits.Count; ++index1)
      {
        ...
        if (allUnit != null)
        {
          ...
          playResumeUnitData.okd = (int) allUnit.OverKillDamage;
          ...
          if (allUnit.AddedAbilitys.Count != 0)
          {
            ...
            for (int index2 = 0; index2 < allUnit.AddedAbilitys.Count; ++index2)
            {
              ...
              playResumeUnitData.addedabils[index2].nct = addedAbility.IsNoneCategory;
            }
          }
      ...
      if ((UnityEngine.Object) this.mEventScript != (UnityEngine.Object) null && this.mEventScript.mSequences != null && this.mEventScript.mSequences.Length != 0)
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CRecvResume\u003Ec__Iterator6() { resumedata = resumedata, \u0024this = this };
    }
    ...
    private void RecvBuildBuffAndCond(ref List<MultiPlayResumeSkillData> buff, ref List<MultiPlayResumeSkillData> cond, MultiPlayResumeUnitData unit)
    {
      ...
      if (unit.buff != null)
      {
        for (int index = 0; index < unit.buff.Length; ++index)
        {
          ...
          MultiPlayResumeSkillData playResumeSkillData = new MultiPlayResumeSkillData() { user = multiPlayResumeBuff.unitindex == -1 ? (Unit) null : this.Battle.AllUnits[multiPlayResumeBuff.unitindex], check = multiPlayResumeBuff.checkunit == -1 ? (Unit) null : this.Battle.AllUnits[multiPlayResumeBuff.checkunit] };
    ...
    {
      if ((UnityEngine.Object) controller == (UnityEngine.Object) null || target == null)
        return;
      if (target.IsDead)
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CRecvReinforcementUnit\u003Ec__Iterator7() { \u0024this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CRestoreWeather\u003Ec__Iterator8() { wth_data = wth_data, \u0024this = this };
    }
    ...
    private UnitGauge GetGaugeTemplateFor(Unit unit)
    {
      ...
      if (unit.IsRaidBoss)
      {
        if ((UnityEngine.Object) this.EnemyBossGaugeOverlayTemplate != (UnityEngine.Object) null)
          return this.EnemyBossGaugeOverlayTemplate;
        return this.GaugeOverlayTemplate;
      }
      if ((UnityEngine.Object) this.EnemyGaugeOverlayTemplate != (UnityEngine.Object) null)
    ...
    public void OnGimmickUpdate()
    {
      ...
      for (int index1 = 0; index1 < this.mUnitList.Count; ++index1)
      {
        ...
        for (int index2 = 0; index2 < this.mGimmickList.Count; ++index2)
        {
          ...
          if (!((UnityEngine.Object) mUnit == (UnityEngine.Object) mGimmick))
          {
    ...
    private void ArenaActionCountSet(uint count)
    {
      ...
      if (!(bool) ((UnityEngine.Object) gameObject) || (int) gameObject.ActionCount == (int) count)
        return;
    ...
    private void RemainingActionCountSet(uint pc_count, uint ec_count)
    {
      ...
      if ((UnityEngine.Object) gameObject1 != (UnityEngine.Object) null && gameObject1.isActiveAndEnabled && (int) gameObject1.ActionCount != (int) pc_count)
      {
      ...
      if (!((UnityEngine.Object) gameObject2 != (UnityEngine.Object) null) || !gameObject2.isActiveAndEnabled || (int) gameObject2.ActionCount == (int) ec_count)
        return;
    ...
    private void EnableWeatherEffect(bool is_enable)
    {
      ...
      if (!(bool) ((UnityEngine.Object) weatherEffectAttach))
        return;
    ...
    private void GotoUnitChgSelect(bool is_back = false)
    {
      ...
      if ((UnityEngine.Object) this.mBattleUI.UnitChgWindow != (UnityEngine.Object) null)
      ...
      if (!is_back)
      {
        ...
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
          ...
          grid1.set(intVector2.x, intVector2.y, (Color32) GameSettings.Instance.Colors.AttackArea);
          GridMap<Color32> grid2 = new GridMap<Color32>(this.Battle.CurrentMap.Width, this.Battle.CurrentMap.Height);
          grid2.set(intVector2.x, intVector2.y, (Color32) GameSettings.Instance.Colors.AttackArea2);
    ...
    private void GotoSkillSelect()
    {
      ...
      if ((UnityEngine.Object) skillWindow != (UnityEngine.Object) null)
      {
        DataSource.Bind<AbilityData>(skillWindow.gameObject, this.UIParam_CurrentAbility, false);
    ...
    private TutorialButtonImage[] TutorialButtonImages
    {
      get
      {
        if (this.mTutorialButtonImages == null && (UnityEngine.Object) this.mBattleUI != (UnityEngine.Object) null)
          this.mTutorialButtonImages = this.mBattleUI.GetComponentsInChildren<TutorialButtonImage>(true);
      ...
      for (int index1 = 0; index1 < SceneBattle.MAX_MASK_BATTLE_UI; ++index1)
      {
        ...
        if (flag1 != flag2)
        {
          ...
          for (int index2 = 0; index2 < all.Count; ++index2)
          {
            ...
            if ((bool) ((UnityEngine.Object) tutorialButtonImage))
              tutorialButtonImage.gameObject.SetActive(flag1);
          }
        }
      }
    ...
    {
      Ray ray = UnityEngine.Camera.main.ScreenPointToRay((Vector3) screenPosition);
      ...
      if (Physics.Raycast(ray, out hitInfo))
      {
        ...
        for (int y = 0; y < this.mHeightMap.h; ++y)
        {
          ...
          {
            float magnitude = (hitInfo.point - new Vector3((float) x + 0.5f, this.mHeightMap.get(x, y), (float) y + 0.5f)).magnitude;
    ...
    private void OnClickBackground(Vector2 screenPosition)
    {
      ...
      if (this.mOnUnitClick != null)
      {
        ...
        Vector3 vector3 = Vector3.up * 0.5f;
        UnityEngine.Camera main = UnityEngine.Camera.main;
        float num2 = (float) (Screen.height / 5);
        for (int index = 0; index < this.mTacticsUnits.Count; ++index)
        {
          float magnitude = ((Vector2) main.WorldToScreenPoint(this.mTacticsUnits[index].transform.position + vector3) - screenPosition).magnitude;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CLoadUIAsync\u003Ec__Iterator9() { \u0024this = this };
    }
    ...
    private void InitTouchArea()
    {
      ...
      if (!(bool) ((UnityEngine.Object) this.mGoWeatherAttach))
        return;
    ...
    private void DestroyUI(bool is_part = false)
    {
      ...
      if (!is_part && (UnityEngine.Object) this.mBattleUI != (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) this.mDefaultBattleScene != (UnityEngine.Object) null)
      {
    ...
    private void HideUnitMarkers(Unit unit)
    {
      ...
      for (int index1 = this.mUnitMarkers.Length - 1; index1 >= 0; --index1)
      {
        for (int index2 = this.mUnitMarkers[index1].Count - 1; index2 >= 0; --index2)
        {
          if ((UnityEngine.Object) this.mUnitMarkers[index1][index2].transform.parent == (UnityEngine.Object) transform)
          {
            GameUtility.SetLayer(this.mUnitMarkers[index1][index2], GameUtility.LayerHidden, true);
            this.mUnitMarkers[index1][index2].transform.SetParent((Transform) null, false);
          }
    ...
    private void ShowUnitMarker(Unit unit, SceneBattle.UnitMarkerTypes markerType)
    {
      ...
      {
        if (mUnitMarker[index].layer != GameUtility.LayerHidden && (UnityEngine.Object) mUnitMarker[index].transform.parent == (UnityEngine.Object) transform)
          return;
      }
      for (int index = mUnitMarker.Count - 1; index >= 0; --index)
      {
        if (mUnitMarker[index].layer == GameUtility.LayerHidden)
        {
          ...
          if (!unit.IsNormalSize)
            num = unit.SizeZ;
          mUnitMarker[index].transform.localPosition = Vector3.up * ((float) num + 1f);
      ...
      go.transform.SetParent(unitController.transform, false);
      int num1 = 1;
      if (!unit.IsNormalSize)
        num1 = unit.SizeZ;
      go.transform.localPosition = Vector3.up * ((float) num1 + 1f);
    ...
    public GameObject PopupDamageNumber(TacticsUnitController tuc, int number)
    {
      return this.PopupNumber(tuc, number, Color.white, this.mDamageTemplate);
    }
    ...
    public GameObject PopupNumber(TacticsUnitController tuc, int number, Color color, DamagePopup popup)
    {
      ...
      SceneBattle.Popup2D(damagePopup.gameObject, uiDispPosition, 1, 0.0f);
      return damagePopup.gameObject;
    }

    public GameObject PopupDamageDsgNumber(TacticsUnitController tuc, int number, eDamageDispType ddt)
    {
      if (!(bool) ((UnityEngine.Object) this.mDamageDsgTemplate))
      {
      ...
      SceneBattle.Popup2D(damageDsgPopup.gameObject, uiDispPosition, 1, 0.0f);
      return damageDsgPopup.gameObject;
    }
    ...
    public bool HasMissPopup
    {
      get
      {
        return (UnityEngine.Object) this.mMissPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasPerfectAvoidPopup
    {
      get
      {
        return (UnityEngine.Object) this.mPerfectAvoidPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasGuardPopup
    {
      get
      {
        return (UnityEngine.Object) this.mGuardPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasAbsorbPopup
    {
      get
      {
        return (UnityEngine.Object) this.mAbsorbPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasCriticalPopup
    {
      get
      {
        return (UnityEngine.Object) this.mCriticalPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasBackstabPopup
    {
      get
      {
        return (UnityEngine.Object) this.mBackstabPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasWeakPopup
    {
      get
      {
        return (UnityEngine.Object) this.mWeakPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasResistPopup
    {
      get
      {
        return (UnityEngine.Object) this.mResistPopup != (UnityEngine.Object) null;
      }
    }
    ...
    public bool HasGutsPopup
    {
      get
      {
        return (UnityEngine.Object) this.mGutsPopup != (UnityEngine.Object) null;
      }
    }

    public void PopupMiss(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mMissPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mMissPopup), position, 0, yOffset);
    }

    public void PopupPefectAvoid(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mPerfectAvoidPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mPerfectAvoidPopup), position, 0, yOffset);
    }

    public void PopupGuard(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mGuardPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mGuardPopup), position, 0, yOffset);
    }

    public void PopupAbsorb(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mAbsorbPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mAbsorbPopup), position, 0, yOffset);
    }

    public void PopupCritical(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mCriticalPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mCriticalPopup), position, 0, yOffset);
    }

    public void PopupBackstab(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mBackstabPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mBackstabPopup), position, 0, yOffset);
    }

    public void PopupWeak(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mWeakPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mWeakPopup), position, 0, yOffset);
    }

    public void PopupResist(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mResistPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mResistPopup), position, 0, yOffset);
    }

    public void PopupGuts(Vector3 position, float yOffset = 0.0f)
    {
      if (!((UnityEngine.Object) this.mGutsPopup != (UnityEngine.Object) null))
        return;
      SceneBattle.Popup2D(UnityEngine.Object.Instantiate<GameObject>(this.mGutsPopup), position, 0, yOffset);
    }
    ...
    public void PopupGoodJob(Vector3 position, GameObject prefab, Sprite sprite = null)
    {
      ...
      if ((UnityEngine.Object) go == (UnityEngine.Object) null)
        return;
      Image image = !((UnityEngine.Object) sprite == (UnityEngine.Object) null) ? go.GetComponentInChildren<Image>() : (Image) null;
    ...
    {
      if ((UnityEngine.Object) this.mParamChangeEffectTemplate == (UnityEngine.Object) null)
    ...
    private Transform CreateEffectChangeCT(int val)
    {
      ...
      if (!(bool) ((UnityEngine.Object) gameObject))
        return (Transform) null;
      BuffEffectText component = gameObject.GetComponent<BuffEffectText>();
      if ((UnityEngine.Object) component != (UnityEngine.Object) null && (UnityEngine.Object) component.Text != (UnityEngine.Object) null)
      {
    ...
    public void PopupParamChange(Vector3 position, BuffBit buff, BuffBit debuff, int ct_change_val = 0)
    {
      ...
      for (int index = 0; index < SkillParam.MAX_PARAMTYPES; ++index)
      {
        ...
        if (buff.CheckBit(type))
        {
          ...
          if ((UnityEngine.Object) paramChangeEffect != (UnityEngine.Object) null)
      ...
      if (val != 0)
      {
        ...
        if ((UnityEngine.Object) effectChangeCt != (UnityEngine.Object) null)
    ...
    {
      if ((UnityEngine.Object) this.mConditionChangeEffectTemplate == (UnityEngine.Object) null)
        return (Transform) null;
    ...
    public void PopupConditionChange(Vector3 position, EUnitCondition fails)
    {
      ...
      for (int index = 0; index < (int) Unit.MAX_UNIT_CONDITION; ++index)
      {
        ...
        if ((condition & fails) != (EUnitCondition) 0)
        {
          ...
          if ((UnityEngine.Object) conditionChangeEffect != (UnityEngine.Object) null)
    ...
    public void ShowSkillNamePlate(Unit unit, SkillData skill, string skill_name = "", float speed = 1f)
    {
      ...
      this.mSkillNamePlate.Open(speed, 0.0f);
      this.mSkillNamePlate.transform.SetParent(this.OverlayCanvas.transform, false);
    }
    ...
    public void ShowInspirationTelopPlate(float disp_time, float speed = 1f)
    {
      ...
      this.mInspirationTelopPlate.transform.SetParent(this.OverlayCanvas.transform, false);
    }
    ...
    private void InternalPopup2D(GameObject go, Vector3 position, int priority, float yOffset = 0.0f)
    {
      ...
      go.transform.SetParent(this.OverlayCanvas.transform, false);
    ...
    private void LayoutPopups(UnityEngine.Camera cam)
    {
      ...
      if ((UnityEngine.Object) overlayCanvas == (UnityEngine.Object) null)
        return;
      RectTransform transform1 = overlayCanvas.transform as RectTransform;
      ...
      for (int index = 0; index < this.mPopups.Count; ++index)
      {
        if ((UnityEngine.Object) this.mPopups[index].Value != (UnityEngine.Object) null)
        {
      ...
      for (int index1 = 0; index1 < this.mPopups.Count; ++index1)
      {
        ...
        screenPoint.x = screenPoint.x / (float) Screen.width * transform1.rect.width;
        screenPoint.y = screenPoint.y / (float) Screen.height * transform1.rect.height;
        screenPoint.y += this.mPopups[index1].Key.yOffset;
        if (this.isScreenMirroring)
          screenPoint.x = transform1.rect.width - screenPoint.x;
        RectTransform transform2 = gameObject.transform as RectTransform;
        if (!this.mPopupPositionCache.ContainsKey(transform2) || this.mPopupPositionCache[transform2] != screenPoint)
        {
          ...
          transform2.anchoredPosition = (Vector2) screenPoint;
          this.mPopupPositionCache[transform2] = screenPoint;
        }
      }
      if (!((UnityEngine.Object) this.mBlockedGridMarker != (UnityEngine.Object) null))
        return;
      if (this.mDisplayBlockedGridMarker)
      {
        ...
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
          Vector3 position = unitController.CenterPosition;
          if (this.mGridDisplayBlockedGridMarker != null)
            position = this.CalcGridCenter(this.mGridDisplayBlockedGridMarker) + Vector3.up * (unitController.Height * 0.5f);
          Vector3 screenPoint = cam.WorldToScreenPoint(position);
          Vector2 localPoint;
          RectTransformUtility.ScreenPointToLocalPointInRectangle(this.mTouchController.GetRectTransform(), (Vector2) screenPoint, (UnityEngine.Camera) null, out localPoint);
          RectTransform component = this.mBlockedGridMarker.GetComponent<RectTransform>();
          if (!this.mPopupPositionCache.ContainsKey(component) || this.mPopupPositionCache[component] != screenPoint)
          {
    ...
    private void LayoutGauges(UnityEngine.Camera cam)
    {
      ...
      RectTransform transform = overlayCanvas.transform as RectTransform;
      ...
      for (int index = 0; index < instances.Count; ++index)
      {
        ...
        if (!((UnityEngine.Object) hpGaugeTransform == (UnityEngine.Object) null) && hpGaugeTransform.gameObject.activeInHierarchy)
        {
          Vector3 uiDispPosition = tacticsUnitController.UIDispPosition;
          uiDispPosition.y += 0.5f;
          if ((UnityEngine.Object) hpGaugeTransform.parent != (UnityEngine.Object) transform)
            hpGaugeTransform.SetParent((Transform) transform, false);
          Vector3 screenPoint = cam.WorldToScreenPoint(uiDispPosition);
          screenPoint.x = screenPoint.x / (float) Screen.width * transform.rect.width;
          screenPoint.y = screenPoint.y / (float) Screen.height * transform.rect.height;
      ...
      for (int index = 0; index < this.mLayoutGauges.Count; ++index)
      {
        ...
        Vector2 vector2_1 = new Vector2(points[index].x, points[index].y);
        if (!this.mGaugePositionCache.ContainsKey(mLayoutGauge) || this.mGaugePositionCache[mLayoutGauge] != vector2_1)
        {
    ...
    private void SetPrioritizedUnit(TacticsUnitController controller)
    {
      ...
      for (int index = 0; index < this.mTacticsUnits.Count; ++index)
      {
        if ((UnityEngine.Object) this.mTacticsUnits[index] != (UnityEngine.Object) controller)
    ...
    private void OnDrag()
    {
      if (!this.mBattle.IsMapCommand || this.mBattle.IsUnitAuto(this.mBattle.CurrentUnit))
        return;
      TacticsUnitController unitController = this.FindUnitController(this.mBattle.CurrentUnit);
      if ((UnityEngine.Object) unitController != (UnityEngine.Object) null && unitController.IsStartSkill())
        return;
      VirtualStick2 virtualStick = this.mBattleUI.VirtualStick;
      if (!((UnityEngine.Object) virtualStick != (UnityEngine.Object) null) || !this.IsControlBattleUI(SceneBattle.eMaskBattleUI.VS_SWIPE))
        return;
    ...
    private void OnDragEnd()
    {
      ...
      if ((UnityEngine.Object) unitController != (UnityEngine.Object) null && unitController.IsStartSkill())
        return;
      VirtualStick2 virtualStick = this.mBattleUI.VirtualStick;
      if (!((UnityEngine.Object) virtualStick != (UnityEngine.Object) null))
        return;
    ...
    {
      if ((UnityEngine.Object) this.mJumpSpotEffectTemplate == (UnityEngine.Object) null)
        return;
      for (int index1 = 0; index1 < this.mBattle.Units.Count; ++index1)
      {
        ...
        if (!unit.IsDead && unit.CastSkill != null && (unit.CastSkill.CastType == ECastTypes.Jump || unit.CastSkill.TeleportType != eTeleportType.None))
        {
          ...
          if (!flag)
          {
            ...
            if (!unit.IsNormalSize && (bool) ((UnityEngine.Object) gameObject))
            {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CLoadShieldEffectsAsync\u003Ec__IteratorA() { skills = skills, \u0024this = this };
    }
    ...
    private GameObject SpawnShieldEffect(TacticsUnitController unit, SkillParam skill, int value, int valueMax, int turn, int turnMax)
    {
      ...
      if ((UnityEngine.Object) mShieldEffect == (UnityEngine.Object) null)
        return (GameObject) null;
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(mShieldEffect, unit.transform.position, Quaternion.identity);
      ...
      if ((UnityEngine.Object) component != (UnityEngine.Object) null)
      {
        ...
        if (valueMax > 0)
        {
          ...
          float f = (float) value * 100f / (float) valueMax;
          component.SetInteger("shield_val_per", (double) f >= 50.0 ? Mathf.FloorToInt(f) : Mathf.CeilToInt(f));
        }
        component.SetInteger("shield_turn", turn);
        if (turnMax > 0)
        {
          component.SetFloat("shield_turn_norm", (float) turn / (float) turnMax);
          float f = (float) turn * 100f / (float) turnMax;
          component.SetInteger("shield_turn_per", (double) f >= 50.0 ? Mathf.FloorToInt(f) : Mathf.CeilToInt(f));
        }
      }
      return gameObject;
    }
    ...
    private class State_ReqBtlComReq : State<SceneBattle>
    {
      ...
      {
        if (!((UnityEngine.Object) this.mGUIEvent != (UnityEngine.Object) null))
          return;
      ...
      {
        if (!string.IsNullOrEmpty(GlobalVars.SelectedQuestID) || !((UnityEngine.Object) this.mGUIEvent == (UnityEngine.Object) null) || Network.Mode != Network.EConnectMode.Offline)
          return;
        this.mGUIEvent = self.gameObject.AddComponent<GUIEventListener>();
    ...
    private class State_Start : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Start.\u003CLoadAndExecuteEvent\u003Ec__Iterator0() { eventName = eventName, \u0024this = this };
      }
      ...
      public override void Update(SceneBattle self)
      {
        ...
        while (logs.Num > 0)
        {
          ...
          if (peek is LogUnitStart)
          {
            ...
            if (!((UnityEngine.Object) self.mBattleUI_MultiPlay == (UnityEngine.Object) null))
            {
          ...
          if (peek is LogCancelTransform)
          {
            self.GotoState<SceneBattle.State_CancelTransform>();
            break;
          }
          if (peek is LogInspiration)
          {
    ...
    private class State_MapCommandMultiPlay : State<SceneBattle>
    {
      ...
      private void SyncCameraPosition(SceneBattle self)
      {
        ...
        transform.position = unitController.transform.position + instance.Quest.MoveCamera.transform.position;
        transform.rotation = instance.Quest.MoveCamera.transform.rotation;
        self.SetCameraTarget((Component) unitController, false);
    ...
    private class State_MapWait : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        if ((UnityEngine.Object) self.mEventScript != (UnityEngine.Object) null)
        {
          TacticsUnitController unitController = self.FindUnitController(self.mBattle.CurrentUnit);
          if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
          {
            self.mEventSequence = self.mEventScript.OnStandbyGrid(unitController, self.mIsFirstPlay);
            if ((UnityEngine.Object) self.mEventSequence != (UnityEngine.Object) null)
            {
    ...
    private class State_MapMoveSelect_Stick : State<SceneBattle>
    {
      ...
      private void Reset()
      {
        this.mController.transform.position = this.mStart;
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        this.mDestY = Mathf.FloorToInt(this.mStart.z - self.mTacticsSceneRoot.transform.position.z);
        ...
        switch (transition)
        {
          case SceneBattle.StateTransitionTypes.Forward:
            ...
            if (this.mScene.Battle.Move(this.mScene.Battle.CurrentUnit, current, direction, true, false))
            {
              ...
              this.mController.transform.position = this.mScene.CalcGridCenter(current);
      ...
      private bool CanMoveToAdj(Vector2 from, Vector2 to)
      {
        if (this.IsGridBlocked(to))
          return false;
        if (this.IsGridBlocked(from.x, to.y))
          return !this.IsGridBlocked(to.x, from.y);
        return true;
      }
      ...
      private void AdjustTargetPos(ref Vector2 basePos, ref Vector2 targetPos, Vector2 inputDir, Vector2 unitPos)
      {
        if (this.CanMoveToAdj(basePos, targetPos))
          return;
        bool flag = false;
        if ((double) Vector3.Dot((Vector3) (targetPos - basePos).normalized, (Vector3) (unitPos - basePos)) >= -0.100000001490116)
        {
          ...
          for (int index = 0; index < vector2Array.Length; ++index)
            numArray[index] = Vector2.Dot(vector2Array[index].normalized, inputDir);
      ...
      private Vector2 Velocity
      {
        get
        {
          if ((UnityEngine.Object) VirtualStick.Instance != (UnityEngine.Object) null)
            return VirtualStick.Instance.GetVelocity(UnityEngine.Camera.main.transform);
          return Vector2.zero;
        }
      }
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            vector2.y -= self.mTacticsSceneRoot.transform.position.z;
            ...
            if ((double) inputDir.sqrMagnitude > 0.0)
            {
              ...
              float f1 = Mathf.Cos(num1 * ((float) Math.PI / 180f));
              float f2 = Mathf.Sin(num1 * ((float) Math.PI / 180f));
              float num2 = (double) Mathf.Abs(f1) < 9.99999974737875E-05 ? 0.0f : Mathf.Sign(f1);
              float num3 = (double) Mathf.Abs(f2) < 9.99999974737875E-05 ? 0.0f : Mathf.Sign(f2);
              this.mTargetPos.x = this.mBasePos.x + num2;
              this.mTargetPos.y = this.mBasePos.y + num3;
              this.AdjustTargetPos(ref this.mBasePos, ref this.mTargetPos, inputDir, vector2);
              this.mDesiredRotation = Quaternion.LookRotation(new Vector3(inputDir.x, 0.0f, inputDir.y));
            ...
            if (this.mTargetSet)
            {
              if (this.CanMoveToAdjDirect(this.mBasePos, this.mTargetPos))
                vector3 = (Vector3) (this.mTargetPos - vector2);
              else if (this.IsGridBlocked(vector2.x, this.mTargetPos.y))
                vector3.x = this.mTargetPos.x - vector2.x;
              else if (this.IsGridBlocked(this.mTargetPos.x, vector2.y))
                vector3.y = this.mTargetPos.y - vector2.y;
              else
                vector3 = (Vector3) (this.mTargetPos - vector2);
              if ((double) vector3.magnitude < 0.100000001490116)
                vector3 = (Vector3) Vector2.zero;
            }
            bool flag = (double) vector3.sqrMagnitude > 0.0;
            if (this.mHasDesiredRotation || flag)
            {
              Quaternion quaternion = !flag ? this.mDesiredRotation : Quaternion.LookRotation(new Vector3(vector3.x, 0.0f, vector3.y));
              GameSettings instance = GameSettings.Instance;
              ...
              {
                t = magnitude;
                this.mController.transform.rotation = Quaternion.Slerp(this.mController.transform.rotation, quaternion, Time.deltaTime * 5f);
              }
              else
              {
                this.mController.transform.rotation = Quaternion.Slerp(this.mController.transform.rotation, quaternion, Time.deltaTime * 10f);
                float num1 = Quaternion.Angle(quaternion, this.mController.transform.rotation);
                if ((double) magnitude > 0.100000001490116)
                {
                  ...
                  {
                    float num2 = 15f;
                    float num3 = Mathf.Clamp01((float) (1.0 - (double) num1 / (double) num2));
                    t = magnitude * num3;
                  }
                }
                if ((double) num1 < 1.0)
                {
                  this.mController.transform.rotation = quaternion;
                  this.mHasDesiredRotation = false;
                }
              }
              if ((double) t > 0.0 && flag)
              {
                this.mController.StartRunning();
                float num = Mathf.Lerp(instance.Quest.MapRunSpeedMin, instance.Quest.MapRunSpeedMax, t);
                Vector3 velocity = new Vector3(vector3.x, 0.0f, vector3.y).normalized * num;
    ...
    private class State_AnimateMove : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null && gameObject.isDisp)
          gameObject.SetDisp(false);
        if (this.mMoveUnit)
        {
      ...
      private void Move()
      {
        ...
        ObjectAnimator.Get((Component) UnityEngine.Camera.main.transform).AnimateTo(UnityEngine.Camera.main.transform.position + (this.mEndPosition - this.mStartPosition), UnityEngine.Camera.main.transform.rotation, this.mController.StartMove(route, -1f), ObjectAnimator.CurveType.EaseInOut);
      }
    }
    ...
    private class State_EventMapDead : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        if ((UnityEngine.Object) this.mController != (UnityEngine.Object) null && self.IsCameraMoving)
          return;
    ...
    private class State_MapDead : State<SceneBattle>
    {
      ...
      public class Camera : SceneBattle.State_MapDead.DirectionBase
      {
        ...
        {
          Vector3 vector3 = this.scene.mCameraTarget - this.m_Center;
          vector3.y = 0.0f;
          return (double) vector3.magnitude * (double) vector3.magnitude >= 0.25;
        }
      ...
      public class Dead : SceneBattle.State_MapDead.DirectionBase
      {
        ...
        public void Initialize(int priority, TacticsUnitController controller, DeadTypes deadType)
        {
          ...
          normal.Initialize(this.GetPriority() + 1, this.mUnit, this.mUnit.Drop, controller.transform.position);
        ...
        protected override bool OnMain()
        {
          return !((UnityEngine.Object) this.mController == (UnityEngine.Object) null);
        }
        ...
        public class CameraForcus : SceneBattle.State_MapDead.Dead
        {
          ...
          protected override bool OnLoading()
          {
            ...
            {
              case 0:
                Vector3 vector3 = this.scene.mCameraTarget - this.mController.transform.position;
                vector3.y = 0.0f;
                if ((double) vector3.magnitude * (double) vector3.magnitude < 0.25)
                {
      ...
      public class TreasureDrop : SceneBattle.State_MapDead.DirectionBase
      {
        ...
        public void Initialize(int priority, Unit owner, Unit.UnitDrop drop, Vector3 pos)
        {
          ...
          this.m_TreasureBox.transform.parent = this.scene.transform;
          this.m_TreasureBox.transform.position = pos;
          this.m_TreasureBox.gameObject.SetActive(false);
        }
        ...
        protected override bool OnMain()
        {
          if (!((UnityEngine.Object) this.m_TreasureBox != (UnityEngine.Object) null))
            return false;
          if (!this.m_TreasureBox.gameObject.activeInHierarchy)
            this.m_TreasureBox.gameObject.SetActive(true);
          return true;
        }
    ...
    public class TreasureEvent : SceneBattle.SimpleEvent.Interface
    {
      ...
      public void OnEvent(string key, object obj)
      {
        if (key == "DropItemEffect.End")
        {
          ...
          if (!((UnityEngine.Object) dropItemEffect != (UnityEngine.Object) null))
            return;
          dropItemEffect.DropOwner?.EndDropDirection();
          SceneBattle.Instance.AddDispTreasureCount(1);
          if (!((UnityEngine.Object) dropItemEffect != (UnityEngine.Object) null) || !((UnityEngine.Object) dropItemEffect.TargetRect != (UnityEngine.Object) null))
            return;
          GameParameter.UpdateAll(dropItemEffect.TargetRect.gameObject);
        }
        else
        {
          ...
          if (!((UnityEngine.Object) dropGoldEffect != (UnityEngine.Object) null))
            return;
          dropGoldEffect.DropOwner?.EndDropDirection();
          SceneBattle.Instance.AddGoldCount(dropGoldEffect.Gold);
          if (!((UnityEngine.Object) dropGoldEffect.TargetRect != (UnityEngine.Object) null))
            return;
          GameParameter.UpdateAll(dropGoldEffect.TargetRect.gameObject);
        }
      }
    }
    ...
    private class State_PickupGimmick : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        else
        {
          ...
          self.mUpdateCameraPosition = true;
          self.SetCameraOffset(GameSettings.Instance.Quest.UnitCamera.transform);
          ...
          if (!this.mItemDrop || this.mDrop == null || this.mDrop.items.Count <= 0)
            return;
          this.mDropItemEffect = UnityEngine.Object.Instantiate<DropItemEffect>(this.mScene.mTreasureDropTemplate, this.mGimmickController.transform.position + this.mPickup.DropEffectOffset, new Quaternion());
          if (!((UnityEngine.Object) this.mDropItemEffect != (UnityEngine.Object) null))
            return;
          this.mDropItemEffect.transform.SetParent(self.OverlayCanvas.transform, false);
          this.mDropItemEffect.gameObject.GetComponent<DropItemIcon>().UpdateValue();
          this.mDropItemEffect.gameObject.SetActive(false);
        }
      }
      ...
      public override void Update(SceneBattle self)
      {
        ...
        if (!this.mLoadFinished)
        {
          ...
          this.mUnitController.PlayPickup(this.mGimmickController.gameObject);
        }
      ...
      public override void End(SceneBattle self)
      {
        ...
        this.mGimmickController.gameObject.SetActive(false);
      ...
      private void OnPickupDone()
      {
        ...
        if (this.mDrop != null)
        {
          Vector3 position = this.mGimmickController.transform.position;
          ...
          {
            this.mDropItemEffect.gameObject.SetActive(true);
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PickupGimmick.\u003CGemPramChangePopup\u003Ec__Iterator0() { \u0024this = this };
      }
    }
    ...
    private class State_CastSkillStartJump : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        self.Battle.CastSkillStart();
        self.RemoveLog();
        if ((UnityEngine.Object) this.mCasterController != (UnityEngine.Object) null)
          this.mCasterController.ChargeIcon.Close();
        self.GotoState<SceneBattle.State_WaitForLog>();
      }
    }
        ...
        switch (this.mSeqState)
        {
            ...
            if (this.mLoadReqEffect != null)
            {
              ...
              if ((bool) ((UnityEngine.Object) asset))
              {
                foreach (SceneBattle.State_MapTrick.TucMapTrick mTucMapTrickList in this.mTucMapTrickLists)
                {
                  ...
                  {
                    go.transform.SetParent(mTucMapTrickList.mController.transform, false);
                    ParticleSystem[] componentsInChildren = go.GetComponentsInChildren<ParticleSystem>();
                    if (componentsInChildren != null)
                    {
                      foreach (ParticleSystem particleSystem in componentsInChildren)
                        particleSystem.subEmitters.enabled = true;
                    }
          ...
          case SceneBattle.State_MapTrick.eSeqState.EFF_PLAY:
            ...
            if (this.mGoEffectLists.Count != 0)
            {
              ...
              {
                if ((double) this.mPassedTime < (double) GameSettings.Instance.Quest.TrickEffectWaitMaxTime && (bool) ((UnityEngine.Object) this.mGoEffectLists[index]))
                {
                  flag1 = true;
                  break;
                }
          ...
          case SceneBattle.State_MapTrick.eSeqState.ACT_PLAY:
            ...
            if (this.mGoPopupLists.Count != 0)
            {
              ...
              {
                if ((bool) ((UnityEngine.Object) this.mGoPopupLists[index]))
                {
                  flag3 = true;
                  break;
                }
    ...
    private class State_UnitEnd : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if (self.mBattle.IsUnitAuto(self.mBattle.CurrentUnit))
          self.HideGrid();
        if ((UnityEngine.Object) self.mTouchController != (UnityEngine.Object) null)
        ...
        if ((UnityEngine.Object) null != (UnityEngine.Object) this.mController)
        {
          this.mController.InitShake(this.mController.transform.position, this.mCurrentUnit.Direction.ToVector());
          if (self.Battle.IsMultiVersus)
    ...
    private class State_OrdealChangeNext : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_OrdealChangeNext.\u003CStepOrdealChangeNextTeam\u003Ec__Iterator0() { \u0024this = this };
      }
    ...
    private class State_ArenaSkipWait : State<SceneBattle>
    {
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) self.mBattleUI != (UnityEngine.Object) null)
        {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        switch (questResult)
        {
          ...
          case BattleCore.QuestResult.Lose:
            ...
            if ((UnityEngine.Object) self.mBattleUI_MultiPlay != (UnityEngine.Object) null && !self.Battle.IsMultiVersus)
            ...
            if (self.IsPlayingArenaQuest)
            {
              if (self.Battle.IsArenaSkip)
                self.Battle.Units.Find((Predicate<Unit>) (u =>
                {
                  if (u == self.Battle.Leader && u.Side == EUnitSide.Player && u.IsEntry)
                    return !u.IsSub;
                  return false;
                }))?.PlayBattleVoice("battle_0028");
              GameUtility.SetDefaultSleepSetting();
              self.GotoState_WaitSignal<SceneBattle.State_Result>();
              break;
            }
            ...
            if (self.Battle.QuestType == QuestTypes.Raid || self.Battle.QuestType == QuestTypes.GenesisBoss)
            {
              if (!self.mQuestResultSent)
                self.SubmitResult();
              self.GotoState_WaitSignal<SceneBattle.State_Result>();
    ...
    private class State_Result : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        if (!this.mIsResDestroy)
        {
          ...
          {
            UnityEngine.Object.Destroy((UnityEngine.Object) self.mTacticsUnits[index].gameObject);
            self.mTacticsUnits.RemoveAt(index);
          }
          if ((UnityEngine.Object) self.mTacticsSceneRoot != (UnityEngine.Object) null)
          {
            UnityEngine.Object.Destroy((UnityEngine.Object) self.mTacticsSceneRoot.gameObject);
    ...
    private class State_ContinueQuest : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        {
          BattleCore.Json_Battle response = new BattleCore.Json_Battle() { btlid = this.mScene.Battle.BtlID, btlinfo = new BattleCore.Json_BtlInfo() };
        ...
        for (int index = 0; index < player.Count; ++index)
        {
          ...
          if (!((UnityEngine.Object) unitController == (UnityEngine.Object) null))
          {
            ...
            if (unitController.Unit.IsDead)
            {
              ...
              GameUtility.DestroyGameObject(unitController.gameObject);
            }
          }
        }
    ...
    private class State_ExitQuest : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_ExitQuest.\u003CExitAsync\u003Ec__Iterator0() { \u0024this = this };
      }
    }
    ...
    private struct PosRot
    {
      ...
      {
        target.position = this.Position + deltaPosition;
        target.rotation = this.Rotation;
      }

      public void AddPosition(Component component)
      {
        this.Position += component.transform.position;
      }
    }
    ...
    private class State_AutoHeal : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          ...
          if (this.mState == SceneBattle.State_AutoHeal.State.EffectStart)
            this.StartEffect();
          if (!((UnityEngine.Object) this.mHealEffect == (UnityEngine.Object) null) || this.mController.IsHPGaugeChanging)
            return;
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_AutoHeal.\u003CWait\u003Ec__Iterator0() { wait = wait, \u0024this = this };
      }

      private void StartEffect()
      {
        GameObject original = this.mLog.type != LogAutoHeal.HealType.Hp ? this.self.mMapAddGemEffectTemplate : this.self.mAutoHealEffectTemplate;
        if ((UnityEngine.Object) original != (UnityEngine.Object) null)
        {
          this.mHealEffect = UnityEngine.Object.Instantiate<GameObject>(original, this.mController.transform.position, Quaternion.identity);
          if ((UnityEngine.Object) this.mHealEffect != (UnityEngine.Object) null)
          {
            this.mHealEffect.transform.SetParent(this.mController.transform);
    ...
    private class State_JumpCastStart : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if ((bool) ((UnityEngine.Object) this.mCasterController) && this.mCasterController.Unit != null && !this.mCasterController.Unit.IsNormalSize)
    ...
    private class State_PrepareSkill : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        else
        {
          ...
          {
            if ((UnityEngine.Object) self.mDrainMpEffectTemplate != (UnityEngine.Object) null && skill.SkillParam.IsJewelAttack())
              unitController.SetDrainEffect(self.mDrainMpEffectTemplate);
            else if ((UnityEngine.Object) self.mDrainHpEffectTemplate != (UnityEngine.Object) null)
          ...
          if ((self.Battle.IsUnitAuto(self1) || self.Battle.EntryBattleMultiPlayTimeUp) && !skill.IsTransformSkill())
          {
            ...
            Color32 attackArea = (Color32) GameSettings.Instance.Colors.AttackArea;
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CPrepareSkill\u003Ec__Iterator0() { skill = skill, unit = unit, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CcutinVoice\u003Ec__Iterator1() { unit = unit, skill = skill, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CloadTransformUnit\u003Ec__Iterator2() { unit = unit, self = self, bef_tuc = bef_tuc, callback = callback };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CloadBreakObjUnit\u003Ec__Iterator3() { unit = unit, self = self, callback = callback };
      }
    }
    ...
    private class State_Battle_PrepareSkill : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) self.mCollaboTargetTuc != (UnityEngine.Object) null)
        {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        this.mInstigator.transform.position = vector3_1;
        this.mInstigator.transform.rotation = Quaternion.LookRotation(self.mBattleSceneRoot.PlayerStart1.position - self.mBattleSceneRoot.PlayerStart2.position);
        this.mInstigator.transform.SetParent(self.mBattleSceneRoot.transform, false);
        if ((UnityEngine.Object) self.mCollaboTargetTuc != (UnityEngine.Object) null)
        {
          self.mCollaboTargetTuc.transform.position = vector3_2;
          self.mCollaboTargetTuc.transform.rotation = Quaternion.LookRotation(self.mBattleSceneRoot.PlayerStart1.position - self.mBattleSceneRoot.PlayerStart2.position);
          self.mCollaboTargetTuc.transform.SetParent(self.mBattleSceneRoot.transform, false);
        }
        if (this.mTargets.Count == 1 && (UnityEngine.Object) this.mTargets[0] != (UnityEngine.Object) this.mInstigator)
        {
          TacticsUnitController mTarget = this.mTargets[0];
          if (peek.skill.IsTransformSkill())
          {
            mTarget.transform.position = vector3_1;
            mTarget.transform.rotation = Quaternion.LookRotation(self.mBattleSceneRoot.PlayerStart1.position - self.mBattleSceneRoot.PlayerStart2.position);
            mTarget.transform.SetParent(self.mBattleSceneRoot.transform, false);
          }
          else
          {
            mTarget.transform.position = vector3_3;
            mTarget.transform.rotation = Quaternion.LookRotation(self.mBattleSceneRoot.PlayerStart2.position - self.mBattleSceneRoot.PlayerStart1.position);
            mTarget.transform.SetParent(self.mBattleSceneRoot.transform, false);
          }
        }
        Transform transform = UnityEngine.Camera.main.transform;
        transform.position = GameSettings.Instance.Quest.BattleCamera.position + self.mBattleSceneRoot.PlayerStart2.position;
        ...
        this.mInstigator.StartSkill(self.CalcGridCenter(peek.pos.x, peek.pos.y), UnityEngine.Camera.main, this.mTargets.ToArray(), (Vector3[]) null, this.mSkill);
        if ((UnityEngine.Object) self.mCollaboTargetTuc != (UnityEngine.Object) null)
          self.mCollaboTargetTuc.StartSkill(self.CalcGridCenter(self.mCollaboTargetTuc.Unit.x, self.mCollaboTargetTuc.Unit.y), UnityEngine.Camera.main, this.mTargets.ToArray(), (Vector3[]) null, this.mSkill);
        GameUtility.FadeIn(0.2f);
        if ((UnityEngine.Object) self.mSkillSplash != (UnityEngine.Object) null)
        {
          if ((bool) ((UnityEngine.Object) self.mSkillSplash))
            self.mSkillSplash.Close();
          self.mSkillSplash = (SkillSplash) null;
        }
        if ((UnityEngine.Object) self.mSkillSplashCollabo != (UnityEngine.Object) null)
        {
          if ((bool) ((UnityEngine.Object) self.mSkillSplashCollabo))
    ...
    private class State_Battle_EndSkill : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Battle_EndSkill.\u003CAsyncUpdate\u003Ec__Iterator0() { \u0024this = this };
      }
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          ...
          if (this.mLogSkill != null)
          {
            ...
            if ((UnityEngine.Object) unitController1 != (UnityEngine.Object) null)
            ...
            if ((UnityEngine.Object) self.mEventScript != (UnityEngine.Object) null)
            {
              ...
              if ((UnityEngine.Object) unitController2 != (UnityEngine.Object) null && this.mLogSkill.targets != null && this.mLogSkill.targets.Count != 0)
              {
                List<TacticsUnitController> TargetLists = new List<TacticsUnitController>();
                foreach (LogSkill.Target target in this.mLogSkill.targets)
                {
                  TacticsUnitController unitController3 = self.FindUnitController(target.target);
                  if ((UnityEngine.Object) unitController3 != (UnityEngine.Object) null)
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          if ((UnityEngine.Object) this.controller != (UnityEngine.Object) null)
          {
            ...
            bool flag2 = false;
            if ((bool) ((UnityEngine.Object) this.controller) && this.controller.Unit != null && !this.controller.Unit.IsNormalSize)
              flag2 = true;
            else if (log.targets != null)
            {
              ...
              {
                TacticsUnitController unitController = self.FindUnitController(log.targets[index].target);
                if ((bool) ((UnityEngine.Object) unitController) && unitController.Unit != null && !unitController.Unit.IsNormalSize)
                {
                  flag2 = true;
                  break;
                }
    ...
    private class State_Map_LoadSkill : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        if (self.mDesiredCameraTargetSet || ObjectAnimator.Get((Component) UnityEngine.Camera.main).isMoving)
          return;
        for (int index = self.mUnitsInBattle.Count - 1; index >= 0; --index)
        {
        ...
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null && unitController.HasPreSkillAnimation)
        {
          self.mBattleUI.OnCommandSelect();
    ...
    private class State_Map_PlayPreSkillAnim : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        Transform transform1 = this.mInstigator.transform;
        transform1.position = vector3_1;
        transform1.rotation = Quaternion.LookRotation(self.mBattleSceneRoot.PlayerStart1.position - self.mBattleSceneRoot.PlayerStart2.position);
        transform1.SetParent(self.mBattleSceneRoot.transform, false);
        if ((UnityEngine.Object) self.mCollaboTargetTuc != (UnityEngine.Object) null)
        {
          self.mCollaboTargetTuc.transform.position = vector3_2;
          self.mCollaboTargetTuc.transform.rotation = Quaternion.LookRotation(self.mBattleSceneRoot.PlayerStart1.position - self.mBattleSceneRoot.PlayerStart2.position);
        ...
        if (peek.skill.IsTransformSkill() && peek.targets.Count != 0)
        {
          ...
          if ((bool) ((UnityEngine.Object) this.mTransformTuc))
          {
            this.mTransformTuc.transform.position = vector3_1;
            this.mTransformTuc.transform.rotation = Quaternion.LookRotation(self.mBattleSceneRoot.PlayerStart1.position - self.mBattleSceneRoot.PlayerStart2.position);
            this.mTransformTuc.transform.SetParent(self.mBattleSceneRoot.transform, false);
          }
        }
        Transform transform2 = UnityEngine.Camera.main.transform;
        transform2.position = GameSettings.Instance.Quest.BattleCamera.position + self.mBattleSceneRoot.PlayerStart2.position;
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Map_PlayPreSkillAnim.\u003CAsyncWork\u003Ec__Iterator0() { \u0024this = this };
      }
    }
        ...
        if (this.mRenkeiUnitIndex < self.mBattle.HelperUnits.Count)
        {
          ...
          if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
          {
            ...
            if ((bool) ((UnityEngine.Object) unitController) && unitController.Unit != null && !unitController.Unit.IsNormalSize)
              skillCameraDistance += GameSettings.Instance.GameCamera_BigUnitAddDistance;
            self.InterpCameraDistance(skillCameraDistance);
            GameUtility.SpawnParticle(self.mRenkeiAssistEffect, unitController.transform, self.gameObject);
            this.mInterval = 0.5f;
          }
    ...
    private class State_Map_LoadSkill_Renkei2 : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
          ...
          GameUtility.SpawnParticle(self.mRenkeiChargeEffect, unitController.transform, self.gameObject);
        ...
        if (peek is LogSkill)
        {
          ...
          for (int index = 0; index < logSkill.targets.Count; ++index)
          {
            if (logSkill.targets[index].IsAvoid())
            {
              ...
              unitController2.LookAt(unitController1.transform.position);
    ...
    private class State_Map_PlaySkill : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if (this.mActionInfo.skill.CastType != ECastTypes.Jump)
          self.mUpdateCameraPosition = false;
        bool flag1 = false;
        if ((bool) ((UnityEngine.Object) this.mInstigator) && this.mInstigator.Unit != null && !this.mInstigator.Unit.IsNormalSize)
        {
          flag1 = true;
        }
        else
        ...
        this.mInstigator.StartSkill(self.CalcGridCenter(this.mActionInfo.pos.x, this.mActionInfo.pos.y), UnityEngine.Camera.main, targets, vector3List2 == null ? (Vector3[]) null : vector3List2.ToArray(), skill.SkillParam);
        if ((UnityEngine.Object) self.mCollaboTargetTuc != (UnityEngine.Object) null)
          self.mCollaboTargetTuc.StartSkill(self.CalcGridCenter(this.mActionInfo.pos.x, this.mActionInfo.pos.y), UnityEngine.Camera.main, targets, vector3List2 == null ? (Vector3[]) null : vector3List2.ToArray(), skill.SkillParam);
      ...
      public override void Update(SceneBattle self)
      {
        ...
        {
          if ((UnityEngine.Object) self.mCollaboTargetTuc != (UnityEngine.Object) null && !self.mCollaboTargetTuc.isIdle)
            return;
          foreach (TacticsUnitController mTarget in this.mTargets)
          {
            if ((bool) ((UnityEngine.Object) mTarget) && mTarget.IsBusy)
              return;
          }
          ...
          else
          {
            ...
            if (this.mActionInfo.skill.IsTransformSkill())
            {
              ...
              UnityEngine.Object.Destroy((UnityEngine.Object) this.mInstigator.gameObject);
              this.mInstigator = (TacticsUnitController) null;
              if (this.mTargets.Count != 0)
              {
                this.mTargets[0].SetVisible(true);
                this.mTargets[0].UpdateShields(true);
              }
              self.InterpCameraDistance(GameSettings.Instance.GameCamera_DefaultDistance);
              self.GotoState<SceneBattle.State_WaitGC<SceneBattle.State_WaitForLog>>();
            }
            else
            {
              ...
              if (this.mActionInfo != null)
              {
                ...
                if ((UnityEngine.Object) self.mEventScript != (UnityEngine.Object) null)
                {
                  ...
                  if ((UnityEngine.Object) unitController1 != (UnityEngine.Object) null && this.mActionInfo.targets != null && this.mActionInfo.targets.Count != 0)
                  {
                    List<TacticsUnitController> TargetLists = new List<TacticsUnitController>();
                    foreach (LogSkill.Target target in this.mActionInfo.targets)
                    {
    ...
    private class State_SpawnShieldEffects : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        {
          if (!self.mIgnoreShieldEffect.Contains(mTacticsUnit))
            mTacticsUnit.UpdateShields(false);
        }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_SpawnShieldEffects.\u003CSpawnEffectsAsync\u003Ec__Iterator0() { \u0024this = this };
      }
    ...
    private class State_Weather : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Weather.\u003CAsyncWeather\u003Ec__Iterator0() { \u0024this = this };
      }
    ...
    private class State_SpawnUnit : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_SpawnUnit.\u003CAsyncWork\u003Ec__Iterator0() { unit = unit, kill_unit = kill_unit, \u0024this = this };
      }
      ...
      public override void Update(SceneBattle self)
      {
        if (!this.mIsFinished)
          return;
        if (this.mSpawnUnit != null && (UnityEngine.Object) self.mEventScript != (UnityEngine.Object) null)
        {
    ...
    private class State_UnitWithdraw : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_UnitWithdraw.\u003CAsyncWork\u003Ec__Iterator0() { unit = unit, \u0024this = this };
      }
    ...
    private class State_CancelTransform : State<SceneBattle>
    {
      ...
      {
        this.mIsFinished = true;
        LogCancelTransform peek = self.mBattle.Logs.Peek as LogCancelTransform;
        if (peek == null || peek.self == null || (peek.next_unit == null || peek.dtu == null))
          return;
        this.mIsFinished = false;
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_CancelTransform.\u003CAsyncWork\u003Ec__Iterator0() { from_unit = from_unit, dtu = dtu, next_unit = next_unit, \u0024this = this };
      }
    ...
    private class State_Inspiration : State<SceneBattle>
    {
      ...
      {
        this.mIsFinished = true;
        LogInspiration peek = self.mBattle.Logs.Peek as LogInspiration;
        if (peek == null || peek.self == null)
          return;
        this.mIsFinished = false;
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Inspiration.\u003CInspirationEffect\u003Ec__Iterator0() { unit = unit, \u0024this = this };
      }
    ...
    private class State_ArenaCalc : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_ArenaCalc.\u003CsendResultStartReplay\u003Ec__Iterator0() { self = self };
      }
    }
    ...
    private class State_DirectionOffSkill : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_PrepareSkill\u003Ec__Iterator0() { self = self, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_MapPrepareSkill\u003Ec__Iterator1() { self = self, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_MapPlaySkill\u003Ec__Iterator2() { self = self, \u0024this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_Execute\u003Ec__Iterator3() { self = self, \u0024this = this };
      }
    ...
    private class State_MultiPlayContinueBase : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        List<MyPhoton.MyPlayer> roomPlayerList = instance.GetRoomPlayerList();
        List<JSON_MyPhotonPlayerParam> myPlayersStarted = instance.GetMyPlayersStarted();
        if (me == null || roomPlayerList == null || (myPlayersStarted == null || (UnityEngine.Object) self.mBattleUI_MultiPlay == (UnityEngine.Object) null))
        {
          this.Cancel();
        }
        else
        {
          ...
          else
          {
            ...
            foreach (SceneBattle.State_MultiPlayContinueBase.MultiPlayContinueRequest playContinueRequest2 in this.mReqPool)
            {
              if (playContinueRequest1.flag != playContinueRequest2.flag || !playContinueRequest1.units.SequenceEqual<int>((IEnumerable<int>) playContinueRequest2.units) || (playContinueRequest1.seed != playContinueRequest2.seed || playContinueRequest1.btlid != playContinueRequest2.btlid))
              {
                this.mInitFlag = false;
                this.CloseUI(this.mRoomOwnerPlayerID == me.playerID, false);
                return;
    ...
    private class State_MultiPlayContinue : SceneBattle.State_MultiPlayContinueBase
    {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else if (!this.mOpenMenu && this.mOpenMenuReq && (UnityEngine.Object) self.mBattleUI.gameObject.transform.Find("quest_lose(Clone)") == (UnityEngine.Object) null)
        {
    ...
    private class State_MapCommandVersus : State<SceneBattle>
    {
      public override void Begin(SceneBattle self)
      {
        if ((UnityEngine.Object) self.mBattleUI.CommandWindow != (UnityEngine.Object) null)
          self.mBattleUI.CommandWindow.OnCommandSelect = new UnitCommands.CommandEvent(this.OnCommandSelect);
        self.ShowAllHPGauges();
        TacticsUnitController unitController = self.FindUnitController(self.mBattle.CurrentUnit);
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
          self.HideUnitCursor(unitController);
        if ((UnityEngine.Object) self.mBattleUI.TargetMain != (UnityEngine.Object) null)
          self.mBattleUI.TargetMain.Close();
        if ((UnityEngine.Object) self.mBattleUI.TargetSub != (UnityEngine.Object) null)
          self.mBattleUI.TargetSub.Close();
        if ((UnityEngine.Object) self.mBattleUI.TargetObjectSub != (UnityEngine.Object) null)
          self.mBattleUI.TargetObjectSub.Close();
        if ((UnityEngine.Object) self.mBattleUI.TargetTrickSub != (UnityEngine.Object) null)
    ...
    private class MultiPlayerUnit
    {
      ...
      public bool IsMoveCompleted(SceneBattle self, int x, int y, TacticsUnitController controller)
      {
        ...
        if (this.mGridSnap != SceneBattle.MultiPlayerUnit.EGridSnap.DONE || this.mIsRunning)
          return false;
        IntVector2 intVector2 = self.CalcCoord(controller.transform.position);
      ...
      public void RecvInput(SceneBattle self, SceneBattle.MultiPlayRecvData data)
      {
        ...
        for (int index = 0; index < num; ++index)
        {
          if (data.c[index] != 0)
          {
            SceneBattle.MultiPlayInput multiPlayInput = new SceneBattle.MultiPlayInput() { b = data.b, t = this.mRecvTurnNum };
      ...
      public void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) unitController == (UnityEngine.Object) null || this.mUnit.IsDead)
          return;
        unitController.AutoUpdateRotation = false;
      ...
      public void End(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
          ...
          unitController.transform.position = self.CalcGridCenter(this.mUnit.x, this.mUnit.y);
      ...
      public void Update(SceneBattle self)
      {
        if (!this.mBegin)
          return;
        TacticsUnitController unitController = self.FindUnitController(this.mUnit);
        if ((UnityEngine.Object) unitController == (UnityEngine.Object) null || this.mUnit.IsDead || !self.IsInState<SceneBattle.State_MapCommandMultiPlay>() && !self.IsInState<SceneBattle.State_MapCommandVersus>() && !self.IsInState<SceneBattle.State_SelectTargetV2>())
          return;
        unitController.AutoUpdateRotation = false;
        ...
        if (this.mRecv.Count <= 0 && !audienceMode && !instance1.IsVSCpuBattle || audienceMode && this.Owner.Disconnected && this.mRecv.Count <= 0 || instance1.IsVSCpuBattle && unitController.Unit.OwnerPlayerIndex == 2)
        {
          if (this.Owner != null && this.IsMoveCompleted(self, this.mGridX, this.mGridY, unitController))
          {
            ...
            if (player == null || !player.start && this.Owner.Disconnected)
            {
              ...
              unitController.transform.rotation = this.mUnit.Direction.ToRotation();
              unitController.AutoUpdateRotation = true;
              self.Battle.EntryBattleMultiPlayTimeUp = true;
        ...
        else if (this.Owner != null)
        {
          ...
          while (this.mTurnCmdDoneNum < num1 && this.mRecv.Count > 0)
          {
            ...
            if (multiPlayInput.c == 4 || multiPlayInput.c == 3 || (multiPlayInput.c == 7 || multiPlayInput.c == 8))
            {
              ...
              {
                IntVector2 intVector2 = self.CalcCoord(unitController.transform.position);
              ...
              else if (multiPlayInput.c != 1)
              {
                ...
                else if (multiPlayInput.c != 2)
                {
                  ...
                  else if (multiPlayInput.c == 9)
                  {
                    ...
                    unitController.transform.position = self.CalcGridCenter(multiPlayInput.gx, multiPlayInput.gy);
                    if (!this.IsMoveCompleted(self, this.mUnit.x, this.mUnit.y, unitController))
                    {
...
label_70:
      ...
      private void Move(SceneBattle self, int tx, int ty)
      {
        ...
        if (path != null && (UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
    ...
    private class State_LoadMapV2 : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) self.mEventScript != (UnityEngine.Object) null && (UnityEngine.Object) (self.mEventSequence = self.mEventScript.OnPostMapLoad()) != (UnityEngine.Object) null)
        {
    ...
    private class State_StartEvent : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        else
        {
          ...
          if ((UnityEngine.Object) this.mSequence == (UnityEngine.Object) null)
            this.Finish();
          else
            self.mUpdateCameraPosition = false;
        }
      ...
      private void Finish()
      {
        ...
        if ((UnityEngine.Object) this.self.mBattleUI_MultiPlay != (UnityEngine.Object) null)
    ...
    private class State_PreUnitStart : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PreUnitStart.\u003CTask_Begin\u003Ec__Iterator0() { self = self };
      }
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          for (int index = 0; index < self.mTacticsUnits.Count; ++index)
          {
            if ((UnityEngine.Object) self.mTacticsUnits[index] != (UnityEngine.Object) null && self.mTacticsUnits[index].IsHPGaugeChanging)
              return;
          }
          for (int index = 0; index < self.mTacticsUnits.Count; ++index)
          {
            if ((UnityEngine.Object) self.mTacticsUnits[index] != (UnityEngine.Object) null)
    ...
    private class State_UnitStartV2 : State<SceneBattle>
    {
      public override void Begin(SceneBattle self)
      {
        ...
        if (self.mTutorialTriggers != null && (UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
          for (int index = 0; index < self.mTutorialTriggers.Length; ++index)
    ...
    private class State_WaitEvent<T> : State<SceneBattle> where T : State<SceneBattle>, new()
    {
      ...
      public override void Update(SceneBattle self)
      {
        if ((UnityEngine.Object) self.mEventSequence != (UnityEngine.Object) null && self.IsCameraMoving || !((UnityEngine.Object) self.mEventSequence == (UnityEngine.Object) null) && self.mEventSequence.IsPlaying)
          return;
        for (int index = 0; index < self.mTacticsUnits.Count; ++index)
        ...
        if ((UnityEngine.Object) self.mEventSequence != (UnityEngine.Object) null)
        {
          UnityEngine.Object.DestroyImmediate((UnityEngine.Object) self.mEventSequence.gameObject);
          self.mEventSequence = (EventScript.Sequence) null;
        }
    ...
    private class State_MapCommandV2 : State<SceneBattle>
    {
      ...
      public override void Update(SceneBattle self)
      {
        if (self.mMoveInput != null)
        {
          ...
          {
            TacticsUnitController unitController = self.FindUnitController(self.mBattle.CurrentUnit);
            if ((UnityEngine.Object) unitController != (UnityEngine.Object) null && self.mTutorialTriggers != null)
            {
              for (int index = 0; index < self.mTutorialTriggers.Length; ++index)
          ...
          {
            TacticsUnitController unitController = self.FindUnitController(self.mBattle.CurrentUnit);
            if ((UnityEngine.Object) unitController != (UnityEngine.Object) null && self.mTutorialTriggers != null && self.mNumHotTargets > 0)
            {
              for (int index = 0; index < self.mTutorialTriggers.Length; ++index)
        ...
        if (!this.IsInputBusy)
        {
          if (!self.IsPause())
          {
            ...
            if (self.Battle.IsAutoBattle)
            {
              ...
              if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
              {
                unitController.transform.position = self.CalcGridCenter(self.mBattle.CurrentUnit.x, self.mBattle.CurrentUnit.y);
                self.InterpCameraTarget((Component) unitController);
              }
              self.HideAllHPGauges();
              self.HideAllUnitOwnerIndex();
    ...
    private class State_SelectItemV2 : State<SceneBattle>
    {
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) self.mBattleUI.ItemWindow != (UnityEngine.Object) null)
    ...
    private class State_SelectUnitChgV2 : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) self.mBattleUI.UnitChgWindow != (UnityEngine.Object) null)
      ...
      private void OnSelectUnit(Unit unit_chg_to)
      {
        ...
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
          ...
          if ((UnityEngine.Object) this.self.mBattleUI.TargetMain != (UnityEngine.Object) null)
          {
          ...
          if ((UnityEngine.Object) this.self.mBattleUI.TargetSub != (UnityEngine.Object) null)
          {
          ...
          if ((UnityEngine.Object) this.self.mBattleUI.TargetObjectSub != (UnityEngine.Object) null)
            this.self.mBattleUI.TargetObjectSub.Close();
          if ((UnityEngine.Object) this.self.mBattleUI.TargetTrickSub != (UnityEngine.Object) null)
      ...
      {
        if (this.mTargets.Count == 0 || !((UnityEngine.Object) this.self.mBattleUI.TargetSub != (UnityEngine.Object) null))
          return;
      ...
      private void OnYesNoSelect(bool yes)
      {
        ...
        if ((UnityEngine.Object) unitController1 != (UnityEngine.Object) null)
        {
          this.self.HideUnitMarkers((bool) ((UnityEngine.Object) unitController1));
    ...
    private class State_ThrowTargetSelect : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if (self.mTargetSelectorParam.DefaultThrowTarget != null)
        {
          ...
          if ((UnityEngine.Object) unitController2 != (UnityEngine.Object) null)
            this.OnFocus(unitController2, (Grid) null);
        ...
        if ((bool) ((UnityEngine.Object) self.mBattleUI.TargetSub))
        {
      ...
      private bool IsGridSelectable(Unit unit)
      {
        ...
        int x = unit.x;
        int y = unit.y;
        if ((UnityEngine.Object) this.self.mFocusedUnit != (UnityEngine.Object) null && this.self.mFocusedUnit.Unit != null && this.self.mFocusedUnit.Unit == unit)
        {
      ...
      {
        if (!(bool) ((UnityEngine.Object) controller) || controller.Unit.IsGimmick && !this.self.Battle.IsTargetBreakUnit(this.self.mBattle.CurrentUnit, controller.Unit, (SkillData) null))
          return;
        if ((UnityEngine.Object) this.mSelectedTarget != (UnityEngine.Object) null)
        ...
        {
          this.self.mTacticsUnits[index].SetHPGaugeMode(TacticsUnitController.HPGaugeModes.Normal, (SkillData) null, (Unit) null);
          if (0 >= YosokuDamageHp || !((UnityEngine.Object) this.self.mTacticsUnits[index] == (UnityEngine.Object) controller))
            this.self.mTacticsUnits[index].SetHPChangeYosou(this.self.mTacticsUnits[index].VisibleHPValue, 0);
        }
        if (this.IsGridSelectable(this.self.mSelectedTarget))
        {
          ...
          this.self.mTacticsSceneRoot.ShowGridLayer(2, grid, (Color32) GameSettings.Instance.Colors.AttackArea2, false);
        }
      ...
      private void OnClickUnit(TacticsUnitController controller)
      {
        ...
        this.OnFocus(controller, (Grid) null);
      }
    ...
    private class State_SelectTargetV2 : State<SceneBattle>
    {
          ...
          if (!this.mSelectGrid)
          {
            ...
            if (attackTargetsAi.Count > 0)
            {
              for (int index = 0; index < attackTargetsAi.Count; ++index)
              {
                ...
                if ((UnityEngine.Object) unitController2 != (UnityEngine.Object) null && self.Battle.IsTargetUnitForGridMap(attackTargetsAi[index], this.mTargetGrids) && !unitController2.Unit.IsDead && (!unitController2.Unit.IsBreakObj || unitController2.Unit.IsBreakDispUI))
                  this.mTargets.Add(unitController2);
              }
              flag1 = false;
            }
      ...
      private void HilitArea(int x, int y)
      {
        ...
        this.self.mTacticsSceneRoot.ShowGridLayer(2, this.mTargetAreaGridMap, (Color32) GameSettings.Instance.Colors.AttackArea2, false);
      }
      ...
      private void HilitNormalAttack(Unit Attacker, bool showOnly = false)
      {
        ...
        this.self.mTacticsSceneRoot.ShowGridLayer(1, this.mTargetAreaGridMap, (Color32) GameSettings.Instance.Colors.AttackArea, true);
      ...
      private void OnFocusGrid(Grid grid)
      {
        ...
        else if (this.self.mTargetSelectorParam.Skill != null && this.self.mTargetSelectorParam.Skill.IsAllEffect())
        {
          if ((UnityEngine.Object) unitController1 != (UnityEngine.Object) null)
          {
            ...
            this.self.mMapModeFocusedUnit = this.self.mFocusedUnit;
            this.OnFocus(unitController1, (Grid) null);
          }
        }
        else
        {
          ...
          if (skill != null)
          {
            ...
            unitController1.SetHPChangeYosou((int) current.CurrentStatus.param.hp - hpCost, 0);
            this.self.mBattleUI.TargetMain.SetHpGaugeParam(current.Side, (int) current.CurrentStatus.param.hp, (int) current.MaximumStatus.param.hp, hpCost, 0, false);
            this.self.mBattleUI.TargetMain.UpdateHpGauge();
            if (this.self.mTargetSelectorParam.OnAccept != null && this.mTargetGrids.get(grid.x, grid.y))
            {
                  ...
                  flag = ((Func<Grid, bool>) (gr =>
                  {
                    for (int minColX = current.MinColX; minColX < current.MaxColX; ++minColX)
                    {
                      for (int minColY = current.MinColY; minColY < current.MaxColY; ++minColY)
                      {
                        ...
                        if (current1 == null || current1.geo != null && (bool) current1.geo.DisableStopped)
                          return false;
                        Unit unit = this.self.mBattle.FindUnitAtGrid(current1);
                        if (unit == null)
                        {
                          unit = this.self.mBattle.FindGimmickAtGrid(current1, false, (Unit) null);
                          if (unit != null && !unit.IsBreakObj)
                            unit = (Unit) null;
                        }
                        if (unit != null && unit != current)
                          return false;
                      }
                    }
                    return true;
              ...
              if (flag)
              {
                BattleCore.CommandResult commandResult = this.self.mBattle.GetCommandResult(current, intVector2_2.x, intVector2_2.y, grid.x, grid.y, skill);
                if (commandResult != null && commandResult.targets != null)
                {
                  for (int index = 0; index < commandResult.targets.Count; ++index)
                  {
                    ...
                    {
                      unitController2.SetHPGaugeMode(TacticsUnitController.HPGaugeModes.Attack, skill, current);
      ...
      private bool IsGridSelectable(Unit unit)
      {
        int x = unit.x;
        int y = unit.y;
        if ((UnityEngine.Object) this.mScene.mFocusedUnit != (UnityEngine.Object) null && this.mScene.mFocusedUnit.Unit != null && this.mScene.mFocusedUnit.Unit == unit)
        {
        ...
        else
        {
          if (skill != null)
          {
            ...
            else if (!this.IsValidSkillTarget(controller.Unit))
            {
              for (int index = 0; index < this.self.mTacticsUnits.Count; ++index)
              {
                if ((UnityEngine.Object) this.self.mTacticsUnits[index] != (UnityEngine.Object) controller && this.self.mTacticsUnits[index].Unit.x == controller.Unit.x && (this.self.mTacticsUnits[index].Unit.y == controller.Unit.y && this.IsValidSkillTarget(this.self.mTacticsUnits[index].Unit)))
                {
          ...
          {
            if ((UnityEngine.Object) controller != (UnityEngine.Object) null && this.self.mTutorialTriggers != null)
            {
            ...
            {
              this.self.mTacticsUnits[index].SetHPGaugeMode(TacticsUnitController.HPGaugeModes.Normal, (SkillData) null, (Unit) null);
              if (0 >= YosokuDamageHp || !((UnityEngine.Object) this.self.mTacticsUnits[index] == (UnityEngine.Object) unitController1))
                this.self.mTacticsUnits[index].SetHPChangeYosou(this.self.mTacticsUnits[index].VisibleHPValue, 0);
            }
                ...
                else if (flag2)
                {
                  ...
                  if (commandResult != null && commandResult.targets != null)
                  {
                    ...
                    if (commandResult.targets.Count > 0)
                    {
                      ...
                      if (index1 != -1 && (UnityEngine.Object) this.self.mBattleUI.TargetMain != (UnityEngine.Object) null)
                      {
                        BattleCore.UnitResult target = commandResult.targets[index1];
                        EUnitSide side = commandResult.targets[index1].unit.Side;
                        int hp1 = (int) commandResult.targets[index1].unit.CurrentStatus.param.hp;
                        int hp2 = (int) commandResult.targets[index1].unit.MaximumStatus.param.hp;
                        if (skill.SkillParam.IsHealSkill())
                        {
                          ...
                          this.self.mBattleUI.TargetSub.SetHpGaugeParam(side, hp1, hp2, 0, commandResult.targets[index1].hp_heal, false);
                        }
                        else if (skill.SkillParam.IsDamagedSkill() || skill.SkillParam.effect_type == SkillEffectTypes.Debuff)
                        {
                          ...
                          this.self.mBattleUI.TargetSub.SetHpGaugeParam(side, hp1, hp2, commandResult.targets[index1].hp_damage, 0, skill.IsMhmDamage());
                        }
                        else
                      ...
                      if (skill.IsTargetTeleport && this.self.mSelectedTarget != null)
                      {
                        ...
                        if (teleportGrid == null)
                        {
                          for (int index2 = 0; index2 < commandResult.targets.Count; ++index2)
                          {
                            ...
                            {
                              TacticsUnitController unitController2 = this.self.FindUnitController(commandResult.targets[index2].unit);
                              if ((UnityEngine.Object) unitController2 != (UnityEngine.Object) null)
                              {
                                unitController2.ResetHPGauge();
                                this.self.mBattleUI.TargetSub.ResetHpGauge(commandResult.targets[index2].unit.Side, (int) commandResult.targets[index2].unit.CurrentStatus.param.hp, commandResult.targets[index2].unit.MaximumStatusHp);
                              }
                            }
                          }
                          this.self.mBattleUI.TargetMain.SetNoAction(this.self.mBattle.CurrentUnit, (List<LogSkill.Target.CondHit>) null);
          ...
          if ((UnityEngine.Object) this.self.mBattleUI.TargetTrickSub != (UnityEngine.Object) null)
          {
            IntVector2 intVector2_2 = new IntVector2(intVector2_1.x, intVector2_1.y);
            if (focus_grid != null)
            {
              intVector2_2.x = focus_grid.x;
              intVector2_2.y = focus_grid.y;
            }
            TrickData trickData = TrickData.SearchEffect(intVector2_2.x, intVector2_2.y);
            if (trickData != null && trickData.IsVisualized())
            {
              this.self.mBattleUI.TargetTrickSub.SetTrick(trickData.TrickParam);
              this.self.mBattleUI.IsEnableTrick = true;
      ...
      public override void Update(SceneBattle self)
      {
        ...
        if (!this.mSelectGrid || self.m_TargetCameraPositionInterp)
          return;
        int index1 = Mathf.Clamp(Mathf.FloorToInt(self.m_CameraPosition.x), 0, self.mBattle.CurrentMap.Width);
        int index2 = Mathf.Clamp(Mathf.FloorToInt(self.m_CameraPosition.z), 0, self.mBattle.CurrentMap.Height);
      ...
      private void ShiftTarget(int delta)
      {
        ...
        if (num < 0)
          num = 0;
        this.OnClickUnit(this.mTargets[(num + delta + this.mTargets.Count) % this.mTargets.Count]);
        if (!(bool) ((UnityEngine.Object) BattleUnitDetail.Instance))
          return;
    ...
    private class State_InputDirection : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        {
          ...
          bool flag = this.mCurrentUnit.IsEnableMoveCondition(false);
      ...
      private void OnStepEnd()
      {
        ...
        for (int index = 0; index < 4; ++index)
        {
          ...
          Vector3 vector3 = rotation * this.self.DirectionArrowTemplate.transform.position;
          this.mArrows[index] = UnityEngine.Object.Instantiate<DirectionArrow>(this.self.DirectionArrowTemplate, this.mController.transform.position + vector3, rotation);
        }
        this.UpdateArrows();
        ...
        if (!((UnityEngine.Object) unitController != (UnityEngine.Object) null) || this.self.mTutorialTriggers == null)
          return;
        for (int index = 0; index < this.self.mTutorialTriggers.Length; ++index)
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          ...
          if ((double) worldSpaceVelocity.magnitude <= 5.0)
            return;
      ...
      public override void End(SceneBattle self)
      {
        ...
        for (int index = 0; index < 4; ++index)
        {
          if ((UnityEngine.Object) this.mArrows[index] != (UnityEngine.Object) null && index != this.mSelectedDirection)
      ...
      private void OnScreenClick(Vector2 position)
      {
        ...
        {
          float magnitude = ((Vector2) main.WorldToScreenPoint(this.mArrows[index].transform.position) - position).magnitude;
    ...
    private class State_SelectSkillV2 : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        TacticsUnitController unitController = self.FindUnitController(currentUnit);
        EUnitDirection direction = unitController.CalcUnitDirectionFromRotation();
        unitController.transform.rotation = direction.ToRotation();
        self.mOnRequestStateChange = new SceneBattle.StateTransitionRequest(this.OnStateChange);
        if ((UnityEngine.Object) this.mSkillList != (UnityEngine.Object) null)
    ...
    public class VirtualStickInput : SceneBattle.MoveInput
    {
      ...
      public override void Reset()
      {
        this.mController.transform.position = this.mStart;
        this.mController.CancelAction();
        this.SceneOwner.SetCameraTarget((Component) this.mController, false);
      ...
      {
        this.OnClick((Vector2) target_screen_pos);
      }
      ...
      private void OnClick(Vector2 screenPos)
      {
        ...
        {
          RectTransform transform = this.SceneOwner.mTouchController.transform as RectTransform;
          Vector2 localPoint;
          RectTransformUtility.ScreenPointToLocalPointInRectangle(transform, screenPos, (UnityEngine.Camera) null, out localPoint);
          Vector2 vector2 = localPoint - transform.rect.position;
          ...
          for (int index = 0; index < this.SceneOwner.mTacticsUnits.Count; ++index)
          {
            ...
            if (!((UnityEngine.Object) mTacticsUnit == (UnityEngine.Object) null))
            {
              ...
              if (unit3 != null)
              {
                ...
                if (!((UnityEngine.Object) hpGaugeTransform == (UnityEngine.Object) null) && hpGaugeTransform.gameObject.activeInHierarchy && (this.mShateiGrid.isValid(unit3.x, unit3.y) && this.mShateiGrid.get(unit3.x, unit3.y)) && this.SceneOwner.mBattle.CheckSkillTarget(unit1, unit3, attackSkill))
                {
                  float magnitude = (hpGaugeTransform.anchoredPosition - vector2).magnitude;
        ...
        IntVector2 intVector2_2 = this.SceneOwner.CalcCoord(this.mController.transform.position);
      ...
      private Vector2 Velocity
      {
        get
        {
          ...
          if (!((UnityEngine.Object) main != (UnityEngine.Object) null) || !((UnityEngine.Object) virtualStick != (UnityEngine.Object) null) || !this.SceneOwner.IsControlBattleUI(SceneBattle.eMaskBattleUI.VS_SWIPE))
            return Vector2.zero;
      ...
      public override void Update()
      {
        ...
        else
        {
          ...
          else
          {
            ...
            Transform transform = this.mController.transform;
            Vector3 centerPosition = this.mController.CenterPosition;
            bool flag1 = false;
            Vector2 vector2 = new Vector2(centerPosition.x, centerPosition.z);
            if (this.mTargetSet && this.GridEqualIn2D(vector2, this.mTargetPos))
            {
              this.mBasePos = this.mTargetPos;
              this.mDestX = Mathf.FloorToInt(this.mBasePos.x);
            ...
            {
              this.SyncCameraPosition();
              if (!this.mController.isMoving || (double) this.Velocity.magnitude >= 0.100000001490116 && !this.mController.IsPlayingFieldAction)
              {
            ...
            {
              if ((double) velocity1.sqrMagnitude > 0.0)
              {
                if (!this.mMoveStarted)
                  this.mMoveStarted = true;
                ...
                this.mDesiredRotation = Quaternion.LookRotation(new Vector3(velocity1.x, 0.0f, velocity1.y));
                this.mHasDesiredRotation = true;
                this.mTargetSet = true;
                this.mGridSnapTime = GameSettings.Instance.Quest.GridSnapDelay;
                this.mHasInput = true;
              ...
              bool flag2 = (double) vector3.sqrMagnitude > 0.0;
              if (this.mHasDesiredRotation || flag2)
              {
                Quaternion quaternion = !flag2 ? this.mDesiredRotation : Quaternion.LookRotation(new Vector3(vector3.x, 0.0f, vector3.y));
                GameSettings instance = GameSettings.Instance;
                float magnitude = velocity1.magnitude;
                float t = 0.0f;
                if (this.mFullAccel)
                {
                  t = magnitude;
                ...
                if ((double) t > 0.0 && flag2)
                {
                  this.mController.StartRunning();
                  float num = Mathf.Lerp(instance.Quest.MapRunSpeedMin, instance.Quest.MapRunSpeedMax, t);
                  Vector3 velocity2 = new Vector3(vector3.x, 0.0f, vector3.y).normalized * num;
                  ...
                  {
                    centerPosition += velocity2 * Time.deltaTime;
                    flag1 = true;
                    for (int index1 = -1; index1 <= 1; ++index1)
                    {
                      for (int index2 = -1; index2 <= 1; ++index2)
                      {
                        if ((index2 != 0 || index1 != 0) && this.IsGridBlocked((float) Mathf.FloorToInt(centerPosition.x + (float) index2 * 0.3f), (float) Mathf.FloorToInt(centerPosition.z + (float) index1 * 0.3f)))
                        {
                          if (index2 < 0)
                            this.mController.AdjustMovePos(EUnitDirection.NegativeX, ref centerPosition);
                          if (index2 > 0)
                            this.mController.AdjustMovePos(EUnitDirection.PositiveX, ref centerPosition);
                          if (index1 < 0)
                            this.mController.AdjustMovePos(EUnitDirection.NegativeY, ref centerPosition);
                          if (index1 > 0)
                            this.mController.AdjustMovePos(EUnitDirection.PositiveY, ref centerPosition);
                        }
                      }
                    }
                  }
              ...
              IntVector2 intVector2 = this.SceneOwner.CalcCoord(centerPosition);
              BattleMap currentMap = this.SceneOwner.Battle.CurrentMap;
              ...
              else
              {
                ...
                if ((double) this.mStopTime > 0.300000011920929 && (this.mUpdateShateiGrid || !this.mShateiVisible) && ((double) this.mGridSnapTime <= 0.0 && this.mController.isIdle))
                {
                  ...
                  if (this.mShateiGrid != null)
                    this.SceneOwner.mTacticsSceneRoot.ShowGridLayer(1, this.mShateiGrid, (Color32) GameSettings.Instance.Colors.AttackArea, true);
      ...
      private void RecalcAttackTargets()
      {
        ...
        for (int index1 = 0; index1 < units.Count; ++index1)
        {
          ...
          if (!((UnityEngine.Object) unitController1 == (UnityEngine.Object) null))
          {
            if (this.mShateiGrid.isValid(units[index1].x, units[index1].y) && this.SceneOwner.mBattle.IsTargetUnitForGridMap(units[index1], this.mShateiGrid) && this.SceneOwner.mBattle.CheckSkillTarget(unit1, units[index1], attackSkill))
            {
              ...
              if (commandResult != null && commandResult.targets != null && commandResult.targets.Count > 0)
              {
                ...
                for (int index2 = 0; index2 < commandResult.targets.Count; ++index2)
                {
                  ...
                  if (!((UnityEngine.Object) unitController2 == (UnityEngine.Object) null))
                  {
                    ...
                    if ((UnityEngine.Object) unitController1 == (UnityEngine.Object) unitController2)
                      flag = true;
                  }
                }
                if (!flag)
