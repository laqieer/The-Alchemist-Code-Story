...
namespace SRPG
{
  ...
  public class RecentPartyList : MonoBehaviour, IFlowInterface
  {
    ...
    private bool IsNoData
    {
      get
      {
        return this.m_ViewParams.Count < 1;
      }
    }
          ...
          for (int index = 0; index < this.m_ViewParams.Count && index < this.m_RecentPartyPanels.Count; ++index)
          {
            foreach (UnitData unit in this.m_ViewParams[index].m_Units)
            {
              if (unit != null && player.FindUnitDataByUnitID(unit.UnitParam.iname) == null)
                this.m_RecentPartyPanels[index].gameObject.SetActive(false);
            }
          }
        }
        if (this.m_RecentPartyPanels.All<RecentPartyPanel>((Func<RecentPartyPanel, bool>) (panel => !panel.gameObject.activeSelf)))
    ...
    private void SetActiveUICoponent()
    {
      ...
      if ((UnityEngine.Object) this.PrevButton != (UnityEngine.Object) null)
      {
        ...
        this.PrevButton.interactable = this.m_CurrentPage > 1;
      }
      if ((UnityEngine.Object) this.NextButton != (UnityEngine.Object) null)
      {
        this.NextButton.gameObject.SetActive(true);
        this.NextButton.interactable = this.m_CurrentPage < this.m_MaxPage;
      }
      if (!((UnityEngine.Object) this.CheckBox != (UnityEngine.Object) null))
        return;
    ...
    private RecentPartyPanel CreatePartyPanel(RecentPartyList.ViewParam viewParam, int index)
    {
      ...
      RecentPartyPanel component1 = UnityEngine.Object.Instantiate<GameObject>(this.PartyPanelTemplate.gameObject).GetComponent<RecentPartyPanel>();
      ...
      SRPG_Button component2 = component1.GetComponent<SRPG_Button>();
    ...
    {
      Network.RequestAPI((WebAPI) new ReqBtlComRecord(this.m_CurrentQuest.iname, this.m_CurrentPage, this.m_UnitId, new Network.ResponseCallback(this.ResponseCallback)), false);
    }
