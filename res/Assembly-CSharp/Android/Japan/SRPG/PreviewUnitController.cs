...
namespace SRPG
{
  public class PreviewUnitController : UnitController
  {
    ...
    private new void LateUpdate()
    {
      ...
      transform2.rotation = this.mCameraShakeOffset * rotation;
      Debug.DrawLine(position, position + transform2.forward * 5f, Color.yellow);
      PreviewUnitController.DrawAxis(position);
      Debug.DrawLine(transform1.position, transform1.position - transform1.forward * 5f, Color.magenta);
