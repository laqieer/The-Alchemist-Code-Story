...
namespace SRPG
{
  public class QuestPartyParam
  {
    ...
    {
      return new PartySlotTypeUnitPair[4]{ new PartySlotTypeUnitPair() { Type = this.type_1, Unit = this.unit_1 }, new PartySlotTypeUnitPair() { Type = this.type_2, Unit = this.unit_2 }, new PartySlotTypeUnitPair() { Type = this.type_3, Unit = this.unit_3 }, new PartySlotTypeUnitPair() { Type = this.type_4, Unit = this.unit_4 } };
    }

    public PartySlotTypeUnitPair[] GetSubSlots()
    {
      return new PartySlotTypeUnitPair[2]{ new PartySlotTypeUnitPair() { Type = this.subtype_1, Unit = this.subunit_1 }, new PartySlotTypeUnitPair() { Type = this.subtype_2, Unit = this.subunit_2 } };
    }

    public PartySlotTypeUnitPair[] GetMainSubSlots()
    {
      return new PartySlotTypeUnitPair[6]{ new PartySlotTypeUnitPair() { Type = this.type_1, Unit = this.unit_1 }, new PartySlotTypeUnitPair() { Type = this.type_2, Unit = this.unit_2 }, new PartySlotTypeUnitPair() { Type = this.type_3, Unit = this.unit_3 }, new PartySlotTypeUnitPair() { Type = this.type_4, Unit = this.unit_4 }, new PartySlotTypeUnitPair() { Type = this.subtype_1, Unit = this.subunit_1 }, new PartySlotTypeUnitPair() { Type = this.subtype_2, Unit = this.subunit_2 } };
    }

    public PartySlotTypeUnitPair[] GetSupportSlots()
    {
      return new PartySlotTypeUnitPair[1]{ new PartySlotTypeUnitPair() { Type = this.support_type, Unit = (string) null } };
    }
