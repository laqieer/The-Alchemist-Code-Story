        ...
        else
        {
          ...
          if ((UnityEngine.Object) this.Player1P != (UnityEngine.Object) null)
          {
            if (myPhotonRoomParam.players.Length > 0)
              DataSource.Bind<JSON_MyPhotonPlayerParam>(this.Player1P, myPhotonRoomParam.players[0], false);
          ...
          if ((UnityEngine.Object) this.Player2P != (UnityEngine.Object) null)
          {
            if (myPhotonRoomParam.players.Length > 1)
              DataSource.Bind<JSON_MyPhotonPlayerParam>(this.Player2P, myPhotonRoomParam.players[1], false);
            else
              DataSource.Bind<JSON_MyPhotonPlayerParam>(this.Player2P, (JSON_MyPhotonPlayerParam) null, false);
