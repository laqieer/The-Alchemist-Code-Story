...
namespace SRPG
{
  public class LimitedShopBuyList : MonoBehaviour
  {
    ...
    private void Refresh()
    {
      ...
      {
        if (!((UnityEngine.Object) this.TimeLimitBase != (UnityEngine.Object) null))
          return;
      ...
      else
      {
        ...
        else
        {
          ...
          else if (timeSpan.TotalSeconds > 0.0)
          {
            ...
            if ((UnityEngine.Object) this.TimeLimitPopup != (UnityEngine.Object) null)
              this.TimeLimitPopup.SetActive(true);
          }
          else if ((UnityEngine.Object) this.self_button != (UnityEngine.Object) null)
            this.self_button.interactable = false;
          if (!((UnityEngine.Object) this.TimeLimitText != (UnityEngine.Object) null) || !(this.TimeLimitText.text != str))
            return;
          this.TimeLimitText.color = color;
