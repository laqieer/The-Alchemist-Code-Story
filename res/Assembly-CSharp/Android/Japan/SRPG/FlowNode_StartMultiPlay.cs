  ...
  public class FlowNode_StartMultiPlay : FlowNode
  {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                foreach (JSON_MyPhotonPlayerParam photonPlayerParam2 in photonPlayerParamList)
                {
                  photonPlayerParam2.SetupUnits();
                  myPlayersStarted.Add(photonPlayerParam2);
                }
              }
    ...
    private class State_GameStart : State<FlowNode_StartMultiPlay>
    {
      ...
      public override void Begin(FlowNode_StartMultiPlay self)
      {
        ...
        {
          if (JSON_MyPhotonPlayerParam.Parse(roomPlayer.json).state != 2)
          {
            self.FailureStartMulti();
            break;
          }
