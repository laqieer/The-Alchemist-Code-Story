...
namespace SRPG
{
  ...
  public class UnitJobDropdown : Pulldown, IFlowInterface
  {
    ...
    protected override void Start()
    {
      ...
      unitJobDropdown.OnSelectionChange = unitJobDropdown.OnSelectionChange + new UnityAction<int>(this.JobChanged);
    ...
    private void PostJobChange()
    {
      ...
      if (this.mTargetUnit != null)
      {
        ...
        if (this.UpdateValue != null)
          this.UpdateValue();
        if (DataSource.FindDataOfClass<PlayerPartyTypes>(this.gameObject, PlayerPartyTypes.Max) == PlayerPartyTypes.MultiTower)
        {
    ...
    private void JobChanged(int value)
    {
      ...
      if ((UnityEngine.Object) this.GameParamterRoot != (UnityEngine.Object) null)
    ...
    public void Refresh()
    {
      this.ClearItems();
      if (this.mTargetUnit == null)
        this.mTargetUnit = DataSource.FindDataOfClass<UnitData>(this.gameObject, (UnitData) null);
      if (this.mTargetUnit == null)
        return;
      this.mOriginalJobID = this.mTargetUnit.CurrentJob.JobID;
      for (int index = 0; index < this.mTargetUnit.Jobs.Length; ++index)
      {
        if (this.mTargetUnit.Jobs[index].IsActivated)
        {
          ...
          if ((UnityEngine.Object) jobPulldownItem.JobIcon != (UnityEngine.Object) null)
          {
    ...
    protected override void UpdateSelection()
    {
      ...
      if (!((UnityEngine.Object) itemAt != (UnityEngine.Object) null) || !((UnityEngine.Object) itemAt.JobIcon != (UnityEngine.Object) null))
        return;
