  ...
  public class MailList : MonoBehaviour, IFlowInterface
  {
    ...
    private void UpdateItems()
    {
      ...
      for (int index1 = mails.Count - 1; index1 >= 0; --index1)
      {
            ...
            if (gift.num > 0)
            {
              if (gift.CheckGiftTypeIncluded(GiftTypes.Artifact))
              {
                ...
                if (artifactData != null)
                  DataSource.Bind<ArtifactData>(gameObject1, artifactData, false);
                MailIcon component = gameObject1.GetComponent<MailIcon>();
                if ((UnityEngine.Object) component != (UnityEngine.Object) null)
                {
              ...
              if (gift.CheckGiftTypeIncluded(GiftTypes.Item))
              {
                ...
                DataSource.Bind<ItemData>(gameObject1, data2, false);
                MailIcon component = gameObject1.GetComponent<MailIcon>();
                if ((UnityEngine.Object) component != (UnityEngine.Object) null)
                {
        ...
        DataSource.Bind<MailData>(gameObject1, data1, false);
        GameObject gameObject2 = gameObject1.transform.Find("btn_read").gameObject;
        if ((UnityEngine.Object) gameObject2 != (UnityEngine.Object) null)
        {
          DataSource.Bind<MailData>(gameObject2, data1, false);
