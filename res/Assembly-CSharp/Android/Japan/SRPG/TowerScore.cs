  ...
  public class TowerScore : MonoBehaviour
  {
    ...
    public void SetRankData(TowerRankItem rankItem, TowerResuponse.TowerRankParam[] rankData)
    {
      ...
      else
      {
        ...
        if (!((UnityEngine.Object) rankItem != (UnityEngine.Object) null))
          return;
        DataSource.Bind<UnitData>(rankItem.gameObject, rankData1.unit, false);
        rankItem.Setup(rankData1);
        GameParameter.UpdateAll(rankItem.gameObject);
      }
    }
