...
namespace SRPG
{
  public class SkillParam
  {
    ...
    public string DependStateSpcEffUId;
    ...
    public bool Deserialize(JSON_SkillParam json)
    {
      ...
      this.DependStateSpcEffUId = json.dsse_id;
      ...
      if (json.is_ob_react != 0)
        this.flags |= SkillFlags.ObstReaction;
    ...
    public bool IsObstReaction()
    {
      return (this.flags & SkillFlags.ObstReaction) != (SkillFlags) 0;
    }
