...
namespace SRPG
{
  ...
  public class PartyWindow2 : MonoBehaviour, IFlowInterface, ISortableList
  {
    ...
    public Toggle[] TeamTabs = new Toggle[0];
    ...
    private bool IsShowDownloadPopup
    {
      get
      {
        if (AssetManager.UseDLC && AssetDownloader.IsEnableShowSizeBeforeDownloading)
          return this.mIsShowDownloadPopup;
        return false;
      }
    }
    ...
    private void OpenQuestDetail()
    {
      ...
      DataSource.Bind<QuestParam>(gameObject, this.mCurrentQuest, false);
      if (this.mGuestUnit != null && this.mGuestUnit.Count > 0 && this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Character)
        DataSource.Bind<UnitData>(gameObject, this.mGuestUnit[0], false);
    ...
    private void OpenMapEffectQuest()
    {
      ...
      if (!(bool) ((UnityEngine.Object) instance))
        return;
      DataSource.Bind<QuestParam>(instance, this.mCurrentQuest, false);
    ...
    private IEnumerator Start()
    {
      ...
      return (IEnumerator) new PartyWindow2.\u003CStart\u003Ec__Iterator0() { \u0024this = this };
    }
    ...
    {
      if (!this.OnTeamChangeImpl(this.mCurrentTeamIndex + 1) || !((UnityEngine.Object) this.TeamPulldown != (UnityEngine.Object) null))
        return;
    ...
    private RectTransform OnGetItemListItem(int id, int old, RectTransform current)
    {
      ...
      DataSource.Bind<ItemData>(rectTransform.gameObject, this.mOwnItems[id - 1], false);
      ...
      if ((UnityEngine.Object) this.ItemListHilit != (UnityEngine.Object) null)
      {
        ...
        else if ((UnityEngine.Object) this.ItemListHilit.parent == (UnityEngine.Object) rectTransform.Find(this.ItemListHilitParent))
        {
    ...
    private void OnPartyMemberChange()
    {
      ...
      if ((UnityEngine.Object) this.AddMainUnitOverlay != (UnityEngine.Object) null)
      {
        ...
        {
          if (this.mCurrentParty.Units[mainmemberStart] == null && mainmemberStart < this.UnitSlots.Length && (mainmemberStart < this.mSlotData.Count && (UnityEngine.Object) this.UnitSlots[mainmemberStart] != (UnityEngine.Object) null) && ((this.mLockedPartySlots & 1 << mainmemberStart) == 0 && this.mSlotData[mainmemberStart].Type == SRPG.PartySlotType.Free))
          {
      ...
      {
        if (this.mCurrentParty.Units[submemberStart] == null && submemberStart < this.UnitSlots.Length && (submemberStart < this.mSlotData.Count && (UnityEngine.Object) this.UnitSlots[submemberStart] != (UnityEngine.Object) null) && ((this.mLockedPartySlots & 1 << submemberStart) == 0 && this.mSlotData[submemberStart].Type == SRPG.PartySlotType.Free))
        {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PartyWindow2.\u003CPopulateItemList\u003Ec__Iterator1() { \u0024this = this };
    }
    ...
    private void RecvRaidResult(WWWResult www)
    {
      if (Network.IsError)
      {
        if (Network.ErrCode == Network.EErrCode.QuestArchive_ArchiveNotOpened)
        {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PartyWindow2.\u003CShowRaidResultAsync\u003Ec__Iterator2() { \u0024this = this };
    }
      ...
      if ((UnityEngine.Object) button == (UnityEngine.Object) this.ForwardButton)
      {
        ...
        else
        {
          if (this.mCurrentQuest != null)
          {
            ...
            {
              if (!this.mCurrentQuest.IsDateUnlock(-1L) && !MonoSingleton<GameManager>.Instance.Player.IsQuestArchiveOpenByArea(this.mCurrentQuest.ChapterID))
              {
    ...
    protected virtual void PostForwardPressed()
    {
      ...
      if (this.PartyType == PartyWindow2.EditPartyTypes.MultiTower)
        ...
        AssetDownloader.StartConfirmDownloadQuestContentYesNo(this.GetBattleEntryUnits(), this.GetBattleEntryItems(), MonoSingleton<GameManager>.Instance.FindQuest(GlobalVars.SelectedQuestID), (UIUtility.DialogResultEvent) (ok => this.SaveAndActivatePin(1)), (UIUtility.DialogResultEvent) (no => GlobalEvent.Invoke("ENABLE_MAINMENU_TOP_COMMAND", (object) null)));
      else
        this.SaveAndActivatePin(1);
    }
    ...
    protected void SaveAndActivatePin(int pinID)
    {
      ...
      else
      {
        ...
        this.SaveParty((PartyWindow2.Callback) (() =>
        {
          ...
          FlowNode_GameObject.ActivateOutputLinks((Component) this, pinID);
        }), (PartyWindow2.Callback) (() => UIUtility.NegativeSystemMessage((string) null, LocalizedText.Get("sys.ILLEGAL_PARTY"), (UIUtility.DialogResultEvent) null, (GameObject) null, false, -1)));
      }
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PartyWindow2.\u003CWaitForSave\u003Ec__Iterator3() { \u0024this = this };
    }
    ...
    protected void RefreshQuest()
    {
      ...
      QuestCampaignData[] questCampaigns = MonoSingleton<GameManager>.Instance.FindQuestCampaigns(this.mCurrentQuest);
      DataSource.Bind<QuestCampaignData[]>(this.gameObject, questCampaigns.Length != 0 ? questCampaigns : (QuestCampaignData[]) null, false);
      if ((UnityEngine.Object) this.QuestCampaigns != (UnityEngine.Object) null && (UnityEngine.Object) this.QuestCampaigns.GetQuestCampaignList != (UnityEngine.Object) null)
    ...
    protected void RefreshNoneQuestInfo(bool keepTeam)
    {
      ...
      DataSource.Bind<PlayerPartyTypes>(this.gameObject, playerPartyType, false);
      if (!keepTeam)
        this.LoadTeam();
      int index1 = 0;
      ...
      bool flag = this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Normal || this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Character || (this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Event || this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Tower) || this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Raid;
      ...
      {
        if (this.mCurrentQuest != null && (this.mCurrentQuest.type == QuestTypes.Tutorial || this.mCurrentQuest.type == QuestTypes.GenesisBoss))
    ...
    public void Refresh(bool keepTeam = false)
    {
      ...
      else
      {
        ...
        if ((UnityEngine.Object) this.QuestInfo != (UnityEngine.Object) null)
        {
          ...
          {
            DataSource.Bind<QuestParam>(this.QuestInfo, this.mCurrentQuest, false);
        ...
        if (this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Character && (UnityEngine.Object) this.QuestUnitCond != (UnityEngine.Object) null && (this.mGuestUnit != null && this.mGuestUnit.Count > 0))
        {
          DataSource.Bind<UnitData>(this.QuestUnitCond, this.mGuestUnit[0], false);
        ...
        {
          bool flag = this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Normal || this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Character || (this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Event || this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Tower) || this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Ordeal || this.mCurrentPartyType == PartyWindow2.EditPartyTypes.Raid;
          if ((UnityEngine.Object) this.RecommendTeamButton != (UnityEngine.Object) null)
          {
        ...
        if (this.mCurrentQuest != null && this.mCurrentQuest.IsMulti && (UnityEngine.Object) this.BattleSettingButton != (UnityEngine.Object) null)
          this.BattleSettingButton.interactable = false;
        this.ToggleRaidInfo();
        this.RefreshRaidTicketNum();
        this.RefreshRaidButtons();
        this.LockSlots();
    ...
    private void CreateSlots()
    {
      ...
      if (this.mCurrentQuest == null)
      {
        ...
        slotData1 = new PartySlotData(SRPG.PartySlotType.Locked, (string) null, PartySlotIndex.Support, false);
      ...
      else if (this.mCurrentQuest.questParty != null)
      {
        ...
        slotData1 = new PartySlotData(questParty.support_type, (string) null, PartySlotIndex.Support, false);
      ...
      else
      {
        ...
        {
          if (this.mCurrentQuest.type == QuestTypes.Tower || this.mCurrentQuest.type == QuestTypes.Raid)
          {
            partySlotDataList1.Add(new PartySlotData(SRPG.PartySlotType.Free, (string) null, PartySlotIndex.Main1, false));
            partySlotDataList1.Add(new PartySlotData(SRPG.PartySlotType.Free, (string) null, PartySlotIndex.Main2, false));
            partySlotDataList1.Add(new PartySlotData(SRPG.PartySlotType.Free, (string) null, PartySlotIndex.Main3, false));
            ...
            slotData1 = new PartySlotData(SRPG.PartySlotType.Free, (string) null, PartySlotIndex.Support, false);
            partySlotDataList2.Add(new PartySlotData(SRPG.PartySlotType.Free, (string) null, PartySlotIndex.Sub1, false));
            partySlotDataList2.Add(new PartySlotData(SRPG.PartySlotType.Free, (string) null, PartySlotIndex.Sub2, false));
          }
      ...
      if ((UnityEngine.Object) this.MainMemberHolder != (UnityEngine.Object) null && partySlotDataList1.Count > 0)
      {
        foreach (PartySlotData slotData2 in partySlotDataList1)
        {
      ...
      if ((UnityEngine.Object) this.SubMemberHolder != (UnityEngine.Object) null && partySlotDataList2.Count > 0)
      {
        foreach (PartySlotData slotData2 in partySlotDataList2)
        {
          GenericSlot genericSlot = slotData2.Type == SRPG.PartySlotType.Npc || slotData2.Type == SRPG.PartySlotType.NpcHero ? this.CreateSlotObject(slotData2, this.NpcSlotTemplate, this.SubMemberHolder) : this.CreateSlotObject(slotData2, this.UnitSlotTemplate, this.SubMemberHolder);
          genericSlotList.Add(genericSlot);
        }
      }
      ...
      {
        if ((UnityEngine.Object) this.UnitSlots[index] != (UnityEngine.Object) null && this.mSlotData[index].Type == SRPG.PartySlotType.Free)
      ...
      if (this.mCurrentQuest == null || this.mCurrentQuest.type != QuestTypes.Raid)
        return;
      bool flag = false;
      this.FriendSlot.gameObject.SetActive(flag);
      this.SupportSkill.gameObject.SetActive(flag);
    }
    ...
    {
      if (this.GetPartyCondType() == PartyCondType.Forced || this.mIsHeloOnly || !((UnityEngine.Object) this.TeamPulldown != (UnityEngine.Object) null))
        return;
      if (maxTeams <= 1)
      {
        this.TeamPulldown.gameObject.SetActive(false);
    ...
    private void RefreshRaidButtons()
    {
      ...
      if (this.mCurrentQuest != null)
      {
        ...
        if ((UnityEngine.Object) this.RaidInfo != (UnityEngine.Object) null)
        {
          DataSource.Bind<ItemParam>(this.RaidInfo.gameObject, data, false);
    ...
    private void OrganizeRecommendedParty(GlobalVars.RecommendType targetType, EElement targetElement)
    {
      ...
      foreach (List<UnitData> unitDataList2 in unitDataListList)
      {
        if (maxUnit > 0)
        {
          ...
          for (int index = 0; index < unitDataList2.Count; ++index)
          {
            unitDataList1.Add(unitDataList2[index]);
            source.Add(index);
            if (--maxUnit <= 0)
              break;
          }
      ...
      int num1 = 0;
      for (int slotIndex = 0; slotIndex < partyData.MAX_UNIT && slotIndex < this.mSlotData.Count && num1 < unitDataList1.Count; ++slotIndex)
      {
        if (this.IsSettableSlot(this.mSlotData[slotIndex]))
          this.SetPartyUnit(slotIndex, unitDataList1[num1++]);
      }
      this.OnPartyMemberChange();
      this.SaveTeamPresets();
    }
    ...
    protected List<UnitData> GetBattleEntryUnits()
    {
      ...
      for (int index = 0; index < this.UnitSlots.Length; ++index)
        action(this.UnitSlots[index].gameObject);
      if ((UnityEngine.Object) this.FriendSlot != (UnityEngine.Object) null)
        action(this.FriendSlot.gameObject);
      return result;
    }
      ...
      for (int index = 0; index < 5 && index < this.mCurrentItems.Length; ++index)
      {
        if (this.mCurrentItems[index] != null)
        {
          ...
          if (itemDataByItemParam != null)
            itemDataList.Add(itemDataByItemParam);
        }
      }
      return itemDataList;
    }
