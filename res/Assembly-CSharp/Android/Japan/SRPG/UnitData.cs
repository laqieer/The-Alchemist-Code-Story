...
namespace SRPG
{
  public class UnitData
  {
    ...
    public QuestClearUnlockUnitDataParam QuestUnlockedLeaderSkill
    {
      get
      {
        return this.mUnlockedLeaderSkill;
      }
    }
    ...
    public void SetJobSkin(string afName, int jobIndex = -1, bool is_need_check = true)
    {
      ...
      else
      {
        ...
        if (af == null)
          return;
        if (Array.FindIndex<ArtifactParam>(this.GetEnableConceptCardSkins(-1), (Predicate<ArtifactParam>) (artifact => artifact.iname == af.iname)) >= 0)
        {
        ...
        for (int index1 = 0; index1 < this.Jobs.Length; ++index1)
        {
          ...
          if (job.AbilitySlots != null || job.Artifacts != null)
          {
            ...
            if (job.ArtifactDatas != null)
            {
              if (flag)
                str5 += ",";
              string str6 = str5 + "\"inspiration_skills\":[";
              for (int index2 = 0; index2 < job.ArtifactDatas.Length; ++index2)
              {
                if (job.ArtifactDatas[index2] != null && job.ArtifactDatas[index2].InspirationSkillList != null)
                {
                  for (int index3 = 0; index3 < job.ArtifactDatas[index2].InspirationSkillList.Count; ++index3)
                  {
                    if (index3 > 0)
                      str6 += ",";
                    str6 = job.ArtifactDatas[index2].InspirationSkillList[index3] != null ? str6 + "{\"artifact_iid\":" + (object) job.ArtifactDatas[index2].UniqueID + ",\"iid\":" + (object) job.ArtifactDatas[index2].InspirationSkillList[index3].UniqueID + ",\"slot\":" + (object) job.ArtifactDatas[index2].InspirationSkillList[index3].Slot + ",\"iname\":\"" + job.ArtifactDatas[index2].InspirationSkillList[index3].InspSkillParam.Iname + "\"" + ",\"level\":" + (object) job.ArtifactDatas[index2].InspirationSkillList[index3].Lv + ",\"is_set\":" + (object) (!(bool) job.ArtifactDatas[index2].InspirationSkillList[index3].IsSet ? 0 : 1) + "}" : str6 + "null";
                  }
                }
              }
              str5 = str6 + "]";
          ...
          if (job.ArtifactDatas != null)
          {
            ...
            for (int index2 = 0; index2 < job.ArtifactDatas.Length; ++index2)
            {
              ...
              {
                string str6 = str5 + "{\"iid\":" + (object) artifactData.UniqueID + ",\"iname\":\"" + artifactData.ArtifactParam.iname + "\"" + ",\"exp\":" + (object) artifactData.Exp + ",\"rare\":" + (object) artifactData.Rarity + ",\"fav\":" + (object) (!artifactData.IsFavorite ? 0 : 1) + ",\"inspiration_skill_slots\":" + (object) artifactData.InspirationSkillSlotNum;
                if (artifactData.InspirationSkillList != null)
                {
                  string str7 = str6 + ",\"inspiration_skills\":[";
                  for (int index3 = 0; index3 < artifactData.InspirationSkillList.Count; ++index3)
                  {
                    InspirationSkillData inspirationSkill = artifactData.InspirationSkillList[index3];
                    if (index3 > 0)
                      str7 += ",";
                    str7 = inspirationSkill != null ? str7 + "{\"iid\":" + (object) inspirationSkill.UniqueID + ",\"slot\":" + (object) inspirationSkill.Slot + ",\"iname\":\"" + inspirationSkill.InspSkillParam.Iname + "\"" + ",\"level\":" + (object) inspirationSkill.Lv + ",\"is_set\":" + (object) (!(bool) inspirationSkill.IsSet ? 0 : 1) + "}" : str7 + "null";
                  }
                  str6 = str7 + "]";
                }
                str5 = str6 + "}";
          ...
          if (job.ArtifactDatas != null)
          {
            ...
            if (job.UniqueID == num1)
            {
              for (int index2 = 0; index2 < job.ArtifactDatas.Length; ++index2)
              {
                ...
                {
                  string str6 = str5 + "{\"iid\":" + (object) artifactData.UniqueID + ",\"iname\":\"" + artifactData.ArtifactParam.iname + "\"" + ",\"exp\":" + (object) artifactData.Exp + ",\"rare\":" + (object) artifactData.Rarity + ",\"inspiration_skill_slots\":" + (object) artifactData.InspirationSkillSlotNum;
                  if (artifactData.InspirationSkillList != null)
                  {
                    string str7 = str6 + ",\"inspiration_skills\":[";
                    for (int index3 = 0; index3 < artifactData.InspirationSkillList.Count; ++index3)
    ...
    public void ShowTooltip(GameObject targetGO, bool allowJobChange = false, UnitJobDropdown.ParentObjectEvent updateValue = null)
    {
      ...
      DataSource.Bind<UnitData>(root, data, false);
      DataSource.Bind<PlayerPartyTypes>(root, dataOfClass, false);
    ...
    public void GainExp(int exp, int playerLv)
    {
      ...
      this.CalcStatus();
      GameManager instanceDirect = MonoSingleton<GameManager>.GetInstanceDirect();
      instanceDirect.Player.OnUnitLevelChange(this.UnitID, (int) this.mLv - mLv, (int) this.mLv, false);
    ...
    public void CalcStatus(int lv, int jobNo, ref BaseStatus status, int disableJobMasterJobNo = -1)
    {
      ...
      if (jobData != null)
      {
        ...
        if (this.mConceptCard != null)
        {
          List<ConceptCardEquipEffect> enableEquipEffects = this.mConceptCard.GetEnableEquipEffects(this, jobData, false);
    ...
    {
      this.AddBattleAbilityArtifacts((int) this.mJobIndex, true);
      this.AddBattleAbilitySkin((int) this.mJobIndex, true);
      this.AddBattleAbilityConceptCard((int) this.mJobIndex, true);
    }
    ...
    private void UpdateUnitBattleAbilityAll(int jobIndex)
    {
      ...
      if (jobData != null)
      {
        ...
        this.AddBattleAbilityArtifacts(jobIndex, false);
        this.AddBattleAbilitySkin(jobIndex, false);
      }
      this.AddBattleAbilityConceptCard(jobIndex, false);
      ...
      {
        if (!string.IsNullOrEmpty(mBattleSkill.ReplaceSkillId))
        {
          mBattleSkill.Setup(mBattleSkill.ReplaceSkillId, mBattleSkill.Rank, mBattleSkill.GetRankCap(), (MasterParam) null);
          mBattleSkill.ReplaceSkillId = (string) null;
        }
        string iname1 = mBattleSkill.SkillParam.iname;
        string iname2 = this.SearchReplacementSkill(iname1);
        if (iname2 != null)
        {
          mBattleSkill.Setup(iname2, mBattleSkill.Rank, mBattleSkill.GetRankCap(), (MasterParam) null);
          mBattleSkill.ReplaceSkillId = iname1;
        }
      }
    ...
    private void AddBattleAbilityArtifacts(int jobIndex, bool is_force = false)
    {
      JobData jobData = this.GetJobData(jobIndex);
          ...
          if (artifactData != null)
          {
            if (artifactData.LearningAbilities != null)
            {
              for (int index2 = 0; index2 < artifactData.LearningAbilities.Count; ++index2)
              {
                ...
                if (learningAbility != null && (is_force || learningAbility.CheckEnableUseAbility(this, jobIndex)) && !this.mBattleAbilitys.Contains(learningAbility))
                {
    ...
    private void AddBattleAbilitySkin(int jobIndex, bool is_force = false)
    {
      JobData jobData = this.GetJobData(jobIndex);
    ...
    private void AddBattleAbilityConceptCard(int jobIndex, bool is_force = false)
    {
      JobData jobData = this.GetJobData(jobIndex);
      if (jobData == null || this.mConceptCard == null)
        return;
      List<ConceptCardEquipEffect> enableEquipEffects = this.mConceptCard.GetEnableEquipEffects(this, jobData, is_force);
    ...
    public int GetSkillUsedCost(SkillParam skill)
    {
      ...
      if (skill.effect_type != SkillEffectTypes.GemsGift && skill.type != ESkillType.Attack && skill.type != ESkillType.Item)
      {
        ...
        num1 = Math.Max(num2 + num2 * (int) this.Status[BattleBonus.UsedJewelRate] / 100, 0);
      }
      return num1;
    }
    ...
    public bool SetEquipArtifactData(int job_index, int slot, ArtifactData artifact, bool is_calc = true)
    {
      ...
      if (jobData == null || !jobData.SetEquipArtifact(slot, artifact, false))
        return false;
    ...
    public void SetJobFor(PlayerPartyTypes type, JobData job)
    {
      if (this.mPartyJobs == null)
        this.mPartyJobs = new long[12];
      else if (this.mPartyJobs.Length != 12)
        Array.Resize<long>(ref this.mPartyJobs, 12);
    ...
    public bool IsChanging
    {
      ...
      {
        if (this.UnitParam != null)
          return this.UnitParam.IsChanging();
        return false;
      }
    }
