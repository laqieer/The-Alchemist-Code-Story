...
namespace SRPG
{
  ...
  public class ConceptCardDetailAbility : ConceptCardDetailBase, IFlowInterface
  {
    ...
    public void SetCardSkill(ConceptCardSkillDatailData data)
    {
      ...
      {
        DataSource.Bind<AbilityData>(this.gameObject, data.effect == null || data.effect.Ability == null ? (AbilityData) null : data.effect.Ability, false);
        DataSource.Bind<SkillData>(this.gameObject, data.skill_data, false);
        ...
        if ((UnityEngine.Object) this.mCardSkillStatusList != (UnityEngine.Object) null)
          this.mCardSkillStatusList.gameObject.SetActive(false);
        if (data.skill_data.Condition == ESkillCondition.CardSkill && (UnityEngine.Object) this.mCardSkillStatusList != (UnityEngine.Object) null && data.skill_data != null)
        {
          this.mCardSkillStatusList.gameObject.SetActive(true);
        ...
        if ((UnityEngine.Object) this.mLock != (UnityEngine.Object) null)
    ...
    {
      if ((UnityEngine.Object) image == (UnityEngine.Object) null || unit_param == null)
        return;
