...
namespace SRPG
{
  ...
  public class HealAp : MonoBehaviour, IFlowInterface
  {
    ...
    public void Refresh(bool is_quest, PartyWindow2 _party_window)
    {
      ...
      if (list != null)
      {
        for (int index = 0; index < list.Count; ++index)
        {
          ...
          gameObject.GetComponent<Button>().interactable = data.Num > 0;
      ...
      if (this.mQuestParam != null)
      {
        ...
        if ((UnityEngine.Object) _party_window != (UnityEngine.Object) null && (UnityEngine.Object) _party_window.RaidSettings != (UnityEngine.Object) null && _party_window.MultiRaidNum > 0)
    ...
    {
      DataSource.Bind<ItemData>(this.gameObject, DataSource.FindDataOfClass<ItemData>(go, (ItemData) null), false);
