...
namespace SRPG
{
  ...
  public class EventPopup : MonoBehaviour, IFlowInterface
  {
    ...
    private List<BannerParam> m_BannerList = new List<BannerParam>();
    ...
    private void Awake()
    {
      if (!((UnityEngine.Object) this.EventBannerTemplate != (UnityEngine.Object) null))
        return;
    ...
    private void Setup(BannerParam[] _params)
    {
      ...
      else if ((UnityEngine.Object) this.EventBannerTemplate == (UnityEngine.Object) null)
      {
    ...
    {
      if (!(bool) ((UnityEngine.Object) MonoSingleton<GameManager>.Instance))
        return;
