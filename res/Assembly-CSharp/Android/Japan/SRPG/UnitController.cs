...
namespace SRPG
{
  public abstract class UnitController : AnimationPlayer
  {
    ...
    public int UIDispOffset
    {
      get
      {
        if ((UnityEngine.Object) this.mCharacterSettings != (UnityEngine.Object) null)
          return this.mCharacterSettings.UIDispOffset;
        return 0;
      }
    }
    ...
    public Vector3 UIDispPosition
    {
      get
      {
        return this.transform.position + Vector3.up * (float) ((double) this.UIDispOffset / 2.0 + 0.5);
      }
    }
    ...
    {
      return this.gameObject.layer != GameUtility.LayerHidden;
    }
    ...
    private IEnumerator AsyncSetup(CharacterDB.Character ch, int jobIndex)
    {
      ...
      return (IEnumerator) new UnitController.\u003CAsyncSetup\u003Ec__Iterator0() { ch = ch, jobIndex = jobIndex, \u0024this = this };
    }
    ...
    public void SetSubEquipment(GameObject primaryHand, GameObject secondaryHand, List<GameObject> primary_lists, List<GameObject> secondary_lists, bool hidden = false)
    {
      ...
      if (primary_lists != null && !string.IsNullOrEmpty(this.Rig.RightHand))
      {
        ...
        if ((bool) ((UnityEngine.Object) childRecursively))
        {
          ...
          foreach (GameObject primaryList in primary_lists)
          {
            ...
            if ((bool) ((UnityEngine.Object) primaryList))
            {
              materialObject = UnityEngine.Object.Instantiate<GameObject>(primaryList, primaryList.transform.position, primaryList.transform.rotation);
      ...
      if (primary_lists != null && !string.IsNullOrEmpty(this.Rig.LeftHand))
      {
        ...
        if ((bool) ((UnityEngine.Object) childRecursively))
        {
          ...
          {
            GameObject materialObject = (GameObject) null;
            if ((bool) ((UnityEngine.Object) secondaryList))
            {
              materialObject = UnityEngine.Object.Instantiate<GameObject>(secondaryList, secondaryList.transform.position, secondaryList.transform.rotation);
              if ((bool) ((UnityEngine.Object) materialObject))
              {
                materialObject.transform.SetParent(childRecursively, false);
                materialObject.transform.localScale = Vector3.one * this.Rig.EquipmentScale;
