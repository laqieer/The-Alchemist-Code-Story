  ...
  public static class Helper
  {
    ...
    public static void LogInfo(string message, UnityEngine.Object context = null)
    {
      if (context == (UnityEngine.Object) null)
        UnityEngine.Debug.Log((object) ("[AVProVideo] " + message));
      else
        UnityEngine.Debug.Log((object) ("[AVProVideo] " + message), context);
    }
    ...
    public static List<Subtitle> LoadSubtitlesSRT(string data)
    {
      ...
      if (!string.IsNullOrEmpty(data))
      {
        ...
        if (strArray1.Length >= 3)
        {
          ...
          UnityEngine.Debug.LogWarning((object) "[AVProVideo] SRT format doesn't appear to be valid");
      }
      return subtitleList;
    }
  }
