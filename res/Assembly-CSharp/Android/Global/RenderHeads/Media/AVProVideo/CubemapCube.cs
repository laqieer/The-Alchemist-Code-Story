...
namespace RenderHeads.Media.AVProVideo
{
  ...
  public class CubemapCube : MonoBehaviour
  {
    ...
    private void BuildMesh()
    {
      ...
      {
        new Vector3(0.0f, -1f, 0.0f) - vector3,
        new Vector3(0.0f, 0.0f, 0.0f) - vector3,
        new Vector3(0.0f, 0.0f, -1f) - vector3,
        new Vector3(0.0f, -1f, -1f) - vector3,
        new Vector3(0.0f, 0.0f, 0.0f) - vector3,
        new Vector3(-1f, 0.0f, 0.0f) - vector3,
        new Vector3(-1f, 0.0f, -1f) - vector3,
        new Vector3(0.0f, 0.0f, -1f) - vector3,
        new Vector3(-1f, 0.0f, 0.0f) - vector3,
        new Vector3(-1f, -1f, 0.0f) - vector3,
        new Vector3(-1f, -1f, -1f) - vector3,
        new Vector3(-1f, 0.0f, -1f) - vector3,
        new Vector3(-1f, -1f, 0.0f) - vector3,
        new Vector3(0.0f, -1f, 0.0f) - vector3,
        new Vector3(0.0f, -1f, -1f) - vector3,
    ...
    private void UpdateMeshUV(int textureWidth, int textureHeight, bool flipY)
    {
      ...
      {
        new Vector2(0.3333333f + num5, 1f - num6),
        new Vector2(0.6666667f - num5, 1f - num6),
        new Vector2(0.6666667f - num5, 0.5f + num6),
        new Vector2(0.3333333f + num5, 0.5f + num6),
        new Vector2(0.3333333f + num5, 0.5f - num6),
        new Vector2(0.6666667f - num5, 0.5f - num6),
        new Vector2(0.6666667f - num5, 0.0f + num6),
        new Vector2(0.3333333f + num5, 0.0f + num6),
        new Vector2(0.0f + num5, 1f - num6),
        new Vector2(0.3333333f - num5, 1f - num6),
        new Vector2(0.3333333f - num5, 0.5f + num6),
        new Vector2(0.0f + num5, 0.5f + num6),
        new Vector2(0.6666667f + num5, 0.5f - num6),
        new Vector2(1f - num5, 0.5f - num6),
        new Vector2(1f - num5, 0.0f + num6),
        new Vector2(0.6666667f + num5, 0.0f + num6),
        new Vector2(0.0f + num5, 0.0f + num6),
        new Vector2(0.0f + num5, 0.5f - num6),
        new Vector2(0.3333333f - num5, 0.5f - num6),
        new Vector2(0.3333333f - num5, 0.0f + num6),
