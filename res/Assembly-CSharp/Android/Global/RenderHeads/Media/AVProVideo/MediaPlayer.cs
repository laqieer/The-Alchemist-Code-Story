  ...
  public class MediaPlayer : MonoBehaviour
  {
    ...
    public bool EnableSubtitles(MediaPlayer.FileLocation fileLocation, string filePath)
    {
      ...
      if (this.m_Subtitles != null)
      {
        if (!string.IsNullOrEmpty(filePath))
        {
          ...
          {
            UnityEngine.Debug.LogError((object) ("[AVProVideo] Subtitle file not found: " + platformFilePath), (UnityEngine.Object) this);
          }
          else
          {
            ...
            try
            {
              ...
              else if (this.m_Subtitles.LoadSubtitlesSRT(File.ReadAllText(platformFilePath)))
              {
                ...
                UnityEngine.Debug.LogError((object) ("[AVProVideo] Failed to load subtitles" + platformFilePath), (UnityEngine.Object) this);
            }
            catch (Exception ex)
            {
              UnityEngine.Debug.LogError((object) ("[AVProVideo] Failed to load subtitles " + platformFilePath), (UnityEngine.Object) this);
          ...
          UnityEngine.Debug.LogError((object) "[AVProVideo] No subtitle file path specified", (UnityEngine.Object) this);
      }
      else
      {
    ...
    private bool OpenVideoFromBufferInternal(byte[] buffer)
    {
      ...
      if (this.m_Control != null)
      {
        ...
        {
          UnityEngine.Debug.LogError((object) "[AVProVideo] Failed to open buffer", (UnityEngine.Object) this);
        }
        else
        {
    ...
    private bool OpenVideoFromFile()
    {
      ...
      if (this.m_Control != null)
      {
        ...
        if (!string.IsNullOrEmpty(this.m_VideoPath))
        {
          ...
          if (false && !File.Exists(platformFilePath))
            UnityEngine.Debug.LogError((object) ("[AVProVideo] File not found: " + platformFilePath), (UnityEngine.Object) this);
          else if (!this.m_Control.OpenVideoFromFile(platformFilePath, platformFileOffset, httpHeaderJson))
          {
            UnityEngine.Debug.LogError((object) ("[AVProVideo] Failed to open " + platformFilePath), (UnityEngine.Object) this);
          }
          else
          {
            this.SetPlaybackOptions();
          ...
          UnityEngine.Debug.LogError((object) "[AVProVideo] No file path specified", (UnityEngine.Object) this);
      }
      return flag1;
    }
    ...
    public static string GetPath(MediaPlayer.FileLocation location)
    {
      ...
      switch (location)
      {
        case MediaPlayer.FileLocation.RelativeToProjectFolder:
          str = Path.GetFullPath(Path.Combine(Application.dataPath, "..")).Replace('\\', '/');
          break;
    ...
    public virtual BaseMediaPlayer CreatePlatformMediaPlayer()
    {
      ...
      {
        UnityEngine.Debug.LogError((object) string.Format("[AVProVideo] Not supported on this platform {0} {1} {2} {3}.  Using null media player!", new object[4]
        {
    ...
    private void UpdateErrors()
    {
      ...
      if (lastError == ErrorCode.None)
        return;
      UnityEngine.Debug.LogError((object) ("[AVProVideo] Error: " + Helper.GetErrorMessage(lastError)));
      if (this.m_events == null)
        return;
    ...
    private Texture ExtractFrame(float timeSeconds = -1f, bool accurateSeek = true, int timeoutMs = 1000)
    {
      ...
      if (this.m_Control != null)
      {
        if ((double) timeSeconds >= 0.0)
        {
          ...
          if ((UnityEngine.Object) this.TextureProducer.GetTexture(0) != (UnityEngine.Object) null && (double) this.m_Control.GetCurrentTimeMs() == (double) timeMs)
          {
