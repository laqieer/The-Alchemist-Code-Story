...
public abstract class FlowNode : MonoBehaviour
{
  ...
  private List<string> GetDetailedInfoLines()
  {
    ...
    for (int index = 0; index < fieldsExcludingLinks.Count; ++index)
    {
      ...
      if (obj != null)
        str = !obj.GetType().IsSubclassOf(typeof (UnityEngine.Object)) || !((UnityEngine.Object) obj != (UnityEngine.Object) null) ? obj.ToString() : ((UnityEngine.Object) obj).name;
  ...
  private List<string> GetSimpleInfoLines()
  {
    ...
    for (int index = 0; index < fields.Length; ++index)
    {
      ...
      if (customAttributes.Length > 0)
      {
        ...
        if (obj != null)
        {
          string str = !obj.GetType().IsSubclassOf(typeof (UnityEngine.Object)) || !((UnityEngine.Object) obj != (UnityEngine.Object) null) ? obj.ToString() : ((UnityEngine.Object) obj).name;
  ...
  public void ActivateOutputLinks(int pinID)
  {
    ...
    {
      if (this.OutputLinks[index].SrcPinID == pinID && !((UnityEngine.Object) this.OutputLinks[index].Dest == (UnityEngine.Object) null))
  ...
  public void LinkPin(FlowNode.Pin srcPin, FlowNode dest, FlowNode.Pin destPin)
  {
    ...
    {
      if (flowNode1.OutputLinks[index].SrcPinID == srcPin.PinID && (UnityEngine.Object) flowNode1.OutputLinks[index].Dest == (UnityEngine.Object) flowNode2 && flowNode1.OutputLinks[index].DestPinID == destPin.PinID)
        return;
    }
  ...
  public class NodeType : Attribute
  {
    ...
    {
      this.Name = name;
      this.Color = (Color) new Color32((byte) (color >> 16 & (int) byte.MaxValue), (byte) (color >> 8 & (int) byte.MaxValue), (byte) (color & (int) byte.MaxValue), byte.MaxValue);
    }
  }
