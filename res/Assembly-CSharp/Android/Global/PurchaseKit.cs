...
public static class PurchaseKit
{
  ...
  public static void Init(string[] productIds, IPurchaseListener listener, GameObject serviceNode = null, PurchaseKit.Logger logger = null, [Optional] IntPtr nativeLogger)
  {
    ...
    if ((UnityEngine.Object) serviceNode == (UnityEngine.Object) null)
    {
      serviceNode = new GameObject("PurchaseService");
      serviceNode.hideFlags |= HideFlags.HideInHierarchy;
      UnityEngine.Object.DontDestroyOnLoad((UnityEngine.Object) serviceNode);
    }
    PurchaseService purchaseService = serviceNode.GetComponent<PurchaseService>();
    if ((UnityEngine.Object) purchaseService == (UnityEngine.Object) null)
