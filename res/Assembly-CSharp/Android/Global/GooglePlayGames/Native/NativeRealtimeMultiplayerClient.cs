...
namespace GooglePlayGames.Native
{
  public class NativeRealtimeMultiplayerClient : IRealTimeMultiplayerClient
  {
      ...
      lock (this.mSessionLock)
      {
        ...
        else
        {
          ...
          using (RealtimeRoomConfigBuilder roomConfigBuilder = RealtimeRoomConfigBuilder.Create())
          {
            ...
            using (config)
            {
              GooglePlayGames.Native.PInvoke.RealTimeEventListenerHelper helper = NativeRealtimeMultiplayerClient.HelperForSession(newSession);
              try
              {
          ...
          this.mRealtimeManager.ShowPlayerSelectUI(minOpponents, maxOppponents, true, (Action<PlayerSelectUIResponse>) (response =>
          {
            ...
            else
            {
              ...
              using (RealtimeRoomConfigBuilder roomConfigBuilder = RealtimeRoomConfigBuilder.Create())
              {
                ...
                RealtimeRoomConfig config = roomConfigBuilder.Build();
                try
                {
                  GooglePlayGames.Native.PInvoke.RealTimeEventListenerHelper helper = NativeRealtimeMultiplayerClient.HelperForSession(newRoom);
                  try
                  {
    ...
    public void AcceptInvitation(string invitationId, RealTimeMultiplayerListener listener)
    {
      ...
      NativeRealtimeMultiplayerClient.\u003CAcceptInvitation\u003Ec__AnonStorey1B3 invitationCAnonStorey1B3_1 = new NativeRealtimeMultiplayerClient.\u003CAcceptInvitation\u003Ec__AnonStorey1B3();
      // ISSUE: reference to a compiler-generated field
      invitationCAnonStorey1B3_1.invitationId = invitationId;
      // ISSUE: reference to a compiler-generated field
      invitationCAnonStorey1B3_1.\u003C\u003Ef__this = this;
      lock (this.mSessionLock)
      {
        NativeRealtimeMultiplayerClient.RoomSession newRoom = new NativeRealtimeMultiplayerClient.RoomSession(this.mRealtimeManager, listener);
        if (this.mCurrentSession.IsActive())
        ...
        else
        {
          ...
          this.mRealtimeManager.FetchInvitations((Action<RealtimeManager.FetchInvitationsResponse>) (response =>
          {
            ...
            {
              // ISSUE: variable of a compiler-generated type
              NativeRealtimeMultiplayerClient.\u003CAcceptInvitation\u003Ec__AnonStorey1B3 invitationCAnonStorey1B3 = invitationCAnonStorey1B3_1;
              // ISSUE: variable of a compiler-generated type
              NativeRealtimeMultiplayerClient.\u003CAcceptInvitation\u003Ec__AnonStorey1B2 invitationCAnonStorey1B2 = this;
