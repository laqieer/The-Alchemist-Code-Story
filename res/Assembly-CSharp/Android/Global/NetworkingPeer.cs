...
internal class NetworkingPeer : LoadBalancingPeer, IPhotonPeerListener
{
  ...
  protected internal void SetupProtocol(ServerConnection serverType)
  {
    ...
    if ((object) type != null)
    {
      ((Dictionary<ConnectionProtocol, System.Type>) this.SocketImplementationConfig)[ConnectionProtocol.WebSocket] = type;
      ((Dictionary<ConnectionProtocol, System.Type>) this.SocketImplementationConfig)[ConnectionProtocol.WebSocketSecure] = type;
    }
  ...
  private void ReadoutProperties(ExitGames.Client.Photon.Hashtable gameProperties, ExitGames.Client.Photon.Hashtable pActorProperties, int targetActorNr)
  {
    if (pActorProperties != null && ((Dictionary<object, object>) pActorProperties).Count > 0)
    {
      if (targetActorNr > 0)
      {
        ...
        {
          ExitGames.Client.Photon.Hashtable properties = this.ReadoutPropertiesForActorNr(pActorProperties, targetActorNr);
      ...
      else
      {
        using (Dictionary<object, object>.KeyCollection.Enumerator enumerator = ((Dictionary<object, object>) pActorProperties).Keys.GetEnumerator())
        {
          while (enumerator.MoveNext())
          {
            ...
            int num = (int) current;
            ExitGames.Client.Photon.Hashtable pActorProperty = (ExitGames.Client.Photon.Hashtable) pActorProperties[current];
  ...
  private ExitGames.Client.Photon.Hashtable ReadoutPropertiesForActorNr(ExitGames.Client.Photon.Hashtable actorProperties, int actorNr)
  {
    if (((Dictionary<object, object>) actorProperties).ContainsKey((object) actorNr))
      return (ExitGames.Client.Photon.Hashtable) actorProperties[(object) actorNr];
      ...
      using (Dictionary<int, PhotonView>.ValueCollection.Enumerator enumerator = this.photonViewList.Values.GetEnumerator())
      {
        while (enumerator.MoveNext())
        {
          ...
          if (current.isRuntimeInstantiated)
            gameObjectSet.Add(current.gameObject);
        }
      }
  ...
  private void GameEnteredOnGameServer(OperationResponse operationResponse)
  {
    ...
    else
    {
      ...
      ExitGames.Client.Photon.Hashtable pActorProperties = (ExitGames.Client.Photon.Hashtable) operationResponse[(byte) 249];
      this.ReadoutProperties((ExitGames.Client.Photon.Hashtable) operationResponse[(byte) 248], pActorProperties, 0);
  ...
  public bool SetMasterClient(int nextMasterId)
  {
    ...
    ExitGames.Client.Photon.Hashtable gameProperties = hashtable1;
  ...
  private void SendPlayerName()
  {
    ...
    else
    {
      ...
      if (this.LocalPlayer.ID <= 0)
        return;
      this.OpSetPropertiesOfActor(this.LocalPlayer.ID, actorProperties, (ExitGames.Client.Photon.Hashtable) null, false);
    ...
    else
    {
      ...
      switch (operationCode)
      {
        case 217:
          ...
          this.mGameList = new Dictionary<string, RoomInfo>();
          ExitGames.Client.Photon.Hashtable hashtable = (ExitGames.Client.Photon.Hashtable) operationResponse[(byte) 222];
          using (Dictionary<object, object>.KeyCollection.Enumerator enumerator = ((Dictionary<object, object>) hashtable).Keys.GetEnumerator())
          {
            while (enumerator.MoveNext())
            {
              ...
              this.mGameList[roomName] = new RoomInfo(roomName, (ExitGames.Client.Photon.Hashtable) hashtable[current]);
            }
          }
          ...
          if (this.Server == ServerConnection.NameServer || this.Server == ServerConnection.MasterServer)
          {
            if (((Dictionary<byte, object>) operationResponse.Parameters).ContainsKey((byte) 225))
            {
              ...
              if (!string.IsNullOrEmpty(parameter))
              {
                ...
                if (PhotonNetwork.logLevel >= PhotonLogLevel.Informational)
                  this.DebugReturn(DebugLevel.INFO, string.Format("Received your UserID from server. Updating local value to: {0}", (object) parameter));
              }
            }
            if (((Dictionary<byte, object>) operationResponse.Parameters).ContainsKey((byte) 202))
            {
              ...
              if (PhotonNetwork.logLevel >= PhotonLogLevel.Informational)
                this.DebugReturn(DebugLevel.INFO, string.Format("Received your NickName from server. Updating local value to: {0}", (object) this.playername));
            }
  ...
  {
    if (PhotonNetwork.logLevel >= PhotonLogLevel.Informational)
      Debug.Log((object) string.Format("OnStatusChanged: {0} current State: {1}", (object) ((Enum) statusCode).ToString(), (object) this.State));
    switch (statusCode)
    {
      ...
      case StatusCode.QueueIncomingUnreliableWarning:
        Debug.Log((object) (((int) statusCode).ToString() + ". This client buffers many incoming messages. This is OK temporarily. With lots of these warnings, check if you send too much or execute messages too slow. " + (!PhotonNetwork.isMessageQueueRunning ? (object) "Your isMessageQueueRunning is false. This can cause the issue temporarily." : (object) string.Empty)));
        break;
      ...
      case StatusCode.DisconnectByServerLogic:
        if (this.IsInitialConnect)
        {
          Debug.LogWarning((object) (((int) statusCode).ToString() + " while connecting to: " + this.ServerAddress + ". Check if the server is available."));
          NetworkingPeer.SendMonoMessage(PhotonNetworkingMessage.OnFailedToConnectToPhoton, (object) (DisconnectCause) statusCode);
        }
        else
          NetworkingPeer.SendMonoMessage(PhotonNetworkingMessage.OnConnectionFail, (object) (DisconnectCause) statusCode);
  ...
  public void OnEvent(EventData photonEvent)
  {
    ...
    {
      index1 = (int) photonEvent[(byte) 254];
    ...
    {
      case 200:
        this.ExecuteRpc(photonEvent[(byte) 245] as ExitGames.Client.Photon.Hashtable, photonPlayer);
        break;
      case 201:
      case 206:
        ExitGames.Client.Photon.Hashtable hashtable1 = (ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 245];
        ...
        for (byte index2 = num1; (int) index2 - (int) num1 < ((Dictionary<object, object>) hashtable1).Count - num2; ++index2)
          this.OnSerializeRead(hashtable1[(object) index2] as object[], photonPlayer, networkTime, correctPrefix);
        break;
      case 202:
        this.DoInstantiate((ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 245], photonPlayer, (GameObject) null);
        break;
      case 203:
        ...
        break;
      case 204:
        int key = (int) ((ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 245])[(object) (byte) 0];
        PhotonView photonView1 = (PhotonView) null;
        if (this.photonViewList.TryGetValue(key, out photonView1))
        {
          this.RemoveInstantiatedGO(photonView1.gameObject, true);
          break;
        }
        ...
        break;
      case 207:
        int playerId = (int) ((ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 245])[(object) (byte) 0];
        if (playerId >= 0)
        {
        ...
        break;
      case 208:
        this.SetMasterClient((int) ((ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 245])[(object) (byte) 1], false);
        break;
      case 209:
        ...
        if ((UnityEngine.Object) photonView2 == (UnityEngine.Object) null)
        {
      ...
      case 210:
        ...
        if (!((UnityEngine.Object) photonView3 != (UnityEngine.Object) null))
          break;
      ...
      case 228:
        break;
      case 229:
        ExitGames.Client.Photon.Hashtable hashtable2 = (ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 222];
        using (Dictionary<object, object>.KeyCollection.Enumerator enumerator = ((Dictionary<object, object>) hashtable2).Keys.GetEnumerator())
        {
          while (enumerator.MoveNext())
          {
            ...
            RoomInfo roomInfo = new RoomInfo(index2, (ExitGames.Client.Photon.Hashtable) hashtable2[current]);
      ...
      case 230:
        this.mGameList = new Dictionary<string, RoomInfo>();
        ExitGames.Client.Photon.Hashtable hashtable3 = (ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 222];
        using (Dictionary<object, object>.KeyCollection.Enumerator enumerator = ((Dictionary<object, object>) hashtable3).Keys.GetEnumerator())
        {
          while (enumerator.MoveNext())
          {
            object current = enumerator.Current;
            string roomName = (string) current;
            this.mGameList[roomName] = new RoomInfo(roomName, (ExitGames.Client.Photon.Hashtable) hashtable3[current]);
          }
        }
        this.mGameListCopy = new RoomInfo[this.mGameList.Count];
        this.mGameList.Values.CopyTo(this.mGameListCopy, 0);
        ...
        switch (code)
        {
          case 251:
            if (PhotonNetwork.OnEventCall != null)
            {
              ...
              PhotonNetwork.OnEventCall(photonEvent.Code, content, index1);
              return;
            }
          ...
          case 253:
            ...
            ExitGames.Client.Photon.Hashtable gameProperties = (ExitGames.Client.Photon.Hashtable) null;
            ExitGames.Client.Photon.Hashtable pActorProperties = (ExitGames.Client.Photon.Hashtable) null;
            if (targetActorNr == 0)
              gameProperties = (ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 251];
            else
              pActorProperties = (ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 251];
          ...
          case byte.MaxValue:
            bool flag = false;
            ExitGames.Client.Photon.Hashtable properties = (ExitGames.Client.Photon.Hashtable) photonEvent[(byte) 249];
    ...
    using (HashSet<GameObject>.Enumerator enumerator = gameObjectSet.GetEnumerator())
    {
      while (enumerator.MoveNext())
      {
        ...
        if ((UnityEngine.Object) current != (UnityEngine.Object) null)
          current.SendMessage(methodName, obj, SendMessageOptions.DontRequireReceiver);
      }
    }
  }
    ...
    else
    {
      ...
      else
      {
        ...
        for (int index1 = 0; index1 < photonView.RpcMonoBehaviours.Length; ++index1)
        {
          ...
          if ((UnityEngine.Object) rpcMonoBehaviour == (UnityEngine.Object) null)
          {
  ...
  internal ExitGames.Client.Photon.Hashtable SendInstantiate(string prefabName, Vector3 position, Quaternion rotation, int group, int[] viewIDs, object[] data, bool isGlobalObject)
  {
    ...
    hashtable[(object) (byte) 0] = (object) prefabName;
    if (position != Vector3.zero)
      hashtable[(object) (byte) 1] = (object) position;
    if (rotation != Quaternion.identity)
      hashtable[(object) (byte) 2] = (object) rotation;
    if (group != 0)
      hashtable[(object) (byte) 3] = (object) group;
    if (viewIDs.Length > 1)
      hashtable[(object) (byte) 4] = (object) viewIDs;
    if (data != null)
      hashtable[(object) (byte) 5] = (object) data;
    if (this.currentLevelPrefix > (short) 0)
      hashtable[(object) (byte) 8] = (object) this.currentLevelPrefix;
    hashtable[(object) (byte) 6] = (object) PhotonNetwork.ServerTimestamp;
    hashtable[(object) (byte) 7] = (object) viewId;
  ...
  internal GameObject DoInstantiate(ExitGames.Client.Photon.Hashtable evData, PhotonPlayer photonPlayer, GameObject resourceGameObject)
  {
    ...
    if (this.ObjectPool != null)
    {
      ...
      go.SendMessage(NetworkingPeer.OnPhotonInstantiateString, (object) new PhotonMessageInfo(photonPlayer, timestamp, (PhotonView) null), SendMessageOptions.DontRequireReceiver);
      return go;
    }
    if ((UnityEngine.Object) resourceGameObject == (UnityEngine.Object) null)
    {
    ...
    GameObject gameObject = (GameObject) UnityEngine.Object.Instantiate((UnityEngine.Object) resourceGameObject, position, identity);
    for (int index = 0; index < numArray.Length; ++index)
    {
    ...
    gameObject.SendMessage(NetworkingPeer.OnPhotonInstantiateString, (object) new PhotonMessageInfo(photonPlayer, timestamp, (PhotonView) null), SendMessageOptions.DontRequireReceiver);
    return gameObject;
  }
  ...
  public void DestroyPlayerObjects(int playerId, bool localOnly)
  {
    ...
    else
    {
      ...
      using (Dictionary<int, PhotonView>.ValueCollection.Enumerator enumerator = this.photonViewList.Values.GetEnumerator())
      {
        ...
        {
          PhotonView current = enumerator.Current;
          if ((UnityEngine.Object) current != (UnityEngine.Object) null && current.CreatorActorNr == playerId)
            gameObjectSet.Add(current.gameObject);
        }
      }
      using (HashSet<GameObject>.Enumerator enumerator = gameObjectSet.GetEnumerator())
  ...
  protected internal void RemoveInstantiatedGO(GameObject go, bool localOnly)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (PhotonNetwork.logLevel >= PhotonLogLevel.Full)
          Debug.Log((object) ("Network destroy Instantiated GO: " + go.name));
        if (this.ObjectPool != null)
        {
  ...
  {
    ExitGames.Client.Photon.Hashtable hashtable1 = new ExitGames.Client.Photon.Hashtable();
    hashtable1[(object) (byte) 7] = (object) instantiateId;
    ...
    ExitGames.Client.Photon.Hashtable hashtable2 = new ExitGames.Client.Photon.Hashtable();
    hashtable2[(object) (byte) 0] = (object) instantiateId;
  ...
  {
    this.OpRaiseEvent((byte) 207, (object) new ExitGames.Client.Photon.Hashtable()
    {
  ...
  public PhotonView GetPhotonView(int viewID)
  {
    ...
    if ((UnityEngine.Object) photonView1 == (UnityEngine.Object) null)
    {
  ...
  public void RegisterPhotonView(PhotonView netView)
  {
    ...
    else
    {
      ...
      {
        if (!((UnityEngine.Object) netView != (UnityEngine.Object) photonView))
          return;
  ...
  {
    this.OpCustom((byte) 253, new Dictionary<byte, object>()
    {
  ...
  internal void RPC(PhotonView view, string methodName, PhotonTargets target, PhotonPlayer player, bool encrypt, params object[] parameters)
  {
    if (this.blockSendingGroups.Contains(view.group))
      return;
    if (view.viewID < 1)
      Debug.LogError((object) ("Illegal view ID:" + (object) view.viewID + " method: " + methodName + " GO:" + view.gameObject.name));
    if (PhotonNetwork.logLevel >= PhotonLogLevel.Full)
    ...
    rpcData[(object) (byte) 0] = (object) view.viewID;
    if (view.prefix > 0)
      rpcData[(object) (byte) 1] = (object) (short) view.prefix;
    rpcData[(object) (byte) 2] = (object) PhotonNetwork.ServerTimestamp;
    int num = 0;
    if (this.rpcShortcuts.TryGetValue(methodName, out num))
      rpcData[(object) (byte) 5] = (object) (byte) num;
    else
      rpcData[(object) (byte) 3] = (object) methodName;
    if (parameters != null && parameters.Length > 0)
      rpcData[(object) (byte) 4] = (object) parameters;
    if (player != null)
    {
  ...
  public void RunViewUpdate()
  {
    ...
    using (Dictionary<int, PhotonView>.ValueCollection.Enumerator enumerator = this.photonViewList.Values.GetEnumerator())
    {
      ...
      {
        PhotonView current = enumerator.Current;
        if (current.synchronization != ViewSynchronization.Off && current.isMine && (current.gameObject.activeInHierarchy && !this.blockSendingGroups.Contains(current.group)))
        {
          ...
          if (objArray != null)
          {
            ...
            {
              ExitGames.Client.Photon.Hashtable hashtable = (ExitGames.Client.Photon.Hashtable) null;
              ...
              if (((Dictionary<object, object>) hashtable).Count >= NetworkingPeer.ObjectsInOneUpdate)
              {
                ...
                hashtable[(object) (byte) 0] = (object) PhotonNetwork.ServerTimestamp;
                if (this.currentLevelPrefix >= (short) 0)
                  hashtable[(object) (byte) 1] = (object) this.currentLevelPrefix;
    ...
    if (num == 0)
      return;
    using (Dictionary<int, ExitGames.Client.Photon.Hashtable>.KeyCollection.Enumerator enumerator = this.dataPerGroupReliable.Keys.GetEnumerator())
    {
      while (enumerator.MoveNext())
      {
        int current = enumerator.Current;
        raiseEventOptions.InterestGroup = (byte) current;
        ExitGames.Client.Photon.Hashtable hashtable = this.dataPerGroupReliable[current];
    ...
    using (Dictionary<int, ExitGames.Client.Photon.Hashtable>.KeyCollection.Enumerator enumerator = this.dataPerGroupUnreliable.Keys.GetEnumerator())
    {
      while (enumerator.MoveNext())
      {
        int current = enumerator.Current;
        raiseEventOptions.InterestGroup = (byte) current;
        ExitGames.Client.Photon.Hashtable hashtable = this.dataPerGroupUnreliable[current];
        if (((Dictionary<object, object>) hashtable).Count != 0)
        {
          hashtable[(object) (byte) 0] = (object) PhotonNetwork.ServerTimestamp;
          if (this.currentLevelPrefix >= (short) 0)
    ...
    else
    {
      ...
      if (photonView.synchronization == ViewSynchronization.ReliableDeltaCompressed)
      {
        ...
        if (objArray == null)
        {
          if (PhotonNetwork.logLevel < PhotonLogLevel.Informational)
            return;
          Debug.Log((object) ("Skipping packet for " + photonView.name + " [" + (object) photonView.viewID + "] as we haven't received a full packet for delta compression yet. This is OK if it happens for the first few frames after joining a game."));
          return;
        }
  ...
  {
    mi = (MethodInfo) null;
    if ((UnityEngine.Object) monob == (UnityEngine.Object) null || string.IsNullOrEmpty(methodType))
      return false;
  ...
  protected internal void LoadLevelIfSynced()
  {
    ...
    if (customProperty is int)
    {
      if (SceneManagerHelper.ActiveSceneBuildIndex == (int) customProperty)
        return;
      PhotonNetwork.LoadLevel((int) customProperty);
    }
    else
    {
      if (!(customProperty is string) || !(SceneManagerHelper.ActiveSceneName != (string) customProperty))
        return;
  ...
  protected internal void SetLevelInPropsIfSynced(object levelId)
  {
    ...
    else
    {
      ...
      {
        object customProperty = PhotonNetwork.room.CustomProperties[(object) "curScn"];
        if (customProperty is int && SceneManagerHelper.ActiveSceneBuildIndex == (int) customProperty || customProperty is string && SceneManagerHelper.ActiveSceneName != null && SceneManagerHelper.ActiveSceneName.Equals((string) customProperty))
          return;
      }
      ExitGames.Client.Photon.Hashtable propertiesToSet = new ExitGames.Client.Photon.Hashtable();
      if (levelId is int)
        propertiesToSet[(object) "curScn"] = (object) (int) levelId;
      ...
      PhotonNetwork.room.SetCustomProperties(propertiesToSet, (ExitGames.Client.Photon.Hashtable) null, false);
