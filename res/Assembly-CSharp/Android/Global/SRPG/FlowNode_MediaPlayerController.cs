...
namespace SRPG
{
  ...
  public class FlowNode_MediaPlayerController : FlowNodePersistent
  {
    ...
    private void Start()
    {
      this.m_MediaPlayerWrapper.Events.RemoveListener(new UnityAction<MediaPlayerWrapper.Event.Type>(this.OnMediaPlayerEvent));
      this.m_MediaPlayerWrapper.Events.AddListener(new UnityAction<MediaPlayerWrapper.Event.Type>(this.OnMediaPlayerEvent));
