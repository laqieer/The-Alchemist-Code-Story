  ...
  public class EventShopCoinList : MonoBehaviour, IFlowInterface
  {
    ...
    private GameObject CreateListItem(EventCoinData eventcoin_data)
    {
      ...
      if ((UnityEngine.Object) component2 != (UnityEngine.Object) null && (UnityEngine.Object) component3 != (UnityEngine.Object) null)
      {
        ...
        bool flag = false;
        if ((UnityEngine.Object) eventShopListItem != (UnityEngine.Object) null && eventShopListItem.shops != null && eventShopListItem.shops.unlock != null && (eventShopListItem.shops.unlock.flg != 1 ? 0 : 1) != 0)
          flag = true;
        if (flag)
        {
    ...
    private void OnSelect(GameObject go)
    {
      ...
      GlobalVars.SelectionEventShop = GlobalVars.EventShopListItems.Find((Predicate<EventShopListItem>) (f => f.shop_cost_iname.Equals(coindata.iname)));
