...
namespace SRPG
{
  public class TrickData
  {
    ...
    public static void RemoveEffect(int grid_x, int grid_y)
    {
      ...
      using (List<TrickData>.Enumerator enumerator = all.GetEnumerator())
      {
        while (enumerator.MoveNext())
        {
          ...
          SceneBattle instance = SceneBattle.Instance;
          if ((bool) ((UnityEngine.Object) instance))
            instance.Battle?.GimmickEventTrickKillCount(current);
        }
      }
    ...
    private static void entryMarker(SceneBattle sb, TrickData td)
    {
      ...
      GameObject gameObject2 = UnityEngine.Object.Instantiate((UnityEngine.Object) gameObject1, position, Quaternion.identity) as GameObject;
