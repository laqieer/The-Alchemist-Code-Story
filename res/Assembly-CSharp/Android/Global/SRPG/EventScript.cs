...
namespace SRPG
{
  public class EventScript : ScriptableObject
  {
    ...
    public class Sequence : MonoBehaviour
    {
      ...
      private void Start()
      {
        UnityEngine.Debug.LogWarning((object) this);
        ...
        HoldGesture component = EventScript.Canvas.GetComponent<HoldGesture>();
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        {
          this.mDownAction = new UnityAction(this.OnDown);
          component.OnHoldStart = new UnityEvent();
          component.OnHoldStart.AddListener(this.mDownAction);
          this.mUpAction = new UnityAction(this.OnUp);
      ...
      private void OnDestroy()
      {
        ...
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        {
          component.OnHoldStart.RemoveListener(new UnityAction(this.OnDown));
          component.OnHoldEnd.RemoveListener(new UnityAction(this.OnUp));
        }
      ...
      private IEnumerator PreloadAssetsAsync()
      {
        ...
        return (IEnumerator) new EventScript.Sequence.\u003CPreloadAssetsAsync\u003Ec__IteratorB6() { \u003C\u003Ef__this = this };
      }
      ...
      private void Update()
      {
        if (!this.mReady)
          return;
        int num = -1;
        this.fastForward = this.buttonDown && (double) Time.time - (double) this.holdDownTime > 0.200000002980232;
        for (int index = 0; index < this.Actions.Length; ++index)
        {
      ...
      public void OnQuit()
      {
        ...
        for (int index2 = 0; index2 < this.Actions.Length; ++index2)
        {
          ...
          {
            if (this.Actions[index2] is Event2dAction_SELoop)
            {
              this.Actions[index2].enabled = false;
