...
namespace SRPG
{
  ...
  public class GameManager : MonoSingleton<GameManager>
  {
    ...
    {
      AnalyticsManager.Setup(MonoSingleton<GameManager>.Instance.DeviceId, MonoSingleton<GameManager>.Instance.Player.PlayerPaidAmount > 0);
      VideoAdManager.Init();
    ...
    public void Deserialize(string language, Json_QuestList json)
    {
      ...
      if (json.VersusRankMission == null)
        return;
      int length1 = json.VersusRankMission.Length;
      this.mVersusRankMission = new List<VersusRankMissionParam>(length1);
      ...
      using (List<LocalNotificationInfo>.Enumerator enumerator = MyLocalNotification.LocaloNotifications.GetEnumerator())
      {
        while (enumerator.MoveNext())
        {
          ...
          if (current.custom_type == 100)
          {
            ...
            {
              message = current.push_word,
              category = current.trophy_iname
            }, (int) (left - 3600L));
          }
...
label_12:
    ...
    {
      this.Player?.SetVersusWinCount(GlobalVars.SelectedMultiPlayVersusType, wincnt);
      return true;
    }
    ...
    public void RequestUpdateBadges(GameManager.BadgeTypes type)
    {
      ...
      if ((type & GameManager.BadgeTypes.DailyMission) != ~GameManager.BadgeTypes.All)
      {
        ...
        if (trophyStates != null)
        {
          ...
          {
            TrophyState state = trophyStates[index];
            if (state.Param.IsShowBadge(state))
            {
              this.BadgeFlags |= GameManager.BadgeTypes.DailyMission;
              ++num;
            }
      ...
      if ((type & GameManager.BadgeTypes.FreeGemsOfferwall) == ~GameManager.BadgeTypes.All)
        return;
      this.BadgeFlags &= ~GameManager.BadgeTypes.FreeGemsOfferwall;
      if (!AnalyticsManager.HasOfferwallToShow() || !(AnalyticsManager.LastKnownSessionIDOfShownOfferwall != Network.SessionID))
        return;
      this.BadgeFlags |= GameManager.BadgeTypes.FreeGemsOfferwall;
    }
    ...
    private IEnumerator UpdateUnitsBadges()
    {
      ...
      return (IEnumerator) new GameManager.\u003CUpdateUnitsBadges\u003Ec__Iterator46() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CUpdateUnitUnlockBadges\u003Ec__Iterator47() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CAsyncWaitForImportantJobs\u003Ec__Iterator48() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CDownloadAndTransitSceneAsync\u003Ec__Iterator49() { sceneName = sceneName, \u003C\u0024\u003EsceneName = sceneName };
    }
    ...
    {
      this.AgreedVer = gu3.Device.Application.GetBundleVersion();
    }
      ...
      for (int index = 0; index < assets.Length; ++index)
      {
        if ((assets[index].Flags & AssetBundleFlags.Tutorial) != (AssetBundleFlags) 0 && ((assets[index].Flags & AssetBundleFlags.TutorialMovie) == (AssetBundleFlags) 0 || (!GameUtility.IsDebugBuild || GlobalVars.DebugIsPlayTutorial) && (instance.Player.TutorialFlags & 1L) == 0L))
        {
          ...
          if (localizedObjectName != assets[index].Path)
          {
            ...
            if (itemByPath == null)
            {
              UnityEngine.Debug.LogError((object) ("Unable to find localized item: " + localizedObjectName + " using " + assets[index].Path));
              continue;
            }
    ...
    public bool PartialDownloadTutorialAssets()
    {
      ...
      if (num <= 0)
        return false;
      AssetDownloader.DownloadState state = AssetDownloader.StartDownload(false, false, System.Threading.ThreadPriority.Lowest);
      if (state == null)
        return false;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CWaitDownloadAsync\u003Ec__Iterator4A() { state = state, queue = queue, \u003C\u0024\u003Estate = state, \u003C\u0024\u003Equeue = queue, \u003C\u003Ef__this = this };
    }
    ...
    private void OnApplicationFocus(bool focus)
    {
      ...
      else
      {
        ...
        AnalyticsManager.OnApplicationFocus(focus);
      }
    }
    ...
    public void UpdateTrophyAPI()
    {
      ...
      if (updateTrophyList.Count > 0)
      {
        ...
        if (this.mUpdateTrophyList.Count == 1 && this.mUpdateTrophyList[0].Param.newapi)
          Network.RequestAPI((WebAPI) new SGReqUpdateTrophy(this.mUpdateTrophyList, new Network.ResponseCallback(this.UpdateTrophyResponseCallback), false), false);
        else
      ...
      if (this.mUpdateTrophyAward.Count == 1 && this.mUpdateTrophyAward[0].Param.newapi)
        Network.RequestAPI((WebAPI) new SGReqUpdateTrophy(this.mUpdateTrophyAward, new Network.ResponseCallback(this.UpdateTrophyAwardResponseCallback), true), false);
      else
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CShowCharacterQuestPopupAsync\u003Ec__Iterator4B() { template = template, \u003C\u0024\u003Etemplate = template, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CSkinUnlockPopup\u003Ec__Iterator4C() { unlockSkin = unlockSkin, \u003C\u0024\u003EunlockSkin = unlockSkin };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new GameManager.\u003CSkinUnlockPopup\u003Ec__Iterator4D() { rewardItems = rewardItems, \u003C\u0024\u003ErewardItems = rewardItems };
    }
    ...
    public enum BadgeTypes
    {
      ...
      FreeGemsOfferwall = 2048, // 0x00000800
      All = -1,
    }
    ...
    public enum BadgeCountTypes
    {
      ...
      FreeGemsOfferwall = 11, // 0x0000000B
    }
