  ...
  public class ArtifactWindow : MonoBehaviour, IFlowInterface
  {
      ...
      else
      {
        ...
        if (!(selection[0] is ArtifactData))
        {
          if (selection[0] is ArtifactParam)
          {
            ...
            {
              UnityEngine.Debug.LogWarning((object) "Non ArtifactParam Selected");
              return;
            }
          }
          else
          {
            UnityEngine.Debug.LogWarning((object) "Non ArtifactData Selected");
            return;
          }
        }
        if (selection[0] is ArtifactData)
    ...
    public void RefreshAbilities()
    {
      ...
      if ((UnityEngine.Object) this.AbilityList == (UnityEngine.Object) null && index1 == 0)
      {
        DataSource.Bind<AbilityParam>(this.AbilityListItem, (AbilityParam) null);
        DataSource.Bind<AbilityData>(this.AbilityListItem, (AbilityData) null);
        Animator component = this.AbilityListItem.GetComponent<Animator>();
        if ((UnityEngine.Object) component != (UnityEngine.Object) null && !string.IsNullOrEmpty(this.AbilityListItemState))
          component.SetInteger(this.AbilityListItemState, this.AbilityListItem_Hidden);
      }
    ...
    public void ShowSelection()
    {
      ...
      for (int index = 0; index < this.mSelectedArtifacts.Length; ++index)
      {
        ...
        DataSource.Bind(artifactIcon.gameObject, this.mSelectedArtifacts[index].GetType(), this.mSelectedArtifacts[index]);
    ...
    public void RefreshWindow()
    {
      ...
      if ((UnityEngine.Object) this.OwnerSlot != (UnityEngine.Object) null)
      {
        ...
        if (unit != null && job_index != -1)
          DataSource.Bind<JobData>(this.OwnerSlot.gameObject, unit.Jobs[job_index]);
        else
          DataSource.Bind<JobData>(this.OwnerSlot.gameObject, (JobData) null);
      }
      this.RefreshKyokaList();
    ...
    private IEnumerator AddRareAsync()
    {
      ...
      return (IEnumerator) new ArtifactWindow.\u003CAddRareAsync\u003Ec__IteratorE7() { \u003C\u003Ef__this = this };
    }
    ...
    public void RefreshDecomposeInfo()
    {
      ...
      if (this.mCurrentArtifact.Kakera != null)
      {
        ...
        if ((UnityEngine.Object) this.DecomposeKakeraNumNew != (UnityEngine.Object) null)
          this.DecomposeKakeraNumNew.text = Mathf.Min(itemAmount + this.mCurrentArtifact.GetKakeraChangeNum(), (int) this.mCurrentArtifact.Kakera.cap).ToString();
      }
    ...
    private void OnTransmuteAccept(GameObject go)
    {
      ...
      else
      {
        ...
        json[0].iid = (long) UnityEngine.Random.Range(1, int.MaxValue);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003CShowTransmuteResultAsync\u003Ec__IteratorE8() { changeset = changeset, \u003C\u0024\u003Echangeset = changeset, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003CShowDecomposeResultAsync\u003Ec__IteratorE9() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003CShowDetailAsync\u003Ec__IteratorEA() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ArtifactWindow.\u003COnSceneChangeAsync\u003Ec__IteratorEB() { \u003C\u003Ef__this = this };
    }
