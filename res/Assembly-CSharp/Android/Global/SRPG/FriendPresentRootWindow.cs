  ...
  public class FriendPresentRootWindow : FlowWindowBase
  {
    ...
    public override void Initialize(FlowWindowBase.SerializeParamBase param)
    {
      ...
      if ((UnityEngine.Object) this.m_ValueList != (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) this.m_ReceiveToggle != (UnityEngine.Object) null)
          this.m_ReceiveToggle.interactable = false;
        this.m_SendToggle = this.m_ValueList.list.GetUIToggle("tgl_send");
        if ((UnityEngine.Object) this.m_SendToggle != (UnityEngine.Object) null)
          this.m_SendToggle.interactable = false;
      }
      if ((UnityEngine.Object) this.m_Param.wantList != (UnityEngine.Object) null)
      {
        this.m_WantController = this.m_Param.wantList.GetComponentInChildren<ContentController>();
        if ((UnityEngine.Object) this.m_WantController != (UnityEngine.Object) null)
          this.m_WantController.SetWork((object) this);
      }
      if ((UnityEngine.Object) this.m_Param.receiveList != (UnityEngine.Object) null)
      {
        this.m_ReceiveController = this.m_Param.receiveList.GetComponentInChildren<ContentController>();
        if ((UnityEngine.Object) this.m_ReceiveController != (UnityEngine.Object) null)
          this.m_ReceiveController.SetWork((object) this);
      }
      if ((UnityEngine.Object) this.m_Param.sendList != (UnityEngine.Object) null)
      {
        this.m_SendController = this.m_Param.sendList.GetComponentInChildren<ContentController>();
        if ((UnityEngine.Object) this.m_SendController != (UnityEngine.Object) null)
    ...
    public override int Update()
    {
      ...
      if ((UnityEngine.Object) this.m_ReceiveToggle != (UnityEngine.Object) null)
        this.m_ReceiveToggle.interactable = active == 0;
      if ((UnityEngine.Object) this.m_SendToggle != (UnityEngine.Object) null)
        this.m_SendToggle.interactable = active == 0;
      return -1;
    }
      ...
      if (this.m_Tab != tab)
      {
        ...
        switch (tab)
        {
          case FriendPresentRootWindow.Tab.NONE:
            if ((UnityEngine.Object) this.m_Param.tabReceive != (UnityEngine.Object) null)
              this.m_Param.tabReceive.SetActive(false);
            if ((UnityEngine.Object) this.m_Param.tabSend != (UnityEngine.Object) null)
            {
    ...
    public void InitializeReceiveList()
    {
      ...
      if ((UnityEngine.Object) this.m_ReceiveController != (UnityEngine.Object) null)
      {
        ...
        if (!flag)
          GlobalEvent.Invoke("EMPTY_PRESENT_RECEIVE", (object) this);
        else
          GlobalEvent.Invoke("GOT_PRESENT_RECEIVE", (object) this);
    ...
    public void InitializeSendList()
    {
      ...
      if ((UnityEngine.Object) this.m_SendController != (UnityEngine.Object) null)
      {
        ...
        if (flag)
          GlobalEvent.Invoke("EMPTY_PRESENT_SEND", (object) this);
        else
          GlobalEvent.Invoke("GOT_PRESENT_SEND", (object) this);
      ...
      this.m_ValueList.list.SetInteractable("btn_send", this.m_SendSource.GetCount() != 0 && flag1);
    }
