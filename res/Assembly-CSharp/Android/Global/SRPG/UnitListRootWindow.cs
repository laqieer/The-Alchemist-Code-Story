...
namespace SRPG
{
  public class UnitListRootWindow : FlowWindowBase
  {
    ...
    public override void Initialize(FlowWindowBase.SerializeParamBase param)
    {
      ...
      if ((UnityEngine.Object) this.m_AccessoryRoot != (UnityEngine.Object) null)
      {
      ...
      GameObject gameObject = this.m_ValueList.GetGameObject("btn_toggle_names");
      if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
        gameObject.GetComponent<Toggle>().isOn = GlobalVars.ShowUnitNames;
    ...
    {
      if (!((UnityEngine.Object) this.m_Param.pieceList != (UnityEngine.Object) null))
        return;
      this.m_PieceController = this.m_Param.pieceList.GetComponentInChildren<ContentController>();
    ...
    public UnitListRootWindow.ListData CreatePieceList()
    {
      ...
      for (int index = 0; index < items.Count; ++index)
      {
        ...
        {
          UnitParam focus = Array.Find<UnitParam>(allUnits, (Predicate<UnitParam>) (p => (string) p.piece == item.iname));
          if (focus != null && focus.summon && (player.FindUnitDataByUnitID(focus.iname) == null && focus.CheckAvailable(TimeManager.ServerTime)) && listData.data.FindIndex((Predicate<UnitListWindow.Data>) (prop => prop.param == focus)) == -1)
            listData.data.Add(new UnitListWindow.Data(focus));
        }
      }
    ...
    private UnitListRootWindow.Content.ItemSource SetupPieceList(UnitListRootWindow.Content.ItemSource source)
    {
      ...
      if (source == null)
      {
        ...
        this.m_ValueList.SetActive(1, false);
        this.m_ValueList.SetActive(2, false);
        this.m_ValueList.SetActive("btn_toggle_names", false);
      ...
      if ((UnityEngine.Object) this.m_Param.unitList != (UnityEngine.Object) null)
        this.m_Param.unitList.SetActive(false);
      if ((UnityEngine.Object) this.m_Param.supportList != (UnityEngine.Object) null)
    ...
    private void InitializeSupportList()
    {
      if (!((UnityEngine.Object) this.m_Param.supportList != (UnityEngine.Object) null))
        return;
      this.m_SupportController = this.m_Param.supportList.GetComponentInChildren<ContentController>();
      if ((UnityEngine.Object) this.m_SupportController != (UnityEngine.Object) null)
        this.m_SupportController.SetWork((object) this);
      this.m_Param.supportList.SetActive(false);
      SerializeValueBehaviour component = this.m_Param.supportList.GetComponent<SerializeValueBehaviour>();
      if ((UnityEngine.Object) component != (UnityEngine.Object) null)
    ...
    private void InitializeUnitList()
    {
      if (!((UnityEngine.Object) this.m_Param.unitList != (UnityEngine.Object) null))
        return;
      this.m_UnitController = this.m_Param.unitList.GetComponentInChildren<ContentController>();
        ...
        switch (editType)
        {
          ...
          case UnitListWindow.EditType.PARTY_TOWER:
            ...
            if (data1 != null && data2 != -1 && data2 < data1.PartyData.MAX_UNIT)
            {
              ...
              {
                UnitData unit = data1.Units[slotNo];
                if (unit != null)
                {
                  UnitListWindow.Data data3 = listData.data.Find((Predicate<UnitListWindow.Data>) (prop =>
                  {
                    if (prop.unit != null)
    ...
    private UnitListRootWindow.Content.ItemSource SetupUnitList(UnitListRootWindow.Content.ItemSource source)
    {
      ...
      if (source == null)
      {
        ...
        this.m_ValueList.SetActive("btn_toggle_names", true);
      ...
      if (listData != null)
      {
        ...
        GlobalVars.ShowUnitNames = this.m_ValueList.GetUIOn("btn_toggle_names");
              ...
              if (this.m_RootWindow != null)
              {
                ...
                switch (editType)
                {
                  ...
                  case UnitListWindow.EditType.PARTY_TOWER:
                    ...
                    if (editType != UnitListWindow.EditType.EQUIP && editType != UnitListWindow.EditType.SHOP_EQUIP)
                    {
                      CanvasGroup component = this.m_Node.gameObject.GetComponent<CanvasGroup>();
                      if ((UnityEngine.Object) component != (UnityEngine.Object) null)
                      {
                        component.alpha = !this.m_Param.interactable ? 0.5f : 1f;
                        component.interactable = this.m_Param.interactable;
                      }
        ...
        public void SetSortValue(UnitListSortWindow.SelectType section, int value)
        {
          ...
          if ((section & selectType) == UnitListSortWindow.SelectType.NONE)
          {
            if ((UnityEngine.Object) this.m_SortBadge.Value != (UnityEngine.Object) null)
              this.m_SortBadge.Value.text = value.ToString();
