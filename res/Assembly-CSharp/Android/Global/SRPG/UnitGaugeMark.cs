    ...
    private GameObject CreateMarkObject()
    {
      ...
      switch (this.MarkType)
      {
        case UnitGaugeMark.EMarkType.MapChest:
          ...
          {
            gameObject = UnityEngine.Object.Instantiate((UnityEngine.Object) this.MapChest, this.transform.position, this.transform.rotation) as GameObject;
            break;
          }
          break;
        case UnitGaugeMark.EMarkType.MapGem:
          ...
          {
            UnitGaugeGemIcon unitGaugeGemIcon = UnityEngine.Object.Instantiate((UnityEngine.Object) this.MapGem, this.transform.position, this.transform.rotation) as UnitGaugeGemIcon;
