...
namespace SRPG
{
  ...
  public class CharacterQuestList : SRPG_FixedList, IFlowInterface, ISortableList
  {
    ...
    {
      base.Start();
      this.RegisterNextButtonCallBack(new UnityAction(this.OnNextPage));
      this.RegisterPrevButtonCallBack(new UnityAction(this.OnPreviousPage));
    }
    ...
    {
      if (!((UnityEngine.Object) this.mSortMenu != (UnityEngine.Object) null))
        return;
