...
namespace SRPG
{
  public class TrophyParam
  {
    ...
    {
      return string.Format("[TrophyParam: IsBeginner={0}, IsChallengeMission={1}, IsChallengeMissionRoot={2}, IsDaily={3}]", new object[4]{ (object) this.IsBeginner, (object) this.IsChallengeMission, (object) this.IsChallengeMissionRoot, (object) this.IsDaily });
    }
