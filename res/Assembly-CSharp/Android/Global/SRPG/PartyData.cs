...
namespace SRPG
{
  public class PartyData
  {
    ...
    public PartyData(PlayerPartyTypes type, VS_MODE vsMode = VS_MODE.THREE_ON_THREE)
    {
      switch (type)
      {
        ...
        case PlayerPartyTypes.RankMatch:
          if (vsMode == VS_MODE.FIVE_ON_FIVE)
          {
            this.mMAX_UNIT = 5;
            this.mMAX_MAINMEMBER = 5;
          }
    ...
    public static PlayerPartyTypes GetPartyTypeFromString(string ptype)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          PartyData.\u003C\u003Ef__switch\u0024map10 = new Dictionary<string, int>(11)
          {
            {
              "norm",
              0
    ...
    public void Deserialize(Json_Party json)
    {
      ...
      {
        if (index < this.mUniqueIDs.Length)
