...
namespace SRPG
{
  public class UnitData
  {
    ...
    public ArtifactParam[] GetAllSkins(int jobIndex = -1)
    {
      ...
      {
        ArtifactParam artifactParam = Array.Find<ArtifactParam>(array, (Predicate<ArtifactParam>) (af => af.iname == (string) this.mUnitParam.skins[i]));
    ...
    public void Deserialize(Json_Unit json)
    {
      ...
      if (this.UnitParam.skins != null)
      {
        ...
        {
          string skinName = (string) this.UnitParam.skins[index];
      ...
      if (json.jobs != null)
      {
        ...
        for (int index1 = 0; index1 < 2; ++index1)
        {
          ...
          {
            JobSetParam jobset = instanceDirect.GetJobSetParam((string) this.mUnitParam.jobsets[index2]);
    ...
    public bool Setup(string unit_iname, int exp, int rare, int awakeLv, string job_iname = null, int jobrank = 1, EElement elem = EElement.None)
    {
      ...
      if (this.UnitParam.default_abilities != null)
      {
        for (int index = 0; index < this.UnitParam.default_abilities.Length; ++index)
        {
          ...
          {
            AbilityParam param = instanceDirect.GetAbilityParam(defaultAbility);
            AbilityData abilityData = this.BattleAbilitys.Find((Predicate<AbilityData>) (p => p.Param == param));
            if (abilityData == null)
            {
              abilityData = this.LearnAbilitys.Find((Predicate<AbilityData>) (p => p.Param == param));
              if (abilityData == null)
              {
    ...
    public class UnitPlaybackVoiceData
    {
      ...
      private string GetUnlockConditionsText(string _dictionary_key)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (UnitData.UnitPlaybackVoiceData.\u003C\u003Ef__switch\u0024map1D == null)
          {
            // ISSUE: reference to a compiler-generated field
            UnitData.UnitPlaybackVoiceData.\u003C\u003Ef__switch\u0024map1D = new Dictionary<string, int>(4)
            {
              {
                "UNIT_LEVEL85",
                0
          ...
          int num;
          // ISSUE: reference to a compiler-generated field
          if (UnitData.UnitPlaybackVoiceData.\u003C\u003Ef__switch\u0024map1D.TryGetValue(key, out num))
          {
            switch (num)
            {
              case 0:
