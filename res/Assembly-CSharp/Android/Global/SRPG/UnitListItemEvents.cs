          ...
          if (!((UnityEngine.Object) this.EqIcons[index] == (UnityEngine.Object) null) && !((UnityEngine.Object) this.AttrIcons[index] == (UnityEngine.Object) null))
          {
            ...
            else
            {
              ...
              if (!equipData.IsEquiped())
              {
                ...
                this.AttrIcons[index].sprite = !player.HasItem(equipData.ItemID) ? (!player.CheckEnableCreateItem(equipData.ItemParam, true, 1, (NeedEquipItemList) null) ? spriteSheet.GetSprite("plus2") : spriteSheet.GetSprite((int) equipData.ItemParam.equipLv <= dataOfClass.Lv ? "plus0" : "plus1")) : spriteSheet.GetSprite((int) equipData.ItemParam.equipLv <= dataOfClass.Lv ? "plus0" : "plus1");
              }
            }
          }
        }
