...
namespace SRPG
{
  ...
  {
    public static EAbilitySlot[] ABILITY_SLOT_TYPES = new EAbilitySlot[5]{ EAbilitySlot.Action, EAbilitySlot.Action, EAbilitySlot.Reaction, EAbilitySlot.Support, EAbilitySlot.Support };
    public static ArtifactTypes[] ARTIFACT_SLOT_TYPES = new ArtifactTypes[3]{ ArtifactTypes.Arms, ArtifactTypes.Armor, ArtifactTypes.Accessory };
    ...
    public BaseStatus GetJobTransfarStatus()
    {
      return this.GetJobTransfarStatus(this.Rank);
    }

    public BaseStatus GetJobTransfarStatus(int rank)
    {
      if (this.Param != null)
        return this.Param.GetJobTransfarStatus(rank);
    ...
    public int GetEnableEquipUnitLevel(int slot)
    {
      if (this.mEquips[slot] == null || this.mEquips[slot].ItemParam == null)
        return 0;
      return (int) this.mEquips[slot].ItemParam.equipLv;
    }
