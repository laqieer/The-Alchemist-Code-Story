...
namespace SRPG
{
  ...
  public class SceneBattle : Scene
  {
    ...
    private IEnumerator DownloadNextQuestAsync()
    {
      ...
      return (IEnumerator) new SceneBattle.\u003CDownloadNextQuestAsync\u003Ec__Iterator5B() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CDownloadQuestAsync\u003Ec__Iterator5C() { quest = quest, \u003C\u0024\u003Equest = quest, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CStartQuestAsync\u003Ec__Iterator5D() { questID = questID, jsonBtl = jsonBtl, \u003C\u0024\u003EquestID = questID, \u003C\u0024\u003EjsonBtl = jsonBtl, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CLoadMapAsync\u003Ec__Iterator5E() { \u003C\u003Ef__this = this };
    }
    ...
    {
      if (this.Battle.GetQuestResult() == BattleCore.QuestResult.Win && (UnityEngine.Object) this.mEventScript != (UnityEngine.Object) null)
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CSetWeatherEffect\u003Ec__Iterator5F() { wd = wd, \u003C\u0024\u003Ewd = wd, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CStopWeatherEffect\u003Ec__Iterator60() { is_immidiate = is_immidiate, \u003C\u0024\u003Eis_immidiate = is_immidiate, \u003C\u003Ef__this = this };
    }
    ...
    {
      this.InterpCameraTarget((Component) this.FindUnitController(this.mBattle.CurrentUnit).transform);
    ...
    private bool UpdateCameraPositionTouchMove(Vector3 xAxis, Vector3 yAxis)
    {
      UnityEngine.Camera main = UnityEngine.Camera.main;
      bool flag = false;
      if (this.m_AllowCameraTranslation && (double) this.mTouchController.Velocity.magnitude > 0.0)
      {
    ...
    {
      this.SetCameraTarget(position.transform.position);
    }
    ...
    {
      this.InterpCameraTarget(position.transform.position);
    }
    ...
    public void InterpCameraDistance(float distance)
    {
      ...
      if (!GameUtility.Config_SkillAnimation || !GameUtility.Config_ZoomEffect.Value)
    ...
    {
      if (!this.mUpdateCameraPosition || this.isBattleCamera || (this.isUpView || ObjectAnimator.Get((Component) UnityEngine.Camera.main).isMoving))
        return;
    ...
    private byte[] CreateSendBinary(SceneBattle.EMultiPlayRecvDataHeader header, int unitID, List<SceneBattle.MultiPlayInput> sendList)
    {
      ...
      if (sendList.Find((Predicate<SceneBattle.MultiPlayInput>) (s => s.dm != def.dm)) != null)
      {
        multiPlayRecvData.dm = new int[sendList.Count];
        for (int index = 0; index < sendList.Count; ++index)
          multiPlayRecvData.dm[index] = sendList[index].dm;
      }
    ...
    private string CreateMultiPlayInputList(SceneBattle.EMultiPlayRecvDataHeader header, int unitID, List<SceneBattle.MultiPlayInput> sendList)
    {
      ...
      UnityEngine.Debug.LogWarning((object) ("SendJson:" + (object) str3.Length));
      return str3;
    }
    ...
    private void RecvEvent()
    {
      ...
      {
        UnityEngine.Debug.LogWarning((object) events[0].code);
        ...
        else if (events[0].code == MyPhoton.SEND_TYPE.Normal)
        {
          ...
          if (events[0].binary is byte[] && GameUtility.Binary2Object<SceneBattle.MultiPlayRecvData>(out data, events[0].binary))
          {
          ...
          if (data != null)
          {
            ...
            else if (data.h == 7)
            {
              if (this.mRecvResumeRequest.Find((Predicate<SceneBattle.MultiPlayRecvData>) (d => d.pidx == data.pidx)) == null)
              {
                ...
                UnityEngine.Debug.Log((object) "ResumeRequest!!");
                UnityEngine.Debug.Log((object) "*********************");
    ...
    {
      MyPhoton instance = PunMonoSingleton<MyPhoton>.Instance;
      if (this.mExecDisconnected && this.Battle.IsMultiTower || (instance.CurrentState == MyPhoton.MyState.ROOM || !((UnityEngine.Object) this.mBattleUI_MultiPlay != (UnityEngine.Object) null)))
        return false;
    ...
    private void OtherPlayerDisconnect()
    {
      ...
      if ((UnityEngine.Object) this.mBattleUI_MultiPlay != (UnityEngine.Object) null && !this.mIsWaitingForBattleSignal && (!BlockInterrupt.IsBlocked(BlockInterrupt.EType.PHOTON_DISCONNECTED) && this.CurrentNotifyDisconnectedPlayer == null))
      {
        List<JSON_MyPhotonPlayerParam> myPlayersStarted = instance.GetMyPlayersStarted();
        MyPhoton.MyPlayer myPlayer = instance.GetMyPlayer();
      ...
      else
      {
        ...
        else
        {
          if (!this.Battle.CurrentUnit.IsUnitFlag(EUnitFlag.Moved))
          {
            ...
            if ((UnityEngine.Object) tacticsUnitController != (UnityEngine.Object) null)
              this.SetCameraTarget(tacticsUnitController.transform.position);
      ...
      using (List<MyPhoton.MyPlayer>.Enumerator enumerator = roomPlayerList.GetEnumerator())
      {
        while (enumerator.MoveNext())
        {
          ...
          if (player.start && multiPlayer != null && !multiPlayer.NotifyDisconnected)
          {
            ...
            UnityEngine.Debug.Log((object) (multiPlayer.SyncWait.ToString() + "/" + (object) multiPlayer.PlayerIndex));
          }
        }
      }
      return flag;
...
label_20:
    ...
    private void UpdateAudiencePlayer()
    {
      ...
      if (!instance.AudienceManager.IsEnd || flag || (this.Battle.RemainVersusTurnCount == 0U || this.IsInState<SceneBattle.State_AudienceForceEnd>()) || (this.IsInState<SceneBattle.State_AudienceEnd>() || this.IsInState<SceneBattle.State_AudienceRetire>() || (this.IsInState<SceneBattle.State_ExitQuest>() || this.CheckAudienceResult() != BattleCore.QuestResult.Pending)))
        return;
      ...
      else
      {
        ...
        for (int index = this.mTacticsUnits.Count - 1; index >= 0; --index)
        {
          ...
          if ((bool) ((UnityEngine.Object) tuc))
          {
            ...
            {
              tuc.gameObject.SetActive(false);
    ...
    private bool SendCheckMultiPlay()
    {
      ...
      UnityEngine.Debug.Log((object) ("*****SendCheckData******::" + (object) data.b));
      return true;
    }
    ...
    private bool CheckMultiPlay()
    {
      ...
      if (flag)
      {
        UnityEngine.Debug.Log((object) "Check OK!");
        return true;
      }
    ...
    public void SendResumeInfo()
    {
      ...
      UnityEngine.Debug.Log((object) "Send ResumeInfo!!!");
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CRecvResume\u003Ec__Iterator61() { resumedata = resumedata, \u003C\u0024\u003Eresumedata = resumedata, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CRecvReinforcementUnit\u003Ec__Iterator62() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CRestoreWeather\u003Ec__Iterator63() { wth_data = wth_data, \u003C\u0024\u003Ewth_data = wth_data, \u003C\u003Ef__this = this };
    }
    ...
    public void SendBattleDamage(int uid, int damage)
    {
      if (MonoSingleton<GameManager>.Instance.AudienceMode)
        return;
      PunMonoSingleton<MyPhoton>.Instance.SendRoomMessageBinary(true, this.CreateSendBinary(SceneBattle.EMultiPlayRecvDataHeader.DAMAGE, uid, new List<SceneBattle.MultiPlayInput>()
      {
        new SceneBattle.MultiPlayInput() { dm = damage }
      }), MyPhoton.SEND_TYPE.Normal, false);
    }
    ...
    {
      if ((unit.Side == EUnitSide.Enemy || unit.IsBreakObj) && (UnityEngine.Object) this.EnemyGaugeOverlayTemplate != (UnityEngine.Object) null)
    ...
    public void OnGimmickUpdate()
    {
      ...
      for (int index1 = 0; index1 < tacticsUnitControllerList1.Count; ++index1)
      {
        ...
        for (int index2 = 0; index2 < tacticsUnitControllerList2.Count; ++index2)
        {
          ...
          if (!((UnityEngine.Object) tacticsUnitController1 == (UnityEngine.Object) tacticsUnitController2))
          {
    ...
    private void OnSelectItemTarget(int x, int y, ItemData item)
    {
      ...
      if (this.Battle.IsMultiPlay)
      {
        UnityEngine.Debug.LogError((object) "Item! Cheat!");
        this.GotoState_WaitSignal<SceneBattle.State_WaitForLog>();
      }
      else
      {
    ...
    private void GotoSkillSelect()
    {
      ...
      {
        DataSource.Bind<AbilityData>(skillWindow.gameObject, this.UIParam_CurrentAbility);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CLoadUIAsync\u003Ec__Iterator64() { \u003C\u003Ef__this = this };
    }
    ...
    private void ShowUnitMarker(Unit unit, SceneBattle.UnitMarkerTypes markerType)
    {
      ...
      GameObject go = UnityEngine.Object.Instantiate((UnityEngine.Object) this.mUnitMarkerTemplates[(int) markerType], Vector3.zero, Quaternion.identity) as GameObject;
    ...
    {
      return this.PopupNumber(position, number, Color.white, this.mDamageTemplate);
    }

    public GameObject PopupHpHealNumber(Vector3 position, int number)
    {
      return this.PopupNumber(position, number, Color.white, this.mHpHealTemplate);
    }

    public GameObject PopupMpHealNumber(Vector3 position, int number)
    {
      return this.PopupNumber(position, number, Color.white, this.mMpHealTemplate);
    }
    ...
    public GameObject PopupNumber(Vector3 position, int number, Color color, DamagePopup popup)
    {
      ...
      {
        UnityEngine.Debug.LogError((object) "mDamageTemplate == null");
        return (GameObject) null;
      }
      ...
      SceneBattle.Popup2D(damagePopup.gameObject, position, 1, 0.0f);
    ...
    public GameObject PopupDamageDsgNumber(Vector3 position, int number, eDamageDispType ddt)
    {
      ...
      {
        UnityEngine.Debug.LogError((object) "mDamageDsgTemplate == null");
        return (GameObject) null;
      }
      ...
      SceneBattle.Popup2D(damageDsgPopup.gameObject, position, 1, 0.0f);
    ...
    private void LayoutGauges(UnityEngine.Camera cam)
    {
      ...
      for (int index = 0; index < instances.Count; ++index)
      {
        ...
        {
          Vector3 position = tacticsUnitController.transform.position + Vector3.up;
    ...
    private void OnDrag()
    {
      if (MonoSingleton<GameManager>.Instance.IsTutorial() && (UnityEngine.Object) SGHighlightObject.Instance() != (UnityEngine.Object) null || (!this.mBattle.IsMapCommand || this.mBattle.IsUnitAuto(this.mBattle.CurrentUnit)))
        return;
      TacticsUnitController unitController = this.FindUnitController(this.mBattle.CurrentUnit);
      ...
      for (int index1 = 0; index1 < this.mBattle.Units.Count; ++index1)
      {
        ...
        if (!unit.IsDead && unit.CastSkill != null && (unit.CastSkill.CastType == ECastTypes.Jump || unit.CastSkill.TeleportType != eTeleportType.None))
        {
          ...
          if (!flag)
          {
            ...
            GameObject gameObject = UnityEngine.Object.Instantiate((UnityEngine.Object) this.mJumpSpotEffectTemplate, this.CalcGridCenter(x, y), Quaternion.identity) as GameObject;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new SceneBattle.\u003CLoadShieldEffectsAsync\u003Ec__Iterator65() { skills = skills, \u003C\u0024\u003Eskills = skills, \u003C\u003Ef__this = this };
    }
    ...
    private GameObject SpawnShieldEffect(TacticsUnitController unit, SkillParam skill, int value, int valueMax, int turn, int turnMax)
    {
      ...
      if ((UnityEngine.Object) mShieldEffect == (UnityEngine.Object) null)
        return (GameObject) null;
      GameObject gameObject = UnityEngine.Object.Instantiate((UnityEngine.Object) mShieldEffect, unit.transform.position, Quaternion.identity) as GameObject;
    ...
    private class State_Start : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Start.\u003CLoadAndExecuteEvent\u003Ec__Iterator66() { eventName = eventName, \u003C\u0024\u003EeventName = eventName, \u003C\u003Ef__this = this };
      }
    ...
    private class State_MapCommandMultiPlay : State<SceneBattle>
    {
      ...
      private void SyncCameraPosition(SceneBattle self)
      {
        ...
        self.SetCameraTarget((Component) unitController.transform);
    ...
    private class State_MapMoveSelect_Stick : State<SceneBattle>
    {
      ...
      private void SyncCameraPosition()
      {
        ...
        this.mScene.SetCameraTarget(position.x, position.z);
      }
    ...
    private class State_PickupGimmick : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        else
        {
          ...
          if (!this.mItemDrop || this.mDrop == null || this.mDrop.items.Count <= 0)
            return;
          this.mDropItemEffect = UnityEngine.Object.Instantiate((UnityEngine.Object) this.mScene.mTreasureDropTemplate, this.mGimmickController.transform.position + this.mPickup.DropEffectOffset, new Quaternion()) as DropItemEffect;
          ...
          this.mDropItemEffect.gameObject.GetComponent<ItemIcon>().UpdateValue();
      ...
      private void OnPickupDone()
      {
        ...
        if (this.mDrop != null)
        {
          ...
          {
            DropGoldEffect dropGoldEffect = UnityEngine.Object.Instantiate((UnityEngine.Object) this.mScene.mTreasureGoldTemplate, position, Quaternion.identity) as DropGoldEffect;
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PickupGimmick.\u003CGemPramChangePopup\u003Ec__Iterator68() { \u003C\u003Ef__this = this };
      }
    }
        ...
        switch (this.mSeqState)
        {
              ...
              if ((bool) ((UnityEngine.Object) asset))
              {
                using (List<SceneBattle.State_MapTrick.TucMapTrick>.Enumerator enumerator = this.mTucMapTrickLists.GetEnumerator())
                {
                  while (enumerator.MoveNext())
                  {
                    ...
                    {
                      go.transform.SetParent(current.mController.transform, false);
          ...
          case SceneBattle.State_MapTrick.eSeqState.EFF_PLAY:
            ...
            if (this.mGoEffectLists.Count != 0)
            {
              ...
              {
                if ((bool) ((UnityEngine.Object) this.mGoEffectLists[index]))
                {
                  flag1 = true;
                  break;
                }
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          if (!this.mController.ShakeStart)
          {
            ...
            {
              self.PopupDamageNumber(this.mController.transform.position, peek.damage);
              this.mController.ReflectDispModel();
              this.mIsDamaged = true;
    ...
    private class State_ExitQuest : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_ExitQuest.\u003CExitAsync\u003Ec__Iterator69() { \u003C\u003Ef__this = this };
      }
    }
    ...
    private class State_AutoHeal : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_AutoHeal.\u003CWait\u003Ec__Iterator6A() { wait = wait, \u003C\u0024\u003Ewait = wait, \u003C\u003Ef__this = this };
      }
      ...
      private void StartEffect()
      {
        ...
        if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
        {
          this.mHealEffect = UnityEngine.Object.Instantiate((UnityEngine.Object) gameObject, this.mController.transform.position, Quaternion.identity) as GameObject;
    ...
    private class State_PrepareSkill : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CPrepareSkill\u003Ec__Iterator6B() { skill = skill, unit = unit, \u003C\u0024\u003Eskill = skill, \u003C\u0024\u003Eunit = unit, \u003C\u003Ef__this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CcutinVoice\u003Ec__Iterator6C() { unit = unit, skill = skill, \u003C\u0024\u003Eunit = unit, \u003C\u0024\u003Eskill = skill, \u003C\u003Ef__this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CloadTransformUnit\u003Ec__Iterator6D() { unit = unit, self = self, bef_tuc = bef_tuc, callback = callback, \u003C\u0024\u003Eunit = unit, \u003C\u0024\u003Eself = self, \u003C\u0024\u003Ebef_tuc = bef_tuc, \u003C\u0024\u003Ecallback = callback };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PrepareSkill.\u003CloadBreakObjUnit\u003Ec__Iterator6E() { unit = unit, self = self, callback = callback, \u003C\u0024\u003Eunit = unit, \u003C\u0024\u003Eself = self, \u003C\u0024\u003Ecallback = callback };
      }
    }
    ...
    private class State_Battle_EndSkill : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Battle_EndSkill.\u003CAsyncUpdate\u003Ec__Iterator6F() { \u003C\u003Ef__this = this };
      }
      ...
      public override void Update(SceneBattle self)
      {
        ...
        {
          if (this.mLogSkill != null && (UnityEngine.Object) self.mEventScript != (UnityEngine.Object) null)
          {
            TacticsUnitController unitController1 = self.FindUnitController(this.mLogSkill.self);
            if ((UnityEngine.Object) unitController1 != (UnityEngine.Object) null && this.mLogSkill.targets != null && this.mLogSkill.targets.Count != 0)
            {
              List<TacticsUnitController> TargetLists = new List<TacticsUnitController>();
    ...
    private class State_Map_PlayPreSkillAnim : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Map_PlayPreSkillAnim.\u003CAsyncWork\u003Ec__Iterator70() { \u003C\u003Ef__this = this };
      }
    }
    ...
    private class State_Map_PlaySkill : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        this.mInstigator.StartSkill(self.CalcGridCenter(this.mActionInfo.pos.x, this.mActionInfo.pos.y), UnityEngine.Camera.main, targets, vector3List == null ? (Vector3[]) null : vector3List.ToArray(), skill.SkillParam);
        if ((UnityEngine.Object) self.mCollaboTargetTuc != (UnityEngine.Object) null)
          self.mCollaboTargetTuc.StartSkill(self.CalcGridCenter(this.mActionInfo.pos.x, this.mActionInfo.pos.y), UnityEngine.Camera.main, targets, vector3List == null ? (Vector3[]) null : vector3List.ToArray(), skill.SkillParam);
      ...
      public override void Update(SceneBattle self)
      {
        ...
        else
        {
          ...
          using (List<TacticsUnitController>.Enumerator enumerator = this.mTargets.GetEnumerator())
          {
            ...
            {
              TacticsUnitController current = enumerator.Current;
              if ((bool) ((UnityEngine.Object) current) && current.IsBusy)
                return;
            }
          }
          ...
          else
          {
            ...
            else
            {
              ...
              if (this.mActionInfo != null && (UnityEngine.Object) self.mEventScript != (UnityEngine.Object) null)
              {
    ...
    private class State_SpawnShieldEffects : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_SpawnShieldEffects.\u003CSpawnEffectsAsync\u003Ec__Iterator71() { \u003C\u003Ef__this = this };
      }
    ...
    private class State_Weather : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_Weather.\u003CAsyncWeather\u003Ec__Iterator72() { \u003C\u003Ef__this = this };
      }
    ...
    private class State_SpawnUnit : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_SpawnUnit.\u003CAsyncWork\u003Ec__Iterator67() { unit = unit, kill_unit = kill_unit, \u003C\u0024\u003Eunit = unit, \u003C\u0024\u003Ekill_unit = kill_unit, \u003C\u003Ef__this = this };
      }
    ...
    private class State_UnitWithdraw : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_UnitWithdraw.\u003CAsyncWork\u003Ec__Iterator73() { unit = unit, \u003C\u0024\u003Eunit = unit, \u003C\u003Ef__this = this };
      }
    ...
    private class State_ArenaCalc : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_ArenaCalc.\u003CsendResultStartReplay\u003Ec__Iterator74() { self = self, \u003C\u0024\u003Eself = self };
      }
    }
    ...
    private class State_DirectionOffSkill : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_PrepareSkill\u003Ec__Iterator75() { self = self, \u003C\u0024\u003Eself = self, \u003C\u003Ef__this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_MapPrepareSkill\u003Ec__Iterator76() { self = self, \u003C\u0024\u003Eself = self, \u003C\u003Ef__this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_MapPlaySkill\u003Ec__Iterator77() { self = self, \u003C\u0024\u003Eself = self, \u003C\u003Ef__this = this };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_DirectionOffSkill.\u003CTask_Execute\u003Ec__Iterator78() { self = self, \u003C\u0024\u003Eself = self, \u003C\u003Ef__this = this };
      }
    ...
    private class State_MapCommandVersus : State<SceneBattle>
    {
      ...
      private void SyncCameraPosition(SceneBattle self)
      {
        ...
        self.SetCameraTarget(position.x, position.z);
        self.mUpdateCameraPosition = true;
      }
...
label_70:
    ...
    private class State_LoadMapV2 : State<SceneBattle>
    {
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        self.IsLoaded = true;
        self.mUpdateCameraPosition = true;
        UnityEngine.Debug.Log((object) ("======= LOAD MAP START (" + (object) self.Battle.MapIndex + ")"));
    ...
    private class State_PreUnitStart : State<SceneBattle>
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SceneBattle.State_PreUnitStart.\u003CTask_Begin\u003Ec__Iterator79() { self = self, \u003C\u0024\u003Eself = self };
      }
      ...
      public override void Begin(SceneBattle self)
      {
        ...
        if ((UnityEngine.Object) unitController != (UnityEngine.Object) null)
        {
          ...
          if (currentUnit != null && !currentUnit.IsDead)
          {
            ...
            UnityEngine.Debug.Log((object) "[PUN]I'm dead or null...");
          ...
          if (!this.mSelectGrid)
          {
            ...
            if (attackTargetsAi.Count > 0)
            {
              for (int index = 0; index < attackTargetsAi.Count; ++index)
              {
                ...
                if ((UnityEngine.Object) unitController2 != (UnityEngine.Object) null && this.mTargetGrids.get(attackTargetsAi[index].x, attackTargetsAi[index].y) && (!unitController2.Unit.IsBreakObj || unitController2.Unit.IsBreakDispUI))
                  this.mTargets.Add(unitController2);
              }
              flag1 = false;
            }
                ...
                else
                {
                  ...
                  if (commandResult != null && commandResult.targets != null)
                  {
                    ...
                    if (commandResult.targets.Count > 0)
                    {
                      ...
                      if (index != -1 && (UnityEngine.Object) this.self.mBattleUI.TargetMain != (UnityEngine.Object) null)
                      {
    ...
    private class State_InputDirection : State<SceneBattle>
    {
      ...
      private void OnStepEnd()
      {
        ...
        for (int index = 0; index < 4; ++index)
        {
          ...
          this.mArrows[index] = UnityEngine.Object.Instantiate((UnityEngine.Object) this.self.DirectionArrowTemplate, this.mController.transform.position + vector3, rotation) as DirectionArrow;
        }
        this.UpdateArrows();
    ...
    public class VirtualStickInput : SceneBattle.MoveInput
    {
      ...
      private void OnClick(Vector2 screenPos)
      {
        ...
        if (this.mShateiGrid != null)
        {
          ...
          localPoint -= transform.rect.position;
          ...
          for (int index = 0; index < this.SceneOwner.mTacticsUnits.Count; ++index)
          {
            ...
            if (!((UnityEngine.Object) mTacticsUnit == (UnityEngine.Object) null))
            {
              ...
              if (unit3 != null)
              {
                ...
                {
                  float magnitude = (hpGaugeTransform.anchoredPosition - localPoint).magnitude;
      ...
      private Vector2 Velocity
      {
        get
        {
          ...
          if (!((UnityEngine.Object) main != (UnityEngine.Object) null) || !((UnityEngine.Object) virtualStick != (UnityEngine.Object) null))
            return Vector2.zero;
      ...
      {
        Vector3 position = this.mController.transform.position;
        this.SceneOwner.SetCameraTarget(position.x, position.z);
      }
