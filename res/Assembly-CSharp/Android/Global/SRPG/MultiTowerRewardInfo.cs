      ...
      else
      {
        ...
        switch (type)
        {
          case MultiTowerRewardItem.RewardType.Item:
            ...
            Transform child1 = this.itemObj.transform.FindChild("icon");
            if ((UnityEngine.Object) child1 != (UnityEngine.Object) null)
            {
              GameParameter component3 = child1.GetComponent<GameParameter>();
          ...
          case MultiTowerRewardItem.RewardType.Award:
            ...
            Transform child2 = this.itemObj.transform.FindChild("icon");
            if ((UnityEngine.Object) child2 != (UnityEngine.Object) null)
            {
              IconLoader iconLoader = GameUtility.RequireComponent<IconLoader>(child2.gameObject);
              if (!string.IsNullOrEmpty(awardParam.icon))
                iconLoader.ResourcePath = AssetPath.ItemIcon(awardParam.icon);
              GameParameter component3 = child2.GetComponent<GameParameter>();
              if ((UnityEngine.Object) component3 != (UnityEngine.Object) null)
                component3.enabled = false;
              if ((UnityEngine.Object) this.rewardName != (UnityEngine.Object) null)
