...
namespace SRPG
{
  public class MyPhoton : PunMonoSingleton<MyPhoton>
  {
    ...
    public override void OnJoinedRoom()
    {
      ...
      if (GlobalVars.SelectedMultiPlayRoomType == JSON_MyPhotonRoomParam.EType.RANKMATCH && !this.IsOldestPlayer() && currentRoom.playerCount > 2)
      {
        this.LeaveRoom();
        MyPhoton instance = PunMonoSingleton<MyPhoton>.Instance;
        if (instance.CurrentState != MyPhoton.MyState.NOP)
          instance.Disconnect();
        this.Log("Room Overflow. Disconnecting.");
      }
      else
      {
        this.mEvents.Clear();
    ...
    public List<MyPhoton.MyRoom> GetRoomList()
    {
      ...
      foreach (global::RoomInfo room in PhotonNetwork.GetRoomList())
      {
        ...
        {
          if (customProperties[(object) "json"] is string)
            myRoom.json = (string) customProperties[(object) "json"];
          else
    ...
    public MyPhoton.MyPlayer GetMyPlayer()
    {
      ...
      if (customProperties != null && ((Dictionary<object, object>) customProperties).Count > 0)
      {
        myPlayer.json = (string) customProperties[(object) "json"];
    ...
    public void SetResumeMyPlayer(int playerID = 0)
    {
      ...
      if (customProperties != null && ((Dictionary<object, object>) customProperties).ContainsKey((object) "json"))
        empty = (string) customProperties[(object) "json"];
      Hashtable propertiesToSet = new Hashtable();
    ...
    public bool JoinRoomCheckParam(string VersusHash, string playerJson, int lvRange, int floorRange, int lv, int floor, string lastuid, string myuid)
    {
      ...
      foreach (global::RoomInfo roomInfo in roomList)
      {
        ...
        if (((Dictionary<object, object>) customProperties).ContainsKey((object) "MatchType") && VersusHash == (string) customProperties[(object) "MatchType"] && (!((Dictionary<object, object>) customProperties).ContainsKey((object) "uid") || string.IsNullOrEmpty(lastuid) || string.Compare((string) customProperties[(object) "uid"], lastuid) != 0) && ((!((Dictionary<object, object>) customProperties).ContainsKey((object) "luid") || string.IsNullOrEmpty(myuid) || string.Compare((string) customProperties[(object) "luid"], myuid) != 0) && (!((Dictionary<object, object>) customProperties).ContainsKey((object) "start") || !(bool) customProperties[(object) "start"])))
    ...
    public bool JoinRankMatchRoomCheckParam(string playerJson, int lv, int lvRange, string myuid, int score, int scoreRangeMax, int scoreRangeMin, int type, string[] exclude_uids)
    {
      ...
      foreach (global::RoomInfo roomInfo in roomList)
      {
        ...
        {
          if (((Dictionary<object, object>) customProperties).ContainsKey((object) "uid") && exclude_uids != null && exclude_uids.Length > 0)
          {
          ...
          if (roomInfo.PlayerCount <= 2 && ((Dictionary<object, object>) customProperties).ContainsKey((object) nameof (score)) && (!((Dictionary<object, object>) customProperties).ContainsKey((object) "start") || !(bool) customProperties[(object) "start"]))
            roomInfoList.Add(roomInfo);
        }
      }
    ...
    public bool AddRoomParam(string key, string param)
    {
      ...
      if (customProperties != null)
      {
        ((Dictionary<object, object>) propertiesToSet).Add((object) "json", customProperties[(object) "json"]);
        if (((Dictionary<object, object>) customProperties).ContainsKey((object) key))
          return false;
      }
    ...
    public bool SendRoomMessage(bool reliable, string msg, MyPhoton.SEND_TYPE eventcode = MyPhoton.SEND_TYPE.Normal)
    {
      ...
      bool flag = PhotonNetwork.RaiseEvent((byte) eventcode, (object) hashtable1, reliable, new RaiseEventOptions() { ForwardToWebhook = true });
    ...
    public bool SendRoomMessageBinary(bool reliable, byte[] msg, MyPhoton.SEND_TYPE eventcode = MyPhoton.SEND_TYPE.Normal, bool isWrite = false)
    {
      ...
      bool flag = PhotonNetwork.RaiseEvent((byte) eventcode, (object) hashtable2, reliable, new RaiseEventOptions() { ForwardToWebhook = true });
      if (!this.DisconnectIfSendRoomMessageFailed || flag)
        return flag;
      this.Disconnect();
      this.mError = MyPhoton.MyError.RAISE_EVENT_FAILED;
