...
namespace SRPG
{
  ...
  public class VersusTowerKey : MonoBehaviour, IFlowInterface
  {
    ...
    private void RefreshData()
    {
      ...
      if (partyOfType != null)
      {
        ...
        if (unitDataByUniqueId != null)
          DataSource.Bind<UnitData>(this.gameObject, unitDataByUniqueId);
      }
    ...
    public virtual IEnumerator UpdateKeyAnim()
    {
      ...
      return (IEnumerator) new VersusTowerKey.\u003CUpdateKeyAnim\u003Ec__Iterator14C() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new VersusTowerKey.\u003CUpdateLostKeyAnim\u003Ec__Iterator14D() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new VersusTowerKey.\u003CUpdateFloorAnim\u003Ec__Iterator14E() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new VersusTowerKey.\u003CUpdateRewardAnim\u003Ec__Iterator14F() { \u003C\u003Ef__this = this };
    }
