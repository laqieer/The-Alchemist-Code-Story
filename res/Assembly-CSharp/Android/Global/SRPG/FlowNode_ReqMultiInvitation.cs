...
namespace SRPG
{
  ...
  public class FlowNode_ReqMultiInvitation : FlowNode_Network
  {
    ...
    public class Api_NotifyInvitation : FlowNode_ReqMultiInvitation.ApiBase
    {
      ...
      {
        bool flag = false;
        if ((UnityEngine.Object) MonoSingleton<GameManager>.Instance != (UnityEngine.Object) null && MonoSingleton<GameManager>.Instance.Player != null && !MonoSingleton<GameManager>.Instance.Player.MultiInvitaionFlag)
          flag = true;
        if (!flag)
          return base.Start();
