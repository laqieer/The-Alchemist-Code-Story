...
namespace SRPG
{
  ...
  public class ChallengeMissionDetail : MonoBehaviour, IFlowInterface
  {
    ...
    private void Start()
    {
      if ((UnityEngine.Object) this.ButtonCancel == (UnityEngine.Object) null || (UnityEngine.Object) this.ButtonTry == (UnityEngine.Object) null)
      {
        this.enabled = false;
      }
      else
      {
        ...
        this.ButtonTry.onClick.AddListener(new UnityAction(this.OnTry));
      }
    }

    private void OnEnable()
    {
      this.UpdateReward(DataSource.FindDataOfClass<TrophyParam>(this.gameObject, (TrophyParam) null));
    }
