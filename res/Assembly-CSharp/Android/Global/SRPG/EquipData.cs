...
namespace SRPG
{
  public class EquipData
  {
    ...
    public bool Setup(string item_iname)
    {
      ...
      this.mRarityParam = instance.GetRarityParam((int) this.mItemParam.rare);
      if (!string.IsNullOrEmpty((string) this.mItemParam.skill))
      {
        int rank = this.CalcRank();
        this.mSkill = new SkillData();
        this.mSkill.Setup((string) this.mItemParam.skill, rank, (int) this.mRarityParam.EquipEnhanceParam.rankcap, (MasterParam) null);
      }
      return true;
    }
    ...
    public void Equip(string iname, long iid, int exp)
    {
      ...
      this.mEquiped = true;
      if (this.mSkill == null && !string.IsNullOrEmpty((string) this.mItemParam.skill))
        this.mSkill = new SkillData();
      if (this.mSkill == null)
        return;
      this.mSkill.Setup((string) this.mItemParam.skill, this.mRank, this.GetRankCap(), (MasterParam) null);
    }
    ...
    public void GainExp(int exp)
    {
      ...
      if (this.mSkill == null || this.ItemParam == null)
        return;
      this.mSkill.Setup((string) this.ItemParam.skill, this.mRank, this.GetRankCap(), (MasterParam) null);
    }
