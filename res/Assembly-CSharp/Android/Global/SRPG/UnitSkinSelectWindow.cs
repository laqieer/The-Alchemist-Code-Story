...
namespace SRPG
{
  ...
  public class UnitSkinSelectWindow : SRPG_ListBase, IFlowInterface
  {
    ...
    protected override void Start()
    {
      ...
      {
        ArtifactParam skin = allSkins[index];
        ...
        bool active = true;
        if (selectableSkins == null || Array.Find<ArtifactParam>(selectableSkins, (Predicate<ArtifactParam>) (s => s.iname == skin.iname)) == null)
          active = false;
        this.SetActiveListItem(gameObject, active);
        UnitData data2 = new UnitData();
        data2.Setup(this.mCurrentUnit);
        data2.SetJobSkin(skin.iname, this.mCurrentUnit.JobIndex);
