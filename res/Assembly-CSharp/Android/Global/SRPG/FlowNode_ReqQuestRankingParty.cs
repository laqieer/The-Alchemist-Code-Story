...
namespace SRPG
{
  ...
  public class FlowNode_ReqQuestRankingParty : FlowNode_Network
  {
    ...
    {
      ReqQuestRankingPartyData dataOfClass = DataSource.FindDataOfClass<ReqQuestRankingPartyData>(this.gameObject, (ReqQuestRankingPartyData) null);
      ...
      else
      {
        ...
        else
        {
          ...
          if (body.party != null)
          {
            ...
            {
              if (string.IsNullOrEmpty(body.party[index].iname))
              {
