      ...
      for (int index = 0; index < array.Length; ++index)
      {
        ...
        if (questParam.difficulty == this.mDifficultyFilter)
        {
          ...
          if (!((UnityEngine.Object) original == (UnityEngine.Object) null))
          {
            ...
            DataSource.Bind<RankingQuestParam>(gameObject, availableRankingQuest);
            DataSource.Bind<QuestParam>(gameObject, questParam);
            ...
            {
              SGHighlightObject.Instance().highlightedObject = component.gameObject;
    ...
    private void RefreshButtons(QuestDifficulties difficulty)
    {
      ...
      switch (difficulty)
      {
        case QuestDifficulties.Normal:
          this.BtnUnitRanking.SetActive(true);
          this.BtnEliteBookmark.SetActive(false);
          this.BtnNormal.GetComponent<Button>().interactable = false;
          this.BtnNormal.GetComponent<Button>().enabled = false;
          this.BtnNormal.GetComponent<Image>().color = this.BtnNormal.GetComponent<Button>().colors.normalColor;
          this.BtnElite.GetComponent<Button>().interactable = true;
          this.BtnElite.GetComponent<Button>().enabled = true;
          this.BtnElite.GetComponent<Image>().color = this.BtnElite.GetComponent<Button>().colors.pressedColor;
          break;
        case QuestDifficulties.Elite:
          this.BtnUnitRanking.SetActive(true);
          this.BtnEliteBookmark.SetActive(true);
          this.BtnNormal.GetComponentInChildren<Button>().interactable = true;
          this.BtnNormal.GetComponentInChildren<Button>().enabled = true;
          this.BtnNormal.GetComponent<Image>().color = this.BtnNormal.GetComponent<Button>().colors.pressedColor;
          this.BtnElite.GetComponentInChildren<Button>().interactable = false;
          this.BtnElite.GetComponentInChildren<Button>().enabled = false;
          this.BtnElite.GetComponent<Image>().color = this.BtnElite.GetComponent<Button>().colors.normalColor;
          break;
      }
    }
