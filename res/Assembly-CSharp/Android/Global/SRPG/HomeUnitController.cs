...
namespace SRPG
{
  public class HomeUnitController : UnitController
  {
    ...
    protected override void Start()
    {
      ...
      if (homeWorld == null)
      {
        UnityEngine.Debug.LogError((object) "home world is null.");
      }
      else
      {
        ...
        {
          UnityEngine.Debug.LogError((object) ("ホーム画面用ユニットが存在しません '" + homeWorld.unit + "'"));
        }
        else
        {
    ...
    private IEnumerator LoadAsync()
    {
      ...
      return (IEnumerator) new HomeUnitController.\u003CLoadAsync\u003Ec__Iterator97() { \u003C\u003Ef__this = this };
    }
  }
}
