...
namespace SRPG
{
  ...
  public class FlowNode_MultiPlayAPI : FlowNode_Network
  {
    ...
    private IEnumerator GetPhotonRoomList(string fuid)
    {
      ...
      return (IEnumerator) new FlowNode_MultiPlayAPI.\u003CGetPhotonRoomList\u003Ec__IteratorD0() { fuid = fuid, \u003C\u0024\u003Efuid = fuid, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_MultiPlayAPI.\u003CGetPhotonRoomName\u003Ec__IteratorD1() { \u003C\u003Ef__this = this };
    }
        ...
        else if (this.API != FlowNode_MultiPlayAPI.EAPI.UPDATE && this.API != FlowNode_MultiPlayAPI.EAPI.VERSION)
        {
          ...
          else if (this.API != FlowNode_MultiPlayAPI.EAPI.VERSUS_LINE_REQ && this.API != FlowNode_MultiPlayAPI.EAPI.VERSUS_LINE_MAKE)
          {
            ...
            else if (this.API == FlowNode_MultiPlayAPI.EAPI.MT_STATUS)
            {
              ...
              UnityEngine.Debug.Log((object) www.text);
              if (jsonObject == null)
              {
                this.OnFailed();
                return;
