...
namespace SRPG
{
  ...
  public class FlowNode_ExecGacha : FlowNode_Network
  {
    ...
    private IEnumerator StartGachaSceneAsync(FlowNode_ExecGacha.GachaModes mode)
    {
      ...
      return (IEnumerator) new FlowNode_ExecGacha.\u003CStartGachaSceneAsync\u003Ec__IteratorCC() { \u003C\u003Ef__this = this };
    }

    private void OnGachaSceneLoad(GameObject scene)
    {
      this.mGachaScene = scene.GetComponent<GachaScene>();
      if ((UnityEngine.Object) this.mGachaScene != (UnityEngine.Object) null)
