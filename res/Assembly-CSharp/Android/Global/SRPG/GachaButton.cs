...
namespace SRPG
{
  public class GachaButton : MonoBehaviour
  {
    ...
    private void Start()
    {
      ...
      if ((UnityEngine.Object) this.optionLayout != (UnityEngine.Object) null)
        this.optionLayout.SetActive(false);
      if ((UnityEngine.Object) this.optionLayout2 != (UnityEngine.Object) null)
        this.optionLayout2.SetActive(false);
      if ((UnityEngine.Object) this.paidOption != (UnityEngine.Object) null)
        this.paidOption.SetActive(false);
      if ((UnityEngine.Object) this.timerOption != (UnityEngine.Object) null)
        this.timerOption.SetActive(false);
      if ((UnityEngine.Object) this.haveOption != (UnityEngine.Object) null)
        this.haveOption.SetActive(false);
      if ((UnityEngine.Object) this.stepupOption != (UnityEngine.Object) null)
        this.stepupOption.SetActive(false);
      if ((UnityEngine.Object) this.GachaBtn != (UnityEngine.Object) null)
    ...
    {
      return !((UnityEngine.Object) gobj == (UnityEngine.Object) null) && gobj.activeInHierarchy;
    }
    ...
    {
      if (cost == GachaButton.GachaCostType.NONE || cost == GachaButton.GachaCostType.ALL || (UnityEngine.Object) this.CostBG == (UnityEngine.Object) null)
        return false;
      Transform parent = this.costBG.transform.parent;
      ...
      this.CostBG.GetComponent<ImageArray>().ImageIndex = cost == GachaButton.GachaCostType.COIN || cost == GachaButton.GachaCostType.COIN_P ? 0 : 1;
      return true;
    }
    ...
    private bool UpdateOptionObject(GachaButton.GachaCategoryType category = GachaButton.GachaCategoryType.NONE, GachaButton.GachaCostType cost = GachaButton.GachaCostType.NONE)
    {
      ...
      if (cost == GachaButton.GachaCostType.TICKET)
      {
        if ((UnityEngine.Object) this.TicketState != (UnityEngine.Object) null)
        {
          Text component = this.TicketState.GetComponent<Text>();
          if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          {
            component.text = this.TicketNum.ToString();
      ...
      {
        if ((UnityEngine.Object) this.StepupState != (UnityEngine.Object) null)
        {
          if ((UnityEngine.Object) this.mCurrentStepup10 == (UnityEngine.Object) null)
          {
            Transform child = this.StepupState.transform.FindChild("current_10");
            this.mCurrentStepup10 = !((UnityEngine.Object) child != (UnityEngine.Object) null) ? (GameObject) null : child.gameObject;
          }
          if ((UnityEngine.Object) this.mCurrentStepup1 == (UnityEngine.Object) null)
          {
            Transform child = this.StepupState.transform.FindChild("current_1");
            this.mCurrentStepup1 = !((UnityEngine.Object) child != (UnityEngine.Object) null) ? (GameObject) null : child.gameObject;
          }
          if ((UnityEngine.Object) this.mMaxStepup10 == (UnityEngine.Object) null)
          {
            Transform child = this.StepupState.transform.FindChild("max_10");
            this.mMaxStepup10 = !((UnityEngine.Object) child != (UnityEngine.Object) null) ? (GameObject) null : child.gameObject;
          }
          if ((UnityEngine.Object) this.mMaxStepup1 == (UnityEngine.Object) null)
          {
            Transform child = this.StepupState.transform.FindChild("max_1");
            this.mMaxStepup1 = !((UnityEngine.Object) child != (UnityEngine.Object) null) ? (GameObject) null : child.gameObject;
          }
          if ((UnityEngine.Object) this.mCurrentStepup1 == (UnityEngine.Object) null || (UnityEngine.Object) this.mCurrentStepup10 == (UnityEngine.Object) null || ((UnityEngine.Object) this.mMaxStepup1 == (UnityEngine.Object) null || (UnityEngine.Object) this.mMaxStepup10 == (UnityEngine.Object) null))
            return false;
      ...
      else if ((this.Category == "coin_1" || this.Category == "gold_1") && ((UnityEngine.Object) this.TimerObject != (UnityEngine.Object) null && (UnityEngine.Object) this.LimitObject != (UnityEngine.Object) null))
      {
        bool flag = true;
    ...
    private bool UpdateLimit(int num)
    {
      ...
      this.Limit10.gameObject.SetActive(num1 > 0);
    ...
    private bool UpdateButtonImage(GachaButton.GachaCostType cost = GachaButton.GachaCostType.NONE)
    {
      if (cost == GachaButton.GachaCostType.NONE || cost == GachaButton.GachaCostType.ALL)
        return false;
      this.gachaBtn.GetComponent<ImageArray>().ImageIndex = cost != GachaButton.GachaCostType.COIN_P ? 0 : 1;
      return true;
    }
    ...
    private bool UpdateButtonText(string update_text = "")
    {
      ...
      {
        Transform transform = this.GachaBtn.transform.Find("text");
        if ((UnityEngine.Object) transform != (UnityEngine.Object) null)
        {
          LText component = transform.GetComponent<LText>();
          if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          {
            component.text = update_text;
            return true;
          }
        }
      }
    ...
    private bool UpdateCostNumber(int cost = -1)
    {
      Transform child1 = this.CostBG.transform.FindChild("num");
      Transform child2 = this.CostBG.transform.FindChild("num_free");
      if ((UnityEngine.Object) child1 == (UnityEngine.Object) null || (UnityEngine.Object) child2 == (UnityEngine.Object) null)
        return false;
    ...
    private bool RefreshCostNum(int cost = 0)
    {
      ...
      {
        Transform child = this.CostBG.transform.FindChild("num/value_" + Mathf.Pow(10f, (float) (displayCostNum - 1)).ToString());
    ...
    private IEnumerator UpdateOption()
    {
      ...
      return (IEnumerator) new GachaButton.\u003CUpdateOption\u003Ec__IteratorF9() { \u003C\u003Ef__this = this };
    }
