...
namespace SRPG
{
  ...
  public class UnitGetDetail : MonoBehaviour, IFlowInterface
  {
    ...
    private IEnumerator UpdateFadeUnitImage()
    {
      ...
      return (IEnumerator) new UnitGetDetail.\u003CUpdateFadeUnitImage\u003Ec__Iterator142() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitGetDetail.\u003CRefreshUnitImage\u003Ec__Iterator143() { \u003C\u003Ef__this = this };
    }
  }
}
