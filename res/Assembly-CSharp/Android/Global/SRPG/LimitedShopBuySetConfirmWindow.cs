    ...
    private void Refresh()
    {
      ...
      else
      {
        ...
        if (data.IsSet)
        {
          ...
          {
            GameObject gameObject = index >= this.limited_shop_item_set_list.Count ? UnityEngine.Object.Instantiate<GameObject>(this.ItemTemplate) : this.limited_shop_item_set_list[index].gameObject;
      ...
      DataSource.Bind<LimitedShopItem>(this.gameObject, data);
