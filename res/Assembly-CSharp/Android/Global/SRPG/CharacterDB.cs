...
namespace SRPG
{
  public class CharacterDB
  {
    ...
    {
      return ((int) color.r).ToString() + "," + (object) color.g + "," + (object) color.b;
    }
        ...
        using (StringReader stringReader = new StringReader(s))
        {
          ...
          while ((str2 = stringReader.ReadLine()) != null)
          {
            ...
            if (str2.Length > 0)
            {
              ...
              CharacterDB.Job job = new CharacterDB.Job() { JobID = strArray[index2] };
    ...
    public class Job
    {
      ...
      [StringIsCharaDBResourcePopup(typeof (GameObject), "CH/BODY/")]
      public string BodyName;
      [StringIsCharaDBResourcePopup(typeof (GameObject), "CH/BODYOPT/")]
      public string BodyAttachmentName;
      [StringIsCharaDBResourcePopup(typeof (Texture2D), "CH/BODYTEX/")]
      public string BodyTextureName;
      [StringIsCharaDBResourcePopup(typeof (GameObject), "CH/HEAD/")]
      public string HeadName;
      [StringIsCharaDBResourcePopup(typeof (GameObject), "CH/HAIR/")]
      public string HairName;
      [StringIsCharaDBResourcePopup(typeof (GameObject), "CH/HEADOPT/")]
