...
namespace SRPG
{
  ...
  public class FlowNode_ExecGacha2 : FlowNode_Network
  {
    ...
    {
      GlobalVars.SelectedGachaId = iname;
      GlobalVars.SelectedGachaType = input;
      ...
      else if (input == "multiple")
      {
        ...
        if (type == "coin")
        {
          if (isPaid)
            ...
            AnalyticsManager.TrackFreePremiumCurrencyUse((long) cost, "Summons");
        }
        else
        {
          if (!(type == "gold"))
    ...
    private IEnumerator AsyncGachaResultData(List<GachaDropData> drops)
    {
      ...
      return (IEnumerator) new FlowNode_ExecGacha2.\u003CAsyncGachaResultData\u003Ec__IteratorCD() { drops = drops, \u003C\u0024\u003Edrops = drops, \u003C\u003Ef__this = this };
    }
