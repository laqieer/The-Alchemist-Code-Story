...
namespace SRPG
{
  public class SkillParam
  {
    ...
    public List<AttackDetailTypes> reaction_det_lists = new List<AttackDetailTypes>();
    public List<string> ReplaceTargetIdLists = new List<string>();
    public List<string> ReplaceChangeIdLists = new List<string>();
    public List<string> AbilityReplaceTargetIdLists = new List<string>();
