...
namespace SRPG
{
  public class GachaUnitShard : MonoBehaviour
  {
    ...
    private string[] DefaultGaugeUpAnimSoundList = new string[5]{ "SE_1027", "SE_1028", "SE_1029", "SE_1030", "SE_1031" };
    ...
    private void RefreshJobWindow()
    {
      ...
      this.JobComment.text = LocalizedText.Get("sys.GACHA_TEXT_SHARD_AWAKE", new object[1]
      {
    ...
    {
      if (this.mNotUnlockUnit)
        return this.msub_shard + this.mget_shard >= this.mnext_shard;
      return false;
    }
    ...
    public void Refresh(UnitParam param, string shard_name = "", int awake_lv = 0, int get_shard = 0, int current_index = 0)
    {
      ...
      if (unitDataByUnitId != null)
      {
        ...
        {
          Transform child = this.mRebirthStars[index2].transform.FindChild("Rebirth_star_anim");
          child.FindChild("Rebirthstar_01").gameObject.SetActive(true);
          child.FindChild("Rebirthstar_02").gameObject.SetActive(true);
          child.FindChild("Rebirthstar_03").gameObject.SetActive(true);
          child.FindChild("Rebirthstar_04").gameObject.SetActive(true);
          child.FindChild("Rebirthstar_05").gameObject.SetActive(true);
        }
        int num2 = this.StartAwakeLv % 5;
        if (num2 > 0)
        {
          Transform child = this.mRebirthStars[index1].transform.FindChild("Rebirth_star_anim");
          for (int index2 = 0; index2 < num2; ++index2)
          {
            string name = "Rebirthstar_0" + (object) (index2 + 1);
            child.FindChild(name).gameObject.SetActive(true);
          }
        }
        if (this.msub_shard > 0)
        {
          ...
          while (msubShard >= awakeNeedPieces)
          {
            ...
            Transform child = this.mRebirthStars[num4 + 1 < num3 ? num4 : num3 - 1].transform.FindChild("Rebirth_star_anim").FindChild("Rebirthstar_0" + num5.ToString());
          ...
          if ((UnityEngine.Object) this.ShardNext != (UnityEngine.Object) null)
            this.ShardNext.text = awakeNeedPieces.ToString();
          if ((UnityEngine.Object) this.ShardCurrent != (UnityEngine.Object) null)
    ...
    private void RefreshAddStar()
    {
      ...
      for (; num2 + this.mstart_gauge >= awakeNeedPieces; this.mstart_gauge = 0)
      {
        int num4 = startAwakeLv / 5;
        int num5 = Math.Min(5, startAwakeLv % 5) + 1;
        Transform child = this.mRebirthStars[num4 + 1 < num1 ? num4 : num1 - 1].transform.FindChild("Rebirth_star_anim").FindChild("Rebirthstar_0" + num5.ToString());
        if ((UnityEngine.Object) child != (UnityEngine.Object) null)
          child.gameObject.SetActive(true);
        ++startAwakeLv;
        if (startAwakeLv >= this.AwakeLvCap)
    ...
    private void AnimationShard()
    {
      ...
      float f = Mathf.Lerp(this.mShardStart, this.mShardEnd, Mathf.Clamp01(this.mShardAnimTime / 1f));
      int num1 = Mathf.FloorToInt(f);
      int mnextShard = this.mnext_shard;
      if ((UnityEngine.Object) this.ShardCurrent != (UnityEngine.Object) null)
        this.ShardCurrent.text = Mathf.FloorToInt((float) (this.mstart_gauge + num1)).ToString();
      if ((UnityEngine.Object) this.ShardGauge != (UnityEngine.Object) null)
      {
        float num2 = ((float) this.mstart_gauge + f) / (float) mnextShard;
        MonoSingleton<MySound>.Instance.PlaySEOneShot(this.GaugeUpAnimSoundList[0], 0.0f);
        this.ShardGauge.AnimateValue(num2, 0.0f);
      }
    ...
    {
      if ((UnityEngine.Object) this.ShardGauge == (UnityEngine.Object) null || this.msub_shard > 0)
        return;
      if ((UnityEngine.Object) this.ShardNext != (UnityEngine.Object) null)
        this.ShardNext.text = this.mnext_shard.ToString();
      if ((UnityEngine.Object) this.ShardCurrent != (UnityEngine.Object) null)
    ...
    private class State_AddingGaugeSkip : State<GachaUnitShard>
    {
      public override void Begin(GachaUnitShard self)
      {
        Animator component = self.GetComponent<Animator>();
      ...
      private IEnumerator WaitGaugeObject()
      {
        ...
        return (IEnumerator) new GachaUnitShard.State_AddingGaugeSkip.\u003CWaitGaugeObject\u003Ec__IteratorFE() { \u003C\u003Ef__this = this };
      }
    }
    ...
    private class State_AddingRebirthStar : State<GachaUnitShard>
    {
      ...
      public override void Begin(GachaUnitShard self)
      {
        ...
        else
        {
          ...
          this.new_star = num3;
          this.rebirth_star = self.mRebirthStars[index].transform.FindChild("Rebirth_star_anim");
          this.rebirth_star.GetComponent<Animator>().SetInteger("new", num3);
        }
      }
      ...
      public override void Update(GachaUnitShard self)
      {
        if (self.mClicked)
        {
          Animator component = this.rebirth_star.GetComponent<Animator>();
    ...
    private class State_ShowRebirthText : State<GachaUnitShard>
    {
      ...
      public override void Begin(GachaUnitShard self)
      {
        ...
        else
        {
          ...
          this.anim = self.Rebirthtext_root.transform.FindChild("Rebirth_txtanim").gameObject;
        }
      }
