...
namespace SRPG
{
  ...
  {
    private List<LogSkill.Target.CondHit> mCondHitLists = new List<LogSkill.Target.CondHit>();
    private TargetPlate.GaugeParam mHpGaugeParam = new TargetPlate.GaugeParam();
    private TargetPlate.GaugeParam mMpGaugeParam = new TargetPlate.GaugeParam();
    private TargetPlate.PlateUnitParam mUnitParam = new TargetPlate.PlateUnitParam();
    ...
    public WindowController WindowController
    {
      get
      {
        if ((UnityEngine.Object) this.mWindowController == (UnityEngine.Object) null)
          this.mWindowController = this.gameObject.GetComponent<WindowController>();
    ...
    private void SetTextValue(GameObject targetObject, string value)
    {
      if ((UnityEngine.Object) targetObject == (UnityEngine.Object) null)
        return;
      Text component = targetObject.GetComponent<Text>();
    ...
    private CanvasGroup TargetCg
    {
      get
      {
        if ((UnityEngine.Object) this.mTargetCg == (UnityEngine.Object) null)
          this.mTargetCg = this.GetComponent<CanvasGroup>();
    ...
    private void Update()
    {
      ...
      if ((bool) ((UnityEngine.Object) targetCg))
        targetCg.blocksRaycasts = (double) targetCg.alpha > 0.0;
      if (this.mCondHitLists.Count <= 1)
        return;
      this.mCondHitPassedTime += Time.deltaTime;
    ...
    private void SetCondHit(List<LogSkill.Target.CondHit> cond_hit_lists = null)
    {
      ...
      if ((bool) ((UnityEngine.Object) this.GoCondHit))
    ...
    private void DispCondHit(int ch_idx)
    {
      ...
      if ((bool) ((UnityEngine.Object) this.TextCondName) && index >= 0 && index < Unit.StrNameUnitConds.Length)
        this.TextCondName.text = Unit.StrNameUnitConds[index];
      if ((bool) ((UnityEngine.Object) this.ImageCondIcon) && index >= 0 && index < this.ImageCondIcon.Images.Length)
        this.ImageCondIcon.ImageIndex = index;
      if (!(bool) ((UnityEngine.Object) this.TextCondPer))
        return;
      this.TextCondPer.text = mCondHitList.Per.ToString();
    }
    ...
    public void SetNoAction(Unit unit, List<LogSkill.Target.CondHit> cond_hit_lists = null)
    {
      ...
      DataSource.Bind<Unit>(this.gameObject, unit);
    ...
    public void SetTrick(TrickParam trick_param)
    {
      ...
      DataSource.Bind<TrickParam>(this.gameObject, trick_param);
      GameParameter.UpdateAll(this.gameObject);
    }
    ...
    private void toggleTargetArrow(ButtonExt.ButtonClickEvent listener, bool active, bool isNextArrow)
    {
      ...
      if (listener == null || (UnityEngine.Object) gameObject == (UnityEngine.Object) null)
        return;
    ...
    {
      if ((UnityEngine.Object) this.MpGauge == (UnityEngine.Object) null)
        return;
      int PlusValue = 0;
      if (0 < YosokuDamageMp)
    ...
    private void SetGaugeParamInternal(ref TargetPlate.GaugeParam Gauge, TargetPlate.EGaugeType Type, int CurrentValue, int MaxValue, int PlusValue)
    {
      ...
      if (0 > PlusValue)
      {
        ...
        color32Array[0] = color32_1;
        color32Array[0].a = (byte) ((double) Mathf.Clamp01((float) (CurrentValue + PlusValue) / (float) CurrentValue) * (double) byte.MaxValue);
        color32Array[1] = color32_2;
        color32Array[1].a = (byte) ((uint) byte.MaxValue - (uint) color32Array[0].a);
      ...
      else if (0 < PlusValue)
      {
        ...
        color32Array[0].a = (byte) ((double) Mathf.Clamp01((float) CurrentValue / num) * (double) byte.MaxValue);
    ...
    {
      if (param == null || param.Colors == null || (UnityEngine.Object) gauge == (UnityEngine.Object) null)
        return;
    ...
    {
      if (this.mSelectedUnit == null || !((UnityEngine.Object) this.GimmickDescription != (UnityEngine.Object) null))
        return;
    ...
    public void Open()
    {
      if ((UnityEngine.Object) this.StatusEffects != (UnityEngine.Object) null && this.mSelectedUnit != null)
    ...
    {
      if ((UnityEngine.Object) this.FlipButton == (UnityEngine.Object) null)
        return;
