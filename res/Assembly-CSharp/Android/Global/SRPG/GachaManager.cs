...
namespace SRPG
{
  public class GachaManager : MonoSingleton<GachaManager>
  {
    ...
    private void OnShiftGacha(Button button)
    {
      if (!this.mInitalize)
        return;
      int num = !((UnityEngine.Object) button == (UnityEngine.Object) this.NextGachaButton) ? 1 : -1;
    ...
    private IEnumerator ShiftGachaAsync(int index)
    {
      ...
      return (IEnumerator) new GachaManager.\u003CShiftGachaAsync\u003Ec__Iterator92() { index = index, \u003C\u0024\u003Eindex = index, \u003C\u003Ef__this = this };
    }
