...
namespace SRPG
{
  public class LoginBonusCustomWindow : MonoBehaviour, IFlowInterface
  {
          ...
          if (!string.IsNullOrEmpty(key))
          {
            ...
            if (itemParam != null)
            {
              ...
              if (loginBonusData.Setup(0L, itemParam, num))
              {
                ...
                DataSource.Bind<ItemData>(item.gameObject, (ItemData) loginBonusData);
                ...
                if (index < this.mLoginBonusCount - 1)
                {
                  Transform child = item.transform.FindChild(this.CheckName);
    ...
    private IEnumerator WaitLoadAsync()
    {
      ...
      LoginBonusCustomWindow.\u003CWaitLoadAsync\u003Ec__Iterator108 asyncCIterator108 = new LoginBonusCustomWindow.\u003CWaitLoadAsync\u003Ec__Iterator108();
      return (IEnumerator) asyncCIterator108;
    }
    ...
    private void FlipTodaysItem()
    {
      ...
      DataSource.Bind<ItemData>(newItem.gameObject, dataOfClass);
