...
label_24:
    ...
    public GameObject Compose(Vector3 position, Quaternion rotation)
    {
      ...
      GameObject gameObject1 = UnityEngine.Object.Instantiate((UnityEngine.Object) this.Body, position, rotation * this.Body.transform.rotation) as GameObject;
      ...
      if ((UnityEngine.Object) childRecursively != (UnityEngine.Object) null)
      {
        if ((UnityEngine.Object) this.Head != (UnityEngine.Object) null)
        {
          ...
          (UnityEngine.Object.Instantiate((UnityEngine.Object) this.Head, transform2.localPosition, transform2.localRotation) as GameObject).transform.SetParent(childRecursively, false);
        }
        if ((UnityEngine.Object) this.Hair != (UnityEngine.Object) null)
        {
          Transform transform2 = this.Hair.transform;
          GameObject gameObject2 = UnityEngine.Object.Instantiate((UnityEngine.Object) this.Hair, transform2.localPosition, transform2.localRotation) as GameObject;
        ...
        if ((UnityEngine.Object) this.HeadAttachment != (UnityEngine.Object) null)
        {
          ...
          (UnityEngine.Object.Instantiate((UnityEngine.Object) this.HeadAttachment, transform2.localPosition, transform2.localRotation) as GameObject).transform.SetParent(childRecursively, false);
        }
      }
      return gameObject1;
    }
