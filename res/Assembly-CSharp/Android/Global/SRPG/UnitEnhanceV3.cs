...
namespace SRPG
{
  ...
  public class UnitEnhanceV3 : MonoBehaviour, IFlowInterface
  {
    ...
    public string PreviewBaseID = "UNITPREVIEWBASE";
    ...
    private IEnumerator Start()
    {
      ...
      return (IEnumerator) new UnitEnhanceV3.\u003CStart\u003Ec__Iterator12C() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003COnSceneChangeAsync\u003Ec__Iterator12D() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostEquip\u003Ec__Iterator12E() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostJobMaster\u003Ec__Iterator12F() { \u003C\u003Ef__this = this };
    }
    ...
    private bool TabChange(SRPG_Button button)
    {
      ...
      {
        bool flag = index == num;
        if ((UnityEngine.Object) this.mTabButtons[index] != (UnityEngine.Object) null)
          this.mTabButtons[index].IsOn = flag;
        if ((UnityEngine.Object) this.mTabPages[index] != (UnityEngine.Object) null)
        {
          Canvas component = this.mTabPages[index].GetComponent<Canvas>();
          if ((UnityEngine.Object) component != (UnityEngine.Object) null)
    ...
    private void InitKyokaPanel(UnitEnhancePanel panel)
    {
      ...
      for (int index = 0; index < player.Items.Count; ++index)
      {
        ...
        if (itemData != null && itemData.Param != null && (itemData.Param.type == EItemType.ExpUpUnit && this.ShowNoStockExpPotions) && itemData.Num > 0)
        {
          ...
          DataSource.Bind<ItemData>(listItemEvents.gameObject, data);
    ...
    private void OnUnitBulkLevelUp(Dictionary<string, int> data)
    {
      ...
      using (Dictionary<string, int>.Enumerator enumerator = data.GetEnumerator())
      {
        ...
        {
          KeyValuePair<string, int> p = enumerator.Current;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostUnitLevelUp\u003Ec__Iterator130() { prevLv = prevLv, \u003C\u0024\u003EprevLv = prevLv, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CWaitForKyokaRequestAsync\u003Ec__Iterator131() { unlockWindow = unlockWindow, \u003C\u0024\u003EunlockWindow = unlockWindow, \u003C\u003Ef__this = this };
    }
    ...
    private void Update()
    {
      ...
      if (this.mUpdatePreviewVisibility && this.mDesiredPreviewVisibility && ((UnityEngine.Object) this.mCurrentPreview != (UnityEngine.Object) null && !this.mCurrentPreview.IsLoading))
      {
    ...
    {
      return !this.IsStopPlayLeftVoice && (!((UnityEngine.Object) this.ViewerUI != (UnityEngine.Object) null) || !this.ViewerUI.activeSelf);
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostJobChange\u003Ec__Iterator132() { \u003C\u003Ef__this = this };
    }
    ...
    private void OnArtifactClick(GenericSlot slot, bool interactable)
    {
      ...
      {
        if ((UnityEngine.Object) this.Prefab_ArtifactWindow == (UnityEngine.Object) null)
          return;
        this.ExecQueuedKyokaRequest((UnitEnhanceV3.DeferredJob) null);
        bool flag = false;
        if ((UnityEngine.Object) this.mArtifactSelector == (UnityEngine.Object) null)
        {
          this.mArtifactSelector = UnityEngine.Object.Instantiate<GameObject>(this.Prefab_ArtifactWindow);
        }
        else
        {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostJobRankUp\u003Ec__Iterator133() { target_rank = target_rank, can_jobmaster = can_jobmaster, can_jobmax = can_jobmax, \u003C\u0024\u003Etarget_rank = target_rank, \u003C\u0024\u003Ecan_jobmaster = can_jobmaster, \u003C\u0024\u003Ecan_jobmax = can_jobmax, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CRefreshAsync\u003Ec__Iterator134() { immediate = immediate, \u003C\u0024\u003Eimmediate = immediate, \u003C\u003Ef__this = this };
    }
    ...
    private void SetPreviewVisible(bool visible)
    {
      ...
      if (!((UnityEngine.Object) this.mPreviewBase != (UnityEngine.Object) null) || this.mPreviewBase.activeSelf || !visible)
        return;
    ...
    {
      if (this.mCurrentUnit == null || (UnityEngine.Object) this.mPreviewParent == (UnityEngine.Object) null)
        return;
      GameUtility.DestroyGameObjects<UnitPreview>(this.mPreviewControllers);
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CLoadAllUnitImage\u003Ec__Iterator135() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CRefreshUnitImage\u003Ec__Iterator136() { \u003C\u003Ef__this = this };
    }
    ...
    private void RefreshJobIcons()
    {
      ...
      for (int jobNo = 0; jobNo < this.mCurrentUnit.Jobs.Length; ++jobNo)
      {
        ...
        if (job != null && job.Param != null)
        {
          ...
          mJobSlot.gameObject.SetActive(true);
          mJobSlot.interactable = this.mCurrentUnit.CheckJobUnlockable(jobNo);
          Toggle.ToggleEvent onValueChanged = mJobSlot.onValueChanged;
          mJobSlot.onValueChanged = toggleEvent;
          mJobSlot.isOn = jobNo == this.mCurrentUnit.JobIndex;
          mJobSlot.onValueChanged = onValueChanged;
          Animator component = mJobSlot.GetComponent<Animator>();
          ...
          DataSource.Bind<JobData>(mJobSlot.gameObject, this.mCurrentUnit.Jobs[jobNo]);
          GameParameter.UpdateAll(mJobSlot.gameObject);
          if (job.UniqueID == this.mCurrentJobUniqueID)
            index3 = jobNo;
        }
      }
      for (int index4 = index2; index4 < this.mCCIcons.Count; ++index4)
        this.mCCIcons[index4].gameObject.SetActive(false);
      for (int index4 = index1; index4 < this.mJobIcons.Count; ++index4)
        this.mJobIcons[index4].gameObject.SetActive(false);
      if ((UnityEngine.Object) this.ActiveJobIndicator != (UnityEngine.Object) null)
      {
        if (index3 >= 0)
        {
          RectTransform transform = this.ActiveJobIndicator.transform as RectTransform;
          transform.anchoredPosition = Vector2.zero;
          transform.SetParent(this.mJobSlots[index3].transform, false);
          this.ActiveJobIndicator.gameObject.SetActive(true);
        }
        else
          this.ActiveJobIndicator.gameObject.SetActive(false);
      }
    ...
    private void UpdateJobSlotStates(bool immediate)
    {
      ...
      {
        this.mJobSlots[index].isOn = this.mCurrentUnit.JobIndex == index;
        Animator component = this.mJobSlots[index].GetComponent<Animator>();
        int num = 0;
        do
        {
    ...
    {
      if ((UnityEngine.Object) this.mActivePanel != (UnityEngine.Object) this.mEquipmentPanel)
      {
        ...
        for (int index = 0; index < equipmentSlots.Length; ++index)
        {
          if (!((UnityEngine.Object) equipmentSlots[index] == (UnityEngine.Object) null) && (slot == -1 || index == slot))
          {
            ...
            else
            {
              ...
              DataSource.Bind<ItemParam>(equipmentSlots[index].gameObject, itemParam);
              DataSource.Bind<EquipData>(equipmentSlots[index].gameObject, rankupEquips[index]);
    ...
    private void ChangeJobSlot(int index)
    {
      ...
      if (!this.mCurrentUnit.CheckJobUnlockable(index))
      {
        ...
        Tooltip.SetTooltipPosition(this.mJobSlots[index].transform as RectTransform, new Vector2(0.5f, 0.5f));
        Tooltip tooltip = UnityEngine.Object.Instantiate<Tooltip>(this.Prefab_LockedJobTooltip);
        DataSource.Bind<JobSetParam>(tooltip.gameObject, jobSetParam);
        JobParam jobParam = MonoSingleton<GameManager>.Instance.GetJobParam(jobSetParam.job);
        DataSource.Bind<JobParam>(tooltip.gameObject, jobParam);
      ...
      else
      {
        ...
        if (this.mCurrentUnit.CurrentJob.Rank == 0)
        {
          if ((UnityEngine.Object) this.mActivePanel == (UnityEngine.Object) this.mAbilitySlotPanel)
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CWaitForKyokaRequestAndInvokeUserClose\u003Ec__Iterator137() { \u003C\u003Ef__this = this };
    }
    ...
    {
      if ((UnityEngine.Object) this.mActivePanel != (UnityEngine.Object) this.mAbilityListPanel)
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CAbilityRankUpSkillUnlockEffect\u003Ec__Iterator138() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostAbilityRankUp\u003Ec__Iterator139() { newSkills = newSkills, \u003C\u0024\u003EnewSkills = newSkills, \u003C\u003Ef__this = this };
    }
    ...
    public void OpenKakeraWindow()
    {
      ...
      this.GetComponent<WindowController>().SetCollision(false);
      this.mKakeraWindow.GetComponent<WindowController>().OnWindowStateChange = new WindowController.WindowStateChangeEvent(this.OnKakuseiCancel);
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003C_OpenProfileWindow\u003Ec__Iterator13A() { \u003C\u003Ef__this = this };
    }
    ...
    private void OnUnitKakusei()
    {
      ...
      {
        UnityEngine.Debug.LogError((object) "なんかエラーだす");
      }
      else
      {
        this.mKakeraWindow.GetComponent<WindowController>().Close();
        this.mKakeraWindow.GetComponent<WindowController>().OnWindowStateChange = new WindowController.WindowStateChangeEvent(this.OnKakuseiAccept);
    ...
    private void OnKakuseiAccept(GameObject go, bool visible)
    {
      if (visible)
        return;
      this.mKakeraWindow.GetComponent<WindowController>().OnWindowStateChange = (WindowController.WindowStateChangeEvent) null;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostUnitKakusei\u003Ec__Iterator13B() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CEvolutionButtonClickSync\u003Ec__Iterator13C() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CPostUnitEvolution\u003Ec__Iterator13D() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CShiftUnitAsync\u003Ec__Iterator13E() { unitUniqueID = unitUniqueID, \u003C\u0024\u003EunitUniqueID = unitUniqueID, \u003C\u003Ef__this = this };
    }
    ...
    {
      if ((UnityEngine.Object) this.Prefab_CharaQuestListWindow == (UnityEngine.Object) null)
        return;
      UnitCharacterQuestWindow characterQuestWindow = UnityEngine.Object.Instantiate<UnitCharacterQuestWindow>(this.Prefab_CharaQuestListWindow);
      if ((UnityEngine.Object) characterQuestWindow == (UnityEngine.Object) null)
        return;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003COnSkinSelectOpenAsync\u003Ec__Iterator13F() { isView = isView, \u003C\u0024\u003EisView = isView, \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitEnhanceV3.\u003CShowUnlockSkillEffect\u003Ec__Iterator140() { \u003C\u003Ef__this = this };
    }
    ...
    public void Activated(int pinID)
    {
      switch (pinID)
      {
        ...
        case 110:
          ...
          if (!((UnityEngine.Object) this.ViewerUI != (UnityEngine.Object) null))
            break;
          this.ExecQueuedKyokaRequest((UnitEnhanceV3.DeferredJob) null);
          this.StopUnitVoice();
