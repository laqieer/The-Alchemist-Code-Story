...
namespace SRPG
{
  ...
  public class FlowNode_ResumeTutorial : FlowNode
  {
      ...
      else
      {
        ...
        if (instance.FindQuest(nextTutorialStep) == null)
        {
          if (nextTutorialStep.Contains("_SG"))
          {
            ...
            UnityEngine.Debug.LogWarning((object) ("SG Tutorial: " + nextTutorialStep + ", going to scene: " + sceneName));
    ...
    private IEnumerator WaitCompleteTutorialAsync()
    {
      ...
      return (IEnumerator) new FlowNode_ResumeTutorial.\u003CWaitCompleteTutorialAsync\u003Ec__IteratorD9() { \u003C\u003Ef__this = this };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_ResumeTutorial.\u003CLoadSceneAsync\u003Ec__IteratorDA() { sceneName = sceneName, \u003C\u0024\u003EsceneName = sceneName, \u003C\u003Ef__this = this };
    }
  }
}
