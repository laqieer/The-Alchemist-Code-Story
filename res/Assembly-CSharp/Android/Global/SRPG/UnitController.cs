...
namespace SRPG
{
  public abstract class UnitController : AnimationPlayer
  {
    ...
    public float Height
    {
      get
      {
        ...
        if ((UnityEngine.Object) rig != (UnityEngine.Object) null)
          return rig.Height * this.transform.localScale.y;
        return 0.0f;
      }
    }
    ...
    public Vector3 CenterPosition
    {
      get
      {
        return this.transform.position + Vector3.up * (this.Height * 0.5f);
      }
    }
    ...
    protected void RemoveLoadThreadCount()
    {
      ...
      if (this.mNumLoadRequests >= 0)
        return;
      UnityEngine.Debug.LogError((object) "Invalid load request count");
    ...
    public bool SetActivateUnitObject(int idx)
    {
      if (idx < 0 || idx >= this.mUnitObjectLists.Count)
        return false;
      int index = 0;
      while (index < this.mUnitObjectLists.Count && !((UnityEngine.Object) this.mUnitObject == (UnityEngine.Object) this.mUnitObjectLists[index]))
        ++index;
    ...
    protected override void Start()
    {
      ...
      if (character == null)
      {
        UnityEngine.Debug.LogError((object) ("Unknown character '" + this.mCharacterID + "'"));
        this.SetLoadError();
      }
      else
      {
    ...
    {
      if ((UnityEngine.Object) Root == (UnityEngine.Object) null || Dest == null || 0 >= Root.childCount)
        return;
    ...
    {
      if ((UnityEngine.Object) this.mFaceAnimation == (UnityEngine.Object) null)
        return;
    ...
    {
      if ((UnityEngine.Object) this.mCharacterSettings == (UnityEngine.Object) null || (UnityEngine.Object) this.mCharacterSettings.Rig == (UnityEngine.Object) null)
        return this.transform;
      Transform childRecursively = GameUtility.findChildRecursively(this.transform, this.mCharacterSettings.Rig.RootBoneName);
    ...
    {
      if (!(bool) ((UnityEngine.Object) go) || !(bool) ((UnityEngine.Object) parent))
        return;
      go.transform.SetParent(parent, false);
      go.transform.localScale = Vector3.one * this.Rig.EquipmentScale;
    }
    ...
    public void SwitchAttachmentLists(UnitController.EquipmentType type, int no)
    {
      ...
      switch (type)
      {
        case UnitController.EquipmentType.PRIMARY:
          ...
          if (!((UnityEngine.Object) childRecursively1 != (UnityEngine.Object) null))
            break;
        ...
        case UnitController.EquipmentType.SECONDARY:
          ...
          if (!((UnityEngine.Object) childRecursively2 != (UnityEngine.Object) null))
            break;
    ...
    {
      if ((UnityEngine.Object) primaryHand != (UnityEngine.Object) null && !string.IsNullOrEmpty(this.Rig.RightHand))
      {
        Transform childRecursively = GameUtility.findChildRecursively(this.UnitObject.transform, this.Rig.RightHand);
        if ((UnityEngine.Object) childRecursively != (UnityEngine.Object) null)
        {
          this.mSubPrimaryEquipment = UnityEngine.Object.Instantiate((UnityEngine.Object) primaryHand, primaryHand.transform.position, primaryHand.transform.rotation) as GameObject;
          ...
          this.mSubPrimaryEquipment.transform.localScale = Vector3.one * this.Rig.EquipmentScale;
        }
        else
          UnityEngine.Debug.LogError((object) ("Node " + this.Rig.RightHand + " not found."));
      }
        ...
        if ((bool) ((UnityEngine.Object) childRecursively))
        {
          ...
          using (List<GameObject>.Enumerator enumerator = primary_lists.GetEnumerator())
          {
            while (enumerator.MoveNext())
            {
              ...
              if ((bool) ((UnityEngine.Object) current))
              {
                materialObject = UnityEngine.Object.Instantiate((UnityEngine.Object) current, current.transform.position, current.transform.rotation) as GameObject;
                if ((bool) ((UnityEngine.Object) materialObject))
                {
                  materialObject.transform.SetParent(childRecursively, false);
                  materialObject.transform.localScale = Vector3.one * this.Rig.EquipmentScale;
      ...
      if ((UnityEngine.Object) secondaryHand != (UnityEngine.Object) null && !string.IsNullOrEmpty(this.Rig.LeftHand))
      {
        Transform childRecursively = GameUtility.findChildRecursively(this.UnitObject.transform, this.Rig.LeftHand);
        if ((UnityEngine.Object) childRecursively != (UnityEngine.Object) null)
        {
          this.mSubSecondaryEquipment = UnityEngine.Object.Instantiate((UnityEngine.Object) secondaryHand, secondaryHand.transform.position, secondaryHand.transform.rotation) as GameObject;
          ...
          this.mSubSecondaryEquipment.transform.localScale = Vector3.one * this.Rig.EquipmentScale;
        }
        else
          UnityEngine.Debug.LogError((object) ("Node " + this.Rig.LeftHand + " not found."));
      }
    ...
    {
      if ((UnityEngine.Object) materialObject == (UnityEngine.Object) null)
        return;
