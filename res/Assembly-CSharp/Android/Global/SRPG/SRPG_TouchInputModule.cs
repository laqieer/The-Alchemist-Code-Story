...
namespace SRPG
{
  ...
  public class SRPG_TouchInputModule : PointerInputModule
  {
    ...
    public override void Process()
    {
      ...
      if (this.IsHandling || !Input.GetKeyDown(KeyCode.Escape) || !((UnityEngine.Object) SGHighlightObject.Instance() == (UnityEngine.Object) null))
        return;
      BackHandler.Invoke();
    ...
    private PointerEventData GetMousePointerEvent(int index)
    {
      ...
      this.eventSystem.RaycastAll(data, (List<RaycastResult>) this.m_RaycastResultCache);
