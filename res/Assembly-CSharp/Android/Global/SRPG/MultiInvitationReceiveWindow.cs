  ...
  public class MultiInvitationReceiveWindow : FlowWindowBase
  {
    ...
    public override void Initialize(FlowWindowBase.SerializeParamBase param)
    {
      ...
      if ((UnityEngine.Object) this.m_ValueList != (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) this.m_ActiveToggle != (UnityEngine.Object) null)
          this.m_ActiveToggle.interactable = false;
        this.m_LogToggle = this.m_ValueList.list.GetUIToggle("tgl_send");
        if ((UnityEngine.Object) this.m_LogToggle != (UnityEngine.Object) null)
          this.m_LogToggle.interactable = false;
      }
      if ((UnityEngine.Object) this.m_Param.activeList != (UnityEngine.Object) null)
      {
        this.m_ActiveController = this.m_Param.activeList.GetComponentInChildren<ContentController>();
        if ((UnityEngine.Object) this.m_ActiveController != (UnityEngine.Object) null)
          this.m_ActiveController.SetWork((object) this);
      }
      if ((UnityEngine.Object) this.m_Param.logList != (UnityEngine.Object) null)
      {
        this.m_LogController = this.m_Param.logList.GetComponentInChildren<ContentController>();
        if ((UnityEngine.Object) this.m_LogController != (UnityEngine.Object) null)
    ...
    public override int Update()
    {
      ...
      if ((UnityEngine.Object) this.m_ActiveToggle != (UnityEngine.Object) null)
        this.m_ActiveToggle.interactable = active == 0;
      if ((UnityEngine.Object) this.m_LogToggle != (UnityEngine.Object) null)
        this.m_LogToggle.interactable = active == 0;
      return -1;
    }
      ...
      if (this.m_Tab != tab)
      {
        ...
        switch (tab)
        {
          case MultiInvitationReceiveWindow.Tab.NONE:
            if ((UnityEngine.Object) this.m_Param.tabActive != (UnityEngine.Object) null)
              this.m_Param.tabActive.SetActive(false);
            if ((UnityEngine.Object) this.m_Param.tabLog != (UnityEngine.Object) null)
            {
    ...
    public void InitializeActiveList()
    {
      ...
      if (!flag)
        GlobalEvent.Invoke("NO_INVITES", (object) this);
      else
        GlobalEvent.Invoke("GOT_INVITES", (object) this);
    ...
    public void InitializeLogList()
    {
      ...
      if (!flag)
        GlobalEvent.Invoke("NO_INVITE_HISTORY", (object) this);
      else
        GlobalEvent.Invoke("INVITE_HISTORY", (object) this);
    ...
    public static class LogContent
    {
      ...
      public class ItemAccessor
      {
        ...
        public void Bind(ContentNode node)
        {
          ...
          TimeSpan timeSpan = TimeManager.ServerTime - GameUtility.UnixtimeToLocalTime(this.m_Param.created_at);
