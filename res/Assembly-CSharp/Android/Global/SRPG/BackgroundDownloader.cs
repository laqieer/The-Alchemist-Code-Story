...
namespace SRPG
{
  public class BackgroundDownloader : MonoBehaviour
  {
    ...
    private BackgroundDownloader()
    {
      ...
      if (num == -1)
        this.isEnabled = SystemInfo.systemMemorySize > 1024;
      else
    ...
    public static BackgroundDownloader Instance
    {
      get
      {
        if ((UnityEngine.Object) BackgroundDownloader.instance == (UnityEngine.Object) null)
        {
          GameObject gameObject = new GameObject(typeof (BackgroundDownloader).Name, new System.Type[1]{ typeof (BackgroundDownloader) });
          BackgroundDownloader.instance = gameObject.GetComponent<BackgroundDownloader>();
    ...
    private IEnumerator BackgroundDLAsync()
    {
      ...
      return (IEnumerator) new BackgroundDownloader.\u003CBackgroundDLAsync\u003Ec__Iterator2B() { \u003C\u003Ef__this = this };
    }
  }
}
