...
public class SerializeValueList
{
  ...
  public List<string> GetKeys()
  {
    ...
    {
      if (stringList.FindIndex((Predicate<string>) (prop => prop == this.m_Fields[i].key)) == -1)
        stringList.Add(this.m_Fields[i].key);
    }
    return stringList;
  }
  ...
  public List<int> GetGroups()
  {
    ...
    for (int i = 0; i < this.m_Fields.Count; ++i)
    {
      if (intList.FindIndex((Predicate<int>) (prop => prop == this.m_Fields[i].group)) == -1)
        intList.Add(this.m_Fields[i].group);
    }
    return intList;
  }
  ...
  public void SetActive(int group, bool sw)
  {
    for (int index = 0; index < this.m_Fields.Count; ++index)
    {
      if (this.m_Fields[index].group == group)
      {
        ...
        if ((UnityEngine.Object) vGameObject != (UnityEngine.Object) null && vGameObject.activeSelf != sw)
  ...
  public Selectable SetInteractable(string key, bool value)
  {
    ...
    if ((UnityEngine.Object) vUiSelectable != (UnityEngine.Object) null && vUiSelectable.interactable != value)
  ...
  {
    return this.GetVector2(key, Vector2.zero);
  }
  ...
  {
    return this.GetVector3(key, Vector3.zero);
  }
  ...
  {
    return this.GetVector4(key, Vector4.zero);
  }
