...
public class AssetDownloader : MonoBehaviour
{
  ...
  public static string GachaBannerURL = string.Empty;
  ...
  public readonly string FileRevisionName = "REVISION.dat";
  ...
  public readonly string FileBaseAssetName = "BASEHASH";
...
label_17:
  ...
  public static AssetDownloader.DownloadState StartDownload(bool checkUpdates, bool canRetry = true, System.Threading.ThreadPriority threadPriority = System.Threading.ThreadPriority.Normal)
  {
  ...
  public static AssetDownloader.DownloadState StartTextDownload(bool checkUpdates, bool canRetry = true, System.Threading.ThreadPriority threadPriority = System.Threading.ThreadPriority.Normal)
  {
  ...
  private IEnumerator ConfirmRetryUnmanaged()
  {
    ...
    return (IEnumerator) new AssetDownloader.\u003CConfirmRetryUnmanaged\u003Ec__Iterator7C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CDonwoloadUnmanagedAsset\u003Ec__Iterator7D()
    {
  ...
  [DebuggerHidden]
  private IEnumerator ParallelDonwloading(AssetList assetList, System.Threading.ThreadPriority threadPriority, string prefix, string cacheDir, Dictionary<string, int> itemCompressedSize, List<string> requestID)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CParallelDonwloading\u003Ec__Iterator7E()
    {
      prefix = prefix,
      requestID = requestID,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CDownloadWWW\u003Ec__Iterator7F()
    {
      prefix = prefix,
      name = name,
      isError = isError,
  ...
  [DebuggerHidden]
  private IEnumerator InternalDownloadAssets(AssetDownloader.DownloadState state, bool checkUpdates, bool isRetry, System.Threading.ThreadPriority threadPriority)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CInternalDownloadAssets\u003Ec__Iterator80()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CConfirmRetry\u003Ec__Iterator81()
    {
      param = param,
      \u003C\u0024\u003Eparam = param
    };
  ...
  public static string TextCachePath
  {
    get
    {
      if (AssetDownloader.mTextCachePath == null)
        AssetDownloader.mTextCachePath = Application.persistentDataPath + "/new_" + AssetManager.AssetFormats.Text.ToPath();
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new AssetDownloader.\u003CDestroyAsset\u003Ec__Iterator82()
    {
      flags = flags,
      \u003C\u0024\u003Eflags = flags,
      \u003C\u003Ef__this = this
