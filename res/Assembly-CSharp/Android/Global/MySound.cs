...
public class MySound : MonoSingleton<MySound>
{
  ...
  private void Setup()
  {
    ...
    if (!((UnityEngine.Object) this.mCriAtomGO != (UnityEngine.Object) null))
      return;
    UnityEngine.Object.DontDestroyOnLoad((UnityEngine.Object) this.mCriAtomGO);
  ...
  {
    if ((UnityEngine.Object) MonoSingleton<MySound>.GetInstanceDirect() == (UnityEngine.Object) null || MonoSingleton<MySound>.Instance.mClearCacheState != MySound.EClearCacheState.END)
      return;
    ...
    else if (this.mClearCacheState == MySound.EClearCacheState.STOPPING)
    {
      ...
      if (MySound.CueSheet.GetLoadedNum() <= 0)
      {
        ...
        if ((UnityEngine.Object) this.mCriAtomGO != (UnityEngine.Object) null)
        {
          ...
          UnityEngine.Object.Destroy((UnityEngine.Object) this.mCriAtomGO);
  ...
  private class CueSheet
  {
    ...
    private IEnumerator LoadCueSheetCore(string sheetName, bool useAcb, bool useAwb, bool isUnManaged)
    {
      ...
      return (IEnumerator) new MySound.CueSheet.\u003CLoadCueSheetCore\u003Ec__IteratorE2()
      {
        useAcb = useAcb,
        sheetName = sheetName,
        useAwb = useAwb,
  ...
  private class Source
  {
    ...
    public float Pitch
    {
      get
      {
        if ((UnityEngine.Object) this.mCore == (UnityEngine.Object) null)
          return 0.0f;
    ...
    public void Cleanup()
    {
      if (!((UnityEngine.Object) this.mCore != (UnityEngine.Object) null))
        return;
      this.mCore.Stop();
      UnityEngine.Object.Destroy((UnityEngine.Object) this.mCore.gameObject);
    ...
    public void Update()
    {
      ...
      else
      {
        ...
        else
        {
          ...
          this.mCore.Stop();
          DebugUtility.Log("[MySound] FadeOutStop." + (object) this.mCore.volume);
        }
      }
    }
    ...
    public void Play(string cueName, bool is_stopplay = false)
    {
      ...
      else if ((UnityEngine.Object) this.mCore == (UnityEngine.Object) null || string.IsNullOrEmpty(cueName))
      {
