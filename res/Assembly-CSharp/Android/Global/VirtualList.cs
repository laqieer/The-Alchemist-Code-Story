...
public class VirtualList : UIBehaviour
{
  ...
  public RectTransform FindItem(int itemID)
  {
    ...
    if ((UnityEngine.Object) itemContainer != (UnityEngine.Object) null)
  ...
  protected override void OnDestroy()
  {
    ...
    {
      if ((UnityEngine.Object) this.mItemObjects[index].Body != (UnityEngine.Object) null && (UnityEngine.Object) this.mItemObjects[index].Body.parent == (UnityEngine.Object) this.mItemObjects[index].Body)
      {
  ...
  private void FillContainer(VirtualList.ItemContainer container, int itemID)
  {
    ...
    if (this.OnGetItemObject != null)
      rectTransform = this.OnGetItemObject(itemID, !((UnityEngine.Object) container.Body != (UnityEngine.Object) null) ? -1 : container.ItemID, container.Body);
    if ((UnityEngine.Object) rectTransform == (UnityEngine.Object) null)
      return;
    if ((UnityEngine.Object) container.Body != (UnityEngine.Object) null && (UnityEngine.Object) container.Body != (UnityEngine.Object) rectTransform && (UnityEngine.Object) container.Body.parent == (UnityEngine.Object) container.RectTr)
  ...
  private void ReparentItems()
  {
    for (int index = 0; index < this.mItemObjects.Count; ++index)
    {
      if ((UnityEngine.Object) this.mItemObjects[index].Body != (UnityEngine.Object) null && (UnityEngine.Object) this.mItemObjects[index].Body.parent != (UnityEngine.Object) this.mItemObjects[index].RectTr)
