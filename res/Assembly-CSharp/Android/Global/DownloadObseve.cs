...
public class DownloadObseve
{
  ...
  private IEnumerator Download()
  {
    ...
    return (IEnumerator) new DownloadObseve.\u003CDownload\u003Ec__Iterator86()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    UnityEngine.Debug.Log((object) ("download retry[" + (object) this.RetryCount + "]..."));
    ++this.RetryCount;
    this.Retry();
    if (this._downloadEnumerator != null)
      this._coroutineExecuter.StopCoroutine(this._downloadEnumerator);
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DownloadObseve.\u003CAbort\u003Ec__Iterator87()
    {
      \u003C\u003Ef__this = this
    };
  }
