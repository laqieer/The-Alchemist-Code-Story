  ...
  public class DMMGamesStore : IPurchaseFlowImpl
  {
    ...
    private class InnerFlow
    {
      ...
      private IEnumerator _Purchase(string productId)
      {
        ...
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_Purchase\u003Ec__IteratorB()
        {
          productId = productId,
          \u003C\u0024\u003EproductId = productId,
          \u003C\u003Ef__this = this
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_GetPaymentId\u003Ec__IteratorC()
        {
          productId = productId,
          \u003C\u0024\u003EproductId = productId,
          \u003C\u003Ef__this = this
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_WaitPurchase\u003Ec__IteratorD()
        {
          \u003C\u003Ef__this = this
        };
      }
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Gsc.Purchase.Platform.DMMGamesStore.InnerFlow.\u003C_Resume\u003Ec__IteratorE()
        {
          handler = handler,
          \u003C\u0024\u003Ehandler = handler
        };
