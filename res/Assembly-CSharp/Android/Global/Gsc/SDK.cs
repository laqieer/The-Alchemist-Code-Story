  ...
  public static class SDK
  {
    ...
    private static class Initializer<T> where T : struct, Configuration.IEnvironment
    {
      ...
      public static IEnumerator Initialize(Configuration.Builder<T> confBuilder, string specifiedEnv)
      {
        ...
        return (IEnumerator) new SDK.Initializer<T>.\u003CInitialize\u003Ec__Iterator1C()
        {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SDK.Initializer<T>.\u003CBuildConfigration\u003Ec__Iterator1D()
        {
          specifiedEnv = specifiedEnv,
          confBuilder = confBuilder,
          \u003C\u0024\u003EspecifiedEnv = specifiedEnv,
    ...
    public class BootLoader : MonoBehaviour
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new SDK.BootLoader.\u003CStart\u003Ec__Iterator1E()
        {
          \u003C\u003Ef__this = this
        };
      }
