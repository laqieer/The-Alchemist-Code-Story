    ...
    public static void Update(Gsc.DOM.IObject root)
    {
      ...
      if (root.TryGetValue("update_models", out obj1))
      {
        foreach (IMember member in (IEnumerable<IMember>) obj1.GetObject())
        {
          ...
          if ((object) type != null)
          {
            AssemblySupport.MethodInfo constructor1 = AssemblySupport.GetConstructor(type, new Type[1]
            {
              typeof (Gsc.DOM.IObject)
            });
            IValue obj2;
            ...
            {
              AssemblySupport.MethodInfo constructor2 = AssemblySupport.GetConstructor(type, new Type[1]
              {
