...
namespace Gsc.Auth.GAuth.GAuth
{
  public class Session : ISession
  {
    ...
    public virtual bool CanRefreshToken(System.Type requestType)
    {
...
label_14:
    ...
    public class AccessTokenChecker : MonoBehaviour
    {
      ...
      private IEnumerator CheckToken()
      {
        ...
        return (IEnumerator) new Session.AccessTokenChecker.\u003CCheckToken\u003Ec__Iterator6()
        {
          \u003C\u003Ef__this = this
        };
      }
    ...
    public class RefreshTokenTask : IRefreshTokenTask, ITask
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Session.RefreshTokenTask.\u003CRun\u003Ec__Iterator7()
        {
          \u003C\u003Ef__this = this
        };
      }
