...
public class StaticBatchGroup : MonoBehaviour
{
  ...
  private static Mesh[] GenerateBatch()
  {
    ...
    for (int index1 = 0; index1 < StaticBatchGroup.mInstances.Count; ++index1)
    {
      ...
      if (!((UnityEngine.Object) mMeshRenderer == (UnityEngine.Object) null) && mMeshRenderer.sharedMaterials.Length > 0)
      {
        MeshFilter mMeshFilter = StaticBatchGroup.mInstances[index1].mMeshFilter;
        if (!((UnityEngine.Object) mMeshFilter == (UnityEngine.Object) null) && !((UnityEngine.Object) mMeshFilter.sharedMesh == (UnityEngine.Object) null))
        {
    ...
    for (int index = 0; index < StaticBatchGroup.mInstances.Count; ++index)
      UnityEngine.Object.Destroy((UnityEngine.Object) StaticBatchGroup.mInstances[index]);
    ...
    for (int index1 = 0; index1 < sectionList.Count; ++index1)
    {
      if (!sectionList[index1].Merged)
      {
        ...
        {
          if (!((UnityEngine.Object) sharedMaterials[index2] == (UnityEngine.Object) null))
          {
            ...
            {
              if (!((UnityEngine.Object) sharedMaterials[index2] != (UnityEngine.Object) sectionList[index3].Material) && !sectionList[index3].Merged)
              {
  ...
  private void Start()
  {
    if ((UnityEngine.Object) this != (UnityEngine.Object) StaticBatchGroup.mInstances[StaticBatchGroup.mInstances.Count - 1])
      return;
