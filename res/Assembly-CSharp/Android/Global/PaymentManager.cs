...
public class PaymentManager : MonoSingleton<PaymentManager>
{
  ...
  public static string BundleApiPath
  {
    get
    {
      return SRPG.Network.Host + "bundle";
    }
  }
  ...
  {
    UnityEngine.Debug.Log((object) "PaymentManager.Initialize");
    UnityEngine.Object.DontDestroyOnLoad((UnityEngine.Object) this);
  }

  protected override void Release()
  {
    UnityEngine.Debug.Log((object) "PaymentManager.Release");
  }
  ...
  public bool Init(bool isResetMaster = false, ProductParamResponse res = null)
  {
    ...
    UnityEngine.Debug.Log((object) ("PaymentManager.Init len" + (object) this.ProductMasters.Count));
  ...
  {
    UnityEngine.Debug.Log((object) nameof (RequestPurchase));
  ...
  {
    UnityEngine.Debug.Log((object) nameof (RegisterBirthday));
  ...
  {
    UnityEngine.Debug.Log((object) "OnAgeResponsePurchase");
  ...
  {
    UnityEngine.Debug.Log((object) "OnUpdateProductDetailsPurchase");
    UnityEngine.Debug.Log((object) ("OnUpdateProductDetailsPurchase " + ((object[]) products).ToStringFull()));
    if (products == null)
      return;
    ...
    {
      UnityEngine.Debug.Log((object) (product.ID + " : " + product.ToString()));
  ...
  {
    UnityEngine.Debug.Log((object) nameof (OnPurchaseSucceeded));
    ProductInfo productInfo1;
    if (this.ProductOnStores.TryGetValue(order.ProductId, out productInfo1))
    {
      UnityEngine.Debug.Log((object) ("OnPurchaseSucceededProduct: " + order.ProductId));
      string id = productInfo1.ID;
      string currencyCode = productInfo1.CurrencyCode;
      double price = (double) productInfo1.Price;
    ...
    if (this.BundleOnStores.TryGetValue(order.ProductId, out productInfo2))
    {
      UnityEngine.Debug.Log((object) ("OnPurchaseSucceededBundle: " + order.ProductId));
      AnalyticsManager.TrackPurchase(productInfo2.ID, productInfo2.CurrencyCode, (double) productInfo2.Price);
    }
  ...
  {
    UnityEngine.Debug.Log((object) nameof (OnPurchaseFailed));
    this.purchaseResult = PaymentManager.ERequestPurchaseResult.ERROR;
  }

  public void OnInsufficientBalances()
  {
    UnityEngine.Debug.Log((object) nameof (OnInsufficientBalances));
  ...
  {
    UnityEngine.Debug.Log((object) nameof (OnNeedBirthday));
    if (this.OnRequestProcessing != null)
    {
  ...
  public class Product
  {
    ...
    public bool Reflesh(string productId_ = null)
    {
      ...
      UnityEngine.Debug.Log((object) ("Product.Reflesh " + this.ToString()));
      if (flag)
        return null != this.master;
      return false;
    }
  ...
  private class MyDebug
  {
    ...
    public static IEnumerable<string> EachMessage()
    {
      ...
      PaymentManager.MyDebug.\u003CEachMessage\u003Ec__Iterator4E messageCIterator4E1 = new PaymentManager.MyDebug.\u003CEachMessage\u003Ec__Iterator4E();
      // ISSUE: variable of a compiler-generated type
      PaymentManager.MyDebug.\u003CEachMessage\u003Ec__Iterator4E messageCIterator4E2 = messageCIterator4E1;
      // ISSUE: reference to a compiler-generated field
      messageCIterator4E2.\u0024PC = -2;
      return (IEnumerable<string>) messageCIterator4E2;
    }
  }
