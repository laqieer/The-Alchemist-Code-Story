...
public class SerializeValue
{
  ...
  public SerializeValue(SerializeValue.Type type, string key)
  {
    ...
    switch (type)
    {
      ...
      case SerializeValue.Type.Vector2:
        this.SetVector2(Vector2.zero);
        break;
      case SerializeValue.Type.Vector3:
        this.SetVector3(Vector3.zero);
        break;
      case SerializeValue.Type.Vector4:
        this.SetVector4(Vector4.zero);
        break;
    }
  }
  ...
  public SerializeValue(string key, Text obj)
  {
    ...
    this.m_Key = key;
    this.m_Obj = ((Component) obj).gameObject;
    this.m_ScriptableObj = (ScriptableObject) null;
    this.m_Serialize = (string) null;
    this.m_Work = (object) null;
  }
  ...
  public int group => this.m_Group;

  public SerializeValue.Type type => this.m_Type;
  ...
  public override string ToString()
  {
    switch (this.type)
    {
      ...
      case SerializeValue.Type.GameObject:
        return string.Format("key:{0} type:{1} value:{2}", (object) this.key, (object) this.type.ToString(), !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.v_GameObject, (UnityEngine.Object) null) ? (object) "null" : (object) ((UnityEngine.Object) this.v_GameObject).name);
      case SerializeValue.Type.UILabel:
        return string.Format("key:{0} type:{1} value:{2}", (object) this.key, (object) this.type.ToString(), !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.v_UILabel, (UnityEngine.Object) null) ? (object) "null" : (object) ((UnityEngine.Object) this.v_UILabel).name);
      case SerializeValue.Type.UIButton:
        return string.Format("key:{0} type:{1} value:{2}", (object) this.key, (object) this.type.ToString(), !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.v_UIButton, (UnityEngine.Object) null) ? (object) "null" : (object) ((UnityEngine.Object) this.v_UIButton).name);
      case SerializeValue.Type.UIToggle:
        return string.Format("key:{0} type:{1} value:{2}", (object) this.key, (object) this.type.ToString(), !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.v_UIToggle, (UnityEngine.Object) null) ? (object) "null" : (object) ((UnityEngine.Object) this.v_UIToggle).name);
      case SerializeValue.Type.ScriptableObject:
        return string.Format("key:{0} type:{1} value:{2}", (object) this.key, (object) this.type.ToString(), !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.v_ScriptableObject, (UnityEngine.Object) null) ? (object) "null" : (object) ((UnityEngine.Object) this.v_ScriptableObject).name);
      ...
      case SerializeValue.Type.UIImage:
        return string.Format("key:{0} type:{1} value:{2}", (object) this.key, (object) this.type.ToString(), !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.v_UIImage, (UnityEngine.Object) null) ? (object) "null" : (object) ((UnityEngine.Object) this.v_UIImage).name);
  ...
  {
    if (propType == SerializeValue.PropertyType.Int)
      return this.v_int > src.v_int;
    return propType == SerializeValue.PropertyType.Float && (double) this.v_float > (double) src.v_float;
  }
  ...
  {
    if (Application.isPlaying && this.m_Work != null)
    ...
    get
    {
      ...
      switch (type1)
      {
        ...
        case SerializeValue.Type.UILabel:
          ...
          {
            int result2 = 0;
            if (int.TryParse(vUiLabel.text, out result2))
              return result2;
            break;
          }
          break;
        default:
          if (type1 == SerializeValue.Type.Global)
          {
            ...
            if (vGlobal != null)
            {
              ...
              {
                int result3 = 0;
                if (int.TryParse(this.GetString(), out result3))
                  return result3;
                break;
              }
              break;
    ...
    get
    {
      ...
      switch (type1)
      {
        ...
        case SerializeValue.Type.UILabel:
          ...
          {
            float result2 = 0.0f;
            if (float.TryParse(vUiLabel.text, out result2))
              return result2;
            break;
          }
          break;
        default:
          if (type1 == SerializeValue.Type.Global)
          {
            ...
            if (vGlobal != null)
            {
              ...
              {
                float result3 = 0.0f;
                if (float.TryParse(this.GetString(), out result3))
                  return result3;
                break;
              }
              break;
  ...
  private string GetString()
  {
    ...
    return this.m_Serialize == null ? string.Empty : this.m_Serialize;
  }
  ...
  {
    return Application.isPlaying && this.m_Work != null ? (Vector2) this.m_Work : SerializeValue.Vector2_Parse(this.m_Serialize);
  }
  ...
  {
    return Application.isPlaying && this.m_Work != null ? (Vector3) this.m_Work : SerializeValue.Vector3_Parse(this.m_Serialize);
  }
  ...
  {
    return Application.isPlaying && this.m_Work != null ? (Vector4) this.m_Work : SerializeValue.Vector4_Parse(this.m_Serialize);
  }
  ...
  public Text v_UILabel
  {
    set
    {
      switch (this.m_Type)
      {
        case SerializeValue.Type.GameObject:
        case SerializeValue.Type.UILabel:
          this.m_Obj = !UnityEngine.Object.op_Inequality((UnityEngine.Object) value, (UnityEngine.Object) null) ? (GameObject) null : ((Component) value).gameObject;
          break;
        case SerializeValue.Type.Global:
          this.v_Global = (object) value;
          break;
    ...
    get
    {
      switch (this.m_Type)
      {
        case SerializeValue.Type.GameObject:
        case SerializeValue.Type.UILabel:
          return UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Obj, (UnityEngine.Object) null) ? this.m_Obj.GetComponent<Text>() : (Text) null;
        case SerializeValue.Type.Global:
          object vGlobal = this.v_Global;
  ...
  public Image v_UIImage
  {
    ...
    get
    {
      switch (this.m_Type)
      {
        case SerializeValue.Type.GameObject:
        case SerializeValue.Type.UIImage:
          return UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Obj, (UnityEngine.Object) null) ? this.m_Obj.GetComponent<Image>() : (Image) null;
        case SerializeValue.Type.Global:
          object vGlobal = this.v_Global;
  ...
  public Button v_UIButton
  {
    ...
    get
    {
      switch (this.m_Type)
      {
        case SerializeValue.Type.GameObject:
        case SerializeValue.Type.UIButton:
          return UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Obj, (UnityEngine.Object) null) ? this.m_Obj.GetComponent<Button>() : (Button) null;
        case SerializeValue.Type.Global:
          object vGlobal = this.v_Global;
  ...
  public Toggle v_UIToggle
  {
    ...
    get
    {
      switch (this.m_Type)
      {
        case SerializeValue.Type.GameObject:
        case SerializeValue.Type.UIToggle:
          return UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Obj, (UnityEngine.Object) null) ? this.m_Obj.GetComponent<Toggle>() : (Toggle) null;
        case SerializeValue.Type.Global:
          object vGlobal = this.v_Global;
  ...
  private void SetGlobal(string value) => this.m_Serialize = value;

  private string GetGlobal() => this.m_Serialize == null ? string.Empty : this.m_Serialize;
  ...
  public Component v_Component => (Component) this.v_MonoBehaviour;
  ...
  public bool v_Active
  {
    ...
    {
      GameObject vGameObject = this.v_GameObject;
      return UnityEngine.Object.op_Inequality((UnityEngine.Object) vGameObject, (UnityEngine.Object) null) ? vGameObject.activeSelf : this.v_bool;
    }
  }
  ...
  public bool v_Enable
  {
    set
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) vMonoBehaviour, (UnityEngine.Object) null))
        return;
      ((Behaviour) vMonoBehaviour).enabled = value;
    }
    get
    {
      MonoBehaviour vMonoBehaviour = this.v_MonoBehaviour;
      return UnityEngine.Object.op_Inequality((UnityEngine.Object) vMonoBehaviour, (UnityEngine.Object) null) ? ((Behaviour) vMonoBehaviour).enabled : this.v_bool;
    }
  }
  ...
  public Selectable v_UISelectable
  {
    ...
    get
    {
      switch (this.m_Type)
      {
        ...
        case SerializeValue.Type.UIToggle:
        case SerializeValue.Type.UIImage:
          return UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Obj, (UnityEngine.Object) null) ? this.m_Obj.GetComponent<Selectable>() : (Selectable) null;
        case SerializeValue.Type.Global:
          object vGlobal = this.v_Global;
  ...
  public string v_UIText
  {
    ...
    {
      Text vUiLabel = this.v_UILabel;
      return UnityEngine.Object.op_Inequality((UnityEngine.Object) vUiLabel, (UnityEngine.Object) null) ? vUiLabel.text : this.v_string;
    }
  }
  ...
  public bool v_UIInteractable
  {
    ...
    {
      Selectable vUiSelectable = this.v_UISelectable;
      return UnityEngine.Object.op_Inequality((UnityEngine.Object) vUiSelectable, (UnityEngine.Object) null) ? vUiSelectable.IsInteractable() : this.v_bool;
    }
  }
  ...
  public bool v_UIOn
  {
    set
    {
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) vUiToggle, (UnityEngine.Object) null))
        return;
      vUiToggle.isOn = value;
    }
    get
    {
      Toggle vUiToggle = this.v_UIToggle;
      return UnityEngine.Object.op_Inequality((UnityEngine.Object) vUiToggle, (UnityEngine.Object) null) ? vUiToggle.isOn : this.v_bool;
    }
  }
