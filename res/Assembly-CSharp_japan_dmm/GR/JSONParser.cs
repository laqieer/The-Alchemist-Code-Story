...
namespace GR
{
  public class JSONParser
  {
    ...
    public static T parseJSONObject<T>(string src) where T : new()
    {
      ...
      ctx.ab = new ArrayList(100);
      T jsonObject = new T();
      JSONParser.parseObject(ctx, (object) jsonObject);
      JSONParser.skipSpaces(ctx);
      if (ctx.pos < ctx.src.Length)
        throw new JSONParser.InvalidCharacterException(ctx);
      return jsonObject;
      ...
      JSONParser.ParseElement<T> parser)
    {
      ...
      if (ctx.src[ctx.pos] != ']')
        throw new JSONParser.UnexpectedCharacterException(ctx);
      ++ctx.pos;
      T[] valueArray = new T[ctx.ab.Count - count];
      for (int index = 0; index < valueArray.Length; ++index)
        valueArray[index] = (T) ctx.ab[index + count];
      ...
      Type type)
    {
      ...
      if (ctx.src[ctx.pos] != ']')
        throw new JSONParser.UnexpectedCharacterException(ctx);
      ++ctx.pos;
      Array objectArray = (Array) null;
      if ((object) type != null)
      {
        objectArray = Array.CreateInstance(type, ctx.ab.Count - count);
        for (int index = 0; index < objectArray.Length; ++index)
          objectArray.SetValue(ctx.ab[index + count], index);
      }
      ctx.ab.RemoveRange(count, ctx.ab.Count - count);
    ...
    private static object parseArray(JSONParser.Context ctx, Type elementType)
    {
      ...
      if ((object) elementType == (object) typeof (long))
      {
        ...
        return JSONParser.parseValueArray<long>(ctx2, fMgCache1);
      }
      if ((object) elementType == (object) typeof (float))
      {
        JSONParser.Context ctx3 = ctx;
        // ISSUE: reference to a compiler-generated field
        ...
        return JSONParser.parseValueArray<float>(ctx3, fMgCache2);
      }
      if ((object) elementType == (object) typeof (double))
      {
        JSONParser.Context ctx4 = ctx;
        // ISSUE: reference to a compiler-generated field
        ...
        return JSONParser.parseValueArray<double>(ctx4, fMgCache3);
      }
      if ((object) elementType == (object) typeof (short))
      {
        JSONParser.Context ctx5 = ctx;
        // ISSUE: reference to a compiler-generated field
        ...
        return JSONParser.parseValueArray<short>(ctx5, fMgCache4);
      }
      if ((object) elementType == (object) typeof (byte))
      {
        JSONParser.Context ctx6 = ctx;
        // ISSUE: reference to a compiler-generated field
        ...
        return JSONParser.parseValueArray<byte>(ctx6, fMgCache5);
      }
      if ((object) elementType == (object) typeof (string))
      {
        JSONParser.Context ctx7 = ctx;
        // ISSUE: reference to a compiler-generated field
      ...
      if ((object) elementType == null)
      {
        ...
        return JSONParser.parseObjectArray(ctx8, fMgCache7, (Type) null);
      }
      JSONParser.Context ctx9 = ctx;
      // ISSUE: reference to a compiler-generated field
      ...
      return JSONParser.parseObjectArray(ctx9, fMgCache8, type1);
    }
          ...
          if (ctx.src[ctx.pos] == '"')
          {
            ...
            if (ctx.sb.Length > 0)
            {
              ...
              if (ctx.src[ctx.pos] == ':')
              {
                ++ctx.pos;
                JSONParser.forward(ctx);
                FieldInfo field = (object) type == null ? (FieldInfo) null : type.GetField(ctx.sb.ToString());
                ...
                else
                {
                  ...
                  if (fieldType.IsValueType || (object) fieldType == (object) typeof (string))
                  {
                    ...
                    {
                      JSONParser.parseNumber(ctx, true);
                      field.SetValue(obj, (object) int.Parse(ctx.sb.ToString()));
                    }
                    else if ((object) fieldType == (object) typeof (long))
                    {
                      JSONParser.parseNumber(ctx, true);
                      field.SetValue(obj, (object) long.Parse(ctx.sb.ToString()));
                    }
                    else if ((object) fieldType == (object) typeof (float))
                    {
                      JSONParser.parseNumber(ctx, false);
                      field.SetValue(obj, (object) float.Parse(ctx.sb.ToString()));
                    }
                    else if ((object) fieldType == (object) typeof (double))
                    {
                      JSONParser.parseNumber(ctx, false);
                      field.SetValue(obj, (object) double.Parse(ctx.sb.ToString()));
                    }
                    else if ((object) fieldType == (object) typeof (short))
                    {
                      JSONParser.parseNumber(ctx, true);
                      field.SetValue(obj, (object) short.Parse(ctx.sb.ToString()));
                    }
                    else if ((object) fieldType == (object) typeof (byte))
                    {
                      JSONParser.parseNumber(ctx, true);
                      field.SetValue(obj, (object) byte.Parse(ctx.sb.ToString()));
                    }
                    else if ((object) fieldType == (object) typeof (string))
                    {
                      JSONParser.parseString(ctx);
                      field.SetValue(obj, (object) ctx.sb.ToString());
                    }
                    else
                      goto label_33;
                  }
...
label_53:
    ...
    public class JSONException : Exception
    {
      ...
      public override string Message => "at position " + (object) this.mCtx.pos;
    }
