  ...
  public override void Download(string url, int size, MonoBehaviour coroutineExecuter = null)
  {
    ...
    this._thread = new Thread((ThreadStart) (() =>
    {
      ...
      try
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          HttpClient.\u003C\u003Ef__mg\u0024cache0 = new System.Net.Security.RemoteCertificateValidationCallback(HttpClient.RemoteCertificateValidationCallback);
        }
        // ISSUE: reference to a compiler-generated field
        System.Net.Security.RemoteCertificateValidationCallback fMgCache0 = HttpClient.\u003C\u003Ef__mg\u0024cache0;
        sslStream = new SslStream((Stream) stream, false, fMgCache0);
...
label_3:;
  ...
  public override byte[] DataBytes => this._exchangedBytes;

  public override int DownloadedSize
  {
    get => this._exchangedBytes == null ? 0 : this._exchangedBytes.Length;
  }
...
label_8:
  ...
  {
    string[] strArray = inputStream != null ? HttpClient.ReadLine(inputStream).Split(' ') : throw new IOException("Cannot read from server, server probably dropped the connection.");
    int result = -1;
