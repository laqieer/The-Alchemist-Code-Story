...
public class SkillSequence
{
  ...
  private static void OnApplicationQuit() => SkillSequence.mSequences = (List<SkillSequence>) null;

  public static void UnloadAll() => SkillSequence.mSequences = (List<SkillSequence>) null;

  private static void LoadSequences(bool is_editor = false)
  {
    if (SkillSequence.mSequences != null)
      return;
    SkillSequence.mSequences = new List<SkillSequence>(512);
    string empty = string.Empty;
    string s = !is_editor ? AssetManager.LoadTextData("SkillSeq/SKILLSEQ") : Resources.Load<TextAsset>("SkillSeq/SKILLSEQ").text;
    if (s == null)
      return;
  ...
  {
    SkillSequence.LoadSequences(is_editor);
