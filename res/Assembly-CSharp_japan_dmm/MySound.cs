...
public class MySound : MonoSingleton<MySound>
{
  ...
  private static List<MySound.EventTagCb> mEventTagCbList = new List<MySound.EventTagCb>();

  private static string CueName(string cueID, string oldPrefix)
  {
    return '0' <= cueID[0] && cueID[0] <= '9' ? oldPrefix + cueID : cueID;
  }

  private static string SECueName(string cueID) => MySound.CueName(cueID, "SE_");

  private static string BGMCueSheetName(string cueID) => MySound.CueName(cueID, "BGM_");

  private static string BGMCueName(string cueID) => MySound.CueName(cueID, "BGM_");

  private static string JingleCueSheetName(string cueID) => MySound.CueName(cueID, "JIN_");

  private static string JingleCueName(string cueID) => MySound.CueName(cueID, "JIN_");

  private static string VoiceCueSheetName(string charName) => "VO_" + charName;
  ...
  private void Setup()
  {
    ...
    this.mCriAtomGO.transform.parent = ((Component) this).gameObject.transform;
  ...
  public bool LoadSE()
  {
    if (SceneManagerHelper.ActiveSceneName == "1_CheckVersion")
      return false;
    if (this.mHandleSE != null)
      return true;
    this.mHandleSE = MySound.CueSheetHandle.Create(MySound.SECueSheetName, MySound.EType.SE);
    if (this.mHandleSE == null)
      return false;
  ...
  public bool IsReadyToClearCache() => this.mClearCacheState == MySound.EClearCacheState.END;
  ...
  public void UpdateCueSheet() => MySound.CueSheet.UpdateAll();
  ...
  public MySound.PlayHandle PlaySELoop(string cueID, float delaySec = 0.0f)
  {
    ...
    cueID = MySound.CueIDConverter.Convert(MySound.EType.SE, cueID);
    this.LoadSE();
    return this.mHandleSE == null || string.IsNullOrEmpty(cueID) ? (MySound.PlayHandle) null : this.mHandleSE.Play(MySound.SECueName(cueID), MySound.CueSheetHandle.ELoopFlag.LOOP, true, delaySec);
  }
  ...
  public bool IsLoopSE(string cueID)
  {
    ...
    cueID = MySound.CueIDConverter.Convert(MySound.EType.SE, cueID);
    this.LoadSE();
    return this.mHandleSE != null && !string.IsNullOrEmpty(cueID) && this.mHandleSE.IsLoop(MySound.SECueName(cueID));
  }
  ...
  public bool IsPlaying(string cueID)
  {
    if (string.IsNullOrEmpty(cueID))
      DebugUtility.LogWarning("[MySound] NO CueID!");
    cueID = MySound.CueIDConverter.Convert(MySound.EType.SE, cueID);
    return this.mHandleSE != null && !string.IsNullOrEmpty(cueID) && this.mHandleSE.IsCueSheetPlaying;
  }

  public MySound.PlayHandle CreatePlayHandleSE()
  {
    this.LoadSE();
    return this.mHandleSE == null ? (MySound.PlayHandle) null : this.mHandleSE.CreatePlayHandle(MySound.CueSheetHandle.ELoopFlag.DEFAULT);
  }
  ...
  public void PlayJingle(string cueID, float delaySec = 0.0f, string sheetName = null)
  {
    ...
    MySound.CueSheetHandle.Create(sheetName, MySound.EType.JINGLE)?.Play(MySound.JingleCueName(cueID), MySound.CueSheetHandle.ELoopFlag.NOT_LOOP, false, delaySec);
  }

  public void PlayOneShot(string sheetName, string cueName, MySound.EType type = MySound.EType.SE, float delaySec = 0.0f)
  {
    MySound.CueSheetHandle.Create(sheetName, type)?.Play(cueName, MySound.CueSheetHandle.ELoopFlag.NOT_LOOP, false, delaySec);
  }
  ...
  public MySound.PlayHandle PlayLoop(
    ...
    float delaySec = 0.0f)
  {
    return MySound.CueSheetHandle.Create(sheetName, type)?.Play(cueName, MySound.CueSheetHandle.ELoopFlag.LOOP, true, delaySec);
  }

  public long PlayingBGMTime => this.mBGM != null ? this.mBGM.CurrentTime : -1L;
  ...
  public void PlayBGM(string cueID, string sheetName = null, bool IsUnManaged = false)
  {
    if (this.mBGM == null || string.IsNullOrEmpty(cueID))
      return;
    this.mBGM.Play(cueID, !string.IsNullOrEmpty(this.mBGM.CurrentCueID) || !string.IsNullOrEmpty(this.mBGM.NextCueID) ? 1f : 0.0f, sheetName, IsUnManaged);
  }
  ...
  public void PlayBGMJukebox(
    ...
    bool _is_unmanaged)
  {
    if (this.mBGM == null || string.IsNullOrEmpty(_cue_id))
      return;
    this.mBGM.Play(_cue_id, _wait_sec, _sheet_name, _is_unmanaged, true);
  }
  ...
  public void StopBGM(float sec)
  {
    if (this.mBGM == null)
      return;
    this.mBGM.Play((string) null, sec);
  }

  public bool StopBGMFadeOut(float sec = 1f) => this.mBGM != null && this.mBGM.Stop(sec);

  public bool CheckCueSheetNames() => true;

  public static void AddEventTagCallback(CriAtomExSequencer.EventCbFunc func, string tag_name = null)
  {
    if (func == null)
      return;
    MySound.EventTagCb eventTagCb = MySound.mEventTagCbList.Find((Predicate<MySound.EventTagCb>) (t => (Delegate) t.mFunc == (Delegate) func));
    if (eventTagCb != null)
      eventTagCb.mTagName = tag_name;
    else
      MySound.mEventTagCbList.Add(new MySound.EventTagCb(func, tag_name));
    // ISSUE: reference to a compiler-generated field
    if (MySound.\u003C\u003Ef__mg\u0024cache0 == null)
    {
      // ISSUE: reference to a compiler-generated field
      // ISSUE: method pointer
      MySound.\u003C\u003Ef__mg\u0024cache0 = new CriAtomExSequencer.EventCbFunc((object) null, __methodptr(EventTagCallback));
    }
    // ISSUE: reference to a compiler-generated field
    CriAtomExSequencer.SetEventCallback(MySound.\u003C\u003Ef__mg\u0024cache0, ','.ToString());
  }
  ...
  public static void RemoveEventTagCallback(CriAtomExSequencer.EventCbFunc func)
  {
    ...
    if (eventTagCb == null)
      return;
    MySound.mEventTagCbList.Remove(eventTagCb);
  }

  private static void EventTagCallback(string eventParamsString)
  {
    if (string.IsNullOrEmpty(eventParamsString))
      return;
    string empty = string.Empty;
    string[] strArray = eventParamsString.Split(',');
    if (strArray != null && strArray.Length > 4)
      empty = strArray[4];
    foreach (MySound.EventTagCb mEventTagCb in MySound.mEventTagCbList)
    {
      if (string.IsNullOrEmpty(mEventTagCb.mTagName) || mEventTagCb.mTagName == empty)
        mEventTagCb.mFunc.Invoke(eventParamsString);
    }
  }
  ...
  private class CueSheet
  {
    ...
    private static List<MySound.CueSheet> sDelCueSheets = new List<MySound.CueSheet>();
    private CriAtomCueSheet mSheet;
    private int refCount;
    private List<MySound.Source> mSrcList = new List<MySound.Source>();
    private List<MySound.Source> mDelSrcList = new List<MySound.Source>();
    ...
    private string name => this.mSheet == null ? (string) null : this.mSheet.name;
    ...
    private static bool IsSheetValid(string sheetName)
    {
      ...
      return acb != null && acb.isAvailable;
    }
    ...
    public static bool IsReady(string sheetName)
    {
      if (string.IsNullOrEmpty(sheetName))
        return false;
      MySound.CueSheet cueSheet = MySound.CueSheet.sCueSheets.Find((Predicate<MySound.CueSheet>) (s => sheetName.Equals(s.name)));
      return cueSheet != null && cueSheet.mState == MySound.CueSheet.EState.READY;
    }
    ...
    public static bool IsLoop(string sheetName, string cueName)
    {
      ...
      return acb != null && acb.GetCueInfo(cueName, ref cueInfo) && cueInfo.length == -1L;
    }
    ...
    private void Update()
    {
      foreach (MySound.Source mSrc in this.mSrcList)
      {
        ...
        if (mSrc.IsReadyToRemove)
        {
          ...
          mSrc.Cleanup();
          this.mDelSrcList.Add(mSrc);
        }
      }
      foreach (MySound.Source mDelSrc in this.mDelSrcList)
        this.mSrcList.Remove(mDelSrc);
      this.mDelSrcList.Clear();
    }
    ...
    public static void UpdateAll()
    {
      foreach (MySound.CueSheet sCueSheet in MySound.CueSheet.sCueSheets)
      {
        ...
        if (sCueSheet.IsReadyToRemove)
        {
          ...
          MySound.CueSheet.sDelCueSheets.Add(sCueSheet);
        }
      }
      foreach (MySound.CueSheet sDelCueSheet in MySound.CueSheet.sDelCueSheets)
        MySound.CueSheet.sCueSheets.Remove(sDelCueSheet);
      MySound.CueSheet.sDelCueSheets.Clear();
    }
    ...
    public static int GetLoadedNum() => MySound.CueSheet.sCueSheets.Count;
    ...
    public static bool IsPlaying(string sheetName)
    {
      if (string.IsNullOrEmpty(sheetName))
        return false;
      MySound.CueSheet cueSheet = MySound.CueSheet.sCueSheets.Find((Predicate<MySound.CueSheet>) (s => sheetName.Equals(s.name)));
      return cueSheet != null && cueSheet.mState == MySound.CueSheet.EState.READY && cueSheet.IsPlaying();
    }
    ...
    public static CriAtomExAcb FindAcb(string sheetName)
    {
      ...
      if (cueSheet == null)
        return (CriAtomExAcb) null;
      return cueSheet.mSheet == null ? (CriAtomExAcb) null : cueSheet.mSheet.acb;
    }
  ...
  public class CueSheetHandle
  {
    ...
    public bool IsReady => MySound.CueSheet.IsReady(this.mSheetName);
    ...
    public bool GetCueInfo(string cue_id, ref CriAtomEx.CueInfo info)
    {
      if (!MySound.CueSheet.IsReady(this.mSheetName))
        return false;
      CriAtomExAcb acb = CriAtom.GetAcb(this.mSheetName);
      return acb != null && acb.GetCueInfo(cue_id, ref info);
    }
    ...
    {
      if (this.mDefaultOneShot != null)
        this.mDefaultOneShot.FadeOutStop(sec);
      if (this.mDefaultOneShotAndroidLowLatency == null)
        return;
      this.mDefaultOneShotAndroidLowLatency.FadeOutStop(sec);
    }
    ...
    private MySound.PlayHandle CreatePlayHandleCore(MySound.Source src)
    {
      ...
      MySound.PlayHandle playHandleCore = MySound.PlayHandle.Create();
      MonoSingleton<MySound>.Instance.mSourceToPlayHandle = (MySound.Source) null;
      return playHandleCore;
    }
    ...
    public MySound.PlayHandle CreatePlayHandle(MySound.CueSheetHandle.ELoopFlag loop)
    {
      ...
      return source == null ? (MySound.PlayHandle) null : this.CreatePlayHandleCore(source);
    }

    public bool IsLoop(string cueName) => MySound.CueSheet.IsLoop(this.mSheetName, cueName);

    ~CueSheetHandle() => this.Cleanup();
    ...
    public bool IsCueSheetPlaying => MySound.CueSheet.IsPlaying(this.mSheetName);
  ...
  private class BGMManager
  {
    ...
    public string NextCueID { get; private set; }
    ...
    public void Cleanup()
    {
      ...
      this.mTimer = 0.0f;
      this.mWaitSec = 0.0f;
      this.NextCueID = (string) null;
      if (this.mNextHandle != null)
        this.mNextHandle.Cleanup();
      this.mNextHandle = (MySound.CueSheetHandle) null;
    }

    public long CurrentTime => this.mCurrent != null ? this.mCurrent.CurrentTime : -1L;
      ...
      bool IsJuke = false)
    {
      ...
      if (!string.IsNullOrEmpty(this.NextCueID) && this.NextCueID.Equals(cueID))
        return;
      if (this.mCurrent != null)
      {
        if (IsJuke)
          this.mCurrent.Stop(waitSec);
        else
          this.mCurrent.Stop(1f);
        this.mCurrent = (MySound.PlayHandle) null;
      }
      ...
      {
        sheetName = !string.IsNullOrEmpty(sheetName) ? sheetName : MySound.BGMCueSheetName(this.NextCueID);
        if (IsJuke)
          this.mNextHandle = MySound.CueSheetHandle.Create(sheetName, MySound.EType.JUKE_BGM, isUnManaged: IsUnManaged);
        else
          this.mNextHandle = MySound.CueSheetHandle.Create(sheetName, MySound.EType.BGM, isUnManaged: IsUnManaged);
      }
    }
    ...
    public void Update()
    {
      if (string.IsNullOrEmpty(this.NextCueID))
        return;
      ...
      {
        this.mCurrentHandle.Cleanup();
        this.mCurrentHandle = (MySound.CueSheetHandle) null;
      }
      if (this.mNextHandle != null)
      {
        if (!this.mNextHandle.IsReady)
          return;
        DebugUtility.Log("[MySound] BGM > " + this.NextCueID);
        this.mCurrent = this.mNextHandle.Play(MySound.BGMCueName(this.NextCueID), MySound.CueSheetHandle.ELoopFlag.DEFAULT, true);
        this.CurrentCueID = this.NextCueID;
        CriAtomEx.CueInfo info = new CriAtomEx.CueInfo();
        if (this.mNextHandle.GetCueInfo(this.CurrentCueID, ref info))
          DebugUtility.Log("BGM block : " + (object) info.numBlocks + " Length : " + (object) info.length);
        this.mCurrentHandle = this.mNextHandle;
      }
      else
      {
  ...
  public class Voice
  {
    ...
    public Voice(string charName, string cue_name_prefix = null)
    {
      ...
      if (string.IsNullOrEmpty(cue_name_prefix))
        cue_name_prefix = charName;
      this.Setup(MySound.VoiceCueSheetName(charName), cue_name_prefix + "_");
    }
    ...
    private void Setup(string sheetName, string cueNamePrefix, bool isUnManaged = false)
    {
      ...
      this.mHandle = MySound.CueSheetHandle.Create(sheetName, MySound.EType.VOICE, isUnManaged: isUnManaged);
    ...
    {
      return string.IsNullOrEmpty(cueName) || string.IsNullOrEmpty(charName) ? cueName : cueName.Replace("charactorname", charName);
    }
    ...
    public bool IsPlaying => this.mHandle != null && this.mHandle.IsDefaultOneShotPlaying;
    ...
    public bool CheckCueIDs() => true;

    public CriAtomExAcb FindAcb(string sheetName)
    {
      return string.IsNullOrEmpty(sheetName) ? (CriAtomExAcb) null : MySound.CueSheet.FindAcb(sheetName);
    }
  }
  ...
  private class VolumeManager
  {
    ...
    public void Discard() => this.mDiscarded = true;
    ...
    public float Volume
    {
      get
      {
        if (this.mDiscarded)
          return 1f;
        return (double) this.mInterpSec <= 0.0 ? this.mVolumeTgt : (this.mVolumeTgt - this.mVolumeStart) * this.mPastSec / this.mInterpSec + this.mVolumeStart;
      }
      set
      {
  ...
  public class VolumeHandle
  {
    ...
    public void SetVolume(float volume, float sec)
    {
      if (this.mMng == null)
        return;
      this.mMng.SetVolume(volume, sec);
    }
  }
  ...
  private class Source
  {
    ...
    public float Pitch
    {
      get => Object.op_Equality((Object) this.mCore, (Object) null) ? 0.0f : this.mCore.pitch;
      set
      {
    ...
    {
      get => Object.op_Inequality((Object) this.mCore, (Object) null) ? this.mCore.time : -1L;
    }
    ...
    private float GetTypeVolume()
    {
      ...
      if (this.mType == MySound.EType.JUKE_BGM)
        return GameUtility.Config_JukeboxVolume * volume;
      return this.mType == MySound.EType.VOICE ? GameUtility.Config_VoiceVolume * volume : GameUtility.Config_SoundVolume * volume;
    }
      ...
      MySound.EType type)
    {
      ...
      this.mName = ((Object) this.mCore).name;
      gameObject.transform.parent = ((Component) MonoSingleton<MySound>.Instance).gameObject.transform;
    ...
    public void Cleanup()
    {
      if (!Object.op_Inequality((Object) this.mCore, (Object) null))
        return;
      this.mCore.Stop();
      Object.Destroy((Object) ((Component) this.mCore).gameObject);
    ...
    public bool IsReadyToRemove
    {
      get
      {
        ...
        if (this.KeepInstance || this.IsPlaying)
          return false;
        DebugUtility.Log("[MySound] source is ready to remove:" + ((Object) ((Component) this.mCore).gameObject).name);
        return true;
      }
    }
  ...
  public class PlayHandle
  {
    ...
    private PlayHandle(MySound.Source src) => this.mSrc = src;

    public float Pitch
    {
      get => this.mSrc == null ? 0.0f : this.mSrc.Pitch;
      set
      {
        if (this.mSrc == null)
          return;
    ...
    public long CurrentTime => this.mSrc != null ? this.mSrc.CurrentTime : -1L;
    ...
    ~PlayHandle() => this.Stop(0.0f);

    public bool KeepInstance
    {
      get => this.mSrc != null && this.mSrc.KeepInstance;
      set
      {
        if (this.mSrc == null)
          return;
