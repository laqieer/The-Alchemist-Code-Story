...
namespace Gsc.Purchase.Platform
{
  public abstract class FlowWithPurchaseKit : IPurchaseFlowImpl, IPurchaseListener
  {
    ...
    {
      GameObject gameObject = ((Component) NativeRootObject.Instance).gameObject;
    ...
    public virtual bool Purchase(ProductInfo product) => PurchaseKit.Purchase(product.ID);
    ...
    public virtual void Consume(string transactionId) => PurchaseKit.Consume(transactionId);
