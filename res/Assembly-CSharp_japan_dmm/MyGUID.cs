...
public class MyGUID
{
  ...
  private string GetPersistFileNameOld() => AppPath.persistentDataPath + "/gu3u3.dat";

  private string GetCacheFileNameOld() => AppPath.persistentDataPath + "/gu3i3.dat";
  ...
  private byte[] ConvertOldCache(int seed)
  {
    ...
    if (data == null || data.Length <= 0)
      return (byte[]) null;
    string src = MyEncrypt.Decrypt(seed, data);
