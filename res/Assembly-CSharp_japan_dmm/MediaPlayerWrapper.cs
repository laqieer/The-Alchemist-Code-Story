...
public class MediaPlayerWrapper : MonoBehaviour
{
  ...
  private float m_BufferingGraceTime = 10f;
  ...
  {
    get => this.m_MediaPlayer.m_AutoStart;
    set => this.m_MediaPlayer.m_AutoStart = value;
  }

  public bool EnableBufferingTimeout
  {
    get => this.m_EnableBufferingTimeout;
    set => this.m_EnableBufferingTimeout = value;
  }

  public float BufferingGraceTime
  {
    get => this.m_BufferingGraceTime;
    set => this.m_BufferingGraceTime = value;
  }
  ...
  private IEnumerator LoadInternal(string url, bool autoPlay)
  {
    ...
    return (IEnumerator) new MediaPlayerWrapper.\u003CLoadInternal\u003Ec__Iterator0()
    {
      url = url,
      autoPlay = autoPlay,
      \u0024this = this
  ...
  public void Play() => this.m_MediaPlayer.Control.Play();

  public void Stop() => this.m_MediaPlayer.Control.Stop();

  public void Pause() => this.m_MediaPlayer.Control.Pause();

  public void Unload() => this.m_MediaPlayer.Control.CloseVideo();

  public void SkipToEnd() => this.Seek01(1f);

  public void BackToStart() => this.Seek01(0.0f);
  ...
  public void SetVolume(float value) => this.m_MediaPlayer.m_Volume = value;

  public float GetVolume() => this.m_MediaPlayer.m_Volume;

  public float GetBufferingProgress() => this.m_MediaPlayer.Control.GetBufferingProgress();

  public int GetBufferedTimeRangeCount() => this.m_MediaPlayer.Control.GetBufferedTimeRangeCount();

  private void Notify(MediaPlayerWrapper.Event.Type eventType) => this.Events.Invoke(eventType);

  private void OnMediaPlayerEvent(
    MediaPlayer mediaPlayer,
    MediaPlayerEvent.EventType eventType,
    RenderHeads.Media.AVProVideo.ErrorCode errorCode)
  {
    switch (eventType)
    {
  ...
  private void UpdateValues() => this.m_IsBuffering = this.m_MediaPlayer.Control.IsBuffering();
