...
// Type: MessagePack.Internal.ILGeneratorExtensions
...
namespace MessagePack.Internal
{
  internal static class ILGeneratorExtensions
  {
    ...
    public static void EmitTrue(this ILGenerator il) => il.EmitBoolean(true);

    public static void EmitFalse(this ILGenerator il) => il.EmitBoolean(false);

    public static void EmitBoolean(this ILGenerator il, bool value)
    {
      il.EmitLdc_I4(!value ? 0 : 1);
    }
    ...
    {
      if (System.Reflection.ReflectionExtensions.GetTypeInfo(type).IsValueType)
    ...
    public static void EmitLoadThis(this ILGenerator il) => il.EmitLdarg(0);
    ...
    {
      il.Emit(OpCodes.Newobj, System.Reflection.ReflectionExtensions.GetTypeInfo(typeof (NotImplementedException)).DeclaredConstructors.First<ConstructorInfo>((Func<ConstructorInfo, bool>) (x => x.GetParameters().Length == 0)));
