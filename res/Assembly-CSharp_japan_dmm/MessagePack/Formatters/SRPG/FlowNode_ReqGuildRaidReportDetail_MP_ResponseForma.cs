...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GuildRaidReport>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      JSON_GuildRaidReport jsonGuildRaidReport = (JSON_GuildRaidReport) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              jsonGuildRaidReport = formatterResolver.GetFormatterWithVerify<JSON_GuildRaidReport>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqGuildRaidReportDetail.MP_Response mpResponse = new FlowNode_ReqGuildRaidReportDetail.MP_Response();
      mpResponse.body = jsonGuildRaidReport;
