    ...
    IMessagePackFormatter
  {
    ...
    public JSON_BuyCoinProductConvertParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[2][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("convert")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.convert, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_BuyCoinProductConvertParam()
      {
        name = str1,
        convert = str2
      };
