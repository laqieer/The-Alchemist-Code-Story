...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqSetConceptLeaderSkill_OverWrite.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqSetConceptLeaderSkill_OverWrite.Response response = (ReqSetConceptLeaderSkill_OverWrite.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqSetConceptLeaderSkill_OverWrite.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqConceptLeaderSkillSet.MP_SetConceptLeaderSkill_OverWriteResponse overWriteResponse = new FlowNode_ReqConceptLeaderSkillSet.MP_SetConceptLeaderSkill_OverWriteResponse();
