...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GvGNodeReward[]>().Serialize(ref bytes, offset, value.rewards, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GvGNodeReward[] jsonGvGnodeRewardArray = (JSON_GvGNodeReward[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              jsonGvGnodeRewardArray = formatterResolver.GetFormatterWithVerify<JSON_GvGNodeReward[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GvGNodeRewardParam()
      {
        id = str,
        rewards = jsonGvGnodeRewardArray
      };
    }
  }
}
