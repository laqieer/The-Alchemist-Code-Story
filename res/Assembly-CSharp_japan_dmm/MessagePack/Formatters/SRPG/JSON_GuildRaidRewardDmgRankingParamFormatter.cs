...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GuildRaidRewardDmgRankingRankParam[]>().Serialize(ref bytes, offset, value.ranking, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GuildRaidRewardDmgRankingRankParam[] rankingRankParamArray = (JSON_GuildRaidRewardDmgRankingRankParam[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              rankingRankParamArray = formatterResolver.GetFormatterWithVerify<JSON_GuildRaidRewardDmgRankingRankParam[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GuildRaidRewardDmgRankingParam()
      {
        id = str,
        ranking = rankingRankParamArray
      };
    }
  }
}
