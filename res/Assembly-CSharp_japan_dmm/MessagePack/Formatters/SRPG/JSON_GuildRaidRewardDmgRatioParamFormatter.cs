...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GuildRaidRewardDmgRatio[]>().Serialize(ref bytes, offset, value.rewards, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GuildRaidRewardDmgRatio[] raidRewardDmgRatioArray = (JSON_GuildRaidRewardDmgRatio[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              raidRewardDmgRatioArray = formatterResolver.GetFormatterWithVerify<JSON_GuildRaidRewardDmgRatio[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GuildRaidRewardDmgRatioParam()
      {
        id = str,
        rewards = raidRewardDmgRatioArray
      };
    }
  }
}
