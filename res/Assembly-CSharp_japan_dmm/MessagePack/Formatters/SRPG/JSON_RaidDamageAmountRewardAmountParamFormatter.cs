...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_RaidDamageAmountRewardAmountParamFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("damage_Amount"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.damage_Amount);
      ...
      out int readSize)
    {
      ...
      return new JSON_RaidDamageAmountRewardAmountParam()
      {
        damage_Amount = num3,
        reward_id = str
      };
