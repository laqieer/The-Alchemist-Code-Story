...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_VersusRankRewardRewardParam[]>().Serialize(ref bytes, offset, value.rewards, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_VersusRankRewardRewardParam[] rewardRewardParamArray = (JSON_VersusRankRewardRewardParam[]) null;
        ...
        else
        {
          switch (num3)
          {
            case 0:
              ...
              break;
            case 1:
              rewardRewardParamArray = formatterResolver.GetFormatterWithVerify<JSON_VersusRankRewardRewardParam[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_VersusRankRewardParam()
      {
        reward_id = str,
        rewards = rewardRewardParamArray
      };
    }
  }
}
