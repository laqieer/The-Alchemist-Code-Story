...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqExpansionPurchase.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqExpansionPurchase.Response response = (ReqExpansionPurchase.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqExpansionPurchase.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqExpansionPurchaseData.MP_ReqExpansionPurchaseResponse purchaseResponse = new FlowNode_ReqExpansionPurchaseData.MP_ReqExpansionPurchaseResponse();
      purchaseResponse.body = response;
      purchaseResponse.stat = num3;
      purchaseResponse.stat_msg = str1;
      purchaseResponse.stat_code = str2;
      purchaseResponse.time = num4;
      purchaseResponse.ticket = num5;
