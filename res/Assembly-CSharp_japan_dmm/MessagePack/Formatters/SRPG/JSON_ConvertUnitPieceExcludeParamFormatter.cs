    ...
    IMessagePackFormatter
  {
    ...
    public JSON_ConvertUnitPieceExcludeParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[2][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("unit_piece_iname")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.unit_piece_iname, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_ConvertUnitPieceExcludeParam()
      {
        id = num3,
        unit_piece_iname = str
      };
    }
  }
}
