...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestProgress.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqAutoRepeatQuestProgress.Response response = (ReqAutoRepeatQuestProgress.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestProgress.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqAutoRepeatQuestProgress.MP_AutoRepeatQuestProgressResponse progressResponse = new FlowNode_ReqAutoRepeatQuestProgress.MP_AutoRepeatQuestProgressResponse();
      progressResponse.body = response;
      progressResponse.stat = num3;
      progressResponse.stat_msg = str1;
      progressResponse.stat_code = str2;
      progressResponse.time = num4;
      progressResponse.ticket = num5;
