...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_FilterArtifactParam.Condition[]>().Serialize(ref bytes, offset, value.cnds, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      int num3 = 0;
      JSON_FilterArtifactParam.Condition[] conditionArray = (JSON_FilterArtifactParam.Condition[]) null;
        ...
        else
        {
          switch (num4)
          {
            ...
            case 3:
              ...
              break;
            case 4:
              conditionArray = formatterResolver.GetFormatterWithVerify<JSON_FilterArtifactParam.Condition[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_FilterArtifactParam()
      {
        iname = str1,
        tab_name = str2,
        name = str3,
