...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public ReqGuildRaidReportSelf_ResponseFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("reports"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GuildRaidReport[]>().Serialize(ref bytes, offset, value.reports, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      JSON_GuildRaidReport[] jsonGuildRaidReportArray = (JSON_GuildRaidReport[]) null;
      int num3 = 0;
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              jsonGuildRaidReportArray = formatterResolver.GetFormatterWithVerify<JSON_GuildRaidReport[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      return new ReqGuildRaidReportSelf.Response()
      {
        reports = jsonGuildRaidReportArray,
        totalPage = num3
      };
    }
  }
