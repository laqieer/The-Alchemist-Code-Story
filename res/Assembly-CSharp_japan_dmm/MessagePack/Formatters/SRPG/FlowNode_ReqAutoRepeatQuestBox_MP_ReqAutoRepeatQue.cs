...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestBox.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqAutoRepeatQuestBox.Response response = (ReqAutoRepeatQuestBox.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestBox.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqAutoRepeatQuestBox.MP_ReqAutoRepeatQuestBoxResponse questBoxResponse = new FlowNode_ReqAutoRepeatQuestBox.MP_ReqAutoRepeatQuestBoxResponse();
      questBoxResponse.body = response;
      questBoxResponse.stat = num3;
      questBoxResponse.stat_msg = str1;
      questBoxResponse.stat_code = str2;
      questBoxResponse.time = num4;
      questBoxResponse.ticket = num5;
      return questBoxResponse;
    }
  }
}
