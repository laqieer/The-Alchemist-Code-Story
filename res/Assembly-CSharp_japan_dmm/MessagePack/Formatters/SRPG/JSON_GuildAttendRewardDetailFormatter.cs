...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_GuildAttendRewardDetailFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("member_cnt"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.member_cnt);
      ...
      out int readSize)
    {
      ...
      return new JSON_GuildAttendRewardDetail()
      {
        member_cnt = num3,
        reward_id = str
      };
