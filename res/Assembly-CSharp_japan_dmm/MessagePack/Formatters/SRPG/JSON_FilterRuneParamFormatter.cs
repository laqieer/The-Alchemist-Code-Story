...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_FilterRuneConditionParam[]>().Serialize(ref bytes, offset, value.cnds, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      int num3 = 0;
      JSON_FilterRuneConditionParam[] runeConditionParamArray = (JSON_FilterRuneConditionParam[]) null;
        ...
        else
        {
          switch (num4)
          {
            ...
            case 3:
              ...
              break;
            case 4:
              runeConditionParamArray = formatterResolver.GetFormatterWithVerify<JSON_FilterRuneConditionParam[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_FilterRuneParam()
      {
        iname = str1,
        tab_name = str2,
        name = str3,
