    ...
    IMessagePackFormatter
  {
    ...
    public ReqAutoRepeatQuestBox_ResponseFormatter()
    {
      ...
      this.____stringByteKeys = new byte[3][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("drip_priority"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string[]>().Serialize(ref bytes, offset, value.drip_priority, formatterResolver);
      ...
      out int readSize)
    {
      ...
      return new ReqAutoRepeatQuestBox.Response()
      {
        box_extension_count = num3,
        drip_priority = strArray,
        box_expansion_purchase_count = num4
      };
    }
  }
}
