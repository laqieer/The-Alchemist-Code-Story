...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_DrawCardParam.DrawInfo[]>().Serialize(ref bytes, offset, value.draw_infos, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_DrawCardParam.DrawInfo[] drawInfoArray = (JSON_DrawCardParam.DrawInfo[]) null;
        ...
        else
        {
          switch (num3)
          {
            ...
            case 2:
              ...
              break;
            case 3:
              drawInfoArray = formatterResolver.GetFormatterWithVerify<JSON_DrawCardParam.DrawInfo[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_DrawCardParam()
      {
        iname = str1,
        begin_at = str2,
        end_at = str3,
        draw_infos = drawInfoArray
      };
    }
  }
}
