...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_GuildRaidScoreDataParamFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("roud"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.roud);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[1]);
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.scale);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_GuildRaidScoreDataParam()
      {
        roud = num3,
        scale = num4
      };
