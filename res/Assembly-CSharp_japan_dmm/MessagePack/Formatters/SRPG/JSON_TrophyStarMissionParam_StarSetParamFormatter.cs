...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_TrophyStarMissionParam_StarSetParamFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("require_star"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.require_star);
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.icon);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_TrophyStarMissionParam.StarSetParam()
      {
        require_star = num3,
        reward_id = str,
        icon = num4
