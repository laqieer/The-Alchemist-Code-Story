...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_GenesisLapBossParam.LapInfo[]>().Serialize(ref bytes, offset, value.lap_info, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      JSON_GenesisLapBossParam.LapInfo[] lapInfoArray = (JSON_GenesisLapBossParam.LapInfo[]) null;
        ...
        else
        {
          switch (num4)
          {
            ...
            case 3:
              ...
              break;
            case 4:
              lapInfoArray = formatterResolver.GetFormatterWithVerify<JSON_GenesisLapBossParam.LapInfo[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new JSON_GenesisLapBossParam()
      {
        iname = str1,
        round_buff_max = num3,
        boss_bid = str2,
