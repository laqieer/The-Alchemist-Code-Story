...
namespace MessagePack.Formatters.SRPG
{
  public sealed class RuneSetEffFormatter : IMessagePackFormatter<RuneSetEff>, IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteByte(ref bytes, offset, value.icon_index);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[3]);
      offset += MessagePackBinary.WriteByte(ref bytes, offset, value.cost);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[4]);
      offset += formatterResolver.GetFormatterWithVerify<RuneSetEffState[]>().Serialize(ref bytes, offset, value.state, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      byte num4 = 0;
      byte num5 = 0;
      RuneSetEffState[] runeSetEffStateArray = (RuneSetEffState[]) null;
        ...
        else
        {
          switch (num6)
          {
            ...
            case 3:
              ...
              break;
            case 4:
              runeSetEffStateArray = formatterResolver.GetFormatterWithVerify<RuneSetEffState[]>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            default:
              readSize = MessagePackBinary.ReadNextBlock(bytes, offset);
              break;
      ...
      return new RuneSetEff()
      {
        seteff_type = num3,
        name = str,
        icon_index = num4,
        cost = num5,
        state = runeSetEffStateArray
      };
    }
  }
}
