    ...
    IMessagePackFormatter
  {
    ...
    public JSON_TobiraLearnAbilityParamFormatter()
    {
      ...
      this.____stringByteKeys = new byte[5][]
      {
        ...
        MessagePackBinary.GetEncodedStringBytes("learn_lv"),
        MessagePackBinary.GetEncodedStringBytes("add_type"),
        MessagePackBinary.GetEncodedStringBytes("target_job"),
        MessagePackBinary.GetEncodedStringBytes("abil_overwrite")
      };
    }
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.learn_lv);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[2]);
      offset += MessagePackBinary.WriteInt32(ref bytes, offset, value.add_type);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[3]);
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.target_job, formatterResolver);
      offset += MessagePackBinary.WriteRaw(ref bytes, offset, this.____stringByteKeys[4]);
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.abil_overwrite, formatterResolver);
      return offset - num;
    }
      ...
      out int readSize)
    {
      ...
      return new JSON_TobiraLearnAbilityParam()
      {
        abil_iname = str1,
        learn_lv = num3,
        add_type = num4,
