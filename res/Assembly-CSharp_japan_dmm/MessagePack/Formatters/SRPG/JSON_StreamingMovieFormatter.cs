...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
    ...
    public JSON_StreamingMovieFormatter()
    {
      ...
      {
        MessagePackBinary.GetEncodedStringBytes("alias"),
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<string>().Serialize(ref bytes, offset, value.alias, formatterResolver);
      ...
      out int readSize)
    {
      ...
      return new JSON_StreamingMovie()
      {
        alias = str1,
        path = str2
      };
