...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestBoxAdd.Response>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      ReqAutoRepeatQuestBoxAdd.Response response = (ReqAutoRepeatQuestBoxAdd.Response) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              response = formatterResolver.GetFormatterWithVerify<ReqAutoRepeatQuestBoxAdd.Response>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      FlowNode_ReqAutoRepeatQuestBoxAdd.MP_ReqAutoRepeatQuestBoxAddResponse questBoxAddResponse = new FlowNode_ReqAutoRepeatQuestBoxAdd.MP_ReqAutoRepeatQuestBoxAddResponse();
      questBoxAddResponse.body = response;
      questBoxAddResponse.stat = num3;
      questBoxAddResponse.stat_msg = str1;
      questBoxAddResponse.stat_code = str2;
      questBoxAddResponse.time = num4;
      questBoxAddResponse.ticket = num5;
      return questBoxAddResponse;
    }
  }
}
