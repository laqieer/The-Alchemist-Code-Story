...
namespace MessagePack.Formatters.SRPG
{
    ...
    IMessagePackFormatter
  {
      ...
      IFormatterResolver formatterResolver)
    {
      ...
      offset += formatterResolver.GetFormatterWithVerify<JSON_TrophyResponse>().Serialize(ref bytes, offset, value.body, formatterResolver);
      ...
      out int readSize)
    {
      ...
      offset += readSize;
      JSON_TrophyResponse jsonTrophyResponse = (JSON_TrophyResponse) null;
      int num3 = 0;
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        else
        {
          ...
          {
            case 0:
              jsonTrophyResponse = formatterResolver.GetFormatterWithVerify<JSON_TrophyResponse>().Deserialize(bytes, offset, formatterResolver, out readSize);
              break;
            case 1:
      ...
      MP_TrophyResponse mpTrophyResponse = new MP_TrophyResponse();
      mpTrophyResponse.body = jsonTrophyResponse;
      mpTrophyResponse.stat = num3;
      mpTrophyResponse.stat_msg = str1;
      mpTrophyResponse.stat_code = str2;
      mpTrophyResponse.time = num4;
      mpTrophyResponse.ticket = num5;
      return mpTrophyResponse;
    }
  }
}
