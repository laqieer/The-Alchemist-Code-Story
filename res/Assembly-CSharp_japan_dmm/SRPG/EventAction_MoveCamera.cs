  ...
  public class EventAction_MoveCamera : EventAction
  {
    ...
    public override void OnActivate()
    {
      ...
      if ((double) this.MoveTime <= 0.0 && this.Speed == EventAction_MoveCamera.CameraMoveSpeeds.Immediate)
      {
        ...
        actionMoveCamera.TargetPosition = Vector3.op_Addition(actionMoveCamera.TargetPosition, Vector3.op_Multiply(Vector3.up, instance.GameCamera_UnitHeightOffset));
      ...
      else
      {
        ...
        else
        {
          ...
          EventAction_MoveCamera actionMoveCamera = this;
          actionMoveCamera.StartTargetPosition = Vector3.op_Addition(actionMoveCamera.StartTargetPosition, Vector3.op_Multiply(Vector3.up, instance.GameCamera_UnitHeightOffset));
        }
        if (this.SnapToGround)
          this.TargetPosition = GameUtility.RaycastGround(this.TargetPosition);
        EventAction_MoveCamera actionMoveCamera1 = this;
        actionMoveCamera1.TargetPosition = Vector3.op_Addition(actionMoveCamera1.TargetPosition, Vector3.op_Multiply(Vector3.up, instance.GameCamera_UnitHeightOffset));
        float num1 = 1f;
        switch (this.Speed)
        {
