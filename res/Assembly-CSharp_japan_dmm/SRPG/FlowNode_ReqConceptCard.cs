...
namespace SRPG
{
  ...
  public class FlowNode_ReqConceptCard : FlowNode_Network
  {
    ...
    public override void OnSuccess(WWWResult www)
    {
      ...
      else
      {
        ...
        try
        {
          ...
          MonoSingleton<GameManager>.Instance.Player.UpdateConceptCardEquipedSlotsAllUnit();
    ...
    private IEnumerator DownloadAssetsAndOutputPin()
    {
      ...
      return (IEnumerator) new FlowNode_ReqConceptCard.\u003CDownloadAssetsAndOutputPin\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
