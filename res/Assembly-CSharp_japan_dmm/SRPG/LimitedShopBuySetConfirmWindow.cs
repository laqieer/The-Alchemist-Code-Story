    ...
    private void Refresh()
    {
      ...
      else
      {
        ...
        if (this.mShopitem.IsSet)
        {
          ...
          {
            GameObject gameObject = index >= this.limited_shop_item_set_list.Count ? UnityEngine.Object.Instantiate<GameObject>(this.ItemTemplate) : ((Component) this.limited_shop_item_set_list[index]).gameObject;
