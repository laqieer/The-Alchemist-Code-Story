...
namespace SRPG
{
  ...
  public class GameSettings : ScriptableObject
  {
    ...
    public float GameCamera_BigUnitAddDistance = 5f;
    ...
    public AnimationCurve Unit_JumpZCurve = new AnimationCurve(new Keyframe[2]
    {
      new Keyframe(0.0f, 0.0f),
      new Keyframe(1f, 1f)
    });
    [Tooltip("段差登り時の上方向へのカーブ")]
    public AnimationCurve Unit_JumpYCurve = new AnimationCurve(new Keyframe[3]
    {
      new Keyframe(0.0f, 0.0f),
    ...
    public float Message_AutoForwardSec = 3f;
    ...
    public Sprite[] ArtifactIcon_InspSkillFrames = new Sprite[0];
    public Sprite[] ArtifactIcon_Rarity = new Sprite[0];
    public Sprite[] ArtifactIcon_RarityBG = new Sprite[0];
    public Sprite[] ConceptCardIcon_Frames = new Sprite[0];
    public Sprite[] ConceptCardIcon_Rarity = new Sprite[0];
    [StringIsResourcePath(typeof (GameObject))]
    public string ConceptCard_GetUnit = string.Empty;
    ...
    public string[] Shop_ShopIdToShopTypeConvTbl = new string[13]
    {
      "Normal",
      "Tabi",
      "Kimagure",
    ...
    public static void Reset() => GameSettings.mInstance = (GameSettings) null;
    ...
    public Sprite GetItemFrame(EItemType type, int rare)
    {
      ...
      return 0 <= index ? spriteArray[index] : (Sprite) null;
    }
    ...
    public Sprite GetConceptCardFrame(int rarity)
    {
      if (this.ConceptCardIcon_Frames != null)
        return this.ConceptCardIcon_Frames[Mathf.Clamp(rarity, 0, this.ConceptCardIcon_Frames.Length - 1)];
      DebugUtility.LogError(string.Format("GameSettings.GetConceptCardFrame => ConceptCardIcon_Frames == null"));
      return (Sprite) null;
    }
