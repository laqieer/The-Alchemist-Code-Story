...
namespace SRPG
{
  public class AdvanceQuestMapSymbol : MonoBehaviour
  {
    ...
    public AdvanceQuestMapIcon Icon => this.mRefIconObject;
    ...
    public void UpdateState()
    {
      if (Object.op_Equality((Object) this.mRefIconObject, (Object) null) || this.mQuestParam == null)
        return;
      AdvanceQuestMapSymbol.eQuestState state = AdvanceQuestMapSymbol.eQuestState.LOCK;
      if (MonoSingleton<GameManager>.Instance.Player.IsQuestCleared(this.mQuestParam.iname))
        state = AdvanceQuestMapSymbol.eQuestState.CLEARED;
      else if (MonoSingleton<GameManager>.Instance.Player.IsQuestAvailable(this.mQuestParam.iname))
        state = AdvanceQuestMapSymbol.eQuestState.PLAYABLE;
