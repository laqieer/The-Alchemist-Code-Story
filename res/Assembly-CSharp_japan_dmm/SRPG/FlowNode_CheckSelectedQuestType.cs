...
namespace SRPG
{
  ...
  public class FlowNode_CheckSelectedQuestType : FlowNode
  {
    ...
    public override void OnActivate(int pinID)
    {
      ...
      switch (questTypeAuto)
      {
        ...
        case QuestTypes.AdvanceStory:
          this.ActivateOutputLinks(1015);
          break;
        case QuestTypes.AdvanceBoss:
          this.ActivateOutputLinks(1016);
          break;
        case QuestTypes.UnitRental:
          this.ActivateOutputLinks(1017);
          break;
        case QuestTypes.GuildRaid:
          this.ActivateOutputLinks(1019);
          break;
        case QuestTypes.GvG:
    ...
    private QuestTypes GetQuestTypeAuto()
    {
      ...
      return this.m_TargetDataType == FlowNode_CheckSelectedQuestType.eDataType.GlobalVars_SelectedQuestID ? this.GetQuestType(MonoSingleton<GameManager>.Instance.FindQuest(GlobalVars.SelectedQuestID)) : QuestTypes.None;
    }

    private QuestTypes GetQuestType(QuestParam questParam)
    {
      return questParam == null ? QuestTypes.None : questParam.type;
    }
