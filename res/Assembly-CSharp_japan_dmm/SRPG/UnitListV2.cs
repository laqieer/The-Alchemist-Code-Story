...
namespace SRPG
{
  ...
  public class UnitListV2 : SRPG_FixedList, IFlowInterface, ISortableList
  {
    ...
    {
      get => this.mUseQuestInfo;
      set => this.mUseQuestInfo = value;
    }

    public int SelectedSlotIndex
    {
      set => this.mSelectedSlotIndex = value;
    }

    public bool IsHeroOnly
    {
      get => this.mIsHeroOnly;
      set => this.mIsHeroOnly = value;
    }
    ...
    protected virtual void Awake()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.PieceTemplate, (UnityEngine.Object) null) && this.PieceTemplate.activeInHierarchy)
        this.PieceTemplate.SetActive(false);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.SelectTemplate, (UnityEngine.Object) null) && this.SelectTemplate.activeInHierarchy)
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.RemoveTemplate, (UnityEngine.Object) null))
        ((Component) this.RemoveTemplate).gameObject.SetActive(false);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.SelectTowerTemplate, (UnityEngine.Object) null) && this.SelectTowerTemplate.activeInHierarchy)
      ...
      for (int index = 0; index < this.UnitToggle.Count; ++index)
      {
        ...
        UnitListV2.\u003CAwake\u003Ec__AnonStorey0 awakeCAnonStorey0 = new UnitListV2.\u003CAwake\u003Ec__AnonStorey0();
        // ISSUE: reference to a compiler-generated field
        awakeCAnonStorey0.\u0024this = this;
        if (!UnityEngine.Object.op_Equality((UnityEngine.Object) this.UnitToggle[index], (UnityEngine.Object) null))
        {
          // ISSUE: reference to a compiler-generated field
          awakeCAnonStorey0.index = index;
          // ISSUE: method pointer
          ((UnityEvent<bool>) this.UnitToggle[index].onValueChanged).AddListener(new UnityAction<bool>((object) awakeCAnonStorey0, __methodptr(\u003C\u003Em__0)));
        }
      }
    }
    ...
    protected override void Start()
    {
      ...
      {
        // ISSUE: method pointer
        ((UnityEvent) this.PieceButton.onClick).AddListener(new UnityAction((object) this, __methodptr(RefreshViewPieceList)));
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.SortButton, (UnityEngine.Object) null))
      {
        // ISSUE: method pointer
        ((UnityEvent) this.SortButton.onClick).AddListener(new UnityAction((object) this, __methodptr(OnUnitSortOpen)));
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.FilterButton, (UnityEngine.Object) null))
      {
        // ISSUE: method pointer
        ((UnityEvent) this.FilterButton.onClick).AddListener(new UnityAction((object) this, __methodptr(OnUnitFilterOpen)));
      }
      ...
      if (!string.IsNullOrEmpty(UnitListV2.UNIT_SORT_PATH))
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject1, (UnityEngine.Object) null))
        {
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject2, (UnityEngine.Object) null))
          {
            ...
            UnitPickerSort component = gameObject2.GetComponent<UnitPickerSort>();
      ...
      {
        GameObject gameObject3 = AssetManager.Load<GameObject>(UnitListV2.UNIT_FILTER_PATH);
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) gameObject3, (UnityEngine.Object) null))
        {
          ...
          {
            this.mFilterWindow = gameObject4;
            UnitPickerFilter component = gameObject4.GetComponent<UnitPickerFilter>();
            if (UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
            {
      ...
      if (this.ChosenUnitBadges != null && this.ChosenUnitBadges.Length > 0)
      {
        for (int index = 0; index < this.ChosenUnitBadges.Length; ++index)
        {
          ...
          {
            this.MoveToOrigin(((Component) this.ChosenUnitBadges[index]).gameObject);
            ((Component) this.ChosenUnitBadges[index]).gameObject.SetActive(false);
          }
        }
      }
      if (this.ChosenUnitBadgesTower != null && this.ChosenUnitBadgesTower.Length > 0)
      {
        for (int index = 0; index < this.ChosenUnitBadgesTower.Length; ++index)
        {
          ...
          {
            this.MoveToOrigin(((Component) this.ChosenUnitBadgesTower[index]).gameObject);
            ((Component) this.ChosenUnitBadgesTower[index]).gameObject.SetActive(false);
          }
        }
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.SelectableToggle, (UnityEngine.Object) null))
      {
        ...
        ((Component) this.SelectableToggle).gameObject.SetActive(false);
      }
      ...
      if (PlayerPrefsUtility.HasKey(this.MenuID + "#"))
      {
        ascending = PlayerPrefsUtility.GetInt(this.MenuID + "#") != 0;
      ...
      if (PlayerPrefsUtility.HasKey(key))
      {
        ...
        if (str != null)
        {
          if (str.IndexOf('|') != -1)
          {
            ...
            string[] filters3 = this.mUnitPickerFilter.GetFilters();
    ...
    protected override void Update()
    {
      ...
      if (!MonoSingleton<GameManager>.Instance.CheckBusyBadges(GameManager.BadgeTypes.Unit) && !MonoSingleton<GameManager>.Instance.CheckBusyBadges(GameManager.BadgeTypes.UnitUnlock))
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.UnitUnlockBadge, (UnityEngine.Object) null))
        {
          bool flag3 = MonoSingleton<GameManager>.Instance.CheckBadges(GameManager.BadgeTypes.UnitUnlock);
    ...
    private void OnSortModeChange(int index)
    {
      ...
      PlayerPrefsUtility.SetInt(PlayerPrefsUtility.UNITLIST_UNIT_SORT_MODE, (int) this.mUnitSortMode);
      this.RefreshData();
    }
    ...
    {
      return this.ItemType == UnitListV2.ItemTypes.PlayerUnits ? UnityEngine.Object.Instantiate<GameObject>(this.ItemTemplate) : UnityEngine.Object.Instantiate<GameObject>(this.PieceTemplate);
    }
    ...
    protected virtual void RefreshUnit(bool clear)
    {
      if (this.mSelectViewMode == UnitListV2.ViewMode.UNITLIST || this.mSelectViewMode == UnitListV2.ViewMode.PIECELIST)
      {
        ...
        List<UnitData> unitDataList = this.mUnitDatas == null || this.mUnitDatas.Count <= 0 ? MonoSingleton<GameManager>.Instance.Player.Units : new List<UnitData>((IEnumerable<UnitData>) this.mUnitDatas);
        List<UnitData> collection = new List<UnitData>();
        for (int index = 0; index < unitDataList.Count; ++index)
        {
          UnitData unitData = unitDataList[index];
          if (this.IncludeShujinko || !unitData.UnitParam.IsHero())
            collection.Add(unitData);
        }
        List<UnitData> units = new List<UnitData>((IEnumerable<UnitData>) collection);
        if (this.mUnitSortMode != GameUtility.UnitSortModes.Time)
        ...
        if (!string.IsNullOrEmpty(s))
        {
          ...
          if (lastselected_uniqueId > 0L && this.mSelectUnitUniqueID > 0L && lastselected_uniqueId != this.mSelectUnitUniqueID)
          {
            ...
            if (index >= 0)
              this.SetPageIndex(index / this.CellCount);
          }
      ...
      {
        List<UnitData> unitDataList1 = new List<UnitData>((IEnumerable<UnitData>) this.mUnitDatas);
        List<UnitData> unitDataList2 = new List<UnitData>();
        List<int> intList1 = new List<int>();
        bool mReverse = this.mReverse;
        if (this.mUnitSortMode != GameUtility.UnitSortModes.Time)
          GameUtility.SortUnits(unitDataList1, this.mUnitSortMode, mReverse, out this.mSortValues, true);
        else
          this.mSortValues = (int[]) null;
        int num = 0;
        ...
        for (int i = 0; i < this.mCurrentParty.PartyData.MAX_UNIT; ++i)
        {
          ...
          {
            unitDataList2.Add(unitDataList1.Find((Predicate<UnitData>) (v => v.UniqueID == this.mCurrentParty.Units[i].UniqueID)));
        ...
        if (this.mSortValues != null && this.mSortValues.Length > 0)
          sortValues = new List<int>((IEnumerable<int>) this.mSortValues);
        UnitListV2.FilterUnits(unitDataList1, sortValues, this.mUnitFilter);
        if (sortValues != null)
          this.mSortValues = sortValues.ToArray();
        if (mReverse)
        {
          unitDataList1.Reverse();
          if (this.mSortValues != null)
            Array.Reverse((Array) this.mSortValues);
        }
        List<UnitData> collection1 = new List<UnitData>();
        if (this.SelectableToggle.isOn)
        {
          if (this.UseQuestInfo)
          {
            ...
            for (int index = 0; index < unitDataList1.Count; ++index)
            {
              ...
              if (this.mCurrentQuest.IsEntryQuestCondition(unitDataList1[index], ref empty))
              {
                collection1.Add(unitDataList1[index]);
                if (this.mSortValues != null && this.mSortValues.Length > index)
                  collection2.Add(this.mSortValues[index]);
              }
            }
            if (collection2 != null && collection2.Count > 0)
              intList1.AddRange((IEnumerable<int>) collection2);
          }
        }
        else
        {
          collection1.AddRange((IEnumerable<UnitData>) unitDataList1);
          if (this.mSortValues != null)
            intList1.AddRange((IEnumerable<int>) this.mSortValues);
        }
        unitDataList2.AddRange((IEnumerable<UnitData>) collection1);
        if (this.mSortValues != null && intList1 != null)
          this.mSortValues = intList1.ToArray();
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.NoMatchingUnit, (UnityEngine.Object) null))
          this.NoMatchingUnit.SetActive(unitDataList2.Count <= 0);
        this.SetData((object[]) unitDataList2.ToArray(), typeof (UnitData));
      }
    }
    ...
    public void SetViewMode(UnitListV2.ViewMode value) => this.mSelectViewMode = value;

    public void UpdateViewMode() => this.UpdateViewMode(this.mSelectViewMode);
    ...
    public void UpdateViewMode(UnitListV2.ViewMode mode)
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.CloseButton, (UnityEngine.Object) null))
        ((Component) this.CloseButton).gameObject.SetActive(mode != UnitListV2.ViewMode.UNITLIST);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.SelectableToggle, (UnityEngine.Object) null))
        ((Component) this.SelectableToggle).gameObject.SetActive(mode == UnitListV2.ViewMode.SELECTLIST || mode == UnitListV2.ViewMode.TOWERSELECTLIST);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.SortButton, (UnityEngine.Object) null))
        ((Component) this.SortButton).gameObject.SetActive(mode != UnitListV2.ViewMode.PIECELIST);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.FilterButton, (UnityEngine.Object) null))
        ((Component) this.FilterButton).gameObject.SetActive(mode != UnitListV2.ViewMode.PIECELIST);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.PieceButton, (UnityEngine.Object) null))
        ((Component) this.PieceButton).gameObject.SetActive(mode == UnitListV2.ViewMode.UNITLIST);
      ...
      if (mode == UnitListV2.ViewMode.SELECTLIST)
        gameObject = ((Component) this.RemoveTemplate).gameObject;
      if (mode == UnitListV2.ViewMode.TOWERSELECTLIST)
        gameObject = ((Component) this.RemoveTowerTemplate).gameObject;
    ...
    private void RefreshViewPieceList()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.CloseButton, (UnityEngine.Object) null) && ((UnityEventBase) this.CloseButton.onClick).GetPersistentEventCount() <= 0)
      {
        // ISSUE: method pointer
        ((UnityEvent) this.CloseButton.onClick).AddListener(new UnityAction((object) this, __methodptr(RefreshViewUnitList)));
      }
      this.Page = 0;
      this.RefreshData();
    }
    ...
    private void RefreshViewSelectList() => this.UpdateViewMode(UnitListV2.ViewMode.SELECTLIST);
            ...
            if (dataOfClass != null)
            {
              for (int index3 = 0; index3 < this.mCurrentParty.Units.Length; ++index3)
              {
                if (this.mCurrentParty.Units[index3] != null && this.mCurrentParty.Units[index3].UniqueID == dataOfClass.UniqueID)
                {
                  ...
                  {
                    if (UnityEngine.Object.op_Inequality((UnityEngine.Object) ((Transform) rectTransform1).parent, (UnityEngine.Object) component))
                    {
                      ...
                      ((Component) rectTransform1).gameObject.SetActive(true);
                    }
                    if (index3 == 0)
                      ((Component) rectTransform1).gameObject.SetActive(this.mPage <= 0 && !this.mIsHeroOnly && (this.mSelectViewMode == UnitListV2.ViewMode.SELECTLIST || this.mSelectViewMode == UnitListV2.ViewMode.TOWERSELECTLIST));
                  }
                }
              }
    ...
    public void SetQuestData(QuestParam quest) => this.mCurrentQuest = quest;
    ...
    public void OnRemoveUnitSelect(SRPG_Button button)
    {
      ...
      ((Component) this).GetComponent<WindowController>().Close();
    }

    private void OnValueChanged(bool value) => this.RefreshData();
    ...
    public string GetFilterInfo()
    {
      ...
      return strArray == null || strArray.Length <= 0 ? string.Empty : string.Join("|", strArray);
    }
