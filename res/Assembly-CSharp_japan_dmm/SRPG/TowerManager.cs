...
namespace SRPG
{
  ...
  public class TowerManager : MonoBehaviour, IFlowInterface
  {
    ...
    private IEnumerator CheckLoadIcon()
    {
      ...
      return (IEnumerator) new TowerManager.\u003CCheckLoadIcon\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    private void OnScrollBegin()
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ChallengeButton, (UnityEngine.Object) null))
        ((Selectable) this.ChallengeButton).interactable = false;
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.MissionButton, (UnityEngine.Object) null))
        return;
      ((Selectable) this.MissionButton).interactable = false;
    }
    ...
    private void AddClickListener(Button button, Action clickListener)
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) button, (UnityEngine.Object) null))
        return;
      // ISSUE: method pointer
      ((UnityEvent) button.onClick).AddListener(new UnityAction((object) clickListener, __methodptr(Invoke)));
    }
    ...
    private void RemoveClickListener(Button button, Action clickListener)
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) button, (UnityEngine.Object) null))
        return;
      // ISSUE: method pointer
      ((UnityEvent) button.onClick).RemoveListener(new UnityAction((object) clickListener, __methodptr(Invoke)));
    }
    ...
    private void OnClick_RecoverButton()
    {
      ...
      else
      {
        ...
        string text = LocalizedText.Get("sys.MSG_TOWER_RECOVER", (object) cost);
        this.mConfirmBox = UIUtility.ConfirmBoxTitle(string.Empty, text, (UIUtility.DialogResultEvent) (go =>
        {
          ((Selectable) this.RecoverButton).interactable = false;
          this.mConfirmBox = (GameObject) null;
          cost = MonoSingleton<GameManager>.Instance.TowerResuponse.CalcRecoverCost();
          DataSource.Bind<TowerRecoverData>(((Component) this).gameObject, new TowerRecoverData(GlobalVars.SelectedTowerID, cost));
    ...
    private void OnClick_Current() => this.mTowerQuestList.ScrollToCurrentFloor();
    ...
    private void OnClick_Reset()
    {
      ...
      {
        this.SetCanvasGroupIntaractable(false);
        this.mConfirmBox = UIUtility.ConfirmBox(LocalizedText.Get("sys.TOWER_RESET_CHECK", (object) resetCost), (UIUtility.DialogResultEvent) (go =>
        {
          ((Selectable) this.RecoverButton).interactable = false;
          ((Selectable) this.ResetButton).interactable = false;
          this.mConfirmBox = (GameObject) null;
    ...
    private void RefreshUI()
    {
      ...
      {
        DataSource.Bind<QuestParam>(((Component) this.ChallengeButton).gameObject, quest);
        ((Selectable) this.ChallengeButton).interactable = quest.IsQuestCondition() && quest.state != QuestStates.Cleared;
        GameParameter.UpdateAll(((Component) this.ChallengeButton).gameObject);
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.RecoverButton, (UnityEngine.Object) null))
      {
        ...
        ((Selectable) this.RecoverButton).interactable = flag && !towerResuponse.is_reset;
      ...
      {
        TowerResuponse towerResuponse = MonoSingleton<GameManager>.Instance.TowerResuponse;
        ((Component) this.ResetButton).gameObject.SetActive(towerResuponse.is_reset);
        ((Selectable) this.ResetButton).interactable = towerResuponse.is_reset;
        ((Component) this.ChallengeButton).gameObject.SetActive(!towerResuponse.is_reset);
        this.ResetText.text = towerResuponse.reset_cost.ToString();
        bool flag = towerResuponse.reset_cost == (short) 0;
        ((Component) this.ResetText).gameObject.SetActive(!flag);
        ((Component) this.ResetTextFree).gameObject.SetActive(flag);
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.MissionButton, (UnityEngine.Object) null))
        ((Selectable) this.MissionButton).interactable = true;
    ...
    private void SetRecoverText()
    {
      ...
      {
        bool flag = num == 0;
        ((Component) this.RecoverCost).gameObject.SetActive(!flag);
        ((Component) this.RecoverCostFree).gameObject.SetActive(flag);
        if (num > 0)
      ...
      TimeSpan timeSpan = TimeManager.FromUnixTime(this.mRecoverTime).AddMinutes(-1.0) - serverTime;
