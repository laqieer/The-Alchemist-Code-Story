...
namespace SRPG
{
  ...
  public class TowerQuestResult : QuestResult
  {
    ...
    public override void Activated(int pinID)
    {
      ...
      if (pinID == 11)
      {
        if (this.ResultFlags_IsOn(TowerQuestResult.eTowerResultFlags.ShowRank))
        {
          ...
          ((Component) this.TowerClear).gameObject.SetActive(true);
        }
        else
    ...
    public void EndTowerClear() => FlowNode_GameObject.ActivateOutputLinks((Component) this, 32);

    [DebuggerHidden]
    private IEnumerator RecvHealAnimation()
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TowerQuestResult.\u003CRecvHealAnimation\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    public override void CreateItemObject(List<QuestResult.DropItemData> items, Transform parent)
    {
      ...
      for (int index = 0; index < towerRewardItem.Count; ++index)
      {
        ...
        if (reward != null && !reward.IsDisableReward)
        {
          ...
          {
            if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Prefab_NewItemBadge, (UnityEngine.Object) null) && reward.is_new)
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.TowerTreasureListItem, (UnityEngine.Object) null))
        return (GameObject) null;
      GameObject rewardObject = UnityEngine.Object.Instantiate<GameObject>(this.TowerTreasureListItem, this.TowerTreasureListItem.transform.parent, false);
      ...
      for (int i = 0; i < this.mHpBar.Count; ++i)
      {
        ...
        if (unit != null && MonoSingleton<GameManager>.Instance.Player.FindUnitDataByUniqueID(unit.UnitData.UniqueID) != null)
        {
          ...
          if (playerUnit != null && playerUnit.isDied)
            ((Component) this.mUnitListItems[i].transform.GetChild(0)).gameObject.GetComponent<CanvasGroup>().alpha = this.DeadAlpha;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TowerQuestResult.\u003CAddExp\u003Ec__Iterator1()
      {
        \u0024this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TowerQuestResult.\u003CPlayAnimationAsync\u003Ec__Iterator2()
      {
        \u0024this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TowerQuestResult.\u003CStartTowerTreasureAnimation\u003Ec__Iterator3()
      {
        \u0024this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TowerQuestResult.\u003CTowerTreasureAnimation\u003Ec__Iterator4()
      {
        ListItems = ListItems,
        \u0024this = this
      };
    ...
    public void OnTowerItemAnimationEnd() => this.mContinueTowerItemAnimation = true;

    public void OnTowerItemEnd() => this.mContinueTowerItem = true;
