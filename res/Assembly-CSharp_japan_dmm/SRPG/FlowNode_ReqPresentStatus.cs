...
namespace SRPG
{
  ...
  public class FlowNode_ReqPresentStatus : FlowNode_Network
  {
    ...
    public class ApiBase
    {
      ...
      public ApiBase(FlowNode_ReqPresentStatus node) => this.m_Node = node;
    ...
    public class Api_PresentListStatus : FlowNode_ReqPresentStatus.ApiBase
    {
      ...
      public override string url => "present";
      ...
      public override void Complete(WWWResult www)
      {
        ...
        else
        {
          ...
          WebAPI.JSON_BodyResponse<FlowNode_ReqPresentStatus.Api_PresentListStatus.Json> jsonBodyResponse = JsonUtility.FromJson<WebAPI.JSON_BodyResponse<FlowNode_ReqPresentStatus.Api_PresentListStatus.Json>>(www.text);
