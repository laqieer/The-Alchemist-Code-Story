...
namespace SRPG
{
  ...
  public class EventAction_Dialog : EventAction
  {
    ...
    public override IEnumerator PreloadAssets()
    {
      ...
      return (IEnumerator) new EventAction_Dialog.\u003CPreloadAssets\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    public override string[] GetUnManagedAssetListData()
    {
      if (!string.IsNullOrEmpty(this.TextID))
      {
        this.LoadTextData();
        if (!string.IsNullOrEmpty(this.mVoiceID))
          return EventAction.GetUnManagedStreamAssets(EventAction_Dialog.GetIDPair(this.mVoiceID));
      }
      return (string[]) null;
    }
