...
namespace SRPG
{
  ...
  public class GuildCommand : MonoBehaviour, IFlowInterface
  {
    ...
    public static GuildCommand Instance => GuildCommand.mInstance;

    public GuildData TempGuild => this.mTempGuild;

    public GuildMemberData TargetMember => this.mTargetMember;

    public GuildMemberData.eRole TargetRole => this.mTargetRole;

    public GuildCommand.RecommendSearchConditions SearchConditions => this.mSearchConditions;
    ...
    private GuildEmblemParam[] HaveEmblemParams
    {
      get
      {
        if (this.mHaveEmblemParams == null)
        {
          ...
          guildEmblemParamList.RemoveAll((Predicate<GuildEmblemParam>) (t => !have.Contains(t.Iname) && t.ConditionsType > 0));
    ...
    public GuildEmblemParam SelectedEmblem => this.mSelectedEmblem;
    ...
    private void Update()
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mSubmit_EditGuildNameButton, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mInputGuildName, (UnityEngine.Object) null))
        ((Selectable) this.mSubmit_EditGuildNameButton).interactable = !string.IsNullOrEmpty(this.mInputGuildName.text) && this.mTempGuild.Name != this.mInputGuildName.text;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mSubmit_EditGuildEmblemButton, (UnityEngine.Object) null) && this.mTempGuild != null)
        ((Selectable) this.mSubmit_EditGuildEmblemButton).interactable = this.mSelectedEmblem.Image != this.mTempGuild.Emblem;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mSubmit_EditGuildBoardButton, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mInputGuildBoard, (UnityEngine.Object) null))
        ((Selectable) this.mSubmit_EditGuildBoardButton).interactable = !string.IsNullOrEmpty(this.mInputGuildBoard.text);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mSubmit_EntryInviteButton, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mInputEntryInviteMessage, (UnityEngine.Object) null))
        ((Selectable) this.mSubmit_EntryInviteButton).interactable = !string.IsNullOrEmpty(this.mInputEntryInviteMessage.text);
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mSubmit_EditInviteMessageButton, (UnityEngine.Object) null) || !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mInputInviteMessage, (UnityEngine.Object) null))
        return;
      ((Selectable) this.mSubmit_EditInviteMessageButton).interactable = !string.IsNullOrEmpty(this.mInputInviteMessage.text);
    }

    public static void SetCommand(GameObject svb_obj, GuildCommand.eCommand command)
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) svb_obj, (UnityEngine.Object) null))
        return;
    ...
    private GuildCommand.eCommand GetCommand()
    {
      ...
      return UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null) ? component.list.GetObject<GuildCommand.eCommand>(GuildSVB_Key.COMMNAD, GuildCommand.eCommand.NONE) : GuildCommand.eCommand.NONE;
    }

    private GuildData GetGuildData()
    {
      SerializeValueBehaviour component = ((Component) this).GetComponent<SerializeValueBehaviour>();
      return UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null) ? component.list.GetObject<GuildData>(GuildSVB_Key.GUILD, (GuildData) null) : (GuildData) null;
    }
    ...
    private void SetupUI(GuildData data)
    {
      ...
      this.mSelectedEmblem = Array.Find<GuildEmblemParam>(this.HaveEmblemParams, (Predicate<GuildEmblemParam>) (e => e.Image == data.Emblem));
      if (this.mSelectedEmblem == null)
        this.mSelectedEmblem = this.HaveEmblemParams[0];
      this.RefreshSendTargetChannel();
      bool isAutoApproval = data.EntryConditions.IsAutoApproval;
      GameUtility.SetGameObjectActive(this.mAutoApprovalOn, isAutoApproval);
      GameUtility.SetGameObjectActive(this.mAutoApprovalOff, !isAutoApproval);
    ...
    private void SetupTempGuildByUI()
    {
      ...
      this.mTempGuild.EntryConditions.IsAutoApproval = this.mAutoApprovalOn.activeSelf;
      this.mTempGuild.EntryConditions.Policy = this.mEntryPolicyPulldown.Selection;
    ...
    public void ResetTempGuild() => this.mTempGuild = GuildData.Clone(this.GetGuildData());
      ...
      GuildCommand.RecommendSearchConditions.AutoApproval auto_approval)
    {
      ...
      {
        pulldown.AddItem(LocalizedText.Get("sys." + dictionary[(GuildCommand.RecommendSearchConditions.AutoApproval) key]), key);
        if (auto_approval == (GuildCommand.RecommendSearchConditions.AutoApproval) key)
          pulldown.Selection = key;
      }
    }
      ...
      eGuildSearchFilterTypes ftype)
    {
      ...
      pulldown.ClearItems();
      pulldown.Selection = -1;
      GuildSearchFilterParam guildSearchFilter = MonoSingleton<GameManager>.Instance.MasterParam.FindGuildSearchFilter(ftype);
      ...
      for (int index = 0; index < condtions.Length; ++index)
      {
        ...
        if (filterConditionParam != null)
        {
          ...
          switch (ftype)
          {
            case eGuildSearchFilterTypes.Policy:
              if (filterConditionParam.sval == svalue)
              {
                num1 = index;
                break;
              }
              break;
            case eGuildSearchFilterTypes.PortMemberCount:
            case eGuildSearchFilterTypes.PortShopLv:
              if (filterConditionParam.sval_min == svalue)
              {
                num1 = index;
                break;
              }
          ...
          pulldown.AddItem(filterConditionParam.name, num2);
        }
      }
      pulldown.Selection = num1;
    }
    ...
    private void Guild_EditGuildName()
    {
      ...
      DataSource.Bind<GuildData>(this.mGuildEditName, this.mTempGuild);
    ...
    private void Guild_ConfirmUseCoin()
    {
      ...
      this.mConfirmBox = UIUtility.ConfirmBox(text, new UIUtility.DialogResultEvent(this.ConfrimNext), new UIUtility.DialogResultEvent(this.ConfrimBack));
    }

    private void ConfrimNext(GameObject obj) => this.Next();

    private void ConfrimBack(GameObject obj) => this.Back();
    ...
    private void RefreshSelectGuildEmblemList()
    {
      ...
      for (int index = 0; index < this.mGuildEmblemItems.Count; ++index)
      {
        DataSource.Bind<GuildEmblemParam>(this.mGuildEmblemItems[index], this.HaveEmblemParams[index]);
    ...
    private void Guild_EditBoard()
    {
      ...
      DataSource.Bind<GuildData>(this.mGuildEditBoard, this.mTempGuild);
    ...
    private void Guild_EditEntryConditions()
    {
      ...
      this.SetupPulldown(this.mEntryPolicyPulldown, this.mTempGuild.EntryConditions.Policy, eGuildSearchFilterTypes.Policy);
      DataSource.Bind<GuildData>(this.mGuildEditEntryConditions, this.mTempGuild);
    ...
    private void Guild_EntryInvite()
    {
      ...
      DataSource.Bind<GuildData>(this.mGuildEntryInvite, this.mTempGuild);
    ...
    {
      if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.mTargetChannelObject, (UnityEngine.Object) null))
        return;
    ...
    {
      if (conditions == null)
        Network.RequestAPI((WebAPI) new ReqGuildRecommendList(new Network.ResponseCallback(this.RequestRecommendListCallback)));
      else
        Network.RequestAPI((WebAPI) new ReqGuildSearch(conditions.guild_id, conditions.guild_name, (int) conditions.auto_approval, conditions.player_lv, conditions.guild_lv_from, conditions.guild_lv_to, conditions.guild_policy, conditions.guild_member_num_from, conditions.guild_member_num_to, conditions.guild_shop_lv_from, conditions.guild_shop_lv_to, new Network.ResponseCallback(this.RequestRecommendListCallback)));
    }
    ...
    private void OpenRecommendListSearch()
    {
      ...
      this.mPulldown_SearchConditionsMemberCount.ClosePulldown(false);
      this.mPulldown_SearchConditionsPolicy.ClosePulldown(false);
      ...
      this.SetupPulldown(this.mPulldown_SearchConditionsPolicy, this.mSearchConditions.guild_policy, eGuildSearchFilterTypes.Policy);
      this.SetupPulldown(this.mPulldown_SearchConditionsMemberCount, this.mSearchConditions.guild_member_num_from, eGuildSearchFilterTypes.PortMemberCount);
      this.SetupPulldown(this.mPulldown_SearchConditionsGuildShopLv, this.mSearchConditions.guild_shop_lv_from, eGuildSearchFilterTypes.PortShopLv);
    ...
    public void SubmitRecommendListSearch()
    {
      ...
      this.mSearchConditions.guild_policy = MonoSingleton<GameManager>.Instance.MasterParam.FindGuildSearchFilter(eGuildSearchFilterTypes.Policy).condtions[this.mPulldown_SearchConditionsPolicy.Selection].sval;
      GuildSearchFilterConditionParam condtion1 = MonoSingleton<GameManager>.Instance.MasterParam.FindGuildSearchFilter(eGuildSearchFilterTypes.PortMemberCount).condtions[this.mPulldown_SearchConditionsMemberCount.Selection];
      this.mSearchConditions.guild_member_num_from = condtion1.sval_min;
      this.mSearchConditions.guild_member_num_to = condtion1.sval_max;
      GuildSearchFilterConditionParam condtion2 = MonoSingleton<GameManager>.Instance.MasterParam.FindGuildSearchFilter(eGuildSearchFilterTypes.PortShopLv).condtions[this.mPulldown_SearchConditionsGuildShopLv.Selection];
      this.mSearchConditions.guild_shop_lv_from = condtion2.sval_min;
      this.mSearchConditions.guild_shop_lv_to = condtion2.sval_max;
      this.RefreshRecommendList(this.mSearchConditions);
      this.mGuildRecommendListSearch.SetActive(false);
    }

    public void CancelRecommendListSearch() => this.mGuildRecommendListSearch.SetActive(false);
    ...
    private void Guild_EditInviteMessage()
    {
      ...
      DataSource.Bind<GuildData>(this.mGuildEditInviteMessage, this.mTempGuild);
    ...
    private void Guild_ChangeRole()
    {
      ...
      this.mCommandErrorCheck = (GuildCommand.CommandErrorCheckProc) null;
      DataSource.Bind<GuildData>(this.mGuildChangeRole, this.mTempGuild);
    ...
    private void RefreshChangeRoleUI()
    {
      ...
      if (MonoSingleton<GameManager>.Instance.Player.PlayerGuild.IsSubGuildMaster)
        ((Component) this.mChangeRoleToggle_Mastar).gameObject.SetActive(false);
    ...
    private bool ErrorCheck_GuildName() => this.IsExistNGWord(this.mInputGuildName.text);

    private bool ErrorCheck_EditBoard() => this.IsExistNGWord(this.mInputGuildBoard.text);

    private bool ErrorCheck_EntryInvite() => this.IsExistNGWord(this.mInputEntryInviteMessage.text);
    ...
    private void CommandEnd()
    {
      switch (this.mCurrentMode)
      {
        ...
        case GuildCommand.eMode.INVITE:
          if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) MonoSingleton<ChatWindow>.Instance, (UnityEngine.Object) null) || !UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mInputEntryInviteMessage, (UnityEngine.Object) null) || string.IsNullOrEmpty(this.mInputEntryInviteMessage.text))
            break;
        ...
        case GuildCommand.eMode.CHANGE_ROLE:
          ...
          if (this.mTargetRole == GuildMemberData.eRole.MASTAER)
          {
            if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mConfirmBox, (UnityEngine.Object) null))
              break;
            this.mConfirmBox = UIUtility.ConfirmBox(LocalizedText.Get("sys.GUILD_CHANGE_ROLE_MASTER_CAUTION"), new UIUtility.DialogResultEvent(this.RequestChangeRole), (UIUtility.DialogResultEvent) null);
            break;
          }
    ...
    private void Close() => UnityEngine.Object.Destroy((UnityEngine.Object) ((Component) this).gameObject);
    ...
    public void OnSelectGuildEmblem(GameObject obj) => this.SelectEmblem(obj);

    public void OnRequestEntry(GameObject obj)
    {
      GuildData dataOfClass = DataSource.FindDataOfClass<GuildData>(obj, (GuildData) null);
      SerializeValueBehaviour component = ((Component) this).GetComponent<SerializeValueBehaviour>();
      if (dataOfClass != null && UnityEngine.Object.op_Inequality((UnityEngine.Object) component, (UnityEngine.Object) null))
      {
    ...
    private void RequestRecommendListCallback(WWWResult www)
    {
      ...
      else
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mRecommendGuildParent, (UnityEngine.Object) null) && UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mRecommendGuildTemplate, (UnityEngine.Object) null))
        {
          if (guildDataArray != null)
          {
            for (int index = 0; index < guildDataArray.Length; ++index)
            {
              ...
              DataSource.Bind<GuildData>(gameObject, guildDataArray[index]);
              gameObject.SetActive(true);
            }
          }
    ...
    public class RecommendSearchConditions
    {
      ...
      public RecommendSearchConditions()
      {
        ...
        this.guild_policy = 0;
        this.guild_member_num_from = 0;
        this.guild_member_num_to = 0;
        this.guild_shop_lv_from = 0;
        this.guild_shop_lv_to = 0;
      }
