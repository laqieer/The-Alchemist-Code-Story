...
namespace SRPG
{
  public static class AssetPath
  {
    ...
    private static string GetJobResourceID(JobParam job)
    {
      ...
      return !string.IsNullOrEmpty(job.ac2d) ? job.ac2d : job.model;
    }
    ...
    public static string UnitImage(string unit)
    {
      AssetPath.mSB.Length = 0;
      AssetPath.mSB.Append("UnitImages/");
      AssetPath.mSB.Append(unit);
      return AssetPath.mSB.ToString();
    }
    ...
    public static string JobIconThumbnail() => "JobIcon/small";
    ...
    public static string SkillEffect(SkillParam skill, string effect_name = null)
    {
      AssetPath.mSB.Length = 0;
    ...
    public static string SkillEffect(string skill_effect_path)
    {
      AssetPath.mSB.Length = 0;
      AssetPath.mSB.Append("SkillEff/");
      AssetPath.mSB.Append(skill_effect_path);
      return AssetPath.mSB.ToString();
    }
    ...
    public static string ConceptCard(string path)
    {
      AssetPath.mSB.Length = 0;
      AssetPath.mSB.Append("ConceptCard/");
      AssetPath.mSB.Append(path);
      return AssetPath.mSB.ToString();
    }

    public static string Highlight(string path)
    {
      AssetPath.mSB.Length = 0;
      AssetPath.mSB.Append("Highlight/");
      AssetPath.mSB.Append(path);
      return AssetPath.mSB.ToString();
    }
  }
