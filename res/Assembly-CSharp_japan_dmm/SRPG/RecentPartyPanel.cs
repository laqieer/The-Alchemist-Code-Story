...
namespace SRPG
{
  public class RecentPartyPanel : MonoBehaviour
  {
    ...
    private void CreateSlots()
    {
      ...
      this.allUnitButtons = ((IEnumerable<GenericSlot>) this.UnitSlots).Select<GenericSlot, SRPG_Button>((Func<GenericSlot, SRPG_Button>) (slot => ((Component) slot).GetComponent<SRPG_Button>())).Where<SRPG_Button>((Func<SRPG_Button, bool>) (button => UnityEngine.Object.op_Inequality((UnityEngine.Object) button, (UnityEngine.Object) null))).ToList<SRPG_Button>();
      this.allUnitButtons.Add(((Component) this.FriendSlot).GetComponent<SRPG_Button>());
    }
