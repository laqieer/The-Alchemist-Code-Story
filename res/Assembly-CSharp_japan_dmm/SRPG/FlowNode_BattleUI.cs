...
namespace SRPG
{
  ...
  public class FlowNode_BattleUI : FlowNodePersistent
  {
    ...
    {
      get => this.UpdateReference<VirtualStick2>(ref this.mVirtualStick, this.VirtualStickID);
    }

    public UnitAbilitySkillList SkillWindow
    {
      get => this.UpdateReference<UnitAbilitySkillList>(ref this.mSkillListRef, this.SkillListID);
    }

    public UnitCommands CommandWindow
    {
      get => this.UpdateReference<UnitCommands>(ref this.mCommandWindow, this.CommandObjectID);
    }

    public BattleInventory ItemWindow
    {
      get => this.UpdateReference<BattleInventory>(ref this.mItemWindow, this.ItemListID);
    }

    public BattleUnitChg UnitChgWindow
    {
      get => this.UpdateReference<BattleUnitChg>(ref this.mUnitChgWindow, this.UnitChgListID);
    }

    private void Output(int pinID) => this.ActivateOutputLinks(pinID);
    ...
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.QuestStart_Raid);
    }

    public void OnQuestStart_GuildRaidMock()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.QuestStart_GuildRaidMock);
    }

    public void OnQuestStart_GenesisBoss()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.QuestStart_GenesisBoss);
    }

    public void OnQuestStart_AdvanceBoss()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.QuestStart_AdvanceBoss);
    }
    ...
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.QuestWin_GenesisBoss);
    }

    public void OnAdvanceBossWin()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.QuestWin_AdvanceBoss);
    }

    public void OnWorldRaidLose()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.QuestLose_WorldRaid);
    }
    ...
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.Result_Raid);
    }

    public void OnResult_GenesisBoss()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.Result_GenesisBoss);
    }

    public void OnResult_AdvanceBoss()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.Result_AdvanceBoss);
    }

    public void OnResult_GuildRaid()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.Result_GuildRaid);
    }

    public void OnResult_GvG()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.Result_GvG);
    }

    public void OnResult_WorldRaid()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.Result_WorldRaid);
    }
    ...
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.AutoBattleToggle);
    }

    public void OnBattleSpeedToggle()
    {
      FlowNode_TriggerLocalEvent.TriggerLocalEvent((Component) this, this.BattleSpeedToggle);
    }

    public void OnMapStart() => this.Output(1005);

    public void OnMapEnd() => this.Output(1006);

    public void OnUnitStart() => this.Output(1060);

    public void OnCastSkillStart() => this.Output(1070);

    public void OnCommandSelectStart() => this.Output(1010);

    public void OnCommandSelect() => this.Output(1020);

    public void OnInputMoveStart() => this.Output(1040);

    public void OnInputMoveEnd() => this.Output(1041);

    public void OnMapModeStart() => this.Output(1050);

    public void OnThrowTargetSelectStart() => this.Output(1035);

    public void OnThrowTargetSelectEnd() => this.Output(1036);

    public void OnTargetSelectStart() => this.Output(1030);

    public void OnTargetSelectEnd() => this.Output(1032);

    public void OnMainTargetSelect() => this.Output(1100);

    public void OnMainTargetDeselect() => this.Output(1101);

    public void OnSubTargetSelect() => this.Output(1110);

    public void OnSubTargetDeselect() => this.Output(1111);
    ...
    public void OnSkillSelectStart() => this.Output(1300);

    public void OnSkillSelectEnd() => this.Output(1301);

    public void OnItemSelectStart() => this.Output(1400);

    public void OnItemSelectEnd() => this.Output(1401);

    public void OnInputTimeLimit() => this.Output(1500);

    public void OnDisconnected() => this.Output(1502);

    public void OnBan() => this.Output(1501);

    public void OnSequenceError() => this.Output(1503);

    public void OnGridEventSelectStart() => this.Output(1600);

    public void OnGridEventSelectEnd() => this.Output(1601);

    public void OnBattleStart() => this.Output(2000);

    public void OnBattleEnd() => this.Output(2001);
    ...
    public void OnUnitChgSelectStart() => this.Output(7100);

    public void OnUnitChgSelectEnd() => this.Output(7101);

    public void OnUnitChgConfirmStart() => this.Output(7102);

    public void OnUnitChgConfirmEnd() => this.Output(7103);

    private void Start()
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Prefab_TargetMain, (UnityEngine.Object) null))
      {
        this.TargetMain = UnityEngine.Object.Instantiate<TargetPlate>(this.Prefab_TargetMain);
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.AttachTargetPanel, (UnityEngine.Object) null))
          ((Component) this.TargetMain).transform.SetParent(((Component) this).transform, false);
        else
          ((Component) this.TargetMain).transform.SetParent(this.AttachTargetPanel.transform, false);
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Prefab_TargetSub, (UnityEngine.Object) null))
      {
        this.TargetSub = UnityEngine.Object.Instantiate<TargetPlate>(this.Prefab_TargetSub);
        ((Component) this.TargetSub).transform.SetParent(((Component) this).transform, false);
      }
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Prefab_ObjectTarget, (UnityEngine.Object) null))
      {
        this.TargetObjectSub = UnityEngine.Object.Instantiate<TargetPlate>(this.Prefab_ObjectTarget);
        ((Component) this.TargetObjectSub).transform.SetParent(((Component) this).transform, false);
      }
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Prefab_TrickTarget, (UnityEngine.Object) null))
        return;
      this.TargetTrickSub = UnityEngine.Object.Instantiate<TargetPlate>(this.Prefab_TrickTarget);
      ((Component) this.TargetTrickSub).transform.SetParent(((Component) this).transform, false);
    }
    ...
    public void OnFirstContact() => this.Output(1550);
    ...
    public bool IsNeedFlip()
    {
      if (!this.IsEnableTrick)
        return false;
      return this.IsEnableUnit || this.IsEnableGimmick;
    }
  }
}
