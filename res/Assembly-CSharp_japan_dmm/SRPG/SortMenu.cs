  ...
  public class SortMenu : MonoBehaviour, IFlowInterface
  {
    ...
    public string CurrentCaption
    {
      get
      {
        for (int index = 0; index < this.Items.Length; ++index)
        {
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Items[index].Toggle, (UnityEngine.Object) null) && this.Items[index].Toggle.isOn)
    ...
    {
      get => UnityEngine.Object.op_Inequality((UnityEngine.Object) this.Ascending, (UnityEngine.Object) null) && !this.Ascending.isOn;
      set
      {
