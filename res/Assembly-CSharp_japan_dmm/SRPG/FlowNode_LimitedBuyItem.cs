        ...
        else
        {
          ...
          switch (shopitem.saleType)
          {
            ...
            case ESaleType.EventCoin:
              if (!this.CheckCanBuy(shopitem, buy, player.EventCoinNum(shopitem.cost_iname), 114))
                return;
              break;
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (shopParam != null)
              MonoSingleton<GameManager>.Instance.Player.OnBuyAtShop(shopParam.iname, limitedShopItem.iname, limitedShopItem.num);
            this.Success();
          }
        }
      }
