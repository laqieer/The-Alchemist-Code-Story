...
namespace SRPG
{
  public class GachaManager : MonoSingleton<GachaManager>
  {
    ...
    public GachaTopParam2[] GachaListRare => this.mGachaListRare.ToArray();

    public GachaTopParam2[] GachaListNormal => this.mGachaListNormal.ToArray();

    public GachaTopParam2[] GachaListTicket => this.mGachaListTicket.ToArray();

    public GachaTopParam2[] GachaListArtifact => this.mGachaListArtifact.ToArray();

    public GachaTopParam2[] GachaListSpecial => this.mGachaListSpecial.ToArray();

    public int UseTicketNum
    {
      get => this.mUseTicketNum;
      set => this.mUseTicketNum = value;
    }

    public string UseTicketIname
    {
      get => this.mUseTicketIname;
      set => this.mUseTicketIname = value;
    }

    public int CurrentGachaIndex
    {
      get => this.mCurrentGachaIndex;
      set => this.mCurrentGachaIndex = value;
    }

    public GachaTopParam GetCurrentGacha() => this.GachaList[this.CurrentGachaIndex];
    ...
    private IEnumerator ShiftGachaAsync(int index)
    {
      ...
      return (IEnumerator) new GachaManager.\u003CShiftGachaAsync\u003Ec__Iterator0()
      {
        index = index,
        \u0024this = this
      };
