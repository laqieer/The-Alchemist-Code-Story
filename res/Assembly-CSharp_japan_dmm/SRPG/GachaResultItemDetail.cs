...
namespace SRPG
{
  ...
  public class GachaResultItemDetail : MonoBehaviour, IFlowInterface
  {
    ...
    private void Start()
    {
      ...
      ((UnityEvent) this.CloseBtn.onClick).AddListener(new UnityAction((object) this, __methodptr(OnCloseDetail)));
    }
    ...
    public void Setup(ItemData _data) => this.mCurrentItem = _data;
