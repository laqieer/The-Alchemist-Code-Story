...
namespace SRPG
{
  public class FriendPresentRootWindow : FlowWindowBase
  {
    ...
    public override string name => nameof (FriendPresentRootWindow);

    public static FriendPresentRootWindow instance => FriendPresentRootWindow.m_Instance;
    ...
    public override void Initialize(FlowWindowBase.SerializeParamBase param)
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ValueList, (UnityEngine.Object) null))
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ReceiveToggle, (UnityEngine.Object) null))
          ((Selectable) this.m_ReceiveToggle).interactable = false;
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_SendToggle, (UnityEngine.Object) null))
          ((Selectable) this.m_SendToggle).interactable = false;
      }
    ...
    public override int Update()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ReceiveToggle, (UnityEngine.Object) null))
        ((Selectable) this.m_ReceiveToggle).interactable = active == 0;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_SendToggle, (UnityEngine.Object) null))
        ((Selectable) this.m_SendToggle).interactable = active == 0;
      return -1;
    }
    ...
    public void InitializeWantList()
    {
      ...
      this.m_WantController.Initialize((ContentSource) this.m_WantSource, Vector2.zero);
    }
    ...
    public void InitializeReceiveList()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ReceiveController, (UnityEngine.Object) null))
      {
        ...
        this.m_ReceiveController.Initialize((ContentSource) this.m_ReceiveSource, Vector2.zero);
      }
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ValueList, (UnityEngine.Object) null))
        return;
    ...
    public void InitializeSendList()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_SendController, (UnityEngine.Object) null))
      {
        ...
        this.m_SendController.Initialize((ContentSource) this.m_SendSource, Vector2.zero);
      }
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ValueList, (UnityEngine.Object) null))
        return;
      bool flag = false;
    ...
    public static class WantContent
    {
      ...
      public class ItemAccessor
      {
        ...
        public int priority
        {
          get => UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Node, (UnityEngine.Object) null) ? this.m_Node.index : 0;
        }
      ...
      public class ItemSource : ContentSource
      {
        ...
        public class ItemParam : ContentSource.Param
        {
          ...
          public FriendPresentRootWindow.WantContent.ItemAccessor accerror => this.m_Accessor;
    ...
    public static class ReceiveContent
    {
      ...
      public class ItemAccessor
      {
        ...
        public FriendPresentReceiveList.Param param => this.m_Param;

        public FriendPresentItemParam present => this.m_Param.present;

        public FriendPresentItemIcon icon => this.m_Icon;

        public bool isValid => this.m_Param != null;

        public void Setup(FriendPresentReceiveList.Param param) => this.m_Param = param;
      ...
      public class ItemSource : ContentSource
      {
        ...
        public class ItemParam : ContentSource.Param
        {
          ...
          public ItemParam(FriendPresentReceiveList.Param param) => this.m_Accessor.Setup(param);

          public override bool IsValid() => this.m_Accessor.isValid;

          public FriendPresentRootWindow.ReceiveContent.ItemAccessor accerror => this.m_Accessor;

          public FriendPresentReceiveList.Param param => this.m_Accessor.param;
    ...
    public static class SendContent
    {
      ...
      public class ItemAccessor
      {
        ...
        public FriendData friend => this.m_Friend;

        public FriendPresentItemParam present => this.m_Present;

        public FriendPresentItemIcon icon => this.m_Icon;

        public bool isValid => this.m_Friend != null && this.m_Present != null;
      ...
      public class ItemSource : ContentSource
      {
        ...
        public class ItemParam : ContentSource.Param
        {
          ...
          public FriendPresentRootWindow.SendContent.ItemAccessor accerror => this.m_Accessor;

          public FriendData friend => this.m_Accessor.friend;
    ...
    public class SerializeParam : FlowWindowBase.SerializeParamBase
    {
      ...
      public override System.Type type => typeof (FriendPresentRootWindow);
    }
  }
}
