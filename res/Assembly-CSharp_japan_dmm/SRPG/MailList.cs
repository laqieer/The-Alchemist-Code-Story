...
namespace SRPG
{
  ...
  public class MailList : MonoBehaviour, IFlowInterface
  {
    ...
    public void Activated(int pinID) => this.OnRefresh();

    private void Awake()
    {
      if (Object.op_Inequality((Object) this.ItemTemplate, (Object) null) && this.ItemTemplate.activeInHierarchy)
        this.ItemTemplate.SetActive(false);
      if (Object.op_Inequality((Object) this.ItemForeverTemplate, (Object) null) && this.ItemForeverTemplate.activeInHierarchy)
      ...
      if (!Object.op_Inequality((Object) this.ButtonReadAll, (Object) null))
        return;
      Button component = ((Component) this.ButtonReadAll).GetComponent<Button>();
      if (!Object.op_Inequality((Object) component, (Object) null))
        return;
      // ISSUE: method pointer
      ((UnityEvent) component.onClick).AddListener(new UnityAction((object) this, __methodptr(OnAllReadAccept)));
    }
    ...
    private void UpdateItems()
    {
      ...
      if (this.mItems != null)
      {
        ...
        for (int index = 0; index < this.mItems.Count; ++index)
          Object.Destroy((Object) this.mItems[index].gameObject);
      }
      List<MailData> mails = MonoSingleton<GameManager>.Instance.Player.Mails;
      ...
      for (int index1 = mails.Count - 1; index1 >= 0; --index1)
      {
        ...
        if (num >= 2)
        {
          MailIcon component = gameObject2.GetComponent<MailIcon>();
          if (Object.op_Inequality((Object) component, (Object) null))
          {
        ...
        GameObject gameObject3 = ((Component) gameObject2.transform.Find("btn_read")).gameObject;
        if (Object.op_Inequality((Object) gameObject3, (Object) null))
        {
          DataSource.Bind<MailData>(gameObject3, data1);
          Button component1 = gameObject3.GetComponent<Button>();
          if (Object.op_Inequality((Object) component1, (Object) null))
          {
            ListItemEvents component2 = ((Component) component1).GetComponent<ListItemEvents>();
    ...
    private void ToggleReadAll()
    {
      if (this.mUnreadMails.Count < 1)
        ((Component) this.ButtonReadAll).gameObject.SetActive(false);
      else
        ((Component) this.ButtonReadAll).gameObject.SetActive(true);
    }
    ...
    private void OnShowRead(bool isActive)
    {
      if (!isActive)
        return;
      foreach (GameObject mUnreadMail in this.mUnreadMails)
      {
        if (DataSource.FindDataOfClass<MailData>(mUnreadMail.gameObject, (MailData) null) != null)
          mUnreadMail.SetActive(false);
      }
      foreach (GameObject mReadMail in this.mReadMails)
      {
        if (DataSource.FindDataOfClass<MailData>(mReadMail.gameObject, (MailData) null) != null)
          mReadMail.SetActive(true);
      }
    ...
    private void OnShowUnRead(bool isActive)
    {
      ...
      {
        if (DataSource.FindDataOfClass<MailData>(mReadMail.gameObject, (MailData) null) != null)
          mReadMail.SetActive(false);
      }
      foreach (GameObject mUnreadMail in this.mUnreadMails)
      {
        if (DataSource.FindDataOfClass<MailData>(mUnreadMail.gameObject, (MailData) null) != null)
          mUnreadMail.SetActive(true);
      }
      if (Object.op_Inequality((Object) this.ScrollView, (Object) null))
        this.ScrollView.SetScrollPos(1f);
      this.ToggleReadAll();
    ...
    {
      int num = 0;
      foreach (GiftRecieveItemData giftRecieveItemData in reward.GiftRecieveItemDataDic.Values)
      {
        if (giftRecieveItemData.type == GiftTypes.Artifact)
          num += this.currentNums[GiftTypes.Artifact] + giftRecieveItemData.num;
      }
    ...
    private void OnAllReadAccept()
    {
      ...
      for (int index1 = 0; index1 < this.mUnreadMails.Count && num1 < this.MaxReadCount; ++index1)
      {
        ...
        if (dataOfClass != null)
        {
          ...
          {
            ++num1;
            foreach (GiftRecieveItemData data in rewardData2.GiftRecieveItemDataDic.Values)
            {
              if (rewardData1.GiftRecieveItemDataDic.ContainsKey(data.iname))
                rewardData1.GiftRecieveItemDataDic[data.iname].num += data.num;
              else
                rewardData1.GiftRecieveItemDataDic.Add(data.iname, data);
              this.AddCurrentNum(data);
            }
