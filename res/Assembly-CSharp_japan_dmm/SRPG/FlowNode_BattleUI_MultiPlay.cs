...
namespace SRPG
{
  ...
  public class FlowNode_BattleUI_MultiPlay : FlowNodePersistent
  {
    ...
    public void OnMyUnitStart() => this.ActivateOutputLinks(1060);

    public void OnOtherUnitStart() => this.ActivateOutputLinks(1061);

    public void OnEnemyUnitStart() => this.ActivateOutputLinks(1062);

    public void OnMyUnitEnd() => this.ActivateOutputLinks(1070);

    public void OnOtherUnitEnd() => this.ActivateOutputLinks(1071);

    public void OnEnemyUnitEnd() => this.ActivateOutputLinks(1072);

    public void StartSelectRevive() => this.ActivateOutputLinks(1100);

    public void StartSelectContinue() => this.ActivateOutputLinks(1101);

    public void ShowWaitRevive() => this.ActivateOutputLinks(1110);

    public void HideWaitRevive() => this.ActivateOutputLinks(1111);

    public void ShowWaitContinue() => this.ActivateOutputLinks(1120);

    public void HideWaitContinue() => this.ActivateOutputLinks(1121);

    public void OnQuestWin() => this.ActivateOutputLinks(1200);

    public void OnQuestLose() => this.ActivateOutputLinks(1201);

    public void OnQuestRetreat() => this.ActivateOutputLinks(1202);

    public void OnMapStart() => this.ActivateOutputLinks(1300);

    public void OnMapEnd() => this.ActivateOutputLinks(1301);

    public void ShowInputTimeLimit() => this.ActivateOutputLinks(4000);

    public void HideInputTimeLimit() => this.ActivateOutputLinks(4001);

    public void ShowThinking() => this.ActivateOutputLinks(4010);

    public void HideThinking() => this.ActivateOutputLinks(4011);

    public void OnOtherDisconnected() => this.ActivateOutputLinks(4030);

    public void OnOtherDisconnectedForce() => this.ActivateOutputLinks(4032);

    public void OnMyDisconnected() => this.ActivateOutputLinks(4050);

    public void OnExtInput() => this.ActivateOutputLinks(4201);

    public void OnOtherPlayerResume() => this.ActivateOutputLinks(4300);

    public void OnOtherPlayerResumeClose() => this.ActivateOutputLinks(4303);

    public void OnMyPlayerResume() => this.ActivateOutputLinks(4302);

    public void OnMyPlayerResumeClose() => this.ActivateOutputLinks(4304);

    public void OnOtherPlayerSyncStart() => this.ActivateOutputLinks(4400);

    public void OnOtherPlayerSyncEnd() => this.ActivateOutputLinks(4401);

    public void OnForceWin() => this.ActivateOutputLinks(4500);

    public void OnForceWinClose() => this.ActivateOutputLinks(4502);

    public void OnAlreadyFinish() => this.ActivateOutputLinks(4600);

    public void OnAudienceMode() => this.ActivateOutputLinks(4700);

    public void OnAudienceForceEnd() => this.ActivateOutputLinks(4701);
          ...
          switch (GlobalVars.SelectedMultiPlayRoomType)
          {
            case JSON_MyPhotonRoomParam.EType.VERSUS:
              if (MonoSingleton<GameManager>.Instance.IsVSCpuBattle)
                return;
              goto case JSON_MyPhotonRoomParam.EType.RANKMATCH;
            case JSON_MyPhotonRoomParam.EType.RANKMATCH:
              instance3.Battle.IsVSForceWin = true;
              return;
            default:
              return;
          }
    ...
    public BattleStamp StampWindow
    {
      get
      {
        BattleStamp[] componentsInChildren = ((Component) this).gameObject.GetComponentsInChildren<BattleStamp>(true);
        return componentsInChildren == null || componentsInChildren.Length <= 0 ? (BattleStamp) null : componentsInChildren[0];
      }
    }
  }
}
