...
namespace SRPG
{
  public class BoxGachaLineupListWindow : FlowWindowBase
  {
    ...
    public int step => this.m_LineupData != null ? this.m_LineupData.step : 1;

    public static BoxGachaLineupListWindow Instance => BoxGachaLineupListWindow.m_Instance;
    ...
    public override void Initialize(FlowWindowBase.SerializeParamBase param)
    {
      ...
      if (this.m_Param == null)
        return;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Param.lineupList, (UnityEngine.Object) null))
      {
        this.m_LineupController = this.m_Param.lineupList.GetComponentInChildren<ContentController>();
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_LineupController, (UnityEngine.Object) null))
    ...
    public static class LineupContent
    {
      ...
      public class ItemAccessor
      {
        ...
        public BoxGachaLineupListWindow.LineupData.BoxItemData param => this.m_Param;
        ...
        public void Bind(ContentNode node)
        {
          ...
          SerializeValueBehaviour component1 = ((Component) this.m_Node).GetComponent<SerializeValueBehaviour>();
          if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) component1, (UnityEngine.Object) null))
            return;
          this.m_FeatureBadge = component1.list.GetGameObject("feature_badge");
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_FeatureBadge, (UnityEngine.Object) null))
            this.m_FeatureBadge.SetActive(this.param.isFeatureItem);
          this.m_Name = component1.list.GetUILabel("name");
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Name, (UnityEngine.Object) null))
            this.m_Name.text = this.param.name;
          this.m_Remain = component1.list.GetUILabel("remain");
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Remain, (UnityEngine.Object) null))
          {
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_Num, (UnityEngine.Object) null))
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_NormalTop, (UnityEngine.Object) null))
            this.m_NormalTop.SetActive(!this.param.isFeatureItem && this.param.isFirst);
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_NormalDefault, (UnityEngine.Object) null))
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_RemainAllFeture, (UnityEngine.Object) null))
          {
            string empty = string.Empty;
            if (!this.param.isLineup)
          ...
          if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_RemainAllNormal, (UnityEngine.Object) null))
            return;
      ...
      public class ItemSource : ContentSource
      {
        ...
        public class ItemParam : ContentSource.Param
        {
          ...
          public BoxGachaLineupListWindow.LineupContent.ItemAccessor accessor => this.m_Accessor;

          public BoxGachaLineupListWindow.LineupData.BoxItemData param => this.m_Accessor.param;
    ...
    public class LineupData
    {
      ...
      public int total => this.m_TotalNum;

      public BoxGachaLineupListWindow.LineupData.BoxItemData[] box_items => this.m_BoxItems;
      ...
      public class BoxItemData
      {
        ...
        public bool isFeatureItem => this.m_IsFeatureItem;

        public string itype => this.m_Itype;

        public string iname => this.m_Iname;

        public int num => this.m_Num;

        public int total_num => this.m_TotalNum;

        public int remain_num => this.m_RemainNum;

        public int coin => this.m_Coin;

        public int gold => this.m_Gold;

        public string box_set_iname => this.m_BoxSetIname;

        public string box_set_name => this.m_BoxSetName;

        public bool isFirst => this.m_IsFirst;

        public GenesisRewardDataParam reward => this.m_Reward;

        public string name => this.m_Name;

        public bool isLineup => this.m_IsLineup;

        public int total_num_feature => this.m_TotalNumFeature;

        public int total_num_normal => this.m_TotalNumNormal;

        public int remain_num_feature => this.m_RemainNumFeature;

        public int remain_num_normal => this.m_RemainNumNormal;
    ...
    public class SerializeParam : FlowWindowBase.SerializeParamBase
    {
      ...
      public override System.Type type => typeof (BoxGachaLineupListWindow);
    }
  }
}
