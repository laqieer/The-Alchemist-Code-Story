...
namespace SRPG
{
  ...
  [FlowNode.Pin(12000, "No Match BattleVersion", FlowNode.PinTypes.Output, 12000)]
  public class FlowNode_MultiPlayAPI : FlowNode_Network
  {
    ...
    private const int PIN_OUT_NO_MATCH_BATTLEVERSION = 12000;
    ...
    private void ResetPlacementParam()
    {
      for (int index = 0; index < this.MULTI_TOWER_UNIT_MAX; ++index)
        PlayerPrefsUtility.SetInt(PlayerPrefsUtility.MULTITW_ID_KEY + (object) index, index);
    ...
    public override void OnActivate(int pinID)
    {
      switch (pinID)
      {
        ...
        case 22:
          ...
          GlobalVars.SelectedMultiPlayHiSpeed = PlayerPrefsUtility.GetInt(PlayerPrefsUtility.MULTI_HI_SPEED) == 1;
          float btlSpeed = PlayerPrefsUtility.GetFloat(PlayerPrefsUtility.MULTI_BATTLE_SPEED, 1f);
          if ((double) btlSpeed > 2.0 && !MonoSingleton<GameManager>.Instance.Player.IsEnableExpansionPurchaseForValue((int) btlSpeed, ExpansionPurchaseParam.eExpansionType.TripleSpeed))
            btlSpeed = 2f;
          GlobalVars.SelectedMultiPlayBtlSpeed = (int) btlSpeed;
          bool isPrivate = flag1;
          ...
          int multiPlayJoinUnitLv = isPrivate || !limit ? 0 : GlobalVars.MultiPlayJoinUnitLv;
          ...
          bool enable_auto1 = PlayerPrefsUtility.GetInt(PlayerPrefsUtility.MULTI_AUTO_ALLOWED) == 1;
          GlobalVars.SelectedMultiPlayAutoAllowed = enable_auto1;
          if (this.IsMultiAreaQuest())
          {
            Vector2 location = GlobalVars.Location;
            this.ExecRequest((WebAPI) new ReqMultiAreaRoomMake(GlobalVars.SelectedQuestID, str, GlobalVars.EditMultiPlayRoomPassCode, isPrivate, (int) btlSpeed, limit, multiPlayJoinUnitLv, clear, enable_auto1, location, new Network.ResponseCallback(((FlowNode_Network) this).ResponseCallback)));
            break;
          }
          if (pinID != 22)
          {
            this.ExecRequest((WebAPI) new ReqMPRoomMake(GlobalVars.SelectedQuestID, str, GlobalVars.EditMultiPlayRoomPassCode, isPrivate, (int) btlSpeed, limit, multiPlayJoinUnitLv, clear, enable_auto1, new Network.ResponseCallback(((FlowNode_Network) this).ResponseCallback)));
            break;
          }
        ...
        case 51:
          ...
          this.ExecRequest((WebAPI) new ReqMultiTwRoomJoin(GlobalVars.SelectedMultiPlayRoomID, new Network.ResponseCallback(((FlowNode_Network) this).ResponseCallback), LockRoom, selectedMultiTowerFloor3));
          break;
        case 7:
        case 26:
        case 55:
        case 56:
          ...
          {
            int btlSpd = PlayerPrefsUtility.GetInt(PlayerPrefsUtility.MULTI_BATTLE_SPEED, 1);
            int enable_auto2 = PlayerPrefsUtility.GetInt(PlayerPrefsUtility.MULTI_AUTO_ALLOWED);
            ...
            if (currentRoom != null)
            {
              ...
              {
                bool flag2 = false;
                btlSpd = myPhotonRoomParam.btlSpd;
                if (instance.IsOldestPlayer())
                {
                  if (myPhotonRoomParam.autoAllowed != enable_auto2)
                  {
                    myPhotonRoomParam.autoAllowed = enable_auto2;
                    flag2 = true;
                  }
                  if (flag2)
            ...
            this.ExecRequest((WebAPI) new ReqMPRoomUpdate(GlobalVars.SelectedMultiPlayRoomID, GlobalVars.EditMultiPlayRoomComment, GlobalVars.EditMultiPlayRoomPassCode, btlSpd, enable_auto2, new Network.ResponseCallback(((FlowNode_Network) this).ResponseCallback)));
            break;
          }
        ...
        case 30:
          ...
          if (pinID == 30)
          {
            ...
            this.ExecRequest((WebAPI) new ReqMultiTwRoomJoin(GlobalVars.SelectedMultiPlayRoomID, new Network.ResponseCallback(((FlowNode_Network) this).ResponseCallback)));
            break;
          }
          this.API = FlowNode_MultiPlayAPI.EAPI.MT_JOIN;
          this.ExecRequest((WebAPI) new ReqMultiTwRoomJoin(GlobalVars.SelectedMultiPlayRoomID, new Network.ResponseCallback(((FlowNode_Network) this).ResponseCallback), true, isInv: pinID == 28));
          break;
        case 9:
          if (Network.Mode != Network.EConnectMode.Online)
          {
        ...
        case 31:
          ...
          int skip_floor = 0;
          if (UnityEngine.Object.op_Implicit((UnityEngine.Object) instance4))
        ...
        case 32:
          ...
          if (UnityEngine.Object.op_Inequality((UnityEngine.Object) instance6, (UnityEngine.Object) null) && instance6.IsConnectedInRoom())
          {
            ...
            if (instance6.IsCreatedRoom())
            {
              ...
              if (currentRoom != null)
              {
                ...
                if (myPhotonRoomParam != null)
                {
                  ...
                  myPhotonRoomParam.support = (JSON_MyPhotonPlayerParam[]) null;
    ...
    private IEnumerator GetPhotonRoomList(string fuid)
    {
      ...
      return (IEnumerator) new FlowNode_MultiPlayAPI.\u003CGetPhotonRoomList\u003Ec__Iterator0()
      {
        fuid = fuid,
        \u0024this = this
      };
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new FlowNode_MultiPlayAPI.\u003CGetPhotonRoomName\u003Ec__Iterator1()
      {
        \u0024this = this
      };
    }
    ...
    public override void OnSuccess(WWWResult www)
    {
      ...
      if (Network.IsError)
      {
        switch (Network.ErrCode)
        {
          ...
          case Network.EErrCode.VS_Version:
            ...
            break;
          case Network.EErrCode.DiffBattleVersion:
            Network.RemoveAPI();
            Network.ResetError();
            if (UnityEngine.Object.op_Equality((UnityEngine.Object) this, (UnityEngine.Object) null))
              break;
            ((Behaviour) this).enabled = false;
            UIUtility.SystemMessage(Network.ErrMsg, (UIUtility.DialogResultEvent) (go => this.ActivateOutputLinks(101)), systemModal: true);
            break;
          ...
          case Network.EErrCode.VS_IllComment:
            if (this.API == FlowNode_MultiPlayAPI.EAPI.MAKE)
            {
              ...
              PlayerPrefsUtility.SetString(PlayerPrefsUtility.ROOM_COMMENT_KEY, str);
            }
            Network.RemoveAPI();
            Network.ResetError();
            if (UnityEngine.Object.op_Equality((UnityEngine.Object) this, (UnityEngine.Object) null))
      ...
      else
      {
        if (this.API == FlowNode_MultiPlayAPI.EAPI.MAKE)
        {
          ...
          if (jsonObject.body.btl_ver != null)
            MonoSingleton<GameManager>.Instance.BattleVersion = jsonObject.body.btl_ver;
        ...
        else if (this.API != FlowNode_MultiPlayAPI.EAPI.UPDATE)
        {
          ...
          else if (this.API == FlowNode_MultiPlayAPI.EAPI.MT_STATUS)
          {
            ...
            GameManager instance = MonoSingleton<GameManager>.Instance;
            if (jsonObject.body.btl_ver != null)
              instance.BattleVersion = jsonObject.body.btl_ver;
            instance.Deserialize(jsonObject.body);
          }
          ...
          else if (this.API == FlowNode_MultiPlayAPI.EAPI.RANKMATCH_STATUS)
          {
            ...
            GameManager gameManager = instance;
            long num4 = 0;
            instance.RankMatchNextTime = num4;
            long num5 = num4;
            gameManager.RankMatchExpiredTime = num5;
            if (jsonObject.body.enabletime != null)
            {
              instance.RankMatchExpiredTime = jsonObject.body.enabletime.expired;
              instance.RankMatchNextTime = jsonObject.body.enabletime.next;
              GlobalVars.SelectedQuestID = jsonObject.body.enabletime.iname;
              long matchExpiredTime = instance.RankMatchExpiredTime;
              long num6 = TimeManager.FromDateTime(TimeManager.ServerTime);
              instance.RankMatchBegin = num6 < matchExpiredTime;
            }
          }
        }
        Network.RemoveAPI();
