...
namespace SRPG
{
  ...
  [FlowNode.Pin(9000, "No Match BattleVersion", FlowNode.PinTypes.Output, 9000)]
  public class FlowNode_MultiPlayResume : FlowNode_StartQuest
  {
    private const int PIN_OUT_NO_MATCH_BATTLEVERSION = 9000;
    ...
    public override void OnActivate(int pinID)
    {
      switch (pinID)
      {
        ...
        case 201:
          ...
          BattleCore.Json_Battle info = new BattleCore.Json_Battle();
          info.btlinfo = (BattleCore.Json_BtlInfo) FlowNode_MultiPlayResume.BtlInfo;
          info.btlid = (long) GlobalVars.BtlID;
          if (AssetDownloader.IsEnableShowSizeBeforeDownloading())
          {
            ...
            AssetDownloader.StartConfirmDownloadQuestContentYesNo(FlowNode_MultiPlayResume.BtlInfo.GetPlayerSideUnits(), (List<ItemData>) null, quest, (UIUtility.DialogResultEvent) (ok => this.StartCoroutine(this.StartScene(info))), (UIUtility.DialogResultEvent) (no =>
            {
          ...
          this.StartCoroutine(this.StartScene(info));
          break;
        case 202:
          if (Network.Mode != Network.EConnectMode.Online)
          {
      ...
      if (Network.IsError)
      {
        switch (Network.ErrCode)
        {
          ...
          case Network.EErrCode.DiffBattleVersion:
            ...
            Network.ResetError();
            ((Behaviour) this).enabled = false;
            UIUtility.SystemMessage(Network.ErrMsg, (UIUtility.DialogResultEvent) (go => this.ActivateOutputLinks(301)), systemModal: true);
            break;
