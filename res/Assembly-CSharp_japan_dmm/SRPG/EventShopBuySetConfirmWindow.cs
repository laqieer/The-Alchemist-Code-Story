    ...
    private void Refresh()
    {
      ...
      else
      {
        ...
        if (this.mShopitem.IsSet)
        {
          ...
          {
            GameObject gameObject = index >= this.event_shop_item_set_list.Count ? UnityEngine.Object.Instantiate<GameObject>(this.ItemTemplate) : ((Component) this.event_shop_item_set_list[index]).gameObject;
      ...
      DataSource.Bind<EventShopItem>(((Component) this).gameObject, this.mShopitem);
