...
namespace SRPG
{
  public class TargetPlate : MonoBehaviour
  {
    ...
    public Unit SelectedUnit => this.mSelectedUnit;
    ...
    public WindowController WindowController
    {
      get
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.mWindowController, (UnityEngine.Object) null))
          this.mWindowController = ((Component) this).gameObject.GetComponent<WindowController>();
    ...
    private CanvasGroup TargetCg
    {
      get
      {
        if (UnityEngine.Object.op_Equality((UnityEngine.Object) this.mTargetCg, (UnityEngine.Object) null))
          this.mTargetCg = ((Component) this).GetComponent<CanvasGroup>();
      ...
      if (this.CgCanTouchs != null)
      {
        ...
        if (UnityEngine.Object.op_Implicit((UnityEngine.Object) targetCg))
        {
          foreach (CanvasGroup cgCanTouch in this.CgCanTouchs)
            cgCanTouch.ignoreParentGroups = (double) targetCg.alpha >= 1.0;
        }
      }
    ...
    public void SetTrick(TrickParam trick_param)
    {
      ...
      DataSource.Bind<TrickParam>(((Component) this).gameObject, trick_param);
      GameParameter.UpdateAll(((Component) this).gameObject);
    }

    public void SetProtectAction(bool isProtect)
    {
      this.SetActive(this.ProtectIcon, isProtect);
      GameParameter.UpdateAll(((Component) this).gameObject);
    }
    ...
    public void SetNextTargetArrowActive(bool active) => this.NextTargetArrow.SetActive(active);

    public void SetPrevTargetArrowActive(bool active) => this.PrevTargetArrow.SetActive(active);
      ...
      bool is_max_damage = false)
    {
      ...
      {
        long num = MaxHp;
        MaxHp = Math.Max(num + (long) PlusValue, 0L);
        this.mHpGaugeParam.MaxValue = num == 0L ? 1f : Mathf.Clamp01((float) MaxHp / (float) num);
        CurrentHp = Math.Min(Math.Max(CurrentHp, 0L), MaxHp);
        PlusValue = 0;
      }
      else
      ...
      int PlusValue)
    {
      ...
      if (0 > PlusValue)
      {
        ...
        color32Array[0].a = (byte) ((double) Mathf.Clamp01((float) (CurrentValue + (long) PlusValue) / (CurrentValue == 0L ? 1f : (float) CurrentValue)) * (double) byte.MaxValue);
      ...
      else if (0 < PlusValue)
      {
        ...
        long num = Math.Min(CurrentValue + (long) PlusValue, MaxValue);
        color32Array[0].a = (byte) ((double) Mathf.Clamp01((float) CurrentValue / (num == 0L ? 1f : (float) num)) * (double) byte.MaxValue);
    ...
    {
      this.SetHpGaugeParam(Side, CurrentHp, MaxHp);
      this.UpdateGauge(this.mHpGaugeParam, this.HpGauge, this.HpMaxGauge);
    }
    ...
    public void OpenGimmickDescription() => this.ToggleGimmickDescription(true);
    ...
    {
      if (!UnityEngine.Object.op_Implicit((UnityEngine.Object) this.GoHpGaugeNormal) || !UnityEngine.Object.op_Implicit((UnityEngine.Object) this.GoHpGaugeBoss))
        return;
      bool flag = this.mSelectedUnit != null && this.mSelectedUnit.IsUseBossLongHP();
      this.GoHpGaugeNormal.SetActive(!flag);
      this.GoHpGaugeBoss.SetActive(flag);
    }
