...
namespace SRPG
{
  ...
  public class VersusDraftList : MonoBehaviour, IFlowInterface
  {
    ...
    private readonly int[] DRAFT_UNIT_LIST_COLS = new int[4]
    {
      6,
      12,
      14,
    ...
    private readonly int[] SECRET_INDEX_LIST = new int[6]
    {
      14,
      13,
      15,
    ...
    private readonly int[] SELECTABLE_UNIT_COUNT_OF_TURN = new int[7]
    {
      1,
      2,
      2,
    ...
    public int SelectableUnitCount
    {
      get
      {
        return this.mTurn < 0 || this.SELECTABLE_UNIT_COUNT_OF_TURN.Length <= this.mTurn ? 0 : this.SELECTABLE_UNIT_COUNT_OF_TURN[this.mTurn];
      }
    }
    ...
    private void Start()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mDraftUnitItem, (UnityEngine.Object) null))
        ((Component) this.mDraftUnitItem).gameObject.SetActive(false);
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mSelectedUnitItem, (UnityEngine.Object) null))
        ((Component) this.mSelectedUnitItem).gameObject.SetActive(false);
    ...
    private IEnumerator RandomSelecting()
    {
      ...
      return (IEnumerator) new VersusDraftList.\u003CRandomSelecting\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    private void UpdateSingleMode()
    {
      ...
      else
      {
        ...
        this.SendRoomMessage(mess1, is_enemy: true);
    ...
    private void Initialize()
    {
      ...
      for (; index3 < VersusDraftList.VersusDraftUnitList.Count; ++index3)
      {
        ...
        {
          while (dictionary[key1] != null)
            ++key1;
          dictionary[key1] = VersusDraftList.VersusDraftUnitList[index3];
        }
      }
      this.mVersusDraftUnitList = new List<VersusDraftUnit>();
      for (int key2 = 0; key2 < dictionary.Count && this.mDraftUnitTransforms != null && this.mDraftUnitTransforms.Length > 0; ++key2)
      {
        Json_Unit jsonUnit = dictionary[key2].GetJson_Unit();
        if (jsonUnit != null)
        {
          ...
          if (unit != null)
          {
            ...
            int index4 = 0;
            for (int index5 = 0; index5 < this.DRAFT_UNIT_LIST_COLS.Length; ++index5)
            {
              if (key2 < this.DRAFT_UNIT_LIST_COLS[index5])
              {
                index4 = index5;
                break;
              }
            }
            if (this.mDraftUnitTransforms.Length > index4)
              draftUnitTransform = this.mDraftUnitTransforms[index4];
            versusDraftUnit.SetUp(unit, draftUnitTransform, dictionary[key2].IsHidden);
          }
        }
      }
      this.mVersusDraftSelectedUnit = new List<VersusDraftSelectedUnit>();
      for (int index6 = 0; index6 < 6 && !UnityEngine.Object.op_Equality((UnityEngine.Object) this.mSelectedUnitTransform, (UnityEngine.Object) null); ++index6)
      {
        ...
        ((Component) draftSelectedUnit).transform.SetParent(this.mSelectedUnitTransform, false);
        ((Component) draftSelectedUnit).gameObject.SetActive(true);
    ...
    {
      List<VersusDraftUnit> all = this.mVersusDraftUnitList.FindAll((Predicate<VersusDraftUnit>) (unit => !VersusDraftUnit.CurrentSelectCursors.Contains(unit) && !unit.IsSelected));
    ...
    private void DecideUnit()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) VersusDraftUnit.CurrentSelectCursors[0], (UnityEngine.Object) null))
      {
        ...
        currentSelectCursor.DecideUnit();
        mess.uidx0 = num;
    ...
    private void FinishTurn()
    {
      ...
      mess.h = 3;
      mess.b = this.mTurn;
      this.SendRoomMessage(mess, true);
    }
      ...
      bool is_enemy = false)
    {
      ...
      instance.SendRoomMessageBinary(true, msg);
      if (!immediate)
        return;
      instance.SendFlush();
    }
    ...
    private bool ChangeTurn(bool isPlayer = true)
    {
      ...
      ((Component) this.mPlayerText).gameObject.SetActive(isPlayer);
      this.mEnemyName.SetActive(!isPlayer);
      ((Component) this.mEnemyText).gameObject.SetActive(!isPlayer);
      string str;
      if (isPlayer)
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new VersusDraftList.\u003CDownloadUnitImage\u003Ec__Iterator1()
      {
        \u0024this = this
      };
    }
    ...
    public class VersusDraftMessageData : SceneBattle.MultiPlayRecvData
    {
      ...
      public VersusDraftMessageData() => this.qst = "draft";
    }
