...
namespace SRPG
{
  public class MultiInvitationReceiveWindow : FlowWindowBase
  {
    ...
    public override string name => nameof (MultiInvitationReceiveWindow);

    public static MultiInvitationReceiveWindow instance => MultiInvitationReceiveWindow.m_Instance;
    ...
    public override void Initialize(FlowWindowBase.SerializeParamBase param)
    {
      ...
      this.m_ValueList = this.m_Param != null ? this.m_Param.window.GetComponent<SerializeValueBehaviour>() : throw new Exception(this.ToString() + " > Failed serializeParam null.");
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ValueList, (UnityEngine.Object) null))
      {
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ActiveToggle, (UnityEngine.Object) null))
          ((Selectable) this.m_ActiveToggle).interactable = false;
        ...
        if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_LogToggle, (UnityEngine.Object) null))
          ((Selectable) this.m_LogToggle).interactable = false;
      }
    ...
    public override int Update()
    {
      ...
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_ActiveToggle, (UnityEngine.Object) null))
        ((Selectable) this.m_ActiveToggle).interactable = active == 0;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_LogToggle, (UnityEngine.Object) null))
        ((Selectable) this.m_LogToggle).interactable = active == 0;
      return -1;
    }
    ...
    public void InitializeActiveList()
    {
      ...
      this.m_ActiveController.Initialize((ContentSource) this.m_ActiveSource, Vector2.zero);
    }
    ...
    public void InitializeLogList()
    {
      ...
      this.m_LogController.Initialize((ContentSource) this.m_LogSource, Vector2.zero);
    }
    ...
    public int GetLogPage() => this.m_LogData != null ? this.m_LogData.page : -1;
        ...
        case 240:
          if (FlowNode_ButtonEvent.currentValue is SerializeValueList currentValue)
          {
            ...
            if (dataSource != null)
            {
              ...
              {
                if (LevelLock.ShowLockMessage(player.Lv, player.VipRank, UnlockTargets.Tower))
                  return -1;
              }
              else if (LevelLock.ShowLockMessage(player.Lv, player.VipRank, UnlockTargets.MultiPlay))
                return -1;
              ...
              if (dataSource.multiType == MultiInvitationReceiveWindow.MultiType.TOWER)
              {
                ...
                GlobalVars.SelectedQuestID = dataSource.quest.param.iname;
    ...
    public static class ActiveContent
    {
      ...
      public class ItemAccessor
      {
        ...
        public MultiInvitationReceiveWindow.ActiveData.RoomData param => this.m_Param;
      ...
      public class ItemSource : ContentSource
      {
        ...
        public class ItemParam : ContentSource.Param
        {
          ...
          public MultiInvitationReceiveWindow.ActiveData.RoomData param => this.m_Accessor.param;
    ...
    public static class LogContent
    {
      ...
      public class ItemAccessor
      {
        ...
        public MultiInvitationReceiveWindow.LogData.RoomData param => this.m_Param;
        ...
        public void Bind(ContentNode node)
        {
          ...
          if (days > 0)
            this.m_Value.list.SetField("time", LocalizedText.Get("sys.MULTIINVITATION_RECEIVE_TIMEDAY", (object) days.ToString()));
          else if (timeSpan.Hours > 0)
            this.m_Value.list.SetField("time", LocalizedText.Get("sys.MULTIINVITATION_RECEIVE_TIMHOUR", (object) timeSpan.Hours.ToString()));
          else
            this.m_Value.list.SetField("time", LocalizedText.Get("sys.MULTIINVITATION_RECEIVE_TIMEMINUTE", (object) timeSpan.Minutes.ToString()));
        }
      ...
      public class ItemSource : ContentSource
      {
        ...
        public class ItemParam : ContentSource.Param
        {
          ...
          public MultiInvitationReceiveWindow.LogContent.ItemAccessor accerror => this.m_Accessor;

          public MultiInvitationReceiveWindow.LogData.RoomData param => this.m_Accessor.param;
    ...
    public class SerializeParam : FlowWindowBase.SerializeParamBase
    {
      ...
      public override System.Type type => typeof (MultiInvitationReceiveWindow);
    }
    ...
    public class ActiveData
    {
      ...
      public class OwnerData
      {
        ...
        public bool isValid => this.friend != null;

        public string fuid => this.friend.FUID;
      }
      ...
      public class QuestData
      {
        ...
        public bool isValid => this.param != null;
      }
      ...
      public class RoomData
      {
        ...
        public bool isValid
        {
          get
          {
            return this.multiType != MultiInvitationReceiveWindow.MultiType.NONE && this.owner != null && this.quest != null && this.owner.isValid && this.quest.isValid;
          }
        }
      }
    }
    ...
    public class LogData
    {
      ...
      public class OwnerData
      {
        ...
        public bool isValid => !string.IsNullOrEmpty(this.uid) && this.unit != null;
      }
