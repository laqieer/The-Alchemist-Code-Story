...
namespace SRPG
{
  ...
  [FlowNode.Pin(12000, "NoBattleVersion", FlowNode.PinTypes.Output, 12000)]
  public class FlowNode_MultiPlayAPIVersus : FlowNode_Network
  {
    ...
    private abstract class Proccess
    {
      ...
      public void SetParent(FlowNode_MultiPlayAPIVersus apiVersus) => this.mParent = apiVersus;

      public abstract void Activate();

      public virtual bool Success(WWWResult www) => true;
    }
    ...
    private class Proccess_VersusLobby : FlowNode_MultiPlayAPIVersus.Proccess
    {
      ...
      {
        ((Behaviour) this.mParent).enabled = true;
      ...
      public override bool Success(WWWResult www)
      {
        ...
        if (jsonObject.body.streakwins != null)
        {
          for (int index = 0; index < jsonObject.body.streakwins.Length; ++index)
          {
            ...
            switch (instance.SearchVersusJudgeType(streakwin.schedule_id))
            {
        ...
        if (jsonObject.body.event_form != null)
          VersusDraft4thAnniversary.Setup(jsonObject.body.event_form);
        return true;
      }
    }
    ...
    private class Proccess_VersusCreateRoom : FlowNode_MultiPlayAPIVersus.Proccess
    {
      public override void Activate()
      {
        ...
        ((Behaviour) this.mParent).enabled = true;
        this.mParent.ExecRequest((WebAPI) new ReqVersusMake(GlobalVars.SelectedMultiPlayVersusType, comment, GlobalVars.SelectedQuestID, response: new Network.ResponseCallback(((FlowNode_Network) this.mParent).ResponseCallback)));
      }
