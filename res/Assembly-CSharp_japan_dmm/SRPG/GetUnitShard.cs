...
namespace SRPG
{
  public class GetUnitShard : MonoBehaviour
  {
    ...
    public bool IsReachingAwakelv() => this.StartAwakeLv >= this.AwakeLvCap;
    ...
    private class State_AddingGaugeSkip : State<GetUnitShard>
    {
      ...
      private IEnumerator WaitGaugeObject()
      {
        ...
        return (IEnumerator) new GetUnitShard.State_AddingGaugeSkip.\u003CWaitGaugeObject\u003Ec__Iterator0()
        {
          \u0024this = this
        };
      }
    ...
    private class State_StartJobOpenAnimation : State<GetUnitShard>
    {
      public override void Begin(GetUnitShard self)
      {
        Animator component = ((Component) self).GetComponent<Animator>();
        component.SetBool("is_skip", false);
        if (self.mJobEffectFlag || GameUtility.CompareAnimatorStateName((Component) self, "UnitShard_gauge_jobopen_loop"))
          return;
