...
namespace SRPG
{
  public class UnitBuffDisplay : MonoBehaviour
  {
    ...
    public UnitBuffDisplay.Object[] objects => this.m_Objects.ToArray();

    private void Awake()
    {
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.m_NodeRoot, (UnityEngine.Object) null))
        return;
      ((Component) this.m_NodeRoot).gameObject.SetActive(false);
    }
    ...
    private IEnumerator Start()
    {
      ...
      return (IEnumerator) new UnitBuffDisplay.\u003CStart\u003Ec__Iterator0()
      {
        \u0024this = this
      };
    }
    ...
    private void Initiallize(Unit owner) => this.m_Owner = owner;
    ...
    private void RequestBuff()
    {
      ...
      foreach (UnitBuffDisplayNode.Param otherParam in UnitBuffDisplayNode.CreateOtherParams(this, this.m_Owner))
      {
        UnitBuffDisplay.Object @object = (UnitBuffDisplay.Object) null;
        for (int index = 0; index < this.m_Objects.Count; ++index)
        {
          if (this.m_Objects[index].IsEqual(otherParam))
          {
            @object = this.m_Objects[index];
            break;
          }
        }
        if (@object == null)
          this.m_Objects.Add(new UnitBuffDisplay.Object(otherParam));
      }
    }
    ...
    private void UpdateBuff()
    {
      ...
      for (int index1 = 0; index1 < this.m_Objects.Count; ++index1)
      {
        ...
        {
          bool flag = false;
          for (int index3 = 0; index3 < @object.paramlist.Count; ++index3)
          {
            if (@object.paramlist[index3].isNeedDispOn)
            {
              flag = true;
              break;
            }
    ...
    private void CreateNode(UnitBuffDisplay.Object obj)
    {
      ...
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(((Component) this.m_NodeRoot).gameObject);
    ...
    private void RemoveNode(UnitBuffDisplay.Object obj)
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) obj.node, (UnityEngine.Object) null))
      {
        UnityEngine.Object.Destroy((UnityEngine.Object) ((Component) obj.node).gameObject);
    ...
    private void OnEnable() => this.UpdateBuff();
    ...
    public class Object
    {
      ...
      public void Add(UnitBuffDisplayNode.Param param) => this.paramlist.Add(param);

      public void Remove(UnitBuffDisplayNode.Param param) => this.paramlist.Remove(param);

      public bool IsEqual(UnitBuffDisplayNode.Param param)
      {
        return this.dispType == param.dispType && this.effectType == param.effectType;
      }
    }
  }
}
