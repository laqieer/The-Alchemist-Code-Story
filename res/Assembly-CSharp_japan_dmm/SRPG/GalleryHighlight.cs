  ...
  public class GalleryHighlight : MonoBehaviour, IFlowInterface
  {
    ...
    private void Update()
    {
      if (this.mLoadReq == null || !this.mFadeoutFinished || !this.mLoadReq.isDone)
        return;
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.ScriptScreen, (UnityEngine.Object) null))
      {
    ...
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.mCurrentImage, (UnityEngine.Object) null))
      ...
      if (!UnityEngine.Object.op_Inequality((UnityEngine.Object) this.HighlightHolder, (UnityEngine.Object) null))
        return;
    ...
    private IEnumerator AutoSkipMessage(float waitTime)
    {
      ...
      return (IEnumerator) new GalleryHighlight.\u003CAutoSkipMessage\u003Ec__Iterator0()
      {
        waitTime = waitTime,
        \u0024this = this
      };
    ...
    {
      if (UnityEngine.Object.op_Inequality((UnityEngine.Object) this.GiftWindow, (UnityEngine.Object) null))
        ((Component) this.GiftWindow).gameObject.SetActive(true);
