...
public class FlowNode_Variable : FlowNode
{
  ...
  public static void Set(string name, string value) => FlowNode_Variable.mKeyValues[name] = value;

  public static string Get(string name)
  {
    return !FlowNode_Variable.mKeyValues.ContainsKey(name) ? (string) null : FlowNode_Variable.mKeyValues[name];
  }
